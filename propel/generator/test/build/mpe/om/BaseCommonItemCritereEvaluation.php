...
abstract class BaseCommonItemCritereEvaluation extends BaseObject implements Persistent
{
    ...
    /**
     * @var        CommonCriteresEvaluation
     */
    protected $aCommonCriteresEvaluation;
    ...
    public function setIdcritereevaluation($v)
    {
        ...
        if ($this->aCommonCriteresEvaluation !== null && $this->aCommonCriteresEvaluation->getId() !== $v) {
            $this->aCommonCriteresEvaluation = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonCriteresEvaluation !== null && $this->idcritereevaluation !== $this->aCommonCriteresEvaluation->getId()) {
            $this->aCommonCriteresEvaluation = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonCriteresEvaluation !== null) {
                if ($this->aCommonCriteresEvaluation->isModified() || $this->aCommonCriteresEvaluation->isNew()) {
                    $affectedRows += $this->aCommonCriteresEvaluation->save($con);
                }
                $this->setCommonCriteresEvaluation($this->aCommonCriteresEvaluation);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonCriteresEvaluation !== null) {
                if (!$this->aCommonCriteresEvaluation->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonCriteresEvaluation->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonCriteresEvaluation) {
                $result['CommonCriteresEvaluation'] = $this->aCommonCriteresEvaluation->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a CommonCriteresEvaluation object.
     *
     * @param   CommonCriteresEvaluation $v
     * @return CommonItemCritereEvaluation The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonCriteresEvaluation(CommonCriteresEvaluation $v = null)
    {
        if ($v === null) {
            $this->setIdcritereevaluation(NULL);
        } else {
            $this->setIdcritereevaluation($v->getId());
        }

        $this->aCommonCriteresEvaluation = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonCriteresEvaluation object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonItemCritereEvaluation($this);
        }
    ...
    /**
     * Get the associated CommonCriteresEvaluation object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonCriteresEvaluation The associated CommonCriteresEvaluation object.
     * @throws PropelException
     */
    public function getCommonCriteresEvaluation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonCriteresEvaluation === null && ($this->idcritereevaluation !== null) && $doQuery) {
            $this->aCommonCriteresEvaluation = CommonCriteresEvaluationQuery::create()->findPk($this->idcritereevaluation, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonCriteresEvaluation->addCommonItemCritereEvaluations($this);
             */
        }

        return $this->aCommonCriteresEvaluation;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonCriteresEvaluation instanceof Persistent) {
              $this->aCommonCriteresEvaluation->clearAllReferences($deep);
            }
