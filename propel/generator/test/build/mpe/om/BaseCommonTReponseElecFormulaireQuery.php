 ...
 *
 * @method CommonTReponseElecFormulaireQuery leftJoinCommonEntreprise($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonTReponseElecFormulaireQuery rightJoinCommonEntreprise($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonTReponseElecFormulaireQuery innerJoinCommonEntreprise($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEntreprise relation
 *
 * @method CommonTReponseElecFormulaireQuery leftJoinCommonInscrit($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonInscrit relation
 * @method CommonTReponseElecFormulaireQuery rightJoinCommonInscrit($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonInscrit relation
 * @method CommonTReponseElecFormulaireQuery innerJoinCommonInscrit($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonInscrit relation
 *
...
abstract class BaseCommonTReponseElecFormulaireQuery extends ModelCriteria
{
    ...
    public function filterByCommonEntreprise($commonEntreprise, $comparison = null)
    {
        if ($commonEntreprise instanceof CommonEntreprise) {
            return $this
                ->addUsingAlias(CommonTReponseElecFormulairePeer::ID_ENTREPRISE, $commonEntreprise->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTReponseElecFormulairePeer::ID_ENTREPRISE, $commonEntreprise->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonInscrit($commonInscrit, $comparison = null)
    {
        if ($commonInscrit instanceof CommonInscrit) {
            return $this
                ->addUsingAlias(CommonTReponseElecFormulairePeer::ID_INSCRIT, $commonInscrit->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTReponseElecFormulairePeer::ID_INSCRIT, $commonInscrit->toKeyValue('Id', 'Id'), $comparison);
        } else {
