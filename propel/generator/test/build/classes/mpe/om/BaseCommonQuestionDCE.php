...
/**
 * Base class that represents a row from the 'QuestionDCE' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonQuestionDCE extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonQuestionDCEPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonQuestionDCEPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonQuestionDCE object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonQuestionDCE The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonQuestionDCEPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonQuestionDCEPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonQuestionDCEPeer::CONSULTATION_REF;
        }
    ...
    public function setDateDepot($v)
    {
        ...
        if ($this->date_depot !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = CommonQuestionDCEPeer::DATE_DEPOT;
            }
    ...
    public function setIdInscrit($v)
    {
        ...
        if ($this->id_inscrit !== $v) {
            $this->id_inscrit = $v;
            $this->modifiedColumns[] = CommonQuestionDCEPeer::ID_INSCRIT;
        }
    ...
    public function setIdEntreprise($v)
    {
        ...
        if ($this->id_entreprise !== $v) {
            ...
            $this->modifiedColumns[] = CommonQuestionDCEPeer::ID_ENTREPRISE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = CommonQuestionDCEPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonQuestionDCE object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonQuestionDCEPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonQuestionDCEQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonQuestionDCEPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonQuestionDCEPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonQuestionDCEPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonQuestionDCEPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonQuestionDCEPeer::DATE_DEPOT)) {
            $modifiedColumns[':p' . $index++]  = '`date_depot`';
        }
        if ($this->isColumnModified(CommonQuestionDCEPeer::ID_INSCRIT)) {
            $modifiedColumns[':p' . $index++]  = '`id_inscrit`';
        }
        if ($this->isColumnModified(CommonQuestionDCEPeer::ID_ENTREPRISE)) {
            $modifiedColumns[':p' . $index++]  = '`id_entreprise`';
        }

        $sql = sprintf(
            'INSERT INTO `QuestionDCE` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonQuestionDCEPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonQuestionDCEPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonQuestionDCE'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonQuestionDCE'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonQuestionDCEPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonQuestionDCEPeer::ID)) $criteria->add(CommonQuestionDCEPeer::ID, $this->id);
        if ($this->isColumnModified(CommonQuestionDCEPeer::ORGANISME)) $criteria->add(CommonQuestionDCEPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonQuestionDCEPeer::CONSULTATION_REF)) $criteria->add(CommonQuestionDCEPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonQuestionDCEPeer::DATE_DEPOT)) $criteria->add(CommonQuestionDCEPeer::DATE_DEPOT, $this->date_depot);
        if ($this->isColumnModified(CommonQuestionDCEPeer::ID_INSCRIT)) $criteria->add(CommonQuestionDCEPeer::ID_INSCRIT, $this->id_inscrit);
        if ($this->isColumnModified(CommonQuestionDCEPeer::ID_ENTREPRISE)) $criteria->add(CommonQuestionDCEPeer::ID_ENTREPRISE, $this->id_entreprise);
    ...
    {
        $criteria = new Criteria(CommonQuestionDCEPeer::DATABASE_NAME);
        $criteria->add(CommonQuestionDCEPeer::ID, $this->id);
        $criteria->add(CommonQuestionDCEPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonQuestionDCE (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonQuestionDCE Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonQuestionDCEPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonQuestionDCEPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonQuestionDCEPeer::DEFAULT_STRING_FORMAT);
    }
