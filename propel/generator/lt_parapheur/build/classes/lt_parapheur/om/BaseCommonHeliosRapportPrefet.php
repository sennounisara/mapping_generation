...
/**
 * Base class that represents a row from the 'Helios_rapport_prefet' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonHeliosRapportPrefet extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonHeliosRapportPrefetPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonHeliosRapportPrefetPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonHeliosRapportPrefet object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonHeliosRapportPrefet The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::CONSULTATION_REF;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::NOM_FICHIER;
        }
    ...
    public function setFichier($v)
    {
        ...
        if ($this->fichier !== $v) {
            $this->fichier = $v;
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::FICHIER;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::UNTRUSTEDDATE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::TAILLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CommonHeliosRapportPrefetPeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = CommonHeliosRapportPrefetPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonHeliosRapportPrefet object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonHeliosRapportPrefetPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonHeliosRapportPrefetQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonHeliosRapportPrefetPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`fichier`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }

        $sql = sprintf(
            'INSERT INTO `Helios_rapport_prefet` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonHeliosRapportPrefetPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonHeliosRapportPrefetPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonHeliosRapportPrefet'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonHeliosRapportPrefet'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonHeliosRapportPrefetPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::ID)) $criteria->add(CommonHeliosRapportPrefetPeer::ID, $this->id);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::ORGANISME)) $criteria->add(CommonHeliosRapportPrefetPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::CONSULTATION_REF)) $criteria->add(CommonHeliosRapportPrefetPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::NOM_FICHIER)) $criteria->add(CommonHeliosRapportPrefetPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::FICHIER)) $criteria->add(CommonHeliosRapportPrefetPeer::FICHIER, $this->fichier);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::HORODATAGE)) $criteria->add(CommonHeliosRapportPrefetPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::UNTRUSTEDDATE)) $criteria->add(CommonHeliosRapportPrefetPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::TAILLE)) $criteria->add(CommonHeliosRapportPrefetPeer::TAILLE, $this->taille);
        if ($this->isColumnModified(CommonHeliosRapportPrefetPeer::DESCRIPTION)) $criteria->add(CommonHeliosRapportPrefetPeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(CommonHeliosRapportPrefetPeer::DATABASE_NAME);
        $criteria->add(CommonHeliosRapportPrefetPeer::ID, $this->id);
        $criteria->add(CommonHeliosRapportPrefetPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonHeliosRapportPrefet (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonHeliosRapportPrefet Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonHeliosRapportPrefetPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonHeliosRapportPrefetPeer();
        }
    ...
    public function setCommonConsultation(CommonConsultation $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonHeliosRapportPrefet($this);
        }
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonHeliosRapportPrefets($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonHeliosRapportPrefetPeer::DEFAULT_STRING_FORMAT);
    }
