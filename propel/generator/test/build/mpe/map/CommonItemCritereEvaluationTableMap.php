...
class CommonItemCritereEvaluationTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('idCritereEvaluation', 'Idcritereevaluation', 'INTEGER', 'Criteres_Evaluation', 'id', true, null, null);
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonCriteresEvaluation', 'CommonCriteresEvaluation', RelationMap::MANY_TO_ONE, array('idCritereEvaluation' => 'id', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
