 ...
 *
 * @method CommonDAConsultationQuery leftJoinCommonOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonDAConsultationQuery rightJoinCommonOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonDAConsultationQuery innerJoinCommonOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonOrganisme relation
 *
...
abstract class BaseCommonDAConsultationQuery extends ModelCriteria
{
    ...
    public function filterByCommonOrganisme($commonOrganisme, $comparison = null)
    {
        if ($commonOrganisme instanceof CommonOrganisme) {
            return $this
                ->addUsingAlias(CommonDAConsultationPeer::ORGANISME, $commonOrganisme->getAcronyme(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonDAConsultationPeer::ORGANISME, $commonOrganisme->toKeyValue('PrimaryKey', 'Acronyme'), $comparison);
        } else {
