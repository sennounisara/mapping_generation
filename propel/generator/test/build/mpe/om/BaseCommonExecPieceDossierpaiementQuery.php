 ...
 *
 * @method CommonExecPieceDossierpaiementQuery leftJoinCommonAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgent relation
 * @method CommonExecPieceDossierpaiementQuery rightJoinCommonAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgent relation
 * @method CommonExecPieceDossierpaiementQuery innerJoinCommonAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgent relation
 *
...
abstract class BaseCommonExecPieceDossierpaiementQuery extends ModelCriteria
{
    ...
    public function filterByCommonAgent($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecPieceDossierpaiementPeer::ID_AGENT_CREAT, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonExecPieceDossierpaiementPeer::ID_AGENT_CREAT, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
