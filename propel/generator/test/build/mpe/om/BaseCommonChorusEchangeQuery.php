 ...
 *
 * @method CommonChorusEchangeQuery leftJoinCommonDecisionEnveloppe($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonDecisionEnveloppe relation
 * @method CommonChorusEchangeQuery rightJoinCommonDecisionEnveloppe($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonDecisionEnveloppe relation
 * @method CommonChorusEchangeQuery innerJoinCommonDecisionEnveloppe($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonDecisionEnveloppe relation
 *
 * @method CommonChorusEchangeQuery leftJoinCommonChorusPj($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonChorusPj relation
 * @method CommonChorusEchangeQuery rightJoinCommonChorusPj($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonChorusPj relation
 * @method CommonChorusEchangeQuery innerJoinCommonChorusPj($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonChorusPj relation
 *
...
abstract class BaseCommonChorusEchangeQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonDecisionEnveloppe()
     *
    ...
    /**
     * Filter the query by a related CommonDecisionEnveloppe object
     *
     * @param   CommonDecisionEnveloppe $commonDecisionEnveloppe The related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonChorusEchangeQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonDecisionEnveloppe($commonDecisionEnveloppe, $comparison = null)
    {
        if ($commonDecisionEnveloppe instanceof CommonDecisionEnveloppe) {
            return $this
                ->addUsingAlias(CommonChorusEchangePeer::ID_DECISION, $commonDecisionEnveloppe->getIdDecisionEnveloppe(), $comparison)
                ->addUsingAlias(CommonChorusEchangePeer::ORGANISME, $commonDecisionEnveloppe->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonDecisionEnveloppe() only accepts arguments of type CommonDecisionEnveloppe');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonDecisionEnveloppe relation
     *
     ...
     * @return CommonChorusEchangeQuery The current query, for fluid interface
     */
    public function joinCommonDecisionEnveloppe($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonDecisionEnveloppe');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonDecisionEnveloppe');
        }
    ...
    /**
     * Use the CommonDecisionEnveloppe relation CommonDecisionEnveloppe object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonDecisionEnveloppeQuery A secondary query class using the current class as primary query
     */
    public function useCommonDecisionEnveloppeQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCommonDecisionEnveloppe($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonDecisionEnveloppe', 'CommonDecisionEnveloppeQuery');
    }

    /**
     * Filter the query by a related CommonChorusPj object
     *
     * @param   CommonChorusPj|PropelObjectCollection $commonChorusPj  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonChorusEchangeQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonChorusPj($commonChorusPj, $comparison = null)
    {
        if ($commonChorusPj instanceof CommonChorusPj) {
            return $this
                ->addUsingAlias(CommonChorusEchangePeer::ID, $commonChorusPj->getIdEchange(), $comparison)
                ->addUsingAlias(CommonChorusEchangePeer::ORGANISME, $commonChorusPj->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonChorusPj() only accepts arguments of type CommonChorusPj');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonChorusPj relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonChorusEchangeQuery The current query, for fluid interface
     */
    public function joinCommonChorusPj($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonChorusPj');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonChorusPj');
        }
    ...
    /**
     * Use the CommonChorusPj relation CommonChorusPj object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonChorusPjQuery A secondary query class using the current class as primary query
     */
    public function useCommonChorusPjQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonChorusPj($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonChorusPj', 'CommonChorusPjQuery');
    }
