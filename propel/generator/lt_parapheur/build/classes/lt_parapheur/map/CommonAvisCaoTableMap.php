...
/**
 * This class defines the structure of the 'AvisCao' table.
 *
 *
 *
 ...
 */
class CommonAvisCaoTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonAvisCaoTableMap';
    ...
    {
        // attributes
        $this->setName('AvisCao');
        $this->setPhpName('CommonAvisCao');
        $this->setClassname('CommonAvisCao');
