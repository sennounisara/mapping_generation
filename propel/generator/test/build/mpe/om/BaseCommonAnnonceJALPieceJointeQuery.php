 ...
 *
 * @method CommonAnnonceJALPieceJointeQuery leftJoinCommonAnnonceJAL($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAnnonceJAL relation
 * @method CommonAnnonceJALPieceJointeQuery rightJoinCommonAnnonceJAL($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAnnonceJAL relation
 * @method CommonAnnonceJALPieceJointeQuery innerJoinCommonAnnonceJAL($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAnnonceJAL relation
 *
...
abstract class BaseCommonAnnonceJALPieceJointeQuery extends ModelCriteria
{
    ...
    public function filterByCommonAnnonceJAL($commonAnnonceJAL, $comparison = null)
    {
        if ($commonAnnonceJAL instanceof CommonAnnonceJAL) {
            return $this
                ->addUsingAlias(CommonAnnonceJALPieceJointePeer::ID_ANNONCE_JAL, $commonAnnonceJAL->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonAnnonceJALPieceJointePeer::ID_ANNONCE_JAL, $commonAnnonceJAL->toKeyValue('Id', 'Id'), $comparison);
        } else {
