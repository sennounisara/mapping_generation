 ...
 *
 * @method CommonFactureQuery leftJoinCommonInscrit($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonInscrit relation
 * @method CommonFactureQuery rightJoinCommonInscrit($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonInscrit relation
 * @method CommonFactureQuery innerJoinCommonInscrit($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonInscrit relation
 *
 * @method CommonFactureQuery leftJoinCommonEntreprise($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonFactureQuery rightJoinCommonEntreprise($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonFactureQuery innerJoinCommonEntreprise($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEntreprise relation
 *
...
abstract class BaseCommonFactureQuery extends ModelCriteria
{
    ...
    public function filterByCommonInscrit($commonInscrit, $comparison = null)
    {
        if ($commonInscrit instanceof CommonInscrit) {
            return $this
                ->addUsingAlias(CommonFacturePeer::ID_INSCRIT, $commonInscrit->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonFacturePeer::ID_INSCRIT, $commonInscrit->toKeyValue('Id', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonEntreprise($commonEntreprise, $comparison = null)
    {
        if ($commonEntreprise instanceof CommonEntreprise) {
            return $this
                ->addUsingAlias(CommonFacturePeer::ID_ENTREPRISE, $commonEntreprise->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonFacturePeer::ID_ENTREPRISE, $commonEntreprise->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
