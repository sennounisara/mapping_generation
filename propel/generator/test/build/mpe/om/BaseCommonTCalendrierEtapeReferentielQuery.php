 ...
 *
 * @method CommonTCalendrierEtapeReferentielQuery leftJoinCommonTypeProcedureOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTypeProcedureOrganisme relation
 * @method CommonTCalendrierEtapeReferentielQuery rightJoinCommonTypeProcedureOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTypeProcedureOrganisme relation
 * @method CommonTCalendrierEtapeReferentielQuery innerJoinCommonTypeProcedureOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTypeProcedureOrganisme relation
 *
...
abstract class BaseCommonTCalendrierEtapeReferentielQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonTypeProcedureOrganisme()
     *
    ...
    /**
     * Filter the query by a related CommonTypeProcedureOrganisme object
     *
     * @param   CommonTypeProcedureOrganisme $commonTypeProcedureOrganisme The related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonTCalendrierEtapeReferentielQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonTypeProcedureOrganisme($commonTypeProcedureOrganisme, $comparison = null)
    {
        if ($commonTypeProcedureOrganisme instanceof CommonTypeProcedureOrganisme) {
            return $this
                ->addUsingAlias(CommonTCalendrierEtapeReferentielPeer::ID_TYPE_PROCEDURE, $commonTypeProcedureOrganisme->getIdTypeProcedure(), $comparison)
                ->addUsingAlias(CommonTCalendrierEtapeReferentielPeer::ORGANISME, $commonTypeProcedureOrganisme->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonTypeProcedureOrganisme() only accepts arguments of type CommonTypeProcedureOrganisme');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonTypeProcedureOrganisme relation
     *
     ...
     * @return CommonTCalendrierEtapeReferentielQuery The current query, for fluid interface
     */
    public function joinCommonTypeProcedureOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonTypeProcedureOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonTypeProcedureOrganisme');
        }
    ...
    /**
     * Use the CommonTypeProcedureOrganisme relation CommonTypeProcedureOrganisme object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonTypeProcedureOrganismeQuery A secondary query class using the current class as primary query
     */
    public function useCommonTypeProcedureOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonTypeProcedureOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonTypeProcedureOrganisme', 'CommonTypeProcedureOrganismeQuery');
    }
