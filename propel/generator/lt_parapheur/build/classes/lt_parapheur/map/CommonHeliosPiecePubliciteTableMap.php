...
/**
 * This class defines the structure of the 'Helios_piece_publicite' table.
 *
 *
 *
 ...
 */
class CommonHeliosPiecePubliciteTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonHeliosPiecePubliciteTableMap';
    ...
    {
        // attributes
        $this->setName('Helios_piece_publicite');
        $this->setPhpName('CommonHeliosPiecePublicite');
        $this->setClassname('CommonHeliosPiecePublicite');
        ...
        $this->addColumn('taille', 'Taille', 'VARCHAR', true, 20, '1');
...
} // CommonHeliosPiecePubliciteTableMap
