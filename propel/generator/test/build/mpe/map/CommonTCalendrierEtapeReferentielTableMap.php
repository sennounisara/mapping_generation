...
class CommonTCalendrierEtapeReferentielTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('ID_TYPE_PROCEDURE', 'IdTypeProcedure', 'INTEGER' , 'Type_Procedure_Organisme', 'id_type_procedure', true, null, 0);
        $this->addForeignPrimaryKey('ORGANISME', 'Organisme', 'VARCHAR' , 'Type_Procedure_Organisme', 'organisme', true, 30, null);
    ...
    {
        $this->addRelation('CommonTypeProcedureOrganisme', 'CommonTypeProcedureOrganisme', RelationMap::MANY_TO_ONE, array('ID_TYPE_PROCEDURE' => 'id_type_procedure', 'ORGANISME' => 'organisme', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
