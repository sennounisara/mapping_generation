...
abstract class BaseCommonServicePeer
{
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonServicePeer::doOnDeleteCascade(new Criteria(CommonServicePeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonServicePeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonServicePeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonServicePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(CommonAffiliationServicePeer::ID_POLE, $obj->getId());
            $criteria->add(CommonAffiliationServicePeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonAffiliationServicePeer::doDelete($criteria, $con);

            // delete related CommonAffiliationService objects
            $criteria = new Criteria(CommonAffiliationServicePeer::DATABASE_NAME);
            
            $criteria->add(CommonAffiliationServicePeer::ID_SERVICE, $obj->getId());
            $criteria->add(CommonAffiliationServicePeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonAffiliationServicePeer::doDelete($criteria, $con);
        }
