 ...
 *
 * @method CommonEnchereTranchesBaremeNETCQuery leftJoinCommonEncherePmiRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchereOrganisme relation
 * @method CommonEnchereTranchesBaremeNETCQuery rightJoinCommonEncherePmiRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchereOrganisme relation
 * @method CommonEnchereTranchesBaremeNETCQuery innerJoinCommonEncherePmiRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEncherePmiRelatedByIdenchereOrganisme relation
 *
 * @method CommonEnchereTranchesBaremeNETCQuery leftJoinCommonEncherePmiRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchere relation
 * @method CommonEnchereTranchesBaremeNETCQuery rightJoinCommonEncherePmiRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchere relation
 * @method CommonEnchereTranchesBaremeNETCQuery innerJoinCommonEncherePmiRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEncherePmiRelatedByIdenchere relation
 *
...
abstract class BaseCommonEnchereTranchesBaremeNETCQuery extends ModelCriteria
{
    ...
    public function filterByCommonEncherePmiRelatedByIdenchereOrganisme($commonEncherePmi, $comparison = null)
    {
        if ($commonEncherePmi instanceof CommonEncherePmi) {
            return $this
                ->addUsingAlias(CommonEnchereTranchesBaremeNETCPeer::IDENCHERE, $commonEncherePmi->getId(), $comparison)
                ->addUsingAlias(CommonEnchereTranchesBaremeNETCPeer::ORGANISME, $commonEncherePmi->getOrganisme(), $comparison);
        } else {
    ...
    public function filterByCommonEncherePmiRelatedByIdenchere($commonEncherePmi, $comparison = null)
    {
        if ($commonEncherePmi instanceof CommonEncherePmi) {
            ...
            return $this
                ->addUsingAlias(CommonEnchereTranchesBaremeNETCPeer::IDENCHERE, $commonEncherePmi->toKeyValue('Id', 'Id'), $comparison);
        } else {
