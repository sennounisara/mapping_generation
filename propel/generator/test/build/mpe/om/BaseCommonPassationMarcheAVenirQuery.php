 ...
 *
 * @method CommonPassationMarcheAVenirQuery leftJoinCommonPassationConsultation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonPassationConsultation relation
 * @method CommonPassationMarcheAVenirQuery rightJoinCommonPassationConsultation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonPassationConsultation relation
 * @method CommonPassationMarcheAVenirQuery innerJoinCommonPassationConsultation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonPassationConsultation relation
 *
...
abstract class BaseCommonPassationMarcheAVenirQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonPassationConsultation()
     *
    ...
    /**
     * Filter the query by a related CommonPassationConsultation object
     *
     * @param   CommonPassationConsultation|PropelObjectCollection $commonPassationConsultation The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonPassationMarcheAVenirQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonPassationConsultation($commonPassationConsultation, $comparison = null)
    {
        if ($commonPassationConsultation instanceof CommonPassationConsultation) {
            return $this
                ->addUsingAlias(CommonPassationMarcheAVenirPeer::ID_PASSATION_CONSULTATION, $commonPassationConsultation->getId(), $comparison);
        } elseif ($commonPassationConsultation instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonPassationMarcheAVenirPeer::ID_PASSATION_CONSULTATION, $commonPassationConsultation->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonPassationConsultation() only accepts arguments of type CommonPassationConsultation or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonPassationConsultation relation
     *
     ...
     * @return CommonPassationMarcheAVenirQuery The current query, for fluid interface
     */
    public function joinCommonPassationConsultation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonPassationConsultation');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonPassationConsultation');
        }
    ...
    /**
     * Use the CommonPassationConsultation relation CommonPassationConsultation object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonPassationConsultationQuery A secondary query class using the current class as primary query
     */
    public function useCommonPassationConsultationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonPassationConsultation($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonPassationConsultation', 'CommonPassationConsultationQuery');
    }
