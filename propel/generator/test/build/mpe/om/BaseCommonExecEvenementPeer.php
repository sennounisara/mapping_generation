...
abstract class BaseCommonExecEvenementPeer
{
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecEvenementPeer::ID_AGENT_CREA, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecEvenementPeer::ID_AGENT_MODIF, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecEvenementPeer::ID_AGENT_REJET, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecEvenementPeer::ID_AGENT_VALIDATION, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecEvenement objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to $obj2 (CommonAgent)
                $obj2->addCommonExecEvenementRelatedByIdAgentCrea($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to $obj2 (CommonAgent)
                $obj2->addCommonExecEvenementRelatedByIdAgentModif($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to $obj2 (CommonAgent)
                $obj2->addCommonExecEvenementRelatedByIdAgentRejet($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to $obj2 (CommonAgent)
                $obj2->addCommonExecEvenementRelatedByIdAgentValidation($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecPhasePeer::addSelectColumns($criteria);
        $startcol9 = $startcol8 + CommonExecPhasePeer::NUM_HYDRATE_COLUMNS;

        CommonExecTypeEvenementPeer::addSelectColumns($criteria);
        $startcol10 = $startcol9 + CommonExecTypeEvenementPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecEvenementRelatedByIdAgentCrea($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj3 (CommonAgent)
                $obj3->addCommonExecEvenementRelatedByIdAgentModif($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj4 (CommonAgent)
                $obj4->addCommonExecEvenementRelatedByIdAgentRejet($obj1);
            } // if joined row not null
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj5 (CommonAgent)
                $obj5->addCommonExecEvenementRelatedByIdAgentValidation($obj1);
            } // if joined row not null
            ...
            if ($key6 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj6 (CommonExecContractant)
                $obj6->addCommonExecEvenement($obj1);
            } // if joined row not null
            ...
            if ($key7 !== null) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj7 (CommonExecContrat)
                $obj7->addCommonExecEvenement($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecPhase rows

            $key8 = CommonExecPhasePeer::getPrimaryKeyHashFromRow($row, $startcol8);
            if ($key8 !== null) {
                $obj8 = CommonExecPhasePeer::getInstanceFromPool($key8);
                if (!$obj8) {
                    ...
                    CommonExecPhasePeer::addInstanceToPool($obj8, $key8);
                } // if obj8 loaded

                // Add the $obj1 (CommonExecEvenement) to the collection in $obj8 (CommonExecPhase)
                $obj8->addCommonExecEvenement($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecTypeEvenement rows

            $key9 = CommonExecTypeEvenementPeer::getPrimaryKeyHashFromRow($row, $startcol9);
            if ($key9 !== null) {
                $obj9 = CommonExecTypeEvenementPeer::getInstanceFromPool($key9);
                if (!$obj9) {
                    ...
                    CommonExecTypeEvenementPeer::addInstanceToPool($obj9, $key9);
                } // if obj9 loaded

                // Add the $obj1 (CommonExecEvenement) to the collection in $obj9 (CommonExecTypeEvenement)
                $obj9->addCommonExecEvenement($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonExecEvenement objects pre-filled with all related objects except CommonAgentRelatedByIdAgentCrea.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecEvenement objects pre-filled with all related objects except CommonAgentRelatedByIdAgentModif.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecEvenement objects pre-filled with all related objects except CommonAgentRelatedByIdAgentRejet.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecEvenement objects pre-filled with all related objects except CommonAgentRelatedByIdAgentValidation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonExecContractant(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecPhasePeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonExecPhasePeer::NUM_HYDRATE_COLUMNS;

        CommonExecTypeEvenementPeer::addSelectColumns($criteria);
        $startcol9 = $startcol8 + CommonExecTypeEvenementPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecEvenementPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonExecEvenement) to the collection in $obj6 (CommonExecContrat)
                $obj6->addCommonExecEvenement($obj1);
                ...
                $key7 = CommonExecPhasePeer::getPrimaryKeyHashFromRow($row, $startcol7);
                if ($key7 !== null) {
                    $obj7 = CommonExecPhasePeer::getInstanceFromPool($key7);
                    if (!$obj7) {
                    ...
                    $obj7 = new $cls();
                    $obj7->hydrate($row, $startcol7);
                    CommonExecPhasePeer::addInstanceToPool($obj7, $key7);
                } // if $obj7 already loaded

                // Add the $obj1 (CommonExecEvenement) to the collection in $obj7 (CommonExecPhase)
                $obj7->addCommonExecEvenement($obj1);
                ...
                $key8 = CommonExecTypeEvenementPeer::getPrimaryKeyHashFromRow($row, $startcol8);
                if ($key8 !== null) {
                    $obj8 = CommonExecTypeEvenementPeer::getInstanceFromPool($key8);
                    if (!$obj8) {
                    ...
                    $obj8 = new $cls();
                    $obj8->hydrate($row, $startcol8);
                    CommonExecTypeEvenementPeer::addInstanceToPool($obj8, $key8);
                } // if $obj8 already loaded

                // Add the $obj1 (CommonExecEvenement) to the collection in $obj8 (CommonExecTypeEvenement)
                $obj8->addCommonExecEvenement($obj1);
