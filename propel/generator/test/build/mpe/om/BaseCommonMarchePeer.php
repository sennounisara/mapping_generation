...
abstract class BaseCommonMarchePeer
{
    ...
    public static function doCountJoinCommonCategorieConsultation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonMarchePeer::NATUREMARCHE, CommonCategorieConsultationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonMarche objects pre-filled with their CommonCategorieConsultation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonMarche objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonCategorieConsultation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonMarchePeer::addSelectColumns($criteria);
        $startcol = CommonMarchePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonMarchePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonMarchePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonMarchePeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonMarche) to $obj2 (CommonCategorieConsultation)
                $obj2->addCommonMarche($obj1);
    ...
    /**
     * Selects a collection of CommonMarche objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonMarchePeer::addSelectColumns($criteria);
        $startcol2 = CommonMarchePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonMarche) to the collection in $obj2 (CommonCategorieConsultation)
                $obj2->addCommonMarche($obj1);
