...
/**
 * Base class that represents a row from the 'mode_execution_contrat' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonModeExecutionContrat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonModeExecutionContratPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonModeExecutionContratPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonModeExecutionContrat object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonModeExecutionContrat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonModeExecutionContratPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonModeExecutionContratPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonModeExecutionContrat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonModeExecutionContratPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonModeExecutionContratQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonModeExecutionContratPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonModeExecutionContratPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `mode_execution_contrat` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonModeExecutionContratPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonModeExecutionContratPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonModeExecutionContrat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonModeExecutionContrat'][$this->getPrimaryKey()] = true;
        $keys = CommonModeExecutionContratPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonModeExecutionContratPeer::ID)) $criteria->add(CommonModeExecutionContratPeer::ID, $this->id);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_FR)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_EN)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_ES)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_SU)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_DU)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_CZ)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_AR)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonModeExecutionContratPeer::LIBELLE_IT)) $criteria->add(CommonModeExecutionContratPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonModeExecutionContratPeer::DATABASE_NAME);
        $criteria->add(CommonModeExecutionContratPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonModeExecutionContrat (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonModeExecutionContrat Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonModeExecutionContratPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonModeExecutionContratPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonModeExecutionContratPeer::DEFAULT_STRING_FORMAT);
    }
