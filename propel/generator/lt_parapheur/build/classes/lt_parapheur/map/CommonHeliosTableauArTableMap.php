...
/**
 * This class defines the structure of the 'Helios_tableau_ar' table.
 *
 *
 *
 ...
 */
class CommonHeliosTableauArTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonHeliosTableauArTableMap';
    ...
    {
        // attributes
        $this->setName('Helios_tableau_ar');
        $this->setPhpName('CommonHeliosTableauAr');
        $this->setClassname('CommonHeliosTableauAr');
