 ...
 */
class CommonTestTableTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonTestTableTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CommonTestTable');
        $this->setClassname('CommonTestTable');
