 ...
 */
abstract class BaseExecLitige extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ExecLitigePeer';
    ...
    /**
     * Initializes internal state of BaseExecLitige object.
     * @see        applyDefaults()
     */
     ...
     * @return ExecLitige The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ExecLitigePeer::ID;
        }
    ...
    public function setNumero($v)
    {
        ...
        if ($this->numero !== $v) {
            $this->numero = $v;
            $this->modifiedColumns[] = ExecLitigePeer::NUMERO;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = ExecLitigePeer::ID_CONTRAT;
        }
    ...
    public function setIdContractant($v)
    {
        ...
        if ($this->id_contractant !== $v) {
            ...
            $this->modifiedColumns[] = ExecLitigePeer::ID_CONTRACTANT;
        }
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[] = ExecLitigePeer::STATUT;
        }
    ...
    public function setDateDeclaration($v)
    {
        ...
        if ($this->date_declaration !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ExecLitigePeer::DATE_DECLARATION;
            }
    ...
    public function setDateValidation($v)
    {
        ...
        if ($this->date_validation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ExecLitigePeer::DATE_VALIDATION;
            }
        } // if either are not null
    ...
    public function setIdAgentValidation($v)
    {
        ...
        if ($this->id_agent_validation !== $v) {
            ...
            $this->modifiedColumns[] = ExecLitigePeer::ID_AGENT_VALIDATION;
        }
    ...
    public function setDateRejet($v)
    {
        ...
        if ($this->date_rejet !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ExecLitigePeer::DATE_REJET;
            }
        } // if either are not null
    ...
    public function setIdAgentRejet($v)
    {
        ...
        if ($this->id_agent_rejet !== $v) {
            ...
            $this->modifiedColumns[] = ExecLitigePeer::ID_AGENT_REJET;
        }
    ...
    public function setCommentaire($v)
    {
        ...
        if ($this->commentaire !== $v) {
            $this->commentaire = $v;
            $this->modifiedColumns[] = ExecLitigePeer::COMMENTAIRE;
        }
    ...
    public function setIdAgentCrea($v)
    {
        ...
        if ($this->id_agent_crea !== $v) {
            ...
            $this->modifiedColumns[] = ExecLitigePeer::ID_AGENT_CREA;
        }
    ...
    public function setDateCrea($v)
    {
        ...
        if ($this->date_crea !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ExecLitigePeer::DATE_CREA;
            }
        } // if either are not null
    ...
    public function setCloture($v)
    {
        ...
        if ($this->cloture !== $v) {
            $this->cloture = $v;
            $this->modifiedColumns[] = ExecLitigePeer::CLOTURE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 14; // 14 = ExecLitigePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ExecLitige object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ExecLitigePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ExecLitigeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExecLitigePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ExecLitigePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ExecLitigePeer::NUMERO)) {
            $modifiedColumns[':p' . $index++]  = '`numero`';
        }
        if ($this->isColumnModified(ExecLitigePeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(ExecLitigePeer::ID_CONTRACTANT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contractant`';
        }
        if ($this->isColumnModified(ExecLitigePeer::STATUT)) {
            $modifiedColumns[':p' . $index++]  = '`statut`';
        }
        if ($this->isColumnModified(ExecLitigePeer::DATE_DECLARATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_declaration`';
        }
        if ($this->isColumnModified(ExecLitigePeer::DATE_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_validation`';
        }
        if ($this->isColumnModified(ExecLitigePeer::ID_AGENT_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_validation`';
        }
        if ($this->isColumnModified(ExecLitigePeer::DATE_REJET)) {
            $modifiedColumns[':p' . $index++]  = '`date_rejet`';
        }
        if ($this->isColumnModified(ExecLitigePeer::ID_AGENT_REJET)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_rejet`';
        }
        if ($this->isColumnModified(ExecLitigePeer::COMMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`commentaire`';
        }
        if ($this->isColumnModified(ExecLitigePeer::ID_AGENT_CREA)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_crea`';
        }
        if ($this->isColumnModified(ExecLitigePeer::DATE_CREA)) {
            $modifiedColumns[':p' . $index++]  = '`date_crea`';
        }
        if ($this->isColumnModified(ExecLitigePeer::CLOTURE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ExecLitigePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ExecLitigePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ExecLitige'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ExecLitige'][$this->getPrimaryKey()] = true;
        $keys = ExecLitigePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ExecLitigePeer::ID)) $criteria->add(ExecLitigePeer::ID, $this->id);
        if ($this->isColumnModified(ExecLitigePeer::NUMERO)) $criteria->add(ExecLitigePeer::NUMERO, $this->numero);
        if ($this->isColumnModified(ExecLitigePeer::ID_CONTRAT)) $criteria->add(ExecLitigePeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(ExecLitigePeer::ID_CONTRACTANT)) $criteria->add(ExecLitigePeer::ID_CONTRACTANT, $this->id_contractant);
        if ($this->isColumnModified(ExecLitigePeer::STATUT)) $criteria->add(ExecLitigePeer::STATUT, $this->statut);
        if ($this->isColumnModified(ExecLitigePeer::DATE_DECLARATION)) $criteria->add(ExecLitigePeer::DATE_DECLARATION, $this->date_declaration);
        if ($this->isColumnModified(ExecLitigePeer::DATE_VALIDATION)) $criteria->add(ExecLitigePeer::DATE_VALIDATION, $this->date_validation);
        if ($this->isColumnModified(ExecLitigePeer::ID_AGENT_VALIDATION)) $criteria->add(ExecLitigePeer::ID_AGENT_VALIDATION, $this->id_agent_validation);
        if ($this->isColumnModified(ExecLitigePeer::DATE_REJET)) $criteria->add(ExecLitigePeer::DATE_REJET, $this->date_rejet);
        if ($this->isColumnModified(ExecLitigePeer::ID_AGENT_REJET)) $criteria->add(ExecLitigePeer::ID_AGENT_REJET, $this->id_agent_rejet);
        if ($this->isColumnModified(ExecLitigePeer::COMMENTAIRE)) $criteria->add(ExecLitigePeer::COMMENTAIRE, $this->commentaire);
        if ($this->isColumnModified(ExecLitigePeer::ID_AGENT_CREA)) $criteria->add(ExecLitigePeer::ID_AGENT_CREA, $this->id_agent_crea);
        if ($this->isColumnModified(ExecLitigePeer::DATE_CREA)) $criteria->add(ExecLitigePeer::DATE_CREA, $this->date_crea);
        if ($this->isColumnModified(ExecLitigePeer::CLOTURE)) $criteria->add(ExecLitigePeer::CLOTURE, $this->cloture);
    ...
    {
        $criteria = new Criteria(ExecLitigePeer::DATABASE_NAME);
        $criteria->add(ExecLitigePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ExecLitige (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ExecLitige Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ExecLitigePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ExecLitigePeer();
        }
    ...
    {
        return (string) $this->exportTo(ExecLitigePeer::DEFAULT_STRING_FORMAT);
    }
