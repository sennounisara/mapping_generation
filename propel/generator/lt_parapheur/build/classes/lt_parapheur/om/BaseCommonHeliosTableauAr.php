...
/**
 * Base class that represents a row from the 'Helios_tableau_ar' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonHeliosTableauAr extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonHeliosTableauArPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonHeliosTableauArPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonHeliosTableauAr object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonHeliosTableauAr The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::CONSULTATION_REF;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::NOM_FICHIER;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::DESCRIPTION;
        }
    ...
    public function setFichier($v)
    {
        ...
        if ($this->fichier !== $v) {
            $this->fichier = $v;
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::FICHIER;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonHeliosTableauArPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::UNTRUSTEDDATE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonHeliosTableauArPeer::TAILLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fichier = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            ...
            $this->untrusteddate = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->taille = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = CommonHeliosTableauArPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonHeliosTableauAr object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonHeliosTableauArPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonHeliosTableauArQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonHeliosTableauArPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonHeliosTableauArPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`fichier`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonHeliosTableauArPeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }

        $sql = sprintf(
            'INSERT INTO `Helios_tableau_ar` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonHeliosTableauArPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonHeliosTableauArPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonHeliosTableauAr'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonHeliosTableauAr'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonHeliosTableauArPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[7] => $this->getUntrusteddate(),
            $keys[8] => $this->getTaille(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setUntrusteddate($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setTaille($arr[$keys[8]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonHeliosTableauArPeer::ID)) $criteria->add(CommonHeliosTableauArPeer::ID, $this->id);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::ORGANISME)) $criteria->add(CommonHeliosTableauArPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::CONSULTATION_REF)) $criteria->add(CommonHeliosTableauArPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::NOM_FICHIER)) $criteria->add(CommonHeliosTableauArPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::DESCRIPTION)) $criteria->add(CommonHeliosTableauArPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::FICHIER)) $criteria->add(CommonHeliosTableauArPeer::FICHIER, $this->fichier);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::HORODATAGE)) $criteria->add(CommonHeliosTableauArPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::UNTRUSTEDDATE)) $criteria->add(CommonHeliosTableauArPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonHeliosTableauArPeer::TAILLE)) $criteria->add(CommonHeliosTableauArPeer::TAILLE, $this->taille);
    ...
    {
        $criteria = new Criteria(CommonHeliosTableauArPeer::DATABASE_NAME);
        $criteria->add(CommonHeliosTableauArPeer::ID, $this->id);
        $criteria->add(CommonHeliosTableauArPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonHeliosTableauAr (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonHeliosTableauAr Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonHeliosTableauArPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonHeliosTableauArPeer();
        }
    ...
    public function setCommonConsultation(CommonConsultation $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonHeliosTableauAr($this);
        }
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonHeliosTableauArs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonHeliosTableauArPeer::DEFAULT_STRING_FORMAT);
    }
