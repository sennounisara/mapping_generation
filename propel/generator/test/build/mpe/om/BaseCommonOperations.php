...
abstract class BaseCommonOperations extends BaseObject implements Persistent
{
     ...
     * If this CommonOperations is new, it will return
    ...
    public function setCommonConsultations(PropelCollection $commonConsultations, PropelPDO $con = null)
    {
        ...
        foreach ($commonConsultationsToDelete as $commonConsultationRemoved) {
            $commonConsultationRemoved->setCommonOperations(null);
        }
    ...
    protected function doAddCommonConsultation($commonConsultation)
    {
        ...
        $commonConsultation->setCommonOperations($this);
    }
    ...
    public function removeCommonConsultation($commonConsultation)
    {
        if ($this->getCommonConsultations()->contains($commonConsultation)) {
            ...
            $commonConsultation->setCommonOperations(null);
        }
     ...
     * Otherwise if this CommonOperations is new, it will return
     * an empty collection; or if this CommonOperations has previously
     * been saved, it will retrieve related CommonConsultations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonOperations.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
