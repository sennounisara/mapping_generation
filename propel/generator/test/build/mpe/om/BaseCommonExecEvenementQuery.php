 ...
 *
 * @method CommonExecEvenementQuery leftJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 * @method CommonExecEvenementQuery rightJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 * @method CommonExecEvenementQuery innerJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 *
 * @method CommonExecEvenementQuery leftJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 * @method CommonExecEvenementQuery rightJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 * @method CommonExecEvenementQuery innerJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 *
 * @method CommonExecEvenementQuery leftJoinCommonAgentRelatedByIdAgentRejet($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentRejet relation
 * @method CommonExecEvenementQuery rightJoinCommonAgentRelatedByIdAgentRejet($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentRejet relation
 * @method CommonExecEvenementQuery innerJoinCommonAgentRelatedByIdAgentRejet($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentRejet relation
 *
 * @method CommonExecEvenementQuery leftJoinCommonAgentRelatedByIdAgentValidation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentValidation relation
 * @method CommonExecEvenementQuery rightJoinCommonAgentRelatedByIdAgentValidation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentValidation relation
 * @method CommonExecEvenementQuery innerJoinCommonAgentRelatedByIdAgentValidation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentValidation relation
 *
...
abstract class BaseCommonExecEvenementQuery extends ModelCriteria
{
    ...
    public function filterByCommonAgentRelatedByIdAgentCrea($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_CREA, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_CREA, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonAgentRelatedByIdAgentModif($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_MODIF, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_MODIF, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonAgentRelatedByIdAgentRejet($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_REJET, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_REJET, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonAgentRelatedByIdAgentValidation($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_VALIDATION, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecEvenementPeer::ID_AGENT_VALIDATION, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
