...
class CommonCriteresEvaluationTableMap extends TableMap
{
    ...
    {
        $this->addRelation('CommonItemCritereEvaluation', 'CommonItemCritereEvaluation', RelationMap::ONE_TO_MANY, array('id' => 'idCritereEvaluation', ), 'CASCADE', 'CASCADE', 'CommonItemCritereEvaluations');
    } // buildRelations()
