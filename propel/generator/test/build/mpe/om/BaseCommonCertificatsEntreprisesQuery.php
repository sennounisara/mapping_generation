 ...
 *
 * @method CommonCertificatsEntreprisesQuery leftJoinCommonInscrit($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonInscrit relation
 * @method CommonCertificatsEntreprisesQuery rightJoinCommonInscrit($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonInscrit relation
 * @method CommonCertificatsEntreprisesQuery innerJoinCommonInscrit($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonInscrit relation
 *
...
abstract class BaseCommonCertificatsEntreprisesQuery extends ModelCriteria
{
    ...
    public function filterByCommonInscrit($commonInscrit, $comparison = null)
    {
        if ($commonInscrit instanceof CommonInscrit) {
            return $this
                ->addUsingAlias(CommonCertificatsEntreprisesPeer::ID_INSCRIT, $commonInscrit->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonCertificatsEntreprisesPeer::ID_INSCRIT, $commonInscrit->toKeyValue('Id', 'Id'), $comparison);
        } else {
