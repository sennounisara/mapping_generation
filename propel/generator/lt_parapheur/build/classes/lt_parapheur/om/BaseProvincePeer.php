...
abstract class BaseProvincePeer
{
    ...
    const ID_REGION = 'province.ID_REGION';

    /** the column name for the NOM_PROVINCE_FR field */
    const NOM_PROVINCE_FR = 'province.NOM_PROVINCE_FR';

    /** the column name for the NOM_PROVINCE_AR field */
    const NOM_PROVINCE_AR = 'province.NOM_PROVINCE_AR';

    /** the column name for the ID_ENTITE field */
    const ID_ENTITE = 'province.ID_ENTITE';

    /** the column name for the ID_EXTERNE field */
    const ID_EXTERNE = 'province.ID_EXTERNE';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'IdRegion', 'NomProvinceFr', 'NomProvinceAr', 'IdEntite', 'IdExterne', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idRegion', 'nomProvinceFr', 'nomProvinceAr', 'idEntite', 'idExterne', ),
        BasePeer::TYPE_COLNAME => array (ProvincePeer::ID, ProvincePeer::ID_REGION, ProvincePeer::NOM_PROVINCE_FR, ProvincePeer::NOM_PROVINCE_AR, ProvincePeer::ID_ENTITE, ProvincePeer::ID_EXTERNE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ID_REGION', 'NOM_PROVINCE_FR', 'NOM_PROVINCE_AR', 'ID_ENTITE', 'ID_EXTERNE', ),
        BasePeer::TYPE_FIELDNAME => array ('ID', 'ID_REGION', 'NOM_PROVINCE_FR', 'NOM_PROVINCE_AR', 'ID_ENTITE', 'ID_EXTERNE', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdRegion' => 1, 'NomProvinceFr' => 2, 'NomProvinceAr' => 3, 'IdEntite' => 4, 'IdExterne' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idRegion' => 1, 'nomProvinceFr' => 2, 'nomProvinceAr' => 3, 'idEntite' => 4, 'idExterne' => 5, ),
        BasePeer::TYPE_COLNAME => array (ProvincePeer::ID => 0, ProvincePeer::ID_REGION => 1, ProvincePeer::NOM_PROVINCE_FR => 2, ProvincePeer::NOM_PROVINCE_AR => 3, ProvincePeer::ID_ENTITE => 4, ProvincePeer::ID_EXTERNE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ID_REGION' => 1, 'NOM_PROVINCE_FR' => 2, 'NOM_PROVINCE_AR' => 3, 'ID_ENTITE' => 4, 'ID_EXTERNE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'ID_REGION' => 1, 'NOM_PROVINCE_FR' => 2, 'NOM_PROVINCE_AR' => 3, 'ID_ENTITE' => 4, 'ID_EXTERNE' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProvincePeer::ID_REGION);
            $criteria->addSelectColumn(ProvincePeer::NOM_PROVINCE_FR);
            $criteria->addSelectColumn(ProvincePeer::NOM_PROVINCE_AR);
            $criteria->addSelectColumn(ProvincePeer::ID_ENTITE);
            $criteria->addSelectColumn(ProvincePeer::ID_EXTERNE);
        } else {
