...
/**
 * Base class that represents a row from the 'TypeAvenant' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonTypeAvenant extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonTypeAvenantPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonTypeAvenantPeer
     */
     ...
     * @return CommonTypeAvenant The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonTypeAvenantPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonTypeAvenantPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonTypeAvenant object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonTypeAvenantPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonTypeAvenantQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonTypeAvenantPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonTypeAvenantPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `TypeAvenant` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonTypeAvenantPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonTypeAvenantPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonTypeAvenant'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonTypeAvenant'][$this->getPrimaryKey()] = true;
        $keys = CommonTypeAvenantPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonTypeAvenantPeer::ID)) $criteria->add(CommonTypeAvenantPeer::ID, $this->id);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE)) $criteria->add(CommonTypeAvenantPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_FR)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_EN)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_ES)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_SU)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_DU)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_CZ)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_AR)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonTypeAvenantPeer::LIBELLE_IT)) $criteria->add(CommonTypeAvenantPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonTypeAvenantPeer::DATABASE_NAME);
        $criteria->add(CommonTypeAvenantPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonTypeAvenant (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonTypeAvenant Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonTypeAvenantPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonTypeAvenantPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonTypeAvenantPeer::DEFAULT_STRING_FORMAT);
    }
