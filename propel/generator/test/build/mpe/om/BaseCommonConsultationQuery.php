 ...
 *
 * @method CommonConsultationQuery leftJoinCommonOperations($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonOperations relation
 * @method CommonConsultationQuery rightJoinCommonOperations($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonOperations relation
 * @method CommonConsultationQuery innerJoinCommonOperations($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonOperations relation
 *
 * @method CommonConsultationQuery leftJoinCommonOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonConsultationQuery rightJoinCommonOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonConsultationQuery innerJoinCommonOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonOrganisme relation
 *
...
abstract class BaseCommonConsultationQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related CommonOperations object
     *
     * @param   CommonOperations|PropelObjectCollection $commonOperations The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonConsultationQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonOperations($commonOperations, $comparison = null)
    {
        if ($commonOperations instanceof CommonOperations) {
            return $this
                ->addUsingAlias(CommonConsultationPeer::IDOPERATION, $commonOperations->getIdOperation(), $comparison);
        } elseif ($commonOperations instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonConsultationPeer::IDOPERATION, $commonOperations->toKeyValue('PrimaryKey', 'IdOperation'), $comparison);
        } else {
            throw new PropelException('filterByCommonOperations() only accepts arguments of type CommonOperations or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonOperations relation
     *
     ...
     * @return CommonConsultationQuery The current query, for fluid interface
     */
    public function joinCommonOperations($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonOperations');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonOperations');
        }
    ...
    /**
     * Use the CommonOperations relation CommonOperations object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonOperationsQuery A secondary query class using the current class as primary query
     */
    public function useCommonOperationsQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCommonOperations($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonOperations', 'CommonOperationsQuery');
    }
    ...
    public function filterByCommonOrganisme($commonOrganisme, $comparison = null)
    {
        if ($commonOrganisme instanceof CommonOrganisme) {
            return $this
                ->addUsingAlias(CommonConsultationPeer::ORGANISME, $commonOrganisme->getAcronyme(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonConsultationPeer::ORGANISME, $commonOrganisme->toKeyValue('PrimaryKey', 'Acronyme'), $comparison);
        } else {
