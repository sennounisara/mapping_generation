...
/**
 * Base class that represents a row from the 'pf_theme' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BasePfTheme extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PfThemePeer';
     ...
     * @return PfTheme The current object (for fluent API support)
     */
    public function setIdTheme($v)
    {
        ...
        if ($this->id_theme !== $v) {
            $this->id_theme = $v;
            $this->modifiedColumns[] = PfThemePeer::ID_THEME;
        }
    ...
    public function setIdOrganisme($v)
    {
        ...
        if ($this->id_organisme !== $v) {
            $this->id_organisme = $v;
            $this->modifiedColumns[] = PfThemePeer::ID_ORGANISME;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = PfThemePeer::LIBELLE_FR;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = PfThemePeer::LIBELLE_AR;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PfThemePeer::DATE_MODIFICATION;
            }
    ...
    public function setTypeTheme($v)
    {
        ...
        if ($this->type_theme !== $v) {
            $this->type_theme = $v;
            $this->modifiedColumns[] = PfThemePeer::TYPE_THEME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->type_theme = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = PfThemePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PfTheme object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PfThemePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PfThemeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PfThemePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PfThemePeer::ID_THEME)) {
            $modifiedColumns[':p' . $index++]  = '`ID_THEME`';
        }
        if ($this->isColumnModified(PfThemePeer::ID_ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`ID_ORGANISME`';
        }
        if ($this->isColumnModified(PfThemePeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`LIBELLE_FR`';
        }
        if ($this->isColumnModified(PfThemePeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`LIBELLE_AR`';
        }
        if ($this->isColumnModified(PfThemePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_MODIFICATION`';
        }
        if ($this->isColumnModified(PfThemePeer::TYPE_THEME)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE_THEME`';
        }

        $sql = sprintf(
            'INSERT INTO `pf_theme` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PfThemePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PfThemePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PfTheme'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PfTheme'][$this->getPrimaryKey()] = true;
        $keys = PfThemePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setTypeTheme($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PfThemePeer::ID_THEME)) $criteria->add(PfThemePeer::ID_THEME, $this->id_theme);
        if ($this->isColumnModified(PfThemePeer::ID_ORGANISME)) $criteria->add(PfThemePeer::ID_ORGANISME, $this->id_organisme);
        if ($this->isColumnModified(PfThemePeer::LIBELLE_FR)) $criteria->add(PfThemePeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(PfThemePeer::LIBELLE_AR)) $criteria->add(PfThemePeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(PfThemePeer::DATE_MODIFICATION)) $criteria->add(PfThemePeer::DATE_MODIFICATION, $this->date_modification);
        if ($this->isColumnModified(PfThemePeer::TYPE_THEME)) $criteria->add(PfThemePeer::TYPE_THEME, $this->type_theme);
    ...
    {
        $criteria = new Criteria(PfThemePeer::DATABASE_NAME);
        $criteria->add(PfThemePeer::ID_THEME, $this->id_theme);
     ...
     * objects.
     *
     * @param object $copyObj An object of PfTheme (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PfTheme Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PfThemePeer::DEFAULT_STRING_FORMAT);
    }
