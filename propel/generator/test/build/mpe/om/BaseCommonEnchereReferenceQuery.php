 ...
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEncherePmiRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchere relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEncherePmiRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchere relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEncherePmiRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEncherePmiRelatedByIdenchere relation
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEncherePmiRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchereOrganisme relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEncherePmiRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEncherePmiRelatedByIdenchereOrganisme relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEncherePmiRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEncherePmiRelatedByIdenchereOrganisme relation
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme relation
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEnchereOffreReferenceRelatedByIdencherereference($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereference relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEnchereOffreReferenceRelatedByIdencherereference($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereference relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEnchereOffreReferenceRelatedByIdencherereference($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereference relation
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreference relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreference relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreference relation
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
 *
 * @method CommonEnchereReferenceQuery leftJoinCommonEnchereValeursInitiales($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereValeursInitiales relation
 * @method CommonEnchereReferenceQuery rightJoinCommonEnchereValeursInitiales($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereValeursInitiales relation
 * @method CommonEnchereReferenceQuery innerJoinCommonEnchereValeursInitiales($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereValeursInitiales relation
 *
...
abstract class BaseCommonEnchereReferenceQuery extends ModelCriteria
{
    ...
    public function filterByCommonEncherePmiRelatedByIdenchere($commonEncherePmi, $comparison = null)
    {
        if ($commonEncherePmi instanceof CommonEncherePmi) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::IDENCHERE, $commonEncherePmi->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::IDENCHERE, $commonEncherePmi->toKeyValue('Id', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonEncherePmiRelatedByIdenchereOrganisme($commonEncherePmi, $comparison = null)
    {
        if ($commonEncherePmi instanceof CommonEncherePmi) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::IDENCHERE, $commonEncherePmi->getId(), $comparison)
                ->addUsingAlias(CommonEnchereReferencePeer::ORGANISME, $commonEncherePmi->getOrganisme(), $comparison);
        } else {
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme($commonEnchereOffreReference, $comparison = null)
    {
        if ($commonEnchereOffreReference instanceof CommonEnchereOffreReference) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::ID, $commonEnchereOffreReference->getIdencherereference(), $comparison)
                ->addUsingAlias(CommonEnchereReferencePeer::ORGANISME, $commonEnchereOffreReference->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme() only accepts arguments of type CommonEnchereOffreReference');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme');
        }
    ...
    /**
     * Use the CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme relation CommonEnchereOffreReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereOffreReferenceRelatedByIdencherereferenceOrganisme', 'CommonEnchereOffreReferenceQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereOffreReferenceRelatedByIdencherereference($commonEnchereOffreReference, $comparison = null)
    {
        if ($commonEnchereOffreReference instanceof CommonEnchereOffreReference) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::ID, $commonEnchereOffreReference->getIdencherereference(), $comparison);
            ...
            return $this
                ->useCommonEnchereOffreReferenceRelatedByIdencherereferenceQuery()
                ->filterByPrimaryKeys($commonEnchereOffreReference->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEnchereOffreReferenceRelatedByIdencherereference() only accepts arguments of type CommonEnchereOffreReference or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereOffreReferenceRelatedByIdencherereference relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonEnchereOffreReferenceRelatedByIdencherereference($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereOffreReferenceRelatedByIdencherereference');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereOffreReferenceRelatedByIdencherereference');
        }
    ...
    /**
     * Use the CommonEnchereOffreReferenceRelatedByIdencherereference relation CommonEnchereOffreReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonEnchereOffreReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereOffreReferenceRelatedByIdencherereferenceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereOffreReferenceRelatedByIdencherereference($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereOffreReferenceRelatedByIdencherereference', 'CommonEnchereOffreReferenceQuery');
    }

    /**
     * Filter the query by a related CommonEnchereTrancheBaremeReference object
     *
     * @param   CommonEnchereTrancheBaremeReference|PropelObjectCollection $commonEnchereTrancheBaremeReference  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEnchereReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereTrancheBaremeReferenceRelatedByIdreference($commonEnchereTrancheBaremeReference, $comparison = null)
    {
        if ($commonEnchereTrancheBaremeReference instanceof CommonEnchereTrancheBaremeReference) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::ID, $commonEnchereTrancheBaremeReference->getIdreference(), $comparison);
        } elseif ($commonEnchereTrancheBaremeReference instanceof PropelObjectCollection) {
            return $this
                ->useCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceQuery()
                ->filterByPrimaryKeys($commonEnchereTrancheBaremeReference->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEnchereTrancheBaremeReferenceRelatedByIdreference() only accepts arguments of type CommonEnchereTrancheBaremeReference or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreference relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereTrancheBaremeReferenceRelatedByIdreference');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereTrancheBaremeReferenceRelatedByIdreference');
        }
    ...
    /**
     * Use the CommonEnchereTrancheBaremeReferenceRelatedByIdreference relation CommonEnchereTrancheBaremeReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonEnchereTrancheBaremeReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereTrancheBaremeReferenceRelatedByIdreference', 'CommonEnchereTrancheBaremeReferenceQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($commonEnchereTrancheBaremeReference, $comparison = null)
    {
        if ($commonEnchereTrancheBaremeReference instanceof CommonEnchereTrancheBaremeReference) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::ID, $commonEnchereTrancheBaremeReference->getIdreference(), $comparison)
                ->addUsingAlias(CommonEnchereReferencePeer::ORGANISME, $commonEnchereTrancheBaremeReference->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme() only accepts arguments of type CommonEnchereTrancheBaremeReference');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme');
        }
    ...
    /**
     * Use the CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation CommonEnchereTrancheBaremeReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonEnchereTrancheBaremeReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme', 'CommonEnchereTrancheBaremeReferenceQuery');
    }

    /**
     * Filter the query by a related CommonEnchereValeursInitiales object
     *
     * @param   CommonEnchereValeursInitiales|PropelObjectCollection $commonEnchereValeursInitiales  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEnchereReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereValeursInitiales($commonEnchereValeursInitiales, $comparison = null)
    {
        if ($commonEnchereValeursInitiales instanceof CommonEnchereValeursInitiales) {
            return $this
                ->addUsingAlias(CommonEnchereReferencePeer::ID, $commonEnchereValeursInitiales->getIdencherereference(), $comparison)
                ->addUsingAlias(CommonEnchereReferencePeer::ORGANISME, $commonEnchereValeursInitiales->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereValeursInitiales() only accepts arguments of type CommonEnchereValeursInitiales');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereValeursInitiales relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonEnchereValeursInitiales($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereValeursInitiales');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereValeursInitiales');
        }
    ...
    /**
     * Use the CommonEnchereValeursInitiales relation CommonEnchereValeursInitiales object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonEnchereValeursInitialesQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereValeursInitialesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereValeursInitiales($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereValeursInitiales', 'CommonEnchereValeursInitialesQuery');
    }
