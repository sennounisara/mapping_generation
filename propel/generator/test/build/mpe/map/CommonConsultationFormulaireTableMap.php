...
class CommonConsultationFormulaireTableMap extends TableMap
{
    ...
    {
        $this->addRelation('CommonItemFormulaireConsultation', 'CommonItemFormulaireConsultation', RelationMap::ONE_TO_MANY, array('id' => 'idFormulaireConsultation', ), 'CASCADE', 'CASCADE', 'CommonItemFormulaireConsultations');
    } // buildRelations()
