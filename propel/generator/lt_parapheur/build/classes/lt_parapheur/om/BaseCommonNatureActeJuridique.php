...
/**
 * Base class that represents a row from the 'nature_acte_juridique' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonNatureActeJuridique extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonNatureActeJuridiquePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonNatureActeJuridiquePeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonNatureActeJuridique object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonNatureActeJuridique The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonNatureActeJuridiquePeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonNatureActeJuridiquePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonNatureActeJuridique object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonNatureActeJuridiquePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonNatureActeJuridiqueQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonNatureActeJuridiquePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `nature_acte_juridique` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonNatureActeJuridiquePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonNatureActeJuridiquePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonNatureActeJuridique'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonNatureActeJuridique'][$this->getPrimaryKey()] = true;
        $keys = CommonNatureActeJuridiquePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::ID)) $criteria->add(CommonNatureActeJuridiquePeer::ID, $this->id);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_FR)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_EN)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_ES)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_SU)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_DU)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_CZ)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_AR)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonNatureActeJuridiquePeer::LIBELLE_IT)) $criteria->add(CommonNatureActeJuridiquePeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonNatureActeJuridiquePeer::DATABASE_NAME);
        $criteria->add(CommonNatureActeJuridiquePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonNatureActeJuridique (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonNatureActeJuridique Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonNatureActeJuridiquePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonNatureActeJuridiquePeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonNatureActeJuridiquePeer::DEFAULT_STRING_FORMAT);
    }
