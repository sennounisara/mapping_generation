...
/**
 * Base class that represents a row from the 'AvisCao' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonAvisCao extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonAvisCaoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonAvisCaoPeer
     */
     ...
     * @return CommonAvisCao The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonAvisCaoPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonAvisCaoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonAvisCao object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonAvisCaoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonAvisCaoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonAvisCaoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonAvisCaoPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `AvisCao` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonAvisCaoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonAvisCaoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonAvisCao'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonAvisCao'][$this->getPrimaryKey()] = true;
        $keys = CommonAvisCaoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonAvisCaoPeer::ID)) $criteria->add(CommonAvisCaoPeer::ID, $this->id);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE)) $criteria->add(CommonAvisCaoPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_FR)) $criteria->add(CommonAvisCaoPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_EN)) $criteria->add(CommonAvisCaoPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_ES)) $criteria->add(CommonAvisCaoPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_SU)) $criteria->add(CommonAvisCaoPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_DU)) $criteria->add(CommonAvisCaoPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_CZ)) $criteria->add(CommonAvisCaoPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_AR)) $criteria->add(CommonAvisCaoPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonAvisCaoPeer::LIBELLE_IT)) $criteria->add(CommonAvisCaoPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonAvisCaoPeer::DATABASE_NAME);
        $criteria->add(CommonAvisCaoPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonAvisCao (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonAvisCao Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonAvisCaoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonAvisCaoPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonAvisCaoPeer::DEFAULT_STRING_FORMAT);
    }
