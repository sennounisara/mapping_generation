...
abstract class BaseCommonNewsletterPeer
{
    ...
    {
        // Invalidate objects in CommonNewsletterPieceJointePeer instance pool,
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonNewsletterPeer::doOnDeleteCascade(new Criteria(CommonNewsletterPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonNewsletterPeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonNewsletterPeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonNewsletterPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CommonNewsletterPieceJointe objects
            $criteria = new Criteria(CommonNewsletterPieceJointePeer::DATABASE_NAME);
            
            $criteria->add(CommonNewsletterPieceJointePeer::ID_NEWSLETTER, $obj->getId());
            $affectedRows += CommonNewsletterPieceJointePeer::doDelete($criteria, $con);
        }
