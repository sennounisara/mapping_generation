...
/**
 * Base class that represents a row from the 'ItemFormulaire' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonItemFormulaire extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonItemFormulairePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonItemFormulairePeer
     */
    ...
    /**
     * The value for the idmodeleformulaire field.
     * @var        int
     */
    protected $idmodeleformulaire;
    ...
    /**
     * Initializes internal state of BaseCommonItemFormulaire object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [idmodeleformulaire] column value.
     * 
     * @return int
     */
    public function getIdmodeleformulaire()
    {

        return $this->idmodeleformulaire;
    }
     ...
     * @return CommonItemFormulaire The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::ID;
        }
    ...
    /**
     * Set the value of [idmodeleformulaire] column.
     * 
     * @param int $v new value
     * @return CommonItemFormulaire The current object (for fluent API support)
     */
    public function setIdmodeleformulaire($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idmodeleformulaire !== $v) {
            $this->idmodeleformulaire = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::IDMODELEFORMULAIRE;
        }


        return $this;
    } // setIdmodeleformulaire()
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::LIBELLE;
        }
    ...
    public function setCommentaireAcheteur($v)
    {
        ...
        if ($this->commentaire_acheteur !== $v) {
            ...
            $this->modifiedColumns[] = CommonItemFormulairePeer::COMMENTAIRE_ACHETEUR;
        }
    ...
    public function setPrixUnitaire($v)
    {
        ...
        if ($this->prix_unitaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonItemFormulairePeer::PRIX_UNITAIRE;
        }
    ...
    public function setQuantite($v)
    {
        ...
        if ($this->quantite !== $v) {
            $this->quantite = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::QUANTITE;
        }
    ...
    public function setPrecisionEntreprise($v)
    {
        ...
        if ($this->precision_entreprise !== $v) {
            ...
            $this->modifiedColumns[] = CommonItemFormulairePeer::PRECISION_ENTREPRISE;
        }
    ...
    public function setTypeReponse($v)
    {
        ...
        if ($this->type_reponse !== $v) {
            $this->type_reponse = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::TYPE_REPONSE;
        }
    ...
    public function setObligatoire($v)
    {
        ...
        if ($this->obligatoire !== $v) {
            $this->obligatoire = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::OBLIGATOIRE;
        }
    ...
    public function setNumero($v)
    {
        ...
        if ($this->numero !== $v) {
            $this->numero = $v;
            $this->modifiedColumns[] = CommonItemFormulairePeer::NUMERO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idmodeleformulaire = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 10; // 10 = CommonItemFormulairePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonItemFormulaire object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonItemFormulairePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonItemFormulaireQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonItemFormulairePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonItemFormulairePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::IDMODELEFORMULAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`idModeleFormulaire`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::COMMENTAIRE_ACHETEUR)) {
            $modifiedColumns[':p' . $index++]  = '`commentaire_acheteur`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::PRIX_UNITAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`prix_unitaire`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::QUANTITE)) {
            $modifiedColumns[':p' . $index++]  = '`quantite`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::PRECISION_ENTREPRISE)) {
            $modifiedColumns[':p' . $index++]  = '`precision_entreprise`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::TYPE_REPONSE)) {
            $modifiedColumns[':p' . $index++]  = '`type_reponse`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::OBLIGATOIRE)) {
            $modifiedColumns[':p' . $index++]  = '`obligatoire`';
        }
        if ($this->isColumnModified(CommonItemFormulairePeer::NUMERO)) {
            $modifiedColumns[':p' . $index++]  = '`numero`';
        }

        $sql = sprintf(
            'INSERT INTO `ItemFormulaire` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':						
                        ...
                        break;
                    case '`idModeleFormulaire`':						
                        $stmt->bindValue($identifier, $this->idmodeleformulaire, PDO::PARAM_INT);
                        break;
                    case '`libelle`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonItemFormulairePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonItemFormulairePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getIdmodeleformulaire();
                break;
            case 2:
    ...
    {
        if (isset($alreadyDumpedObjects['CommonItemFormulaire'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonItemFormulaire'][$this->getPrimaryKey()] = true;
        $keys = CommonItemFormulairePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdmodeleformulaire(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setIdmodeleformulaire($value);
                break;
            case 2:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setIdmodeleformulaire($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonItemFormulairePeer::ID)) $criteria->add(CommonItemFormulairePeer::ID, $this->id);
        if ($this->isColumnModified(CommonItemFormulairePeer::IDMODELEFORMULAIRE)) $criteria->add(CommonItemFormulairePeer::IDMODELEFORMULAIRE, $this->idmodeleformulaire);
        if ($this->isColumnModified(CommonItemFormulairePeer::LIBELLE)) $criteria->add(CommonItemFormulairePeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonItemFormulairePeer::COMMENTAIRE_ACHETEUR)) $criteria->add(CommonItemFormulairePeer::COMMENTAIRE_ACHETEUR, $this->commentaire_acheteur);
        if ($this->isColumnModified(CommonItemFormulairePeer::PRIX_UNITAIRE)) $criteria->add(CommonItemFormulairePeer::PRIX_UNITAIRE, $this->prix_unitaire);
        if ($this->isColumnModified(CommonItemFormulairePeer::QUANTITE)) $criteria->add(CommonItemFormulairePeer::QUANTITE, $this->quantite);
        if ($this->isColumnModified(CommonItemFormulairePeer::PRECISION_ENTREPRISE)) $criteria->add(CommonItemFormulairePeer::PRECISION_ENTREPRISE, $this->precision_entreprise);
        if ($this->isColumnModified(CommonItemFormulairePeer::TYPE_REPONSE)) $criteria->add(CommonItemFormulairePeer::TYPE_REPONSE, $this->type_reponse);
        if ($this->isColumnModified(CommonItemFormulairePeer::OBLIGATOIRE)) $criteria->add(CommonItemFormulairePeer::OBLIGATOIRE, $this->obligatoire);
        if ($this->isColumnModified(CommonItemFormulairePeer::NUMERO)) $criteria->add(CommonItemFormulairePeer::NUMERO, $this->numero);
    ...
    {
        $criteria = new Criteria(CommonItemFormulairePeer::DATABASE_NAME);
        $criteria->add(CommonItemFormulairePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonItemFormulaire (or compatible) type.
    ...
    {
        $copyObj->setIdmodeleformulaire($this->getIdmodeleformulaire());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonItemFormulaire Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonItemFormulairePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonItemFormulairePeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonItemFormulairePeer::DEFAULT_STRING_FORMAT);
    }
