...
class CommonHeliosTeletransmissionLotTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonHeliosTeletransmissionLotTableMap';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id_teletransmission', 'IdTeletransmission', 'INTEGER', true, null, 0);
