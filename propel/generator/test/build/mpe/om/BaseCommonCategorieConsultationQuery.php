 ...
 *
 * @method CommonCategorieConsultationQuery leftJoinCommonMarche($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonMarche relation
 * @method CommonCategorieConsultationQuery rightJoinCommonMarche($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonMarche relation
 * @method CommonCategorieConsultationQuery innerJoinCommonMarche($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonMarche relation
 *
 * @method CommonCategorieConsultationQuery leftJoinCommonExecContrat($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonExecContrat relation
 * @method CommonCategorieConsultationQuery rightJoinCommonExecContrat($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonExecContrat relation
 * @method CommonCategorieConsultationQuery innerJoinCommonExecContrat($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonExecContrat relation
 *
...
abstract class BaseCommonCategorieConsultationQuery extends ModelCriteria
{
    ...
    public function filterByCommonMarche($commonMarche, $comparison = null)
    {
        if ($commonMarche instanceof CommonMarche) {
            return $this
                ->addUsingAlias(CommonCategorieConsultationPeer::ID, $commonMarche->getNaturemarche(), $comparison);
     ...
     * @return CommonCategorieConsultationQuery The current query, for fluid interface
     */
    public function joinCommonMarche($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonMarcheQuery A secondary query class using the current class as primary query
     */
    public function useCommonMarcheQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCommonMarche($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonMarche', 'CommonMarcheQuery');
    }
    ...
    public function filterByCommonExecContrat($commonExecContrat, $comparison = null)
    {
        if ($commonExecContrat instanceof CommonExecContrat) {
            return $this
                ->addUsingAlias(CommonCategorieConsultationPeer::ID, $commonExecContrat->getIdNaturePrestation(), $comparison);
