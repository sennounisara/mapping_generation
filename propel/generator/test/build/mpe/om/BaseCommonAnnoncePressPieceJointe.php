...
abstract class BaseCommonAnnoncePressPieceJointe extends BaseObject implements Persistent
{
    ...
    /**
     * @var        CommonAnnoncePress
     */
    protected $aCommonAnnoncePress;
    ...
    public function setIdAnnoncePress($v)
    {
        ...
        if ($this->aCommonAnnoncePress !== null && $this->aCommonAnnoncePress->getId() !== $v) {
            $this->aCommonAnnoncePress = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonAnnoncePress !== null && $this->id_annonce_press !== $this->aCommonAnnoncePress->getId()) {
            $this->aCommonAnnoncePress = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonAnnoncePress !== null) {
                if ($this->aCommonAnnoncePress->isModified() || $this->aCommonAnnoncePress->isNew()) {
                    $affectedRows += $this->aCommonAnnoncePress->save($con);
                }
                $this->setCommonAnnoncePress($this->aCommonAnnoncePress);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonAnnoncePress !== null) {
                if (!$this->aCommonAnnoncePress->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonAnnoncePress->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonAnnoncePress) {
                $result['CommonAnnoncePress'] = $this->aCommonAnnoncePress->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a CommonAnnoncePress object.
     *
     * @param   CommonAnnoncePress $v
     * @return CommonAnnoncePressPieceJointe The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonAnnoncePress(CommonAnnoncePress $v = null)
    {
        if ($v === null) {
            $this->setIdAnnoncePress(0);
        } else {
            $this->setIdAnnoncePress($v->getId());
        }

        $this->aCommonAnnoncePress = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonAnnoncePress object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonAnnoncePressPieceJointe($this);
        }
    ...
    /**
     * Get the associated CommonAnnoncePress object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonAnnoncePress The associated CommonAnnoncePress object.
     * @throws PropelException
     */
    public function getCommonAnnoncePress(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAnnoncePress === null && ($this->id_annonce_press !== null) && $doQuery) {
            $this->aCommonAnnoncePress = CommonAnnoncePressQuery::create()
                ->filterByCommonAnnoncePressPieceJointe($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonAnnoncePress->addCommonAnnoncePressPieceJointes($this);
             */
        }

        return $this->aCommonAnnoncePress;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonAnnoncePress instanceof Persistent) {
              $this->aCommonAnnoncePress->clearAllReferences($deep);
            }
