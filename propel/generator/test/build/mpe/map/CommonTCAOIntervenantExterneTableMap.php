...
class CommonTCAOIntervenantExterneTableMap extends TableMap
{
    ...
    {
        $this->addRelation('CommonTCAOCommissionIntervenantExterne', 'CommonTCAOCommissionIntervenantExterne', RelationMap::ONE_TO_MANY, array('id_intervenant_externe' => 'id_intervenant_externe', ), null, null, 'CommonTCAOCommissionIntervenantExternes');
        $this->addRelation('CommonTCAOSeanceIntervenantExterne', 'CommonTCAOSeanceIntervenantExterne', RelationMap::ONE_TO_MANY, array('id_intervenant_externe' => 'id_intervenant_externe', ), null, null, 'CommonTCAOSeanceIntervenantExternes');
        $this->addRelation('CommonTCAOSeanceInvite', 'CommonTCAOSeanceInvite', RelationMap::ONE_TO_MANY, array('id_intervenant_externe' => 'id_intervenant_externe', ), null, null, 'CommonTCAOSeanceInvites');
    } // buildRelations()
