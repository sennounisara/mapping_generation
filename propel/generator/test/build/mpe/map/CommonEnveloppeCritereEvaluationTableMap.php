...
class CommonEnveloppeCritereEvaluationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonEnveloppeCritereEvaluationTableMap';
    ...
    {
        $this->addRelation('CommonEnveloppeItemCritereEvaluation', 'CommonEnveloppeItemCritereEvaluation', RelationMap::ONE_TO_MANY, array('id' => 'idEnveloppeCritereEvaluation', ), null, null, 'CommonEnveloppeItemCritereEvaluations');
    } // buildRelations()
