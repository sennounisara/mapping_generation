...
abstract class BaseCommonNewsletterPieceJointe extends BaseObject implements Persistent
{
    ...
    /**
     * @var        CommonNewsletter
     */
    protected $aCommonNewsletter;
    ...
    public function setIdNewsletter($v)
    {
        ...
        if ($this->aCommonNewsletter !== null && $this->aCommonNewsletter->getId() !== $v) {
            $this->aCommonNewsletter = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonNewsletter !== null && $this->id_newsletter !== $this->aCommonNewsletter->getId()) {
            $this->aCommonNewsletter = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonNewsletter !== null) {
                if ($this->aCommonNewsletter->isModified() || $this->aCommonNewsletter->isNew()) {
                    $affectedRows += $this->aCommonNewsletter->save($con);
                }
                $this->setCommonNewsletter($this->aCommonNewsletter);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonNewsletter !== null) {
                if (!$this->aCommonNewsletter->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonNewsletter->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonNewsletter) {
                $result['CommonNewsletter'] = $this->aCommonNewsletter->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a CommonNewsletter object.
     *
     * @param   CommonNewsletter $v
     * @return CommonNewsletterPieceJointe The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonNewsletter(CommonNewsletter $v = null)
    {
        if ($v === null) {
            $this->setIdNewsletter(0);
        } else {
            $this->setIdNewsletter($v->getId());
        }

        $this->aCommonNewsletter = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonNewsletter object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonNewsletterPieceJointe($this);
        }
    ...
    /**
     * Get the associated CommonNewsletter object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonNewsletter The associated CommonNewsletter object.
     * @throws PropelException
     */
    public function getCommonNewsletter(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonNewsletter === null && ($this->id_newsletter !== null) && $doQuery) {
            $this->aCommonNewsletter = CommonNewsletterQuery::create()
                ->filterByCommonNewsletterPieceJointe($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonNewsletter->addCommonNewsletterPieceJointes($this);
             */
        }

        return $this->aCommonNewsletter;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonNewsletter instanceof Persistent) {
              $this->aCommonNewsletter->clearAllReferences($deep);
            }
