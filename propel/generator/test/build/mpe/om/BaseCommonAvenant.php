...
abstract class BaseCommonAvenant extends BaseObject implements Persistent
{
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->aCommonContrat !== null && $this->aCommonContrat->getIdContrat() !== $v) {
            $this->aCommonContrat = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonContrat !== null && $this->id_contrat !== $this->aCommonContrat->getIdContrat()) {
            $this->aCommonContrat = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonContrat !== null) {
                if ($this->aCommonContrat->isModified() || $this->aCommonContrat->isNew()) {
                    $affectedRows += $this->aCommonContrat->save($con);
                }
                $this->setCommonContrat($this->aCommonContrat);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonContrat !== null) {
                if (!$this->aCommonContrat->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonContrat->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonContrat) {
                $result['CommonContrat'] = $this->aCommonContrat->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a CommonContrat object.
     *
     * @param   CommonContrat $v
     * @return CommonAvenant The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonContrat(CommonContrat $v = null)
    {
        if ($v === null) {
        ...
        $this->aCommonContrat = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonContrat object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonAvenant($this);
        }
    ...
    /**
     * Get the associated CommonContrat object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonContrat The associated CommonContrat object.
     * @throws PropelException
     */
    public function getCommonContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonContrat === null && ($this->id_contrat !== null) && $doQuery) {
            $this->aCommonContrat = CommonContratQuery::create()
                ->filterByCommonAvenant($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonContrat->addCommonAvenants($this);
             */
        }

        return $this->aCommonContrat;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonContrat instanceof Persistent) {
              $this->aCommonContrat->clearAllReferences($deep);
            }
