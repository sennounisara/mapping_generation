...
/**
 * This class defines the structure of the 'ValeurReferentielOrg' table.
 *
 *
 *
 ...
 */
class CommonValeurReferentielOrgTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonValeurReferentielOrgTableMap';
    ...
    {
        // attributes
        $this->setName('ValeurReferentielOrg');
        $this->setPhpName('CommonValeurReferentielOrg');
        $this->setClassname('CommonValeurReferentielOrg');
        $this->setPackage('lt_parapheur');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, 10, null);
        $this->addPrimaryKey('organisme', 'Organisme', 'VARCHAR', true, 30, '');
        $this->addColumn('id_referentiel', 'IdReferentiel', 'INTEGER', true, 10, 0);
...
} // CommonValeurReferentielOrgTableMap
