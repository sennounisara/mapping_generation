...
abstract class BaseCommonService extends BaseObject implements Persistent
{
     ...
     */
    protected $collCommonAffiliationServicesRelatedByIdPoleOrganisme;
    protected $collCommonAffiliationServicesRelatedByIdPoleOrganismePartial;

    /**
     * @var        PropelObjectCollection|CommonAffiliationService[] Collection to store aggregation of CommonAffiliationService objects.
     */
    protected $collCommonAffiliationServicesRelatedByIdServiceOrganisme;
    protected $collCommonAffiliationServicesRelatedByIdServiceOrganismePartial;
     ...
     */
    protected $commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion = null;

    /**
     * An array of objects scheduled for deletion.
     * @var		PropelObjectCollection
     */
    protected $commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion = null;
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = null;

            $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = null;
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion !== null) {
                if (!$this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion->isEmpty()) {
                    //the foreign key is flagged as `CASCADE`, so we delete the items
                    CommonAffiliationServiceQuery::create()
                        ->filterByPrimaryKeys($this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion = null;
                }
            }

            if ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme !== null) {
                foreach ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme as $referrerFK) {
            ...
            if ($this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion !== null) {
                if (!$this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion->isEmpty()) {
                    //the foreign key is flagged as `CASCADE`, so we delete the items
                    CommonAffiliationServiceQuery::create()
                        ->filterByPrimaryKeys($this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion = null;
                }
            }

            if ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme !== null) {
                foreach ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme) {
                $result['CommonAffiliationServicesRelatedByIdPoleOrganisme'] = $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
            if (null !== $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme) {
                $result['CommonAffiliationServicesRelatedByIdServiceOrganisme'] = $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getCommonAffiliationServicesRelatedByIdPoleOrganisme() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addCommonAffiliationServiceRelatedByIdPoleOrganisme($relObj->copy($deepCopy));
                }
            }

            foreach ($this->getCommonAffiliationServicesRelatedByIdServiceOrganisme() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addCommonAffiliationServiceRelatedByIdServiceOrganisme($relObj->copy($deepCopy));
                }
            }
    ...
    {
        if ('CommonAffiliationServiceRelatedByIdPoleOrganisme' == $relationName) {
            $this->initCommonAffiliationServicesRelatedByIdPoleOrganisme();
        }
        if ('CommonAffiliationServiceRelatedByIdServiceOrganisme' == $relationName) {
            $this->initCommonAffiliationServicesRelatedByIdServiceOrganisme();
        }
    }

    /**
     * Clears out the collCommonAffiliationServicesRelatedByIdPoleOrganisme collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return CommonService The current object (for fluent API support)
     * @see        addCommonAffiliationServicesRelatedByIdPoleOrganisme()
     */
    public function clearCommonAffiliationServicesRelatedByIdPoleOrganisme()
    {
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = null; // important to set this to null since that means it is uninitialized
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial = null;

        return $this;
    }

    /**
     * reset is the collCommonAffiliationServicesRelatedByIdPoleOrganisme collection loaded partially
     *
     * @return void
     */
    public function resetPartialCommonAffiliationServicesRelatedByIdPoleOrganisme($v = true)
    {
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial = $v;
    }

    /**
     * Initializes the collCommonAffiliationServicesRelatedByIdPoleOrganisme collection.
     *
     * By default this just sets the collCommonAffiliationServicesRelatedByIdPoleOrganisme collection to an empty array (like clearcollCommonAffiliationServicesRelatedByIdPoleOrganisme());
     ...
     * @return void
     */
    public function initCommonAffiliationServicesRelatedByIdPoleOrganisme($overrideExisting = true)
    {
        if (null !== $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme && !$overrideExisting) {
            return;
        }
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = new PropelObjectCollection();
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->setModel('CommonAffiliationService');
    }
     ...
     * @throws PropelException
     */
    public function getCommonAffiliationServicesRelatedByIdPoleOrganisme($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial && !$this->isNew();
        if (null === $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme) {
                // return empty collection
                $this->initCommonAffiliationServicesRelatedByIdPoleOrganisme();
            } else {
                $collCommonAffiliationServicesRelatedByIdPoleOrganisme = CommonAffiliationServiceQuery::create(null, $criteria)
                    ->filterByCommonServiceRelatedByIdPoleOrganisme($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial && count($collCommonAffiliationServicesRelatedByIdPoleOrganisme)) {
                      $this->initCommonAffiliationServicesRelatedByIdPoleOrganisme(false);

                      foreach ($collCommonAffiliationServicesRelatedByIdPoleOrganisme as $obj) {
                        if (false == $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->contains($obj)) {
                          $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->append($obj);
                        }
                      }

                      $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial = true;
                    }

                    $collCommonAffiliationServicesRelatedByIdPoleOrganisme->getInternalIterator()->rewind();

                    return $collCommonAffiliationServicesRelatedByIdPoleOrganisme;
                }

                if ($partial && $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme) {
                    foreach ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme as $obj) {
                        if ($obj->isNew()) {
                            $collCommonAffiliationServicesRelatedByIdPoleOrganisme[] = $obj;
                        }
                    }
                }

                $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = $collCommonAffiliationServicesRelatedByIdPoleOrganisme;
                $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial = false;
            }
        }

        return $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme;
    }

    /**
     * Sets a collection of CommonAffiliationServiceRelatedByIdPoleOrganisme objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $commonAffiliationServicesRelatedByIdPoleOrganisme A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return CommonService The current object (for fluent API support)
     */
    public function setCommonAffiliationServicesRelatedByIdPoleOrganisme(PropelCollection $commonAffiliationServicesRelatedByIdPoleOrganisme, PropelPDO $con = null)
    {
        $commonAffiliationServicesRelatedByIdPoleOrganismeToDelete = $this->getCommonAffiliationServicesRelatedByIdPoleOrganisme(new Criteria(), $con)->diff($commonAffiliationServicesRelatedByIdPoleOrganisme);


        //since at least one column in the foreign key is at the same time a PK
        //we can not just set a PK to NULL in the lines below. We have to store
        //a backup of all values, so we are able to manipulate these items based on the onDelete value later.
        $this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion = clone $commonAffiliationServicesRelatedByIdPoleOrganismeToDelete;

        foreach ($commonAffiliationServicesRelatedByIdPoleOrganismeToDelete as $commonAffiliationServiceRelatedByIdPoleOrganismeRemoved) {
            $commonAffiliationServiceRelatedByIdPoleOrganismeRemoved->setCommonServiceRelatedByIdPoleOrganisme(null);
        }

        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = null;
        foreach ($commonAffiliationServicesRelatedByIdPoleOrganisme as $commonAffiliationServiceRelatedByIdPoleOrganisme) {
            $this->addCommonAffiliationServiceRelatedByIdPoleOrganisme($commonAffiliationServiceRelatedByIdPoleOrganisme);
        }

        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = $commonAffiliationServicesRelatedByIdPoleOrganisme;
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial = false;
     ...
     * @throws PropelException
     */
    public function countCommonAffiliationServicesRelatedByIdPoleOrganisme(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial && !$this->isNew();
        if (null === $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme) {
            ...
            if ($partial && !$criteria) {
                return count($this->getCommonAffiliationServicesRelatedByIdPoleOrganisme());
            }
        ...
        return count($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme);
    }
     ...
     * @return CommonService The current object (for fluent API support)
     */
    public function addCommonAffiliationServiceRelatedByIdPoleOrganisme(CommonAffiliationService $l)
    {
        if ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme === null) {
            $this->initCommonAffiliationServicesRelatedByIdPoleOrganisme();
            $this->collCommonAffiliationServicesRelatedByIdPoleOrganismePartial = true;
        }
        if (!in_array($l, $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddCommonAffiliationServiceRelatedByIdPoleOrganisme($l);
        }
    ...
    /**
     * @param	CommonAffiliationServiceRelatedByIdPoleOrganisme $commonAffiliationServiceRelatedByIdPoleOrganisme The commonAffiliationServiceRelatedByIdPoleOrganisme object to add.
     */
    protected function doAddCommonAffiliationServiceRelatedByIdPoleOrganisme($commonAffiliationServiceRelatedByIdPoleOrganisme)
    {
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme[]= $commonAffiliationServiceRelatedByIdPoleOrganisme;
        $commonAffiliationServiceRelatedByIdPoleOrganisme->setCommonServiceRelatedByIdPoleOrganisme($this);
    }

    /**
     * @param	CommonAffiliationServiceRelatedByIdPoleOrganisme $commonAffiliationServiceRelatedByIdPoleOrganisme The commonAffiliationServiceRelatedByIdPoleOrganisme object to remove.
     * @return CommonService The current object (for fluent API support)
     */
    public function removeCommonAffiliationServiceRelatedByIdPoleOrganisme($commonAffiliationServiceRelatedByIdPoleOrganisme)
    {
        if ($this->getCommonAffiliationServicesRelatedByIdPoleOrganisme()->contains($commonAffiliationServiceRelatedByIdPoleOrganisme)) {
            $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->remove($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->search($commonAffiliationServiceRelatedByIdPoleOrganisme));
            if (null === $this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion) {
                $this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion = clone $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme;
                $this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion->clear();
            }
            $this->commonAffiliationServicesRelatedByIdPoleOrganismeScheduledForDeletion[]= clone $commonAffiliationServiceRelatedByIdPoleOrganisme;
            $commonAffiliationServiceRelatedByIdPoleOrganisme->setCommonServiceRelatedByIdPoleOrganisme(null);
        }
     ...
     * been saved, it will retrieve related CommonAffiliationServicesRelatedByIdPoleOrganisme from storage.
     *
     ...
     * @return PropelObjectCollection|CommonAffiliationService[] List of CommonAffiliationService objects
     */
    public function getCommonAffiliationServicesRelatedByIdPoleOrganismeJoinCommonOrganisme($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommonAffiliationServiceQuery::create(null, $criteria);
        $query->joinWith('CommonOrganisme', $join_behavior);

        return $this->getCommonAffiliationServicesRelatedByIdPoleOrganisme($query, $con);
    }

    /**
     * Clears out the collCommonAffiliationServicesRelatedByIdServiceOrganisme collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return CommonService The current object (for fluent API support)
     * @see        addCommonAffiliationServicesRelatedByIdServiceOrganisme()
     */
    public function clearCommonAffiliationServicesRelatedByIdServiceOrganisme()
    {
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = null; // important to set this to null since that means it is uninitialized
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial = null;

        return $this;
    }

    /**
     * reset is the collCommonAffiliationServicesRelatedByIdServiceOrganisme collection loaded partially
     *
     * @return void
     */
    public function resetPartialCommonAffiliationServicesRelatedByIdServiceOrganisme($v = true)
    {
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial = $v;
    }

    /**
     * Initializes the collCommonAffiliationServicesRelatedByIdServiceOrganisme collection.
     *
     * By default this just sets the collCommonAffiliationServicesRelatedByIdServiceOrganisme collection to an empty array (like clearcollCommonAffiliationServicesRelatedByIdServiceOrganisme());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initCommonAffiliationServicesRelatedByIdServiceOrganisme($overrideExisting = true)
    {
        if (null !== $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme && !$overrideExisting) {
            return;
        }
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = new PropelObjectCollection();
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->setModel('CommonAffiliationService');
    }
     ...
     * @throws PropelException
     */
    public function getCommonAffiliationServicesRelatedByIdServiceOrganisme($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial && !$this->isNew();
        if (null === $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme) {
                // return empty collection
                $this->initCommonAffiliationServicesRelatedByIdServiceOrganisme();
            } else {
                $collCommonAffiliationServicesRelatedByIdServiceOrganisme = CommonAffiliationServiceQuery::create(null, $criteria)
                    ->filterByCommonServiceRelatedByIdServiceOrganisme($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial && count($collCommonAffiliationServicesRelatedByIdServiceOrganisme)) {
                      $this->initCommonAffiliationServicesRelatedByIdServiceOrganisme(false);

                      foreach ($collCommonAffiliationServicesRelatedByIdServiceOrganisme as $obj) {
                        if (false == $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->contains($obj)) {
                          $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->append($obj);
                        }
                      }

                      $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial = true;
                    }

                    $collCommonAffiliationServicesRelatedByIdServiceOrganisme->getInternalIterator()->rewind();

                    return $collCommonAffiliationServicesRelatedByIdServiceOrganisme;
                }

                if ($partial && $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme) {
                    foreach ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme as $obj) {
                        if ($obj->isNew()) {
                            $collCommonAffiliationServicesRelatedByIdServiceOrganisme[] = $obj;
                        }
                    }
                }

                $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = $collCommonAffiliationServicesRelatedByIdServiceOrganisme;
                $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial = false;
            }
        }

        return $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme;
    }

    /**
     * Sets a collection of CommonAffiliationServiceRelatedByIdServiceOrganisme objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $commonAffiliationServicesRelatedByIdServiceOrganisme A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return CommonService The current object (for fluent API support)
     */
    public function setCommonAffiliationServicesRelatedByIdServiceOrganisme(PropelCollection $commonAffiliationServicesRelatedByIdServiceOrganisme, PropelPDO $con = null)
    {
        $commonAffiliationServicesRelatedByIdServiceOrganismeToDelete = $this->getCommonAffiliationServicesRelatedByIdServiceOrganisme(new Criteria(), $con)->diff($commonAffiliationServicesRelatedByIdServiceOrganisme);


        //since at least one column in the foreign key is at the same time a PK
        //we can not just set a PK to NULL in the lines below. We have to store
        //a backup of all values, so we are able to manipulate these items based on the onDelete value later.
        $this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion = clone $commonAffiliationServicesRelatedByIdServiceOrganismeToDelete;

        foreach ($commonAffiliationServicesRelatedByIdServiceOrganismeToDelete as $commonAffiliationServiceRelatedByIdServiceOrganismeRemoved) {
            $commonAffiliationServiceRelatedByIdServiceOrganismeRemoved->setCommonServiceRelatedByIdServiceOrganisme(null);
        }

        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = null;
        foreach ($commonAffiliationServicesRelatedByIdServiceOrganisme as $commonAffiliationServiceRelatedByIdServiceOrganisme) {
            $this->addCommonAffiliationServiceRelatedByIdServiceOrganisme($commonAffiliationServiceRelatedByIdServiceOrganisme);
        }

        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = $commonAffiliationServicesRelatedByIdServiceOrganisme;
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial = false;
     ...
     * @throws PropelException
     */
    public function countCommonAffiliationServicesRelatedByIdServiceOrganisme(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial && !$this->isNew();
        if (null === $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme) {
            ...
            if ($partial && !$criteria) {
                return count($this->getCommonAffiliationServicesRelatedByIdServiceOrganisme());
            }
            $query = CommonAffiliationServiceQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
        ...
        return count($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme);
    }
     ...
     * @return CommonService The current object (for fluent API support)
     */
    public function addCommonAffiliationServiceRelatedByIdServiceOrganisme(CommonAffiliationService $l)
    {
        if ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme === null) {
            $this->initCommonAffiliationServicesRelatedByIdServiceOrganisme();
            $this->collCommonAffiliationServicesRelatedByIdServiceOrganismePartial = true;
        }
        if (!in_array($l, $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddCommonAffiliationServiceRelatedByIdServiceOrganisme($l);
        }
    ...
    /**
     * @param	CommonAffiliationServiceRelatedByIdServiceOrganisme $commonAffiliationServiceRelatedByIdServiceOrganisme The commonAffiliationServiceRelatedByIdServiceOrganisme object to add.
     */
    protected function doAddCommonAffiliationServiceRelatedByIdServiceOrganisme($commonAffiliationServiceRelatedByIdServiceOrganisme)
    {
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme[]= $commonAffiliationServiceRelatedByIdServiceOrganisme;
        $commonAffiliationServiceRelatedByIdServiceOrganisme->setCommonServiceRelatedByIdServiceOrganisme($this);
    }

    /**
     * @param	CommonAffiliationServiceRelatedByIdServiceOrganisme $commonAffiliationServiceRelatedByIdServiceOrganisme The commonAffiliationServiceRelatedByIdServiceOrganisme object to remove.
     * @return CommonService The current object (for fluent API support)
     */
    public function removeCommonAffiliationServiceRelatedByIdServiceOrganisme($commonAffiliationServiceRelatedByIdServiceOrganisme)
    {
        if ($this->getCommonAffiliationServicesRelatedByIdServiceOrganisme()->contains($commonAffiliationServiceRelatedByIdServiceOrganisme)) {
            $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->remove($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->search($commonAffiliationServiceRelatedByIdServiceOrganisme));
            if (null === $this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion) {
                $this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion = clone $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme;
                $this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion->clear();
            }
            $this->commonAffiliationServicesRelatedByIdServiceOrganismeScheduledForDeletion[]= clone $commonAffiliationServiceRelatedByIdServiceOrganisme;
            $commonAffiliationServiceRelatedByIdServiceOrganisme->setCommonServiceRelatedByIdServiceOrganisme(null);
        }
     ...
     * Otherwise if this CommonService is new, it will return
     * an empty collection; or if this CommonService has previously
     * been saved, it will retrieve related CommonAffiliationServicesRelatedByIdServiceOrganisme from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonService.
     ...
     * @return PropelObjectCollection|CommonAffiliationService[] List of CommonAffiliationService objects
     */
    public function getCommonAffiliationServicesRelatedByIdServiceOrganismeJoinCommonOrganisme($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommonAffiliationServiceQuery::create(null, $criteria);
        $query->joinWith('CommonOrganisme', $join_behavior);

        return $this->getCommonAffiliationServicesRelatedByIdServiceOrganisme($query, $con);
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme) {
                foreach ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme as $o) {
                    $o->clearAllReferences($deep);
                }
            }
            if ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme) {
                foreach ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        if ($this->collCommonAffiliationServicesRelatedByIdPoleOrganisme instanceof PropelCollection) {
            $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme->clearIterator();
        }
        $this->collCommonAffiliationServicesRelatedByIdPoleOrganisme = null;
        if ($this->collCommonAffiliationServicesRelatedByIdServiceOrganisme instanceof PropelCollection) {
            $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme->clearIterator();
        }
        $this->collCommonAffiliationServicesRelatedByIdServiceOrganisme = null;
    }
