 ...
 *
 * @method CommonEchangePieceJointeQuery leftJoinCommonEchange($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEchange relation
 * @method CommonEchangePieceJointeQuery rightJoinCommonEchange($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEchange relation
 * @method CommonEchangePieceJointeQuery innerJoinCommonEchange($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEchange relation
 *
...
abstract class BaseCommonEchangePieceJointeQuery extends ModelCriteria
{
    ...
    public function filterByCommonEchange($commonEchange, $comparison = null)
    {
        if ($commonEchange instanceof CommonEchange) {
            return $this
                ->addUsingAlias(CommonEchangePieceJointePeer::ID_MESSAGE, $commonEchange->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonEchangePieceJointePeer::ID_MESSAGE, $commonEchange->toKeyValue('Id', 'Id'), $comparison);
        } else {
