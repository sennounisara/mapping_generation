...
abstract class BaseActionPeer
{
    ...
    const ID_ACTION = 'action.ID_ACTION';

    /** the column name for the LIBELLE_ACTION_FR field */
    const LIBELLE_ACTION_FR = 'action.LIBELLE_ACTION_FR';

    /** the column name for the LIBELLE_ACTION_AR field */
    const LIBELLE_ACTION_AR = 'action.LIBELLE_ACTION_AR';

    /** the column name for the CONDITIONS_VISIBILITE field */
    const CONDITIONS_VISIBILITE = 'action.CONDITIONS_VISIBILITE';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdAction', 'LibelleActionFr', 'LibelleActionAr', 'ConditionsVisibilite', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idAction', 'libelleActionFr', 'libelleActionAr', 'conditionsVisibilite', ),
        BasePeer::TYPE_COLNAME => array (ActionPeer::ID_ACTION, ActionPeer::LIBELLE_ACTION_FR, ActionPeer::LIBELLE_ACTION_AR, ActionPeer::CONDITIONS_VISIBILITE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_ACTION', 'LIBELLE_ACTION_FR', 'LIBELLE_ACTION_AR', 'CONDITIONS_VISIBILITE', ),
        BasePeer::TYPE_FIELDNAME => array ('ID_ACTION', 'LIBELLE_ACTION_FR', 'LIBELLE_ACTION_AR', 'CONDITIONS_VISIBILITE', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdAction' => 0, 'LibelleActionFr' => 1, 'LibelleActionAr' => 2, 'ConditionsVisibilite' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idAction' => 0, 'libelleActionFr' => 1, 'libelleActionAr' => 2, 'conditionsVisibilite' => 3, ),
        BasePeer::TYPE_COLNAME => array (ActionPeer::ID_ACTION => 0, ActionPeer::LIBELLE_ACTION_FR => 1, ActionPeer::LIBELLE_ACTION_AR => 2, ActionPeer::CONDITIONS_VISIBILITE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_ACTION' => 0, 'LIBELLE_ACTION_FR' => 1, 'LIBELLE_ACTION_AR' => 2, 'CONDITIONS_VISIBILITE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('ID_ACTION' => 0, 'LIBELLE_ACTION_FR' => 1, 'LIBELLE_ACTION_AR' => 2, 'CONDITIONS_VISIBILITE' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ActionPeer::ID_ACTION);
            $criteria->addSelectColumn(ActionPeer::LIBELLE_ACTION_FR);
            $criteria->addSelectColumn(ActionPeer::LIBELLE_ACTION_AR);
            $criteria->addSelectColumn(ActionPeer::CONDITIONS_VISIBILITE);
        } else {
            $criteria->addSelectColumn($alias . '.ID_ACTION');
            $criteria->addSelectColumn($alias . '.LIBELLE_ACTION_FR');
            $criteria->addSelectColumn($alias . '.LIBELLE_ACTION_AR');
            $criteria->addSelectColumn($alias . '.CONDITIONS_VISIBILITE');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ActionPeer::ID_ACTION) && $criteria->keyContainsValue(ActionPeer::ID_ACTION) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ActionPeer::ID_ACTION);
            $value = $criteria->remove(ActionPeer::ID_ACTION);
            if ($value) {
                $selectCriteria->add(ActionPeer::ID_ACTION, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ActionPeer::ID_ACTION, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ActionPeer::DATABASE_NAME);
        $criteria->add(ActionPeer::ID_ACTION, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ActionPeer::DATABASE_NAME);
            $criteria->add(ActionPeer::ID_ACTION, $pks, Criteria::IN);
