 ...
 *
 * @method CommonTCAOSeanceQuery leftJoinCommonTCAOCommission($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOCommission relation
 * @method CommonTCAOSeanceQuery rightJoinCommonTCAOCommission($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOCommission relation
 * @method CommonTCAOSeanceQuery innerJoinCommonTCAOCommission($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOCommission relation
 *
 * @method CommonTCAOSeanceQuery leftJoinCommonTCAOOrdreDePassageRelatedByDateSeance($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByDateSeance relation
 * @method CommonTCAOSeanceQuery rightJoinCommonTCAOOrdreDePassageRelatedByDateSeance($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByDateSeance relation
 * @method CommonTCAOSeanceQuery innerJoinCommonTCAOOrdreDePassageRelatedByDateSeance($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByDateSeance relation
 *
 * @method CommonTCAOSeanceQuery leftJoinCommonTCAOOrdreDePassageRelatedByIdSeance($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByIdSeance relation
 * @method CommonTCAOSeanceQuery rightJoinCommonTCAOOrdreDePassageRelatedByIdSeance($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByIdSeance relation
 * @method CommonTCAOSeanceQuery innerJoinCommonTCAOOrdreDePassageRelatedByIdSeance($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByIdSeance relation
 *
 * @method CommonTCAOSeanceQuery leftJoinCommonTCAOSeanceAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOSeanceAgent relation
 * @method CommonTCAOSeanceQuery rightJoinCommonTCAOSeanceAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOSeanceAgent relation
 * @method CommonTCAOSeanceQuery innerJoinCommonTCAOSeanceAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOSeanceAgent relation
 *
 * @method CommonTCAOSeanceQuery leftJoinCommonTCAOSeanceIntervenantExterne($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOSeanceIntervenantExterne relation
 * @method CommonTCAOSeanceQuery rightJoinCommonTCAOSeanceIntervenantExterne($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOSeanceIntervenantExterne relation
 * @method CommonTCAOSeanceQuery innerJoinCommonTCAOSeanceIntervenantExterne($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOSeanceIntervenantExterne relation
 *
...
abstract class BaseCommonTCAOSeanceQuery extends ModelCriteria
{
    ...
    public function filterByCommonTCAOCommission($commonTCAOCommission, $comparison = null)
    {
        if ($commonTCAOCommission instanceof CommonTCAOCommission) {
            return $this
                ->addUsingAlias(CommonTCAOSeancePeer::ID_COMMISSION, $commonTCAOCommission->getIdCommission(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeancePeer::ID_COMMISSION, $commonTCAOCommission->toKeyValue('IdCommission', 'IdCommission'), $comparison);
        } else {
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonTCAOOrdreDePassageRelatedByDateSeance($commonTCAOOrdreDePassage, $comparison = null)
    {
        if ($commonTCAOOrdreDePassage instanceof CommonTCAOOrdreDePassage) {
            return $this
                ->addUsingAlias(CommonTCAOSeancePeer::DATE, $commonTCAOOrdreDePassage->getDateSeance(), $comparison);
        } elseif ($commonTCAOOrdreDePassage instanceof PropelObjectCollection) {
            return $this
                ->useCommonTCAOOrdreDePassageRelatedByDateSeanceQuery()
                ->filterByPrimaryKeys($commonTCAOOrdreDePassage->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonTCAOOrdreDePassageRelatedByDateSeance() only accepts arguments of type CommonTCAOOrdreDePassage or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByDateSeance relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonTCAOSeanceQuery The current query, for fluid interface
     */
    public function joinCommonTCAOOrdreDePassageRelatedByDateSeance($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonTCAOOrdreDePassageRelatedByDateSeance');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonTCAOOrdreDePassageRelatedByDateSeance');
        }
    ...
    /**
     * Use the CommonTCAOOrdreDePassageRelatedByDateSeance relation CommonTCAOOrdreDePassage object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonTCAOOrdreDePassageRelatedByDateSeanceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonTCAOOrdreDePassageRelatedByDateSeance($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonTCAOOrdreDePassageRelatedByDateSeance', 'CommonTCAOOrdreDePassageQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonTCAOOrdreDePassageRelatedByIdSeance($commonTCAOOrdreDePassage, $comparison = null)
    {
        if ($commonTCAOOrdreDePassage instanceof CommonTCAOOrdreDePassage) {
            return $this
                ->addUsingAlias(CommonTCAOSeancePeer::ID_SEANCE, $commonTCAOOrdreDePassage->getIdSeance(), $comparison);
        } elseif ($commonTCAOOrdreDePassage instanceof PropelObjectCollection) {
            return $this
                ->useCommonTCAOOrdreDePassageRelatedByIdSeanceQuery()
                ->filterByPrimaryKeys($commonTCAOOrdreDePassage->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonTCAOOrdreDePassageRelatedByIdSeance() only accepts arguments of type CommonTCAOOrdreDePassage or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonTCAOOrdreDePassageRelatedByIdSeance relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonTCAOSeanceQuery The current query, for fluid interface
     */
    public function joinCommonTCAOOrdreDePassageRelatedByIdSeance($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonTCAOOrdreDePassageRelatedByIdSeance');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonTCAOOrdreDePassageRelatedByIdSeance');
        }
    ...
    /**
     * Use the CommonTCAOOrdreDePassageRelatedByIdSeance relation CommonTCAOOrdreDePassage object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonTCAOOrdreDePassageQuery A secondary query class using the current class as primary query
     */
    public function useCommonTCAOOrdreDePassageRelatedByIdSeanceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonTCAOOrdreDePassageRelatedByIdSeance($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonTCAOOrdreDePassageRelatedByIdSeance', 'CommonTCAOOrdreDePassageQuery');
    }
    ...
    public function filterByCommonTCAOSeanceAgent($commonTCAOSeanceAgent, $comparison = null)
    {
        if ($commonTCAOSeanceAgent instanceof CommonTCAOSeanceAgent) {
            return $this
                ->addUsingAlias(CommonTCAOSeancePeer::ID_SEANCE, $commonTCAOSeanceAgent->getIdSeance(), $comparison);
    ...
    public function filterByCommonTCAOSeanceIntervenantExterne($commonTCAOSeanceIntervenantExterne, $comparison = null)
    {
        if ($commonTCAOSeanceIntervenantExterne instanceof CommonTCAOSeanceIntervenantExterne) {
            return $this
                ->addUsingAlias(CommonTCAOSeancePeer::ID_SEANCE, $commonTCAOSeanceIntervenantExterne->getIdSeance(), $comparison);
