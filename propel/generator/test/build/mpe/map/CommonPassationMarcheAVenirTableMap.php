...
class CommonPassationMarcheAVenirTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_passation_consultation', 'IdPassationConsultation', 'INTEGER', 'Passation_consultation', 'id', true, null, 0);
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonPassationConsultation', 'CommonPassationConsultation', RelationMap::MANY_TO_ONE, array('id_passation_consultation' => 'id', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
