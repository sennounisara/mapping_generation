 ...
 *
 * @method CommonServiceQuery leftJoinCommonAffiliationServiceRelatedByIdPoleOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAffiliationServiceRelatedByIdPoleOrganisme relation
 * @method CommonServiceQuery rightJoinCommonAffiliationServiceRelatedByIdPoleOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAffiliationServiceRelatedByIdPoleOrganisme relation
 * @method CommonServiceQuery innerJoinCommonAffiliationServiceRelatedByIdPoleOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAffiliationServiceRelatedByIdPoleOrganisme relation
 *
 * @method CommonServiceQuery leftJoinCommonAffiliationServiceRelatedByIdServiceOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAffiliationServiceRelatedByIdServiceOrganisme relation
 * @method CommonServiceQuery rightJoinCommonAffiliationServiceRelatedByIdServiceOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAffiliationServiceRelatedByIdServiceOrganisme relation
 * @method CommonServiceQuery innerJoinCommonAffiliationServiceRelatedByIdServiceOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAffiliationServiceRelatedByIdServiceOrganisme relation
 *
...
abstract class BaseCommonServiceQuery extends ModelCriteria
{
     ...
     */
    public function filterByCommonAffiliationServiceRelatedByIdPoleOrganisme($commonAffiliationService, $comparison = null)
    {
        if ($commonAffiliationService instanceof CommonAffiliationService) {
            return $this
                ->addUsingAlias(CommonServicePeer::ID, $commonAffiliationService->getIdPole(), $comparison)
                ->addUsingAlias(CommonServicePeer::ORGANISME, $commonAffiliationService->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonAffiliationServiceRelatedByIdPoleOrganisme() only accepts arguments of type CommonAffiliationService');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonAffiliationServiceRelatedByIdPoleOrganisme relation
     *
     ...
     * @return CommonServiceQuery The current query, for fluid interface
     */
    public function joinCommonAffiliationServiceRelatedByIdPoleOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonAffiliationServiceRelatedByIdPoleOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonAffiliationServiceRelatedByIdPoleOrganisme');
        }
    ...
    /**
     * Use the CommonAffiliationServiceRelatedByIdPoleOrganisme relation CommonAffiliationService object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonAffiliationServiceRelatedByIdPoleOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonAffiliationServiceRelatedByIdPoleOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonAffiliationServiceRelatedByIdPoleOrganisme', 'CommonAffiliationServiceQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonAffiliationServiceRelatedByIdServiceOrganisme($commonAffiliationService, $comparison = null)
    {
        if ($commonAffiliationService instanceof CommonAffiliationService) {
            return $this
                ->addUsingAlias(CommonServicePeer::ID, $commonAffiliationService->getIdService(), $comparison)
                ->addUsingAlias(CommonServicePeer::ORGANISME, $commonAffiliationService->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonAffiliationServiceRelatedByIdServiceOrganisme() only accepts arguments of type CommonAffiliationService');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonAffiliationServiceRelatedByIdServiceOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonServiceQuery The current query, for fluid interface
     */
    public function joinCommonAffiliationServiceRelatedByIdServiceOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonAffiliationServiceRelatedByIdServiceOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonAffiliationServiceRelatedByIdServiceOrganisme');
        }
    ...
    /**
     * Use the CommonAffiliationServiceRelatedByIdServiceOrganisme relation CommonAffiliationService object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonAffiliationServiceQuery A secondary query class using the current class as primary query
     */
    public function useCommonAffiliationServiceRelatedByIdServiceOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonAffiliationServiceRelatedByIdServiceOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonAffiliationServiceRelatedByIdServiceOrganisme', 'CommonAffiliationServiceQuery');
    }
