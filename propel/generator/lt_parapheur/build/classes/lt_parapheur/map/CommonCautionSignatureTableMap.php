...
/**
 * This class defines the structure of the 'caution_signature' table.
 *
 *
 *
 ...
 */
class CommonCautionSignatureTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonCautionSignatureTableMap';
    ...
    {
        // attributes
        $this->setName('caution_signature');
        $this->setPhpName('CommonCautionSignature');
        $this->setClassname('CommonCautionSignature');
  ...
  1 => '2',
        ...
        $this->addColumn('SIGNATURE_ARCHIVEE', 'SignatureArchivee', 'TINYINT', false, null, 0);
        // validators
    } // initialize()
...
} // CommonCautionSignatureTableMap
