...
class CommonFichierEnveloppeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonFichierEnveloppeTableMap';
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonBlocFichierEnveloppe', 'CommonBlocFichierEnveloppe', RelationMap::ONE_TO_MANY, array('id_fichier' => 'id_fichier', 'organisme' => 'organisme', ), null, null, 'CommonBlocFichierEnveloppes');
    } // buildRelations()
