...
abstract class BaseCommonExecPieceEvenementPeer
{
    ...
    public static function doSelectJoinAllExceptCommonExecContrat(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecEvenementPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonExecEvenementPeer::NUM_HYDRATE_COLUMNS;

        CommonExecTypePieceEvenementPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + CommonExecTypePieceEvenementPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecPieceEvenementPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = CommonExecEvenementPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = CommonExecEvenementPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (CommonExecPieceEvenement) to the collection in $obj2 (CommonExecEvenement)
                $obj2->addCommonExecPieceEvenement($obj1);
                ...
                $key3 = CommonExecTypePieceEvenementPeer::getPrimaryKeyHashFromRow($row, $startcol3);
                if ($key3 !== null) {
                    $obj3 = CommonExecTypePieceEvenementPeer::getInstanceFromPool($key3);
                    if (!$obj3) {
                    ...
                    $obj3 = new $cls();
                    $obj3->hydrate($row, $startcol3);
                    CommonExecTypePieceEvenementPeer::addInstanceToPool($obj3, $key3);
                } // if $obj3 already loaded

                // Add the $obj1 (CommonExecPieceEvenement) to the collection in $obj3 (CommonExecTypePieceEvenement)
                $obj3->addCommonExecPieceEvenement($obj1);
