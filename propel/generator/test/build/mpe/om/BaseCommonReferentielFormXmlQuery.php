 ...
 *
 * @method CommonReferentielFormXmlQuery leftJoinCommonReferentielTypeXml($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonReferentielTypeXml relation
 * @method CommonReferentielFormXmlQuery rightJoinCommonReferentielTypeXml($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonReferentielTypeXml relation
 * @method CommonReferentielFormXmlQuery innerJoinCommonReferentielTypeXml($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonReferentielTypeXml relation
 *
 * @method CommonReferentielFormXmlQuery leftJoinCommonAnnonceMoniteur($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAnnonceMoniteur relation
 * @method CommonReferentielFormXmlQuery rightJoinCommonAnnonceMoniteur($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAnnonceMoniteur relation
 * @method CommonReferentielFormXmlQuery innerJoinCommonAnnonceMoniteur($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAnnonceMoniteur relation
 *
...
abstract class BaseCommonReferentielFormXmlQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonReferentielTypeXml()
     *
    ...
    /**
     * Filter the query by a related CommonReferentielTypeXml object
     *
     * @param   CommonReferentielTypeXml|PropelObjectCollection $commonReferentielTypeXml The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonReferentielFormXmlQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonReferentielTypeXml($commonReferentielTypeXml, $comparison = null)
    {
        if ($commonReferentielTypeXml instanceof CommonReferentielTypeXml) {
            return $this
                ->addUsingAlias(CommonReferentielFormXmlPeer::ID_TYPE_XML, $commonReferentielTypeXml->getId(), $comparison);
        } elseif ($commonReferentielTypeXml instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonReferentielFormXmlPeer::ID_TYPE_XML, $commonReferentielTypeXml->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonReferentielTypeXml() only accepts arguments of type CommonReferentielTypeXml or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonReferentielTypeXml relation
     *
     ...
     * @return CommonReferentielFormXmlQuery The current query, for fluid interface
     */
    public function joinCommonReferentielTypeXml($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonReferentielTypeXml');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonReferentielTypeXml');
        }
    ...
    /**
     * Use the CommonReferentielTypeXml relation CommonReferentielTypeXml object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonReferentielTypeXmlQuery A secondary query class using the current class as primary query
     */
    public function useCommonReferentielTypeXmlQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonReferentielTypeXml($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonReferentielTypeXml', 'CommonReferentielTypeXmlQuery');
    }
    ...
    public function filterByCommonAnnonceMoniteur($commonAnnonceMoniteur, $comparison = null)
    {
        if ($commonAnnonceMoniteur instanceof CommonAnnonceMoniteur) {
            return $this
                ->addUsingAlias(CommonReferentielFormXmlPeer::ID, $commonAnnonceMoniteur->getIdFormXml(), $comparison);
