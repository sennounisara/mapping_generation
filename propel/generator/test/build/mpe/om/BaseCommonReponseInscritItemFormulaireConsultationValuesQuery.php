 ...
 *
 * @method CommonReponseInscritItemFormulaireConsultationValuesQuery leftJoinCommonItemFormulaireConsultation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonItemFormulaireConsultation relation
 * @method CommonReponseInscritItemFormulaireConsultationValuesQuery rightJoinCommonItemFormulaireConsultation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonItemFormulaireConsultation relation
 * @method CommonReponseInscritItemFormulaireConsultationValuesQuery innerJoinCommonItemFormulaireConsultation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonItemFormulaireConsultation relation
 *
...
abstract class BaseCommonReponseInscritItemFormulaireConsultationValuesQuery extends ModelCriteria
{
    ...
    public function filterByCommonItemFormulaireConsultation($commonItemFormulaireConsultation, $comparison = null)
    {
        if ($commonItemFormulaireConsultation instanceof CommonItemFormulaireConsultation) {
            return $this
                ->addUsingAlias(CommonReponseInscritItemFormulaireConsultationValuesPeer::IDITEMFORMULAIRECONSULTATION, $commonItemFormulaireConsultation->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonReponseInscritItemFormulaireConsultationValuesPeer::IDITEMFORMULAIRECONSULTATION, $commonItemFormulaireConsultation->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
