...
/**
 * Base class that represents a row from the 'Socle_Habilitation_Profil' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonSocleHabilitationProfil extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonSocleHabilitationProfilPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonSocleHabilitationProfilPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonSocleHabilitationProfil object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonSocleHabilitationProfil The current object (for fluent API support)
     */
    public function setIdProfil($v)
    {
        ...
        if ($this->id_profil !== $v) {
            $this->id_profil = $v;
            $this->modifiedColumns[] = CommonSocleHabilitationProfilPeer::ID_PROFIL;
        }
    ...
    public function setGestionAgentPoleSocle($v)
    {
        ...
        if ($this->gestion_agent_pole_socle !== $v) {
            ...
            $this->modifiedColumns[] = CommonSocleHabilitationProfilPeer::GESTION_AGENT_POLE_SOCLE;
        }
    ...
    public function setGestionAgentsSocle($v)
    {
        ...
        if ($this->gestion_agents_socle !== $v) {
            ...
            $this->modifiedColumns[] = CommonSocleHabilitationProfilPeer::GESTION_AGENTS_SOCLE;
        }
    ...
    public function setDroitGestionServicesSocle($v)
    {
        ...
        if ($this->droit_gestion_services_socle !== $v) {
            ...
            $this->modifiedColumns[] = CommonSocleHabilitationProfilPeer::DROIT_GESTION_SERVICES_SOCLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = CommonSocleHabilitationProfilPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonSocleHabilitationProfil object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonSocleHabilitationProfilPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonSocleHabilitationProfilQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonSocleHabilitationProfilPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::ID_PROFIL)) {
            $modifiedColumns[':p' . $index++]  = '`id_profil`';
        }
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::GESTION_AGENT_POLE_SOCLE)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_agent_pole_socle`';
        }
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::GESTION_AGENTS_SOCLE)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_agents_socle`';
        }
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::DROIT_GESTION_SERVICES_SOCLE)) {
            $modifiedColumns[':p' . $index++]  = '`droit_gestion_services_socle`';
        }

        $sql = sprintf(
            'INSERT INTO `Socle_Habilitation_Profil` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonSocleHabilitationProfilPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonSocleHabilitationProfilPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonSocleHabilitationProfil'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonSocleHabilitationProfil'][$this->getPrimaryKey()] = true;
        $keys = CommonSocleHabilitationProfilPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdProfil(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdProfil($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::ID_PROFIL)) $criteria->add(CommonSocleHabilitationProfilPeer::ID_PROFIL, $this->id_profil);
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::GESTION_AGENT_POLE_SOCLE)) $criteria->add(CommonSocleHabilitationProfilPeer::GESTION_AGENT_POLE_SOCLE, $this->gestion_agent_pole_socle);
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::GESTION_AGENTS_SOCLE)) $criteria->add(CommonSocleHabilitationProfilPeer::GESTION_AGENTS_SOCLE, $this->gestion_agents_socle);
        if ($this->isColumnModified(CommonSocleHabilitationProfilPeer::DROIT_GESTION_SERVICES_SOCLE)) $criteria->add(CommonSocleHabilitationProfilPeer::DROIT_GESTION_SERVICES_SOCLE, $this->droit_gestion_services_socle);
    ...
    {
        $criteria = new Criteria(CommonSocleHabilitationProfilPeer::DATABASE_NAME);
        $criteria->add(CommonSocleHabilitationProfilPeer::ID_PROFIL, $this->id_profil);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonSocleHabilitationProfil (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonSocleHabilitationProfil Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonSocleHabilitationProfilPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonSocleHabilitationProfilPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonSocleHabilitationProfilPeer::DEFAULT_STRING_FORMAT);
    }
