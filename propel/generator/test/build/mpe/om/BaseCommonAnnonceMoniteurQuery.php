 ...
 *
 * @method CommonAnnonceMoniteurQuery leftJoinCommonReferentielDestinationFormXml($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonReferentielDestinationFormXml relation
 * @method CommonAnnonceMoniteurQuery rightJoinCommonReferentielDestinationFormXml($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonReferentielDestinationFormXml relation
 * @method CommonAnnonceMoniteurQuery innerJoinCommonReferentielDestinationFormXml($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonReferentielDestinationFormXml relation
 *
 * @method CommonAnnonceMoniteurQuery leftJoinCommonReferentielFormXml($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonReferentielFormXml relation
 * @method CommonAnnonceMoniteurQuery rightJoinCommonReferentielFormXml($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonReferentielFormXml relation
 * @method CommonAnnonceMoniteurQuery innerJoinCommonReferentielFormXml($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonReferentielFormXml relation
 *
...
abstract class BaseCommonAnnonceMoniteurQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonReferentielFormXml()
     *
     ...
     * </code>
     *
     * @see       filterByCommonReferentielDestinationFormXml()
     *
    ...
    /**
     * Filter the query by a related CommonReferentielDestinationFormXml object
     *
     * @param   CommonReferentielDestinationFormXml|PropelObjectCollection $commonReferentielDestinationFormXml The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonAnnonceMoniteurQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonReferentielDestinationFormXml($commonReferentielDestinationFormXml, $comparison = null)
    {
        if ($commonReferentielDestinationFormXml instanceof CommonReferentielDestinationFormXml) {
            return $this
                ->addUsingAlias(CommonAnnonceMoniteurPeer::ID_DESTINATION_FORM_XML, $commonReferentielDestinationFormXml->getId(), $comparison);
        } elseif ($commonReferentielDestinationFormXml instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonAnnonceMoniteurPeer::ID_DESTINATION_FORM_XML, $commonReferentielDestinationFormXml->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonReferentielDestinationFormXml() only accepts arguments of type CommonReferentielDestinationFormXml or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonReferentielDestinationFormXml relation
     *
     ...
     * @return CommonAnnonceMoniteurQuery The current query, for fluid interface
     */
    public function joinCommonReferentielDestinationFormXml($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonReferentielDestinationFormXml');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonReferentielDestinationFormXml');
        }
    ...
    /**
     * Use the CommonReferentielDestinationFormXml relation CommonReferentielDestinationFormXml object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonReferentielDestinationFormXmlQuery A secondary query class using the current class as primary query
     */
    public function useCommonReferentielDestinationFormXmlQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonReferentielDestinationFormXml($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonReferentielDestinationFormXml', 'CommonReferentielDestinationFormXmlQuery');
    }

    /**
     * Filter the query by a related CommonReferentielFormXml object
     *
     * @param   CommonReferentielFormXml|PropelObjectCollection $commonReferentielFormXml The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonAnnonceMoniteurQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonReferentielFormXml($commonReferentielFormXml, $comparison = null)
    {
        if ($commonReferentielFormXml instanceof CommonReferentielFormXml) {
            return $this
                ->addUsingAlias(CommonAnnonceMoniteurPeer::ID_FORM_XML, $commonReferentielFormXml->getId(), $comparison);
        } elseif ($commonReferentielFormXml instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonAnnonceMoniteurPeer::ID_FORM_XML, $commonReferentielFormXml->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonReferentielFormXml() only accepts arguments of type CommonReferentielFormXml or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonReferentielFormXml relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonAnnonceMoniteurQuery The current query, for fluid interface
     */
    public function joinCommonReferentielFormXml($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonReferentielFormXml');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonReferentielFormXml');
        }
    ...
    /**
     * Use the CommonReferentielFormXml relation CommonReferentielFormXml object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonReferentielFormXmlQuery A secondary query class using the current class as primary query
     */
    public function useCommonReferentielFormXmlQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonReferentielFormXml($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonReferentielFormXml', 'CommonReferentielFormXmlQuery');
    }
