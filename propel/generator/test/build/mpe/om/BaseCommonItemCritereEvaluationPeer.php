...
abstract class BaseCommonItemCritereEvaluationPeer
{
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonCriteresEvaluation table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonCriteresEvaluation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonItemCritereEvaluationPeer::IDCRITEREEVALUATION, CommonCriteresEvaluationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonItemCritereEvaluation objects pre-filled with their CommonCriteresEvaluation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonItemCritereEvaluation objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonCriteresEvaluation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        CommonItemCritereEvaluationPeer::addSelectColumns($criteria);
        $startcol = CommonItemCritereEvaluationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonItemCritereEvaluationPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonItemCritereEvaluationPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonItemCritereEvaluationPeer::addInstanceToPool($obj1, $key1);
            } // if $obj1 already loaded

            $key2 = CommonCriteresEvaluationPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CommonCriteresEvaluationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    CommonCriteresEvaluationPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (CommonItemCritereEvaluation) to $obj2 (CommonCriteresEvaluation)
                $obj2->addCommonItemCritereEvaluation($obj1);
    ...
    /**
     * Selects a collection of CommonItemCritereEvaluation objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonItemCritereEvaluationPeer::addSelectColumns($criteria);
        $startcol2 = CommonItemCritereEvaluationPeer::NUM_HYDRATE_COLUMNS;

        CommonCriteresEvaluationPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonCriteresEvaluationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined CommonCriteresEvaluation rows

            $key2 = CommonCriteresEvaluationPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = CommonCriteresEvaluationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (CommonItemCritereEvaluation) to the collection in $obj2 (CommonCriteresEvaluation)
                $obj2->addCommonItemCritereEvaluation($obj1);
