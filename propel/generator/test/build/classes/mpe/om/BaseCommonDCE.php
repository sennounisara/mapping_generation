...
/**
 * Base class that represents a row from the 'DCE' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonDCE extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonDCEPeer';
    ...
    /**
     * The value for the nom_dce field.
     * @var        string
     */
    protected $nom_dce;
    ...
    /**
     * The value for the ancien_fichier field.
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $ancien_fichier;
    ...
    /**
     * Initializes internal state of BaseCommonDCE object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [nom_dce] column value.
     * 
     * @return string
     */
    public function getNomDce()
    {
    ...
    /**
     * Get the [ancien_fichier] column value.
     * 
     * @return string
     */
    public function getAncienFichier()
    {

        return $this->ancien_fichier;
    }
     ...
     * @return CommonDCE The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonDCEPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonDCEPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonDCEPeer::CONSULTATION_REF;
        }
    ...
    /**
     * Set the value of [dce] column.
     * 
     * @param int $v new value
     * @return CommonDCE The current object (for fluent API support)
     */
    public function setDce($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->dce !== $v) {
            $this->dce = $v;
            $this->modifiedColumns[] = CommonDCEPeer::DCE;
        }
    ...
    /**
     * Set the value of [nom_dce] column.
     * 
     * @param string $v new value
     * @return CommonDCE The current object (for fluent API support)
     */
    public function setNomDce($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->nom_dce !== $v) {
            $this->nom_dce = $v;
            $this->modifiedColumns[] = CommonDCEPeer::NOM_DCE;
        }
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[] = CommonDCEPeer::STATUT;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonDCEPeer::NOM_FICHIER;
        }
    ...
    /**
     * Set the value of [ancien_fichier] column.
     * 
     * @param string $v new value
     * @return CommonDCE The current object (for fluent API support)
     */
    public function setAncienFichier($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->ancien_fichier !== $v) {
            $this->ancien_fichier = $v;
            $this->modifiedColumns[] = CommonDCEPeer::ANCIEN_FICHIER;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonDCEPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = CommonDCEPeer::UNTRUSTEDDATE;
            }
    ...
    public function setAgentId($v)
    {
        ...
        if ($this->agent_id !== $v) {
            $this->agent_id = $v;
            $this->modifiedColumns[] = CommonDCEPeer::AGENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->dce = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->nom_dce = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->statut = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->nom_fichier = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->ancien_fichier = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            return $startcol + 11; // 11 = CommonDCEPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonDCE object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonDCEPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonDCEQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonDCEPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonDCEPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonDCEPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonDCEPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonDCEPeer::DCE)) {
            $modifiedColumns[':p' . $index++]  = '`dce`';
        }
        if ($this->isColumnModified(CommonDCEPeer::NOM_DCE)) {
            $modifiedColumns[':p' . $index++]  = '`nom_dce`';
        }
        if ($this->isColumnModified(CommonDCEPeer::STATUT)) {
            $modifiedColumns[':p' . $index++]  = '`statut`';
        }
        if ($this->isColumnModified(CommonDCEPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonDCEPeer::ANCIEN_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`ancien_fichier`';
        }
        if ($this->isColumnModified(CommonDCEPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonDCEPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonDCEPeer::AGENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`agent_id`';
        }

        $sql = sprintf(
            'INSERT INTO `DCE` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`consultation_ref`':						
                        ...
                        break;
                    case '`dce`':						
                        $stmt->bindValue($identifier, $this->dce, PDO::PARAM_INT);
                        break;
                    case '`nom_dce`':						
                        $stmt->bindValue($identifier, $this->nom_dce, PDO::PARAM_STR);
                        break;
                    case '`statut`':						
                    ...
                    case '`nom_fichier`':						
                        ...
                        break;
                    case '`ancien_fichier`':						
                        $stmt->bindValue($identifier, $this->ancien_fichier, PDO::PARAM_STR);
                        break;
                    case '`horodatage`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonDCEPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonDCEPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonDCE'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonDCE'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonDCEPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrganisme(),
            $keys[2] => $this->getConsultationRef(),
            $keys[3] => $this->getDce(),
            $keys[4] => $this->getNomDce(),
            $keys[5] => $this->getStatut(),
            $keys[6] => $this->getNomFichier(),
            $keys[7] => $this->getAncienFichier(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setDce($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setNomDce($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setStatut($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setNomFichier($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setAncienFichier($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonDCEPeer::ID)) $criteria->add(CommonDCEPeer::ID, $this->id);
        if ($this->isColumnModified(CommonDCEPeer::ORGANISME)) $criteria->add(CommonDCEPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonDCEPeer::CONSULTATION_REF)) $criteria->add(CommonDCEPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonDCEPeer::DCE)) $criteria->add(CommonDCEPeer::DCE, $this->dce);
        if ($this->isColumnModified(CommonDCEPeer::NOM_DCE)) $criteria->add(CommonDCEPeer::NOM_DCE, $this->nom_dce);
        if ($this->isColumnModified(CommonDCEPeer::STATUT)) $criteria->add(CommonDCEPeer::STATUT, $this->statut);
        if ($this->isColumnModified(CommonDCEPeer::NOM_FICHIER)) $criteria->add(CommonDCEPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonDCEPeer::ANCIEN_FICHIER)) $criteria->add(CommonDCEPeer::ANCIEN_FICHIER, $this->ancien_fichier);
        if ($this->isColumnModified(CommonDCEPeer::HORODATAGE)) $criteria->add(CommonDCEPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonDCEPeer::UNTRUSTEDDATE)) $criteria->add(CommonDCEPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonDCEPeer::AGENT_ID)) $criteria->add(CommonDCEPeer::AGENT_ID, $this->agent_id);
    ...
    {
        $criteria = new Criteria(CommonDCEPeer::DATABASE_NAME);
        $criteria->add(CommonDCEPeer::ID, $this->id);
        $criteria->add(CommonDCEPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonDCE (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDce($this->getDce());
        $copyObj->setNomDce($this->getNomDce());
        $copyObj->setStatut($this->getStatut());
        $copyObj->setNomFichier($this->getNomFichier());
        $copyObj->setAncienFichier($this->getAncienFichier());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonDCE Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonDCEPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonDCEPeer();
        }
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonDCEs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonDCEPeer::DEFAULT_STRING_FORMAT);
    }
