...
abstract class BaseCommonExecLivrableContratPeer
{
    ...
    public static function doCountJoinCommonAgent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecLivrableContratPeer::ID_AGENT_CREA, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecLivrableContrat objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonAgent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecLivrableContrat) to $obj2 (CommonAgent)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecLivrableContrat) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecLivrableContrat($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecLivrableContrat) to the collection in $obj3 (CommonExecContrat)
                $obj3->addCommonExecLivrableContrat($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonExecLivrableContrat objects pre-filled with all related objects except CommonAgent.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecLivrableContrat objects pre-filled with all related objects except CommonExecContrat.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
