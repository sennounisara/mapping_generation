 ...
 *
 * @method CommonConsultationFormulaireQuery leftJoinCommonItemFormulaireConsultation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonItemFormulaireConsultation relation
 * @method CommonConsultationFormulaireQuery rightJoinCommonItemFormulaireConsultation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonItemFormulaireConsultation relation
 * @method CommonConsultationFormulaireQuery innerJoinCommonItemFormulaireConsultation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonItemFormulaireConsultation relation
 *
...
abstract class BaseCommonConsultationFormulaireQuery extends ModelCriteria
{
     ...
     *
     * @param   CommonItemFormulaireConsultation|PropelObjectCollection $commonItemFormulaireConsultation  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonConsultationFormulaireQuery The current query, for fluid interface
    ...
    public function filterByCommonItemFormulaireConsultation($commonItemFormulaireConsultation, $comparison = null)
    {
        if ($commonItemFormulaireConsultation instanceof CommonItemFormulaireConsultation) {
            return $this
                ->addUsingAlias(CommonConsultationFormulairePeer::ID, $commonItemFormulaireConsultation->getIdformulaireconsultation(), $comparison);
        } elseif ($commonItemFormulaireConsultation instanceof PropelObjectCollection) {
            return $this
                ->useCommonItemFormulaireConsultationQuery()
                ->filterByPrimaryKeys($commonItemFormulaireConsultation->getPrimaryKeys())
                ->endUse();
        } else {
