...
/**
 * Base class that represents a row from the 'Helios_pv_consultation' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonHeliosPvConsultation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonHeliosPvConsultationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonHeliosPvConsultationPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonHeliosPvConsultation object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonHeliosPvConsultation The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::CONSULTATION_REF;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::NOM_FICHIER;
        }
    ...
    public function setFichier($v)
    {
        ...
        if ($this->fichier !== $v) {
            $this->fichier = $v;
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::FICHIER;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::UNTRUSTEDDATE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::TAILLE;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CommonHeliosPvConsultationPeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = CommonHeliosPvConsultationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonHeliosPvConsultation object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonHeliosPvConsultationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonHeliosPvConsultationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonHeliosPvConsultationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`fichier`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }

        $sql = sprintf(
            'INSERT INTO `Helios_pv_consultation` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonHeliosPvConsultationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonHeliosPvConsultationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonHeliosPvConsultation'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonHeliosPvConsultation'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonHeliosPvConsultationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::ID)) $criteria->add(CommonHeliosPvConsultationPeer::ID, $this->id);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::ORGANISME)) $criteria->add(CommonHeliosPvConsultationPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::CONSULTATION_REF)) $criteria->add(CommonHeliosPvConsultationPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::NOM_FICHIER)) $criteria->add(CommonHeliosPvConsultationPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::FICHIER)) $criteria->add(CommonHeliosPvConsultationPeer::FICHIER, $this->fichier);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::HORODATAGE)) $criteria->add(CommonHeliosPvConsultationPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::UNTRUSTEDDATE)) $criteria->add(CommonHeliosPvConsultationPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::TAILLE)) $criteria->add(CommonHeliosPvConsultationPeer::TAILLE, $this->taille);
        if ($this->isColumnModified(CommonHeliosPvConsultationPeer::DESCRIPTION)) $criteria->add(CommonHeliosPvConsultationPeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(CommonHeliosPvConsultationPeer::DATABASE_NAME);
        $criteria->add(CommonHeliosPvConsultationPeer::ID, $this->id);
        $criteria->add(CommonHeliosPvConsultationPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonHeliosPvConsultation (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonHeliosPvConsultation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonHeliosPvConsultationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonHeliosPvConsultationPeer();
        }
    ...
    public function setCommonConsultation(CommonConsultation $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonHeliosPvConsultation($this);
        }
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonHeliosPvConsultations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonHeliosPvConsultationPeer::DEFAULT_STRING_FORMAT);
    }
