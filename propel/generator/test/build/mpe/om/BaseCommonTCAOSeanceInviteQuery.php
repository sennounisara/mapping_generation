 ...
 *
 * @method CommonTCAOSeanceInviteQuery leftJoinCommonAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgent relation
 * @method CommonTCAOSeanceInviteQuery rightJoinCommonAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgent relation
 * @method CommonTCAOSeanceInviteQuery innerJoinCommonAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgent relation
 *
 * @method CommonTCAOSeanceInviteQuery leftJoinCommonTCAOIntervenantExterne($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOIntervenantExterne relation
 * @method CommonTCAOSeanceInviteQuery rightJoinCommonTCAOIntervenantExterne($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOIntervenantExterne relation
 * @method CommonTCAOSeanceInviteQuery innerJoinCommonTCAOIntervenantExterne($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOIntervenantExterne relation
 *
 * @method CommonTCAOSeanceInviteQuery leftJoinCommonTCAOOrdreDePassage($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOOrdreDePassage relation
 * @method CommonTCAOSeanceInviteQuery rightJoinCommonTCAOOrdreDePassage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOOrdreDePassage relation
 * @method CommonTCAOSeanceInviteQuery innerJoinCommonTCAOOrdreDePassage($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOOrdreDePassage relation
 *
 * @method CommonTCAOSeanceInviteQuery leftJoinCommonOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonTCAOSeanceInviteQuery rightJoinCommonOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonTCAOSeanceInviteQuery innerJoinCommonOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonOrganisme relation
 *
...
abstract class BaseCommonTCAOSeanceInviteQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonTCAOOrdreDePassage()
     *
    ...
    public function filterByCommonAgent($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ID_AGENT, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ID_AGENT, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonTCAOIntervenantExterne($commonTCAOIntervenantExterne, $comparison = null)
    {
        if ($commonTCAOIntervenantExterne instanceof CommonTCAOIntervenantExterne) {
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ID_INTERVENANT_EXTERNE, $commonTCAOIntervenantExterne->getIdIntervenantExterne(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ID_INTERVENANT_EXTERNE, $commonTCAOIntervenantExterne->toKeyValue('IdIntervenantExterne', 'IdIntervenantExterne'), $comparison);
        } else {
     ...
     * @return CommonTCAOSeanceInviteQuery The current query, for fluid interface
     */
    public function joinCommonTCAOIntervenantExterne($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     */
    public function useCommonTCAOIntervenantExterneQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
     ...
     *
     * @param   CommonTCAOOrdreDePassage|PropelObjectCollection $commonTCAOOrdreDePassage The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonTCAOSeanceInviteQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
    ...
    public function filterByCommonTCAOOrdreDePassage($commonTCAOOrdreDePassage, $comparison = null)
    {
        if ($commonTCAOOrdreDePassage instanceof CommonTCAOOrdreDePassage) {
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ID_ORDRE_DE_PASSAGE, $commonTCAOOrdreDePassage->getIdOrdreDePassage(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ID_ORDRE_DE_PASSAGE, $commonTCAOOrdreDePassage->toKeyValue('IdOrdreDePassage', 'IdOrdreDePassage'), $comparison);
        } else {
    ...
    public function filterByCommonOrganisme($commonOrganisme, $comparison = null)
    {
        if ($commonOrganisme instanceof CommonOrganisme) {
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ORGANISME, $commonOrganisme->getAcronyme(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeanceInvitePeer::ORGANISME, $commonOrganisme->toKeyValue('PrimaryKey', 'Acronyme'), $comparison);
        } else {
