...
class CommonHeliosTeletransmissionTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CommonHeliosTeletransmissionLot', 'CommonHeliosTeletransmissionLot', RelationMap::ONE_TO_MANY, array('id' => 'id_teletransmission', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonHeliosTeletransmissionLots');
    } // buildRelations()
