...
abstract class BaseCommonDecisionEnveloppePeer
{
    ...
    {
        // Invalidate objects in CommonChorusEchangePeer instance pool,
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonDecisionEnveloppePeer::doOnDeleteCascade(new Criteria(CommonDecisionEnveloppePeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonDecisionEnveloppePeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonDecisionEnveloppePeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonDecisionEnveloppePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CommonChorusEchange objects
            $criteria = new Criteria(CommonChorusEchangePeer::DATABASE_NAME);
            
            $criteria->add(CommonChorusEchangePeer::ID_DECISION, $obj->getIdDecisionEnveloppe());
            $criteria->add(CommonChorusEchangePeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonChorusEchangePeer::doDelete($criteria, $con);
        }
