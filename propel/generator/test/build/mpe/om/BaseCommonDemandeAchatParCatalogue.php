...
/**
 * Base class that represents a row from the 'demande_achat_par_catalogue' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonDemandeAchatParCatalogue extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonDemandeAchatParCataloguePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonDemandeAchatParCataloguePeer
     */
     ...
     * @return CommonDemandeAchatParCatalogue The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::ID;
        }
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::REFERENCE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::DATE_CREATION;
            }
    ...
    public function setDateValidation($v)
    {
        ...
        if ($this->date_validation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::DATE_VALIDATION;
            }
        } // if either are not null
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::STATUT;
        }
    ...
    public function setIdAgent($v)
    {
        ...
        if ($this->id_agent !== $v) {
            $this->id_agent = $v;
            $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::ID_AGENT;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonDemandeAchatParCataloguePeer::ORGANISME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->date_validation = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 7; // 7 = CommonDemandeAchatParCataloguePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonDemandeAchatParCatalogue object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonDemandeAchatParCataloguePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonDemandeAchatParCatalogueQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonDemandeAchatParCataloguePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::REFERENCE)) {
            $modifiedColumns[':p' . $index++]  = '`reference`';
        }
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::DATE_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_validation`';
        }
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::STATUT)) {
            $modifiedColumns[':p' . $index++]  = '`statut`';
        }
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::ID_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent`';
        }
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }

        $sql = sprintf(
            'INSERT INTO `demande_achat_par_catalogue` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonDemandeAchatParCataloguePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonDemandeAchatParCataloguePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonDemandeAchatParCatalogue'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonDemandeAchatParCatalogue'][$this->getPrimaryKey()] = true;
        $keys = CommonDemandeAchatParCataloguePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getReference(),
            $keys[2] => $this->getDateCreation(),
            $keys[3] => $this->getDateValidation(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setDateValidation($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::ID)) $criteria->add(CommonDemandeAchatParCataloguePeer::ID, $this->id);
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::REFERENCE)) $criteria->add(CommonDemandeAchatParCataloguePeer::REFERENCE, $this->reference);
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::DATE_CREATION)) $criteria->add(CommonDemandeAchatParCataloguePeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::DATE_VALIDATION)) $criteria->add(CommonDemandeAchatParCataloguePeer::DATE_VALIDATION, $this->date_validation);
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::STATUT)) $criteria->add(CommonDemandeAchatParCataloguePeer::STATUT, $this->statut);
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::ID_AGENT)) $criteria->add(CommonDemandeAchatParCataloguePeer::ID_AGENT, $this->id_agent);
        if ($this->isColumnModified(CommonDemandeAchatParCataloguePeer::ORGANISME)) $criteria->add(CommonDemandeAchatParCataloguePeer::ORGANISME, $this->organisme);
    ...
    {
        $criteria = new Criteria(CommonDemandeAchatParCataloguePeer::DATABASE_NAME);
        $criteria->add(CommonDemandeAchatParCataloguePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonDemandeAchatParCatalogue (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonDemandeAchatParCatalogue Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonDemandeAchatParCataloguePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonDemandeAchatParCataloguePeer();
        }
    ...
    public function setCommonAgent(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonDemandeAchatParCatalogue($this);
        }
    ...
    public function getCommonAgent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgent === null && ($this->id_agent !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgent->addCommonDemandeAchatParCatalogues($this);
             */
        }
    ...
    public function getCommonOrganisme(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonOrganisme === null && (($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            $this->aCommonOrganisme = CommonOrganismeQuery::create()
                ->filterByCommonDemandeAchatParCatalogue($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonOrganisme->addCommonDemandeAchatParCatalogues($this);
             */
        }
     ...
     * If this CommonDemandeAchatParCatalogue is new, it will return
        ...
        if (null === $this->collCommonBonCommandeParCatalogues || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonBonCommandeParCatalogues) {
                ...
                $collCommonBonCommandeParCatalogues = CommonBonCommandeParCatalogueQuery::create(null, $criteria)
                    ->filterByCommonDemandeAchatParCatalogue($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCommonBonCommandeParCatalogues(PropelCollection $commonBonCommandeParCatalogues, PropelPDO $con = null)
    {
        ...
        foreach ($commonBonCommandeParCataloguesToDelete as $commonBonCommandeParCatalogueRemoved) {
            $commonBonCommandeParCatalogueRemoved->setCommonDemandeAchatParCatalogue(null);
        }
    ...
    protected function doAddCommonBonCommandeParCatalogue($commonBonCommandeParCatalogue)
    {
        ...
        $commonBonCommandeParCatalogue->setCommonDemandeAchatParCatalogue($this);
    }
    ...
    public function removeCommonBonCommandeParCatalogue($commonBonCommandeParCatalogue)
    {
        if ($this->getCommonBonCommandeParCatalogues()->contains($commonBonCommandeParCatalogue)) {
            ...
            $commonBonCommandeParCatalogue->setCommonDemandeAchatParCatalogue(null);
        }
     ...
     * Otherwise if this CommonDemandeAchatParCatalogue is new, it will return
     * an empty collection; or if this CommonDemandeAchatParCatalogue has previously
     * been saved, it will retrieve related CommonBonCommandeParCatalogues from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonDemandeAchatParCatalogue.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CommonBonCommandeParCatalogue[] List of CommonBonCommandeParCatalogue objects
     */
    public function getCommonBonCommandeParCataloguesJoinCommonEntreprise($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommonBonCommandeParCatalogueQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CommonDemandeAchatParCataloguePeer::DEFAULT_STRING_FORMAT);
    }
