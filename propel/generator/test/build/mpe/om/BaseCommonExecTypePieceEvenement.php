...
/**
 * Base class that represents a row from the 'exec_type_piece_evenement' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecTypePieceEvenement extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecTypePieceEvenementPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecTypePieceEvenementPeer
     */
     ...
     * @return CommonExecTypePieceEvenement The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecTypePieceEvenementPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecTypePieceEvenementPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonExecTypePieceEvenementPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonExecTypePieceEvenementPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonExecTypePieceEvenementPeer::LIBELLE_EN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = CommonExecTypePieceEvenementPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecTypePieceEvenement object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecTypePieceEvenementPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecTypePieceEvenementQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecTypePieceEvenementPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_type_piece_evenement` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecTypePieceEvenementPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecTypePieceEvenementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecTypePieceEvenement'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecTypePieceEvenement'][$this->getPrimaryKey()] = true;
        $keys = CommonExecTypePieceEvenementPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::ID)) $criteria->add(CommonExecTypePieceEvenementPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE)) $criteria->add(CommonExecTypePieceEvenementPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE_FR)) $criteria->add(CommonExecTypePieceEvenementPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE_AR)) $criteria->add(CommonExecTypePieceEvenementPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonExecTypePieceEvenementPeer::LIBELLE_EN)) $criteria->add(CommonExecTypePieceEvenementPeer::LIBELLE_EN, $this->libelle_en);
    ...
    {
        $criteria = new Criteria(CommonExecTypePieceEvenementPeer::DATABASE_NAME);
        $criteria->add(CommonExecTypePieceEvenementPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecTypePieceEvenement (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecTypePieceEvenement Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecTypePieceEvenementPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecTypePieceEvenementPeer();
        }
     ...
     * If this CommonExecTypePieceEvenement is new, it will return
        ...
        if (null === $this->collCommonExecPieceEvenements || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonExecPieceEvenements) {
                ...
                $collCommonExecPieceEvenements = CommonExecPieceEvenementQuery::create(null, $criteria)
                    ->filterByCommonExecTypePieceEvenement($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCommonExecPieceEvenements(PropelCollection $commonExecPieceEvenements, PropelPDO $con = null)
    {
        ...
        foreach ($commonExecPieceEvenementsToDelete as $commonExecPieceEvenementRemoved) {
            $commonExecPieceEvenementRemoved->setCommonExecTypePieceEvenement(null);
        }
    ...
    protected function doAddCommonExecPieceEvenement($commonExecPieceEvenement)
    {
        ...
        $commonExecPieceEvenement->setCommonExecTypePieceEvenement($this);
    }
    ...
    public function removeCommonExecPieceEvenement($commonExecPieceEvenement)
    {
        if ($this->getCommonExecPieceEvenements()->contains($commonExecPieceEvenement)) {
            ...
            $this->commonExecPieceEvenementsScheduledForDeletion[]= $commonExecPieceEvenement;
            $commonExecPieceEvenement->setCommonExecTypePieceEvenement(null);
        }
     ...
     * Otherwise if this CommonExecTypePieceEvenement is new, it will return
     * an empty collection; or if this CommonExecTypePieceEvenement has previously
     * been saved, it will retrieve related CommonExecPieceEvenements from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonExecTypePieceEvenement.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(CommonExecTypePieceEvenementPeer::DEFAULT_STRING_FORMAT);
    }
