...
/**
 * This class defines the structure of the 'exec_facture_signature' table.
 *
 *
 *
 ...
 */
class CommonExecFactureSignatureTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonExecFactureSignatureTableMap';
    ...
    {
        // attributes
        $this->setName('exec_facture_signature');
        $this->setPhpName('CommonExecFactureSignature');
        $this->setClassname('CommonExecFactureSignature');
        $this->setPackage('lt_parapheur');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('ID', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('ID_BLOB', 'IdBlob', 'INTEGER', true, null, null);
        $this->addColumn('ID_FACTURE', 'IdFacture', 'INTEGER', true, null, null);
...
} // CommonExecFactureSignatureTableMap
