 ...
 *
 * @method CommonParametrageEnchereTranchesBaremeNETCQuery leftJoinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
 * @method CommonParametrageEnchereTranchesBaremeNETCQuery rightJoinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
 * @method CommonParametrageEnchereTranchesBaremeNETCQuery innerJoinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
 *
 * @method CommonParametrageEnchereTranchesBaremeNETCQuery leftJoinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
 * @method CommonParametrageEnchereTranchesBaremeNETCQuery rightJoinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
 * @method CommonParametrageEnchereTranchesBaremeNETCQuery innerJoinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
 *
...
abstract class BaseCommonParametrageEnchereTranchesBaremeNETCQuery extends ModelCriteria
{
    ...
    public function filterByCommonParametrageEnchereRelatedByIdenchere($commonParametrageEnchere, $comparison = null)
    {
        if ($commonParametrageEnchere instanceof CommonParametrageEnchere) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereTranchesBaremeNETCPeer::IDENCHERE, $commonParametrageEnchere->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonParametrageEnchereTranchesBaremeNETCPeer::IDENCHERE, $commonParametrageEnchere->toKeyValue('Id', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonParametrageEnchereRelatedByIdenchereOrganisme($commonParametrageEnchere, $comparison = null)
    {
        if ($commonParametrageEnchere instanceof CommonParametrageEnchere) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereTranchesBaremeNETCPeer::IDENCHERE, $commonParametrageEnchere->getId(), $comparison)
                ->addUsingAlias(CommonParametrageEnchereTranchesBaremeNETCPeer::ORGANISME, $commonParametrageEnchere->getOrganisme(), $comparison);
        } else {
