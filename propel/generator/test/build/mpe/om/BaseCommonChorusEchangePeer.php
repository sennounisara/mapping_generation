...
abstract class BaseCommonChorusEchangePeer
{
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonDecisionEnveloppe table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonDecisionEnveloppe(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        array(CommonChorusEchangePeer::ID_DECISION, CommonDecisionEnveloppePeer::ID_DECISION_ENVELOPPE),
        array(CommonChorusEchangePeer::ORGANISME, CommonDecisionEnveloppePeer::ORGANISME),
      ), $join_behavior);
    ...
    /**
     * Selects a collection of CommonChorusEchange objects pre-filled with their CommonDecisionEnveloppe objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonChorusEchange objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonDecisionEnveloppe(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        CommonChorusEchangePeer::addSelectColumns($criteria);
        $startcol = CommonChorusEchangePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonChorusEchangePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonChorusEchangePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonChorusEchangePeer::addInstanceToPool($obj1, $key1);
            } // if $obj1 already loaded

            $key2 = CommonDecisionEnveloppePeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CommonDecisionEnveloppePeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    CommonDecisionEnveloppePeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (CommonChorusEchange) to $obj2 (CommonDecisionEnveloppe)
                $obj2->addCommonChorusEchange($obj1);
    ...
    /**
     * Selects a collection of CommonChorusEchange objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonChorusEchangePeer::addSelectColumns($criteria);
        $startcol2 = CommonChorusEchangePeer::NUM_HYDRATE_COLUMNS;

        CommonDecisionEnveloppePeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonDecisionEnveloppePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined CommonDecisionEnveloppe rows

            $key2 = CommonDecisionEnveloppePeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = CommonDecisionEnveloppePeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (CommonChorusEchange) to the collection in $obj2 (CommonDecisionEnveloppe)
                $obj2->addCommonChorusEchange($obj1);
