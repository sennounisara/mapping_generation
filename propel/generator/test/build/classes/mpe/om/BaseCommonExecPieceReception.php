 ...
 */
abstract class BaseCommonExecPieceReception extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecPieceReceptionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecPieceReceptionPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonExecPieceReception object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonExecPieceReception The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::ID;
        }
    ...
    public function setIdReception($v)
    {
        ...
        if ($this->id_reception !== $v) {
            $this->id_reception = $v;
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::ID_RECEPTION;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::ID_CONTRAT;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::LIBELLE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::TAILLE;
        }
    ...
    public function setIdAgentCrea($v)
    {
        ...
        if ($this->id_agent_crea !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::ID_AGENT_CREA;
        }
    ...
    public function setDateCreat($v)
    {
        ...
        if ($this->date_creat !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecPieceReceptionPeer::DATE_CREAT;
            }
    ...
    public function setIdBlob($v)
    {
        ...
        if ($this->id_blob !== $v) {
            $this->id_blob = $v;
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::ID_BLOB;
        }
    ...
    public function setDepuisParaph($v)
    {
        ...
        if ($this->depuis_paraph !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::DEPUIS_PARAPH;
        }
    ...
    public function setAccesFournisseur($v)
    {
        ...
        if ($this->acces_fournisseur !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceReceptionPeer::ACCES_FOURNISSEUR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonExecPieceReceptionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecPieceReception object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecPieceReceptionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecPieceReceptionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecPieceReceptionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_RECEPTION)) {
            $modifiedColumns[':p' . $index++]  = '`id_reception`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_AGENT_CREA)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_crea`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::DATE_CREAT)) {
            $modifiedColumns[':p' . $index++]  = '`date_creat`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_BLOB)) {
            $modifiedColumns[':p' . $index++]  = '`id_blob`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::DEPUIS_PARAPH)) {
            $modifiedColumns[':p' . $index++]  = '`depuis_paraph`';
        }
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ACCES_FOURNISSEUR)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecPieceReceptionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecPieceReceptionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecPieceReception'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecPieceReception'][$this->getPrimaryKey()] = true;
        $keys = CommonExecPieceReceptionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID)) $criteria->add(CommonExecPieceReceptionPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_RECEPTION)) $criteria->add(CommonExecPieceReceptionPeer::ID_RECEPTION, $this->id_reception);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_CONTRAT)) $criteria->add(CommonExecPieceReceptionPeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::LIBELLE)) $criteria->add(CommonExecPieceReceptionPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::TAILLE)) $criteria->add(CommonExecPieceReceptionPeer::TAILLE, $this->taille);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_AGENT_CREA)) $criteria->add(CommonExecPieceReceptionPeer::ID_AGENT_CREA, $this->id_agent_crea);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::DATE_CREAT)) $criteria->add(CommonExecPieceReceptionPeer::DATE_CREAT, $this->date_creat);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ID_BLOB)) $criteria->add(CommonExecPieceReceptionPeer::ID_BLOB, $this->id_blob);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::DEPUIS_PARAPH)) $criteria->add(CommonExecPieceReceptionPeer::DEPUIS_PARAPH, $this->depuis_paraph);
        if ($this->isColumnModified(CommonExecPieceReceptionPeer::ACCES_FOURNISSEUR)) $criteria->add(CommonExecPieceReceptionPeer::ACCES_FOURNISSEUR, $this->acces_fournisseur);
    ...
    {
        $criteria = new Criteria(CommonExecPieceReceptionPeer::DATABASE_NAME);
        $criteria->add(CommonExecPieceReceptionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecPieceReception (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecPieceReception Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecPieceReceptionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecPieceReceptionPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonExecPieceReceptionPeer::DEFAULT_STRING_FORMAT);
    }
