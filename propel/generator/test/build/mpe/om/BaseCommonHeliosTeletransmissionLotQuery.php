 ...
 *
 * @method CommonHeliosTeletransmissionLotQuery leftJoinCommonHeliosTeletransmission($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonHeliosTeletransmission relation
 * @method CommonHeliosTeletransmissionLotQuery rightJoinCommonHeliosTeletransmission($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonHeliosTeletransmission relation
 * @method CommonHeliosTeletransmissionLotQuery innerJoinCommonHeliosTeletransmission($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonHeliosTeletransmission relation
 *
...
abstract class BaseCommonHeliosTeletransmissionLotQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonHeliosTeletransmission()
     *
     ...
     *
     * @param   CommonHeliosTeletransmission $commonHeliosTeletransmission The related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonHeliosTeletransmissionLotQuery The current query, for fluid interface
    ...
    public function filterByCommonHeliosTeletransmission($commonHeliosTeletransmission, $comparison = null)
    {
        if ($commonHeliosTeletransmission instanceof CommonHeliosTeletransmission) {
            return $this
                ->addUsingAlias(CommonHeliosTeletransmissionLotPeer::ID_TELETRANSMISSION, $commonHeliosTeletransmission->getId(), $comparison)
                ->addUsingAlias(CommonHeliosTeletransmissionLotPeer::ORGANISME, $commonHeliosTeletransmission->getOrganisme(), $comparison);
        } else {
     ...
     * @return CommonHeliosTeletransmissionLotQuery The current query, for fluid interface
     */
    public function joinCommonHeliosTeletransmission($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useCommonHeliosTeletransmissionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
