...
/**
 * Base class that represents a row from the 'Certificat_Agent' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonCertificatAgent extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonCertificatAgentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonCertificatAgentPeer
     */
    ...
    /**
     * The value for the mail_agent field.
     * Note: this column has a database default value of: ''
     * @var        string
     */
    protected $mail_agent;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->prenom_agent = '';
        $this->statut_revoque = '';
        $this->date_revoquation = '';
        $this->mail_agent = '';
    }

    /**
     * Initializes internal state of BaseCommonCertificatAgent object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [mail_agent] column value.
     * 
     * @return string
     */
     ...
     * @return CommonCertificatAgent The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::ID;
        }
    ...
    public function setCertificat($v)
    {
        ...
        if ($this->certificat !== $v) {
            $this->certificat = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::CERTIFICAT;
        }
    ...
    public function setDateDebut($v)
    {
        ...
        if ($this->date_debut !== $v) {
            $this->date_debut = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::DATE_DEBUT;
        }
    ...
    public function setDateFin($v)
    {
        ...
        if ($this->date_fin !== $v) {
            $this->date_fin = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::DATE_FIN;
        }
    ...
    public function setIdAgent($v)
    {
        ...
        if ($this->id_agent !== $v) {
            $this->id_agent = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::ID_AGENT;
        }
    ...
    public function setNomAgent($v)
    {
        ...
        if ($this->nom_agent !== $v) {
            $this->nom_agent = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::NOM_AGENT;
        }
    ...
    public function setPrenomAgent($v)
    {
        ...
        if ($this->prenom_agent !== $v) {
            $this->prenom_agent = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::PRENOM_AGENT;
        }
    ...
    public function setIdService($v)
    {
        ...
        if ($this->id_service !== $v) {
            $this->id_service = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::ID_SERVICE;
        }
    ...
    public function setStatutRevoque($v)
    {
        ...
        if ($this->statut_revoque !== $v) {
            ...
            $this->modifiedColumns[] = CommonCertificatAgentPeer::STATUT_REVOQUE;
        }
    ...
    public function setDateRevoquation($v)
    {
        ...
        if ($this->date_revoquation !== $v) {
            ...
            $this->modifiedColumns[] = CommonCertificatAgentPeer::DATE_REVOQUATION;
        }
    ...
    /**
     * Set the value of [mail_agent] column.
     * 
     * @param string $v new value
     * @return CommonCertificatAgent The current object (for fluent API support)
     */
    public function setMailAgent($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->mail_agent !== $v) {
            $this->mail_agent = $v;
            $this->modifiedColumns[] = CommonCertificatAgentPeer::MAIL_AGENT;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->statut_revoque !== '') {
                return false;
            }

            if ($this->date_revoquation !== '') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_service = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            ...
            $this->mail_agent = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->resetModified();
            ...
            return $startcol + 11; // 11 = CommonCertificatAgentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonCertificatAgent object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonCertificatAgentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonCertificatAgentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonCertificatAgentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonCertificatAgentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::CERTIFICAT)) {
            $modifiedColumns[':p' . $index++]  = '`certificat`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::DATE_DEBUT)) {
            $modifiedColumns[':p' . $index++]  = '`date_debut`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::DATE_FIN)) {
            $modifiedColumns[':p' . $index++]  = '`date_fin`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::ID_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::NOM_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`nom_agent`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::PRENOM_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`prenom_agent`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::ID_SERVICE)) {
            $modifiedColumns[':p' . $index++]  = '`id_service`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::STATUT_REVOQUE)) {
            $modifiedColumns[':p' . $index++]  = '`statut_revoque`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::DATE_REVOQUATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_revoquation`';
        }
        if ($this->isColumnModified(CommonCertificatAgentPeer::MAIL_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`mail_agent`';
        }

        $sql = sprintf(
            'INSERT INTO `Certificat_Agent` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`date_revoquation`':						
                        ...
                        break;
                    case '`mail_agent`':						
                        $stmt->bindValue($identifier, $this->mail_agent, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonCertificatAgentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonCertificatAgentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonCertificatAgent'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonCertificatAgent'][$this->getPrimaryKey()] = true;
        $keys = CommonCertificatAgentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setIdService($arr[$keys[7]]);
        ...
        if (array_key_exists($keys[10], $arr)) $this->setMailAgent($arr[$keys[10]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonCertificatAgentPeer::ID)) $criteria->add(CommonCertificatAgentPeer::ID, $this->id);
        if ($this->isColumnModified(CommonCertificatAgentPeer::CERTIFICAT)) $criteria->add(CommonCertificatAgentPeer::CERTIFICAT, $this->certificat);
        if ($this->isColumnModified(CommonCertificatAgentPeer::DATE_DEBUT)) $criteria->add(CommonCertificatAgentPeer::DATE_DEBUT, $this->date_debut);
        if ($this->isColumnModified(CommonCertificatAgentPeer::DATE_FIN)) $criteria->add(CommonCertificatAgentPeer::DATE_FIN, $this->date_fin);
        if ($this->isColumnModified(CommonCertificatAgentPeer::ID_AGENT)) $criteria->add(CommonCertificatAgentPeer::ID_AGENT, $this->id_agent);
        if ($this->isColumnModified(CommonCertificatAgentPeer::NOM_AGENT)) $criteria->add(CommonCertificatAgentPeer::NOM_AGENT, $this->nom_agent);
        if ($this->isColumnModified(CommonCertificatAgentPeer::PRENOM_AGENT)) $criteria->add(CommonCertificatAgentPeer::PRENOM_AGENT, $this->prenom_agent);
        if ($this->isColumnModified(CommonCertificatAgentPeer::ID_SERVICE)) $criteria->add(CommonCertificatAgentPeer::ID_SERVICE, $this->id_service);
        if ($this->isColumnModified(CommonCertificatAgentPeer::STATUT_REVOQUE)) $criteria->add(CommonCertificatAgentPeer::STATUT_REVOQUE, $this->statut_revoque);
        if ($this->isColumnModified(CommonCertificatAgentPeer::DATE_REVOQUATION)) $criteria->add(CommonCertificatAgentPeer::DATE_REVOQUATION, $this->date_revoquation);
        if ($this->isColumnModified(CommonCertificatAgentPeer::MAIL_AGENT)) $criteria->add(CommonCertificatAgentPeer::MAIL_AGENT, $this->mail_agent);
    ...
    {
        $criteria = new Criteria(CommonCertificatAgentPeer::DATABASE_NAME);
        $criteria->add(CommonCertificatAgentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonCertificatAgent (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMailAgent($this->getMailAgent());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonCertificatAgent Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonCertificatAgentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonCertificatAgentPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonCertificatAgentPeer::DEFAULT_STRING_FORMAT);
    }
