 ...
 *
 * @method CommonEnveloppeCritereEvaluationQuery leftJoinCommonEnveloppeItemCritereEvaluation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnveloppeItemCritereEvaluation relation
 * @method CommonEnveloppeCritereEvaluationQuery rightJoinCommonEnveloppeItemCritereEvaluation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnveloppeItemCritereEvaluation relation
 * @method CommonEnveloppeCritereEvaluationQuery innerJoinCommonEnveloppeItemCritereEvaluation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnveloppeItemCritereEvaluation relation
 *
...
abstract class BaseCommonEnveloppeCritereEvaluationQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related CommonEnveloppeItemCritereEvaluation object
     *
     * @param   CommonEnveloppeItemCritereEvaluation|PropelObjectCollection $commonEnveloppeItemCritereEvaluation  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEnveloppeCritereEvaluationQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnveloppeItemCritereEvaluation($commonEnveloppeItemCritereEvaluation, $comparison = null)
    {
        if ($commonEnveloppeItemCritereEvaluation instanceof CommonEnveloppeItemCritereEvaluation) {
            return $this
                ->addUsingAlias(CommonEnveloppeCritereEvaluationPeer::ID, $commonEnveloppeItemCritereEvaluation->getIdenveloppecritereevaluation(), $comparison);
        } elseif ($commonEnveloppeItemCritereEvaluation instanceof PropelObjectCollection) {
            return $this
                ->useCommonEnveloppeItemCritereEvaluationQuery()
                ->filterByPrimaryKeys($commonEnveloppeItemCritereEvaluation->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEnveloppeItemCritereEvaluation() only accepts arguments of type CommonEnveloppeItemCritereEvaluation or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnveloppeItemCritereEvaluation relation
     *
     ...
     * @return CommonEnveloppeCritereEvaluationQuery The current query, for fluid interface
     */
    public function joinCommonEnveloppeItemCritereEvaluation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnveloppeItemCritereEvaluation');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnveloppeItemCritereEvaluation');
        }
    ...
    /**
     * Use the CommonEnveloppeItemCritereEvaluation relation CommonEnveloppeItemCritereEvaluation object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonEnveloppeItemCritereEvaluationQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnveloppeItemCritereEvaluationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnveloppeItemCritereEvaluation($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnveloppeItemCritereEvaluation', 'CommonEnveloppeItemCritereEvaluationQuery');
    }
