...
/**
 * Base class that represents a row from the 'exec_piece_facture' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecPieceFacture extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecPieceFacturePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecPieceFacturePeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonExecPieceFacture object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonExecPieceFacture The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::ID;
        }
    ...
    public function setIdFacture($v)
    {
        ...
        if ($this->id_facture !== $v) {
            $this->id_facture = $v;
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::ID_FACTURE;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::ID_CONTRAT;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::LIBELLE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::TAILLE;
        }
    ...
    public function setIdAgentCrea($v)
    {
        ...
        if ($this->id_agent_crea !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::ID_AGENT_CREA;
        }
    ...
    public function setDateCreat($v)
    {
        ...
        if ($this->date_creat !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecPieceFacturePeer::DATE_CREAT;
            }
    ...
    public function setIdBlob($v)
    {
        ...
        if ($this->id_blob !== $v) {
            $this->id_blob = $v;
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::ID_BLOB;
        }
    ...
    public function setDepuisParaph($v)
    {
        ...
        if ($this->depuis_paraph !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::DEPUIS_PARAPH;
        }
    ...
    public function setAccesFournisseur($v)
    {
        ...
        if ($this->acces_fournisseur !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceFacturePeer::ACCES_FOURNISSEUR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonExecPieceFacturePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecPieceFacture object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecPieceFacturePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecPieceFactureQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecPieceFacturePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_FACTURE)) {
            $modifiedColumns[':p' . $index++]  = '`id_facture`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_AGENT_CREA)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_crea`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::DATE_CREAT)) {
            $modifiedColumns[':p' . $index++]  = '`date_creat`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_BLOB)) {
            $modifiedColumns[':p' . $index++]  = '`id_blob`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::DEPUIS_PARAPH)) {
            $modifiedColumns[':p' . $index++]  = '`depuis_paraph`';
        }
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ACCES_FOURNISSEUR)) {
            $modifiedColumns[':p' . $index++]  = '`acces_fournisseur`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_piece_facture` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecPieceFacturePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecPieceFacturePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecPieceFacture'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecPieceFacture'][$this->getPrimaryKey()] = true;
        $keys = CommonExecPieceFacturePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID)) $criteria->add(CommonExecPieceFacturePeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_FACTURE)) $criteria->add(CommonExecPieceFacturePeer::ID_FACTURE, $this->id_facture);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_CONTRAT)) $criteria->add(CommonExecPieceFacturePeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::LIBELLE)) $criteria->add(CommonExecPieceFacturePeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::TAILLE)) $criteria->add(CommonExecPieceFacturePeer::TAILLE, $this->taille);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_AGENT_CREA)) $criteria->add(CommonExecPieceFacturePeer::ID_AGENT_CREA, $this->id_agent_crea);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::DATE_CREAT)) $criteria->add(CommonExecPieceFacturePeer::DATE_CREAT, $this->date_creat);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ID_BLOB)) $criteria->add(CommonExecPieceFacturePeer::ID_BLOB, $this->id_blob);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::DEPUIS_PARAPH)) $criteria->add(CommonExecPieceFacturePeer::DEPUIS_PARAPH, $this->depuis_paraph);
        if ($this->isColumnModified(CommonExecPieceFacturePeer::ACCES_FOURNISSEUR)) $criteria->add(CommonExecPieceFacturePeer::ACCES_FOURNISSEUR, $this->acces_fournisseur);
    ...
    {
        $criteria = new Criteria(CommonExecPieceFacturePeer::DATABASE_NAME);
        $criteria->add(CommonExecPieceFacturePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecPieceFacture (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecPieceFacture Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecPieceFacturePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecPieceFacturePeer();
        }
    ...
    public function setCommonAgent(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonExecPieceFacture($this);
        }
    ...
    public function getCommonAgent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgent === null && ($this->id_agent_crea !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgent->addCommonExecPieceFactures($this);
             */
        }
    ...
    public function getCommonExecContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContrat === null && ($this->id_contrat !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecContrat->addCommonExecPieceFactures($this);
             */
        }
    ...
    public function getCommonExecFacture(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecFacture === null && ($this->id_facture !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecFacture->addCommonExecPieceFactures($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonExecPieceFacturePeer::DEFAULT_STRING_FORMAT);
    }
