...
abstract class BaseCommonExecRepartitionPeer
{
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecRepartitionPeer::ID_AGENT_CREA, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecRepartitionPeer::ID_AGENT_MODIF, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonEntreprise(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecRepartitionPeer::ID_ENTREPRISE_CREA, CommonEntreprisePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecRepartition objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecRepartition) to $obj2 (CommonAgent)
                $obj2->addCommonExecRepartitionRelatedByIdAgentCrea($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecRepartition) to $obj2 (CommonAgent)
                $obj2->addCommonExecRepartitionRelatedByIdAgentModif($obj1);
    ...
    /**
     * Selects a collection of CommonExecRepartition objects pre-filled with their CommonEntreprise objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonExecRepartition objects.
    ...
    public static function doSelectJoinCommonEntreprise(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecRepartition) to $obj2 (CommonEntreprise)
                $obj2->addCommonExecRepartition($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecContractantPeer::addSelectColumns($criteria);
        $startcol5 = $startcol4 + CommonExecContractantPeer::NUM_HYDRATE_COLUMNS;

        CommonExecContratPeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CommonExecContratPeer::NUM_HYDRATE_COLUMNS;

        CommonEntreprisePeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + CommonEntreprisePeer::NUM_HYDRATE_COLUMNS;

        CommonExecFacturePeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonExecFacturePeer::NUM_HYDRATE_COLUMNS;

        CommonExecPrixPeer::addSelectColumns($criteria);
        $startcol9 = $startcol8 + CommonExecPrixPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecRepartitionRelatedByIdAgentCrea($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj3 (CommonAgent)
                $obj3->addCommonExecRepartitionRelatedByIdAgentModif($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecContractant rows

            $key4 = CommonExecContractantPeer::getPrimaryKeyHashFromRow($row, $startcol4);
            if ($key4 !== null) {
                $obj4 = CommonExecContractantPeer::getInstanceFromPool($key4);
                if (!$obj4) {
                    ...
                    CommonExecContractantPeer::addInstanceToPool($obj4, $key4);
                } // if obj4 loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj4 (CommonExecContractant)
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj5 (CommonExecContrat)
                $obj5->addCommonExecRepartition($obj1);
            } // if joined row not null

            // Add objects for joined CommonEntreprise rows

            $key6 = CommonEntreprisePeer::getPrimaryKeyHashFromRow($row, $startcol6);
            if ($key6 !== null) {
                $obj6 = CommonEntreprisePeer::getInstanceFromPool($key6);
                if (!$obj6) {
                    ...
                    CommonEntreprisePeer::addInstanceToPool($obj6, $key6);
                } // if obj6 loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj6 (CommonEntreprise)
                $obj6->addCommonExecRepartition($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecFacture rows

            $key7 = CommonExecFacturePeer::getPrimaryKeyHashFromRow($row, $startcol7);
            if ($key7 !== null) {
                $obj7 = CommonExecFacturePeer::getInstanceFromPool($key7);
                if (!$obj7) {
                    ...
                    CommonExecFacturePeer::addInstanceToPool($obj7, $key7);
                } // if obj7 loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj7 (CommonExecFacture)
                $obj7->addCommonExecRepartition($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecPrix rows

            $key8 = CommonExecPrixPeer::getPrimaryKeyHashFromRow($row, $startcol8);
            if ($key8 !== null) {
                $obj8 = CommonExecPrixPeer::getInstanceFromPool($key8);
                if (!$obj8) {
                    ...
                    CommonExecPrixPeer::addInstanceToPool($obj8, $key8);
                } // if obj8 loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj8 (CommonExecPrix)
                $obj8->addCommonExecRepartition($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonExecRepartition objects pre-filled with all related objects except CommonAgentRelatedByIdAgentCrea.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecFacturePeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CommonExecFacturePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecRepartitionPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj4 (CommonEntreprise)
                $obj4->addCommonExecRepartition($obj1);
                ...
                $key5 = CommonExecFacturePeer::getPrimaryKeyHashFromRow($row, $startcol5);
                if ($key5 !== null) {
                    $obj5 = CommonExecFacturePeer::getInstanceFromPool($key5);
                    if (!$obj5) {
                    ...
                    $obj5 = new $cls();
                    $obj5->hydrate($row, $startcol5);
                    CommonExecFacturePeer::addInstanceToPool($obj5, $key5);
                } // if $obj5 already loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj5 (CommonExecFacture)
                $obj5->addCommonExecRepartition($obj1);
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj6 (CommonExecPrix)
                $obj6->addCommonExecRepartition($obj1);
    ...
    /**
     * Selects a collection of CommonExecRepartition objects pre-filled with all related objects except CommonAgentRelatedByIdAgentModif.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonExecContractant(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecFacturePeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + CommonExecFacturePeer::NUM_HYDRATE_COLUMNS;

        CommonExecPrixPeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonExecPrixPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecRepartitionPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj4 (CommonExecContrat)
                $obj4->addCommonExecRepartition($obj1);
                ...
                // Add the $obj1 (CommonExecRepartition) to the collection in $obj5 (CommonEntreprise)
                $obj5->addCommonExecRepartition($obj1);
                ...
                $key6 = CommonExecFacturePeer::getPrimaryKeyHashFromRow($row, $startcol6);
                if ($key6 !== null) {
                    $obj6 = CommonExecFacturePeer::getInstanceFromPool($key6);
                    if (!$obj6) {
                    ...
                    $obj6 = new $cls();
                    $obj6->hydrate($row, $startcol6);
                    CommonExecFacturePeer::addInstanceToPool($obj6, $key6);
                } // if $obj6 already loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj6 (CommonExecFacture)
                $obj6->addCommonExecRepartition($obj1);
                ...
                $key7 = CommonExecPrixPeer::getPrimaryKeyHashFromRow($row, $startcol7);
                if ($key7 !== null) {
                    $obj7 = CommonExecPrixPeer::getInstanceFromPool($key7);
                    if (!$obj7) {
                    ...
                    $obj7 = new $cls();
                    $obj7->hydrate($row, $startcol7);
                    CommonExecPrixPeer::addInstanceToPool($obj7, $key7);
                } // if $obj7 already loaded

                // Add the $obj1 (CommonExecRepartition) to the collection in $obj7 (CommonExecPrix)
                $obj7->addCommonExecRepartition($obj1);
    ...
    /**
     * Selects a collection of CommonExecRepartition objects pre-filled with all related objects except CommonEntreprise.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
