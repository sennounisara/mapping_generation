...
abstract class BaseCommonEnchereTrancheBaremeReference extends BaseObject implements Persistent
{
     ...
     */
    protected $aCommonEnchereReferenceRelatedByIdreference;

    /**
     * @var        CommonEnchereReference
     */
    protected $aCommonEnchereReferenceRelatedByIdreferenceOrganisme;
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme !== null && $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->getOrganisme() !== $v) {
            $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme = null;
        }
    ...
    public function setIdreference($v)
    {
        ...
        if ($this->aCommonEnchereReferenceRelatedByIdreference !== null && $this->aCommonEnchereReferenceRelatedByIdreference->getId() !== $v) {
            $this->aCommonEnchereReferenceRelatedByIdreference = null;
        }

        if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme !== null && $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->getId() !== $v) {
            $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme !== null && $this->organisme !== $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->getOrganisme()) {
            $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme = null;
        }
        if ($this->aCommonEnchereReferenceRelatedByIdreference !== null && $this->idreference !== $this->aCommonEnchereReferenceRelatedByIdreference->getId()) {
            $this->aCommonEnchereReferenceRelatedByIdreference = null;
        }
        if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme !== null && $this->idreference !== $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->getId()) {
            $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonEnchereReferenceRelatedByIdreference !== null) {
                if ($this->aCommonEnchereReferenceRelatedByIdreference->isModified() || $this->aCommonEnchereReferenceRelatedByIdreference->isNew()) {
                    $affectedRows += $this->aCommonEnchereReferenceRelatedByIdreference->save($con);
                }
                $this->setCommonEnchereReferenceRelatedByIdreference($this->aCommonEnchereReferenceRelatedByIdreference);
            }

            if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme !== null) {
                if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->isModified() || $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->isNew()) {
                    $affectedRows += $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->save($con);
                }
                $this->setCommonEnchereReferenceRelatedByIdreferenceOrganisme($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonEnchereReferenceRelatedByIdreference !== null) {
                if (!$this->aCommonEnchereReferenceRelatedByIdreference->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonEnchereReferenceRelatedByIdreference->getValidationFailures());
                }
            }

            if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme !== null) {
                if (!$this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonEnchereReferenceRelatedByIdreference) {
                $result['CommonEnchereReferenceRelatedByIdreference'] = $this->aCommonEnchereReferenceRelatedByIdreference->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme) {
                $result['CommonEnchereReferenceRelatedByIdreferenceOrganisme'] = $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
     ...
     * @throws PropelException
     */
    public function setCommonEnchereReferenceRelatedByIdreference(CommonEnchereReference $v = null)
    {
        if ($v === null) {
        ...
        $this->aCommonEnchereReferenceRelatedByIdreference = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonEnchereReference object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonEnchereTrancheBaremeReferenceRelatedByIdreference($this);
        }
     ...
     * @throws PropelException
     */
    public function getCommonEnchereReferenceRelatedByIdreference(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEnchereReferenceRelatedByIdreference === null && ($this->idreference !== null) && $doQuery) {
            $this->aCommonEnchereReferenceRelatedByIdreference = CommonEnchereReferenceQuery::create()
                ->filterByCommonEnchereTrancheBaremeReferenceRelatedByIdreference($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonEnchereReferenceRelatedByIdreference->addCommonEnchereTrancheBaremeReferencesRelatedByIdreference($this);
             */
        }

        return $this->aCommonEnchereReferenceRelatedByIdreference;
    }
     ...
     * @throws PropelException
     */
    public function setCommonEnchereReferenceRelatedByIdreferenceOrganisme(CommonEnchereReference $v = null)
    {
        if ($v === null) {
            $this->setIdreference(0);
        } else {
        ...
        $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonEnchereReference object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($this);
        }
     ...
     * @throws PropelException
     */
    public function getCommonEnchereReferenceRelatedByIdreferenceOrganisme(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme === null && ($this->idreference !== null && ($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme = CommonEnchereReferenceQuery::create()->findPk(array($this->idreference, $this->organisme), $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->addCommonEnchereTrancheBaremeReferencesRelatedByIdreferenceOrganisme($this);
             */
        }

        return $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonEnchereReferenceRelatedByIdreference instanceof Persistent) {
              $this->aCommonEnchereReferenceRelatedByIdreference->clearAllReferences($deep);
            }
            if ($this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme instanceof Persistent) {
              $this->aCommonEnchereReferenceRelatedByIdreferenceOrganisme->clearAllReferences($deep);
            }
