...
/**
 * This class defines the structure of the 'Socle_Habilitation_Agent' table.
 *
 *
 *
 ...
 */
class CommonSocleHabilitationAgentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonSocleHabilitationAgentTableMap';
    ...
    {
        // attributes
        $this->setName('Socle_Habilitation_Agent');
        $this->setPhpName('CommonSocleHabilitationAgent');
        $this->setClassname('CommonSocleHabilitationAgent');
...
} // CommonSocleHabilitationAgentTableMap
