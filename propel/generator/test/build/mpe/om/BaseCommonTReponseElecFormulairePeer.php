...
abstract class BaseCommonTReponseElecFormulairePeer
{
    ...
    public static function doCountJoinCommonEntreprise(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonTReponseElecFormulairePeer::ID_ENTREPRISE, CommonEntreprisePeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonInscrit(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonTReponseElecFormulairePeer::ID_INSCRIT, CommonInscritPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonTReponseElecFormulaire objects pre-filled with their CommonEntreprise objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonEntreprise(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to $obj2 (CommonEntreprise)
    ...
    /**
     * Selects a collection of CommonTReponseElecFormulaire objects pre-filled with their CommonInscrit objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonTReponseElecFormulaire objects.
    ...
    public static function doSelectJoinCommonInscrit(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to $obj2 (CommonInscrit)
                $obj2->addCommonTReponseElecFormulaire($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to the collection in $obj2 (CommonEntreprise)
                $obj2->addCommonTReponseElecFormulaire($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to the collection in $obj3 (CommonInscrit)
                $obj3->addCommonTReponseElecFormulaire($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to the collection in $obj4 (CommonConsultation)
                $obj4->addCommonTReponseElecFormulaire($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonTReponseElecFormulaire objects pre-filled with all related objects except CommonEntreprise.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonEntreprise(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonTReponseElecFormulairePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to the collection in $obj2 (CommonInscrit)
                $obj2->addCommonTReponseElecFormulaire($obj1);
                ...
                // Add the $obj1 (CommonTReponseElecFormulaire) to the collection in $obj3 (CommonConsultation)
                $obj3->addCommonTReponseElecFormulaire($obj1);
    ...
    /**
     * Selects a collection of CommonTReponseElecFormulaire objects pre-filled with all related objects except CommonInscrit.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonTReponseElecFormulaire objects pre-filled with all related objects except CommonConsultation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
