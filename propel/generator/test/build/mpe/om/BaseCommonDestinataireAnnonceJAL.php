...
abstract class BaseCommonDestinataireAnnonceJAL extends BaseObject implements Persistent
{
    ...
    public function setIdjal($v)
    {
        ...
        if ($this->aCommonJAL !== null && $this->aCommonJAL->getId() !== $v) {
            $this->aCommonJAL = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonJAL !== null && $this->idjal !== $this->aCommonJAL->getId()) {
            $this->aCommonJAL = null;
        }
        if ($this->aCommonAnnonceJAL !== null && $this->idannoncejal !== $this->aCommonAnnonceJAL->getId()) {
            $this->aCommonAnnonceJAL = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonJAL !== null) {
                if ($this->aCommonJAL->isModified() || $this->aCommonJAL->isNew()) {
                    $affectedRows += $this->aCommonJAL->save($con);
                }
                $this->setCommonJAL($this->aCommonJAL);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonJAL !== null) {
                if (!$this->aCommonJAL->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonJAL->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonJAL) {
                $result['CommonJAL'] = $this->aCommonJAL->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    /**
     * Declares an association between this object and a CommonJAL object.
     *
     * @param   CommonJAL $v
     * @return CommonDestinataireAnnonceJAL The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonJAL(CommonJAL $v = null)
    {
        if ($v === null) {
            $this->setIdjal(0);
        } else {
            $this->setIdjal($v->getId());
        }

        $this->aCommonJAL = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonJAL object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonDestinataireAnnonceJAL($this);
        }
    ...
    /**
     * Get the associated CommonJAL object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonJAL The associated CommonJAL object.
     * @throws PropelException
     */
    public function getCommonJAL(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonJAL === null && ($this->idjal !== null) && $doQuery) {
            $this->aCommonJAL = CommonJALQuery::create()
                ->filterByCommonDestinataireAnnonceJAL($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonJAL->addCommonDestinataireAnnonceJALs($this);
             */
        }

        return $this->aCommonJAL;
    }
    ...
    {
        if ($this->aCommonAnnonceJAL === null && ($this->idannoncejal !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonAnnonceJAL->addCommonDestinataireAnnonceJALs($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonJAL instanceof Persistent) {
              $this->aCommonJAL->clearAllReferences($deep);
            }
