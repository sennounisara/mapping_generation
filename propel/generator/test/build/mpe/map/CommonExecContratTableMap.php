...
class CommonExecContratTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonExecContratTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_nature_prestation', 'IdNaturePrestation', 'VARCHAR', 'CategorieConsultation', 'id', true, 30, null);
        ...
        $this->addForeignKey('id_agent_gestion', 'IdAgentGestion', 'INTEGER', 'Agent', 'id', false, null, null);
  ...
  1 => '1',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CommonAgentRelatedByIdAgentGestion', 'CommonAgent', RelationMap::MANY_TO_ONE, array('id_agent_gestion' => 'id', ), null, null);
        $this->addRelation('CommonAgentRelatedByIdAgentModif', 'CommonAgent', RelationMap::MANY_TO_ONE, array('id_agent_modif' => 'id', ), null, null);
        $this->addRelation('CommonCategorieConsultation', 'CommonCategorieConsultation', RelationMap::MANY_TO_ONE, array('id_nature_prestation' => 'id', ), null, null);
