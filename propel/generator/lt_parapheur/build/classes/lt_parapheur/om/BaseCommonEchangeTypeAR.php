...
/**
 * Base class that represents a row from the 'EchangeTypeAR' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonEchangeTypeAR extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonEchangeTypeARPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonEchangeTypeARPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonEchangeTypeAR object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonEchangeTypeAR The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonEchangeTypeARPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonEchangeTypeARPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonEchangeTypeAR object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonEchangeTypeARPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonEchangeTypeARQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonEchangeTypeARPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonEchangeTypeARPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `EchangeTypeAR` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonEchangeTypeARPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonEchangeTypeARPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonEchangeTypeAR'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonEchangeTypeAR'][$this->getPrimaryKey()] = true;
        $keys = CommonEchangeTypeARPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonEchangeTypeARPeer::ID)) $criteria->add(CommonEchangeTypeARPeer::ID, $this->id);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_FR)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_EN)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_ES)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_SU)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_DU)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_CZ)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_AR)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonEchangeTypeARPeer::LIBELLE_IT)) $criteria->add(CommonEchangeTypeARPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonEchangeTypeARPeer::DATABASE_NAME);
        $criteria->add(CommonEchangeTypeARPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonEchangeTypeAR (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonEchangeTypeAR Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonEchangeTypeARPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonEchangeTypeARPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonEchangeTypeARPeer::DEFAULT_STRING_FORMAT);
    }
