 ...
 *
 * @method CommonTCAOSeanceAgentQuery leftJoinCommonAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgent relation
 * @method CommonTCAOSeanceAgentQuery rightJoinCommonAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgent relation
 * @method CommonTCAOSeanceAgentQuery innerJoinCommonAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgent relation
 *
 * @method CommonTCAOSeanceAgentQuery leftJoinCommonTCAOSeance($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOSeance relation
 * @method CommonTCAOSeanceAgentQuery rightJoinCommonTCAOSeance($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOSeance relation
 * @method CommonTCAOSeanceAgentQuery innerJoinCommonTCAOSeance($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOSeance relation
 *
...
abstract class BaseCommonTCAOSeanceAgentQuery extends ModelCriteria
{
    ...
    public function filterByCommonAgent($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonTCAOSeanceAgentPeer::ID_AGENT, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeanceAgentPeer::ID_AGENT, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonTCAOSeance($commonTCAOSeance, $comparison = null)
    {
        if ($commonTCAOSeance instanceof CommonTCAOSeance) {
            return $this
                ->addUsingAlias(CommonTCAOSeanceAgentPeer::ID_SEANCE, $commonTCAOSeance->getIdSeance(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOSeanceAgentPeer::ID_SEANCE, $commonTCAOSeance->toKeyValue('IdSeance', 'IdSeance'), $comparison);
        } else {
