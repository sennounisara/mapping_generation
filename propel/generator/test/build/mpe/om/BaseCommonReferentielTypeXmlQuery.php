 ...
 *
 * @method CommonReferentielTypeXmlQuery leftJoinCommonReferentielFormXml($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonReferentielFormXml relation
 * @method CommonReferentielTypeXmlQuery rightJoinCommonReferentielFormXml($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonReferentielFormXml relation
 * @method CommonReferentielTypeXmlQuery innerJoinCommonReferentielFormXml($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonReferentielFormXml relation
 *
...
abstract class BaseCommonReferentielTypeXmlQuery extends ModelCriteria
{
     ...
     *
     * @param   CommonReferentielFormXml|PropelObjectCollection $commonReferentielFormXml  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonReferentielTypeXmlQuery The current query, for fluid interface
    ...
    public function filterByCommonReferentielFormXml($commonReferentielFormXml, $comparison = null)
    {
        if ($commonReferentielFormXml instanceof CommonReferentielFormXml) {
            return $this
                ->addUsingAlias(CommonReferentielTypeXmlPeer::ID, $commonReferentielFormXml->getIdTypeXml(), $comparison);
        } elseif ($commonReferentielFormXml instanceof PropelObjectCollection) {
            return $this
                ->useCommonReferentielFormXmlQuery()
                ->filterByPrimaryKeys($commonReferentielFormXml->getPrimaryKeys())
                ->endUse();
        } else {
