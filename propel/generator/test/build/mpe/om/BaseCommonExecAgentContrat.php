...
/**
 * Base class that represents a row from the 'exec_agent_contrat' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecAgentContrat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecAgentContratPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecAgentContratPeer
     */
     ...
     * @return CommonExecAgentContrat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecAgentContratPeer::ID;
        }
    ...
    public function setIdAgent($v)
    {
        ...
        if ($this->id_agent !== $v) {
            $this->id_agent = $v;
            $this->modifiedColumns[] = CommonExecAgentContratPeer::ID_AGENT;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecAgentContratPeer::ID_CONTRAT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CommonExecAgentContratPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecAgentContrat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecAgentContratPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecAgentContratQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecAgentContratPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecAgentContratPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecAgentContratPeer::ID_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent`';
        }
        if ($this->isColumnModified(CommonExecAgentContratPeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_agent_contrat` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecAgentContratPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecAgentContratPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecAgentContrat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecAgentContrat'][$this->getPrimaryKey()] = true;
        $keys = CommonExecAgentContratPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecAgentContratPeer::ID)) $criteria->add(CommonExecAgentContratPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecAgentContratPeer::ID_AGENT)) $criteria->add(CommonExecAgentContratPeer::ID_AGENT, $this->id_agent);
        if ($this->isColumnModified(CommonExecAgentContratPeer::ID_CONTRAT)) $criteria->add(CommonExecAgentContratPeer::ID_CONTRAT, $this->id_contrat);
    ...
    {
        $criteria = new Criteria(CommonExecAgentContratPeer::DATABASE_NAME);
        $criteria->add(CommonExecAgentContratPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecAgentContrat (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecAgentContrat Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecAgentContratPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecAgentContratPeer();
        }
    ...
    public function setCommonAgent(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonExecAgentContrat($this);
        }
    ...
    public function getCommonAgent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgent === null && ($this->id_agent !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgent->addCommonExecAgentContrats($this);
             */
        }
    ...
    public function getCommonExecContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContrat === null && ($this->id_contrat !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecContrat->addCommonExecAgentContrats($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonExecAgentContratPeer::DEFAULT_STRING_FORMAT);
    }
