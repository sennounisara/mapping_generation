 ...
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereEntreprisePmi($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereEntreprisePmi relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereEntreprisePmi($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereEntreprisePmi relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereEntreprisePmi($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereEntreprisePmi relation
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereOffreRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchereOrganisme relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereOffreRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchereOrganisme relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereOffreRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchereOrganisme relation
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereOffreRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchere relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereOffreRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchere relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereOffreRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchere relation
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereReferenceRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchere relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereReferenceRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchere relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereReferenceRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchere relation
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereReferenceRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchereOrganisme relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereReferenceRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchereOrganisme relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereReferenceRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchereOrganisme relation
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme relation
 *
 * @method CommonEncherePmiQuery leftJoinCommonEnchereTranchesBaremeNETCRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchere relation
 * @method CommonEncherePmiQuery rightJoinCommonEnchereTranchesBaremeNETCRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchere relation
 * @method CommonEncherePmiQuery innerJoinCommonEnchereTranchesBaremeNETCRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchere relation
 *
...
abstract class BaseCommonEncherePmiQuery extends ModelCriteria
{
     ...
     *
     * @param   CommonEnchereEntreprisePmi|PropelObjectCollection $commonEnchereEntreprisePmi  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEncherePmiQuery The current query, for fluid interface
    ...
    public function filterByCommonEnchereEntreprisePmi($commonEnchereEntreprisePmi, $comparison = null)
    {
        if ($commonEnchereEntreprisePmi instanceof CommonEnchereEntreprisePmi) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereEntreprisePmi->getIdenchere(), $comparison)
                ->addUsingAlias(CommonEncherePmiPeer::ORGANISME, $commonEnchereEntreprisePmi->getOrganisme(), $comparison);
        } else {
     ...
     *
     * @param   CommonEnchereOffre|PropelObjectCollection $commonEnchereOffre  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEncherePmiQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereOffreRelatedByIdenchereOrganisme($commonEnchereOffre, $comparison = null)
    {
        if ($commonEnchereOffre instanceof CommonEnchereOffre) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereOffre->getIdenchere(), $comparison)
                ->addUsingAlias(CommonEncherePmiPeer::ORGANISME, $commonEnchereOffre->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereOffreRelatedByIdenchereOrganisme() only accepts arguments of type CommonEnchereOffre');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchereOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEncherePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereOffreRelatedByIdenchereOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereOffreRelatedByIdenchereOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereOffreRelatedByIdenchereOrganisme');
        }
    ...
    /**
     * Use the CommonEnchereOffreRelatedByIdenchereOrganisme relation CommonEnchereOffre object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonEnchereOffreRelatedByIdenchereOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereOffreRelatedByIdenchereOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereOffreRelatedByIdenchereOrganisme', 'CommonEnchereOffreQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereOffreRelatedByIdenchere($commonEnchereOffre, $comparison = null)
    {
        if ($commonEnchereOffre instanceof CommonEnchereOffre) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereOffre->getIdenchere(), $comparison);
            ...
            return $this
                ->useCommonEnchereOffreRelatedByIdenchereQuery()
                ->filterByPrimaryKeys($commonEnchereOffre->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEnchereOffreRelatedByIdenchere() only accepts arguments of type CommonEnchereOffre or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereOffreRelatedByIdenchere relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEncherePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereOffreRelatedByIdenchere($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereOffreRelatedByIdenchere');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereOffreRelatedByIdenchere');
        }
    ...
    /**
     * Use the CommonEnchereOffreRelatedByIdenchere relation CommonEnchereOffre object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonEnchereOffreQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereOffreRelatedByIdenchereQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereOffreRelatedByIdenchere($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereOffreRelatedByIdenchere', 'CommonEnchereOffreQuery');
    }

    /**
     * Filter the query by a related CommonEnchereReference object
     *
     * @param   CommonEnchereReference|PropelObjectCollection $commonEnchereReference  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEncherePmiQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereReferenceRelatedByIdenchere($commonEnchereReference, $comparison = null)
    {
        if ($commonEnchereReference instanceof CommonEnchereReference) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereReference->getIdenchere(), $comparison);
        } elseif ($commonEnchereReference instanceof PropelObjectCollection) {
            return $this
                ->useCommonEnchereReferenceRelatedByIdenchereQuery()
                ->filterByPrimaryKeys($commonEnchereReference->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEnchereReferenceRelatedByIdenchere() only accepts arguments of type CommonEnchereReference or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchere relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEncherePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereReferenceRelatedByIdenchere($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereReferenceRelatedByIdenchere');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereReferenceRelatedByIdenchere');
        }
    ...
    /**
     * Use the CommonEnchereReferenceRelatedByIdenchere relation CommonEnchereReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonEnchereReferenceRelatedByIdenchereQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereReferenceRelatedByIdenchere($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereReferenceRelatedByIdenchere', 'CommonEnchereReferenceQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereReferenceRelatedByIdenchereOrganisme($commonEnchereReference, $comparison = null)
    {
        if ($commonEnchereReference instanceof CommonEnchereReference) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereReference->getIdenchere(), $comparison)
                ->addUsingAlias(CommonEncherePmiPeer::ORGANISME, $commonEnchereReference->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereReferenceRelatedByIdenchereOrganisme() only accepts arguments of type CommonEnchereReference');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereReferenceRelatedByIdenchereOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEncherePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereReferenceRelatedByIdenchereOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereReferenceRelatedByIdenchereOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereReferenceRelatedByIdenchereOrganisme');
        }
    ...
    /**
     * Use the CommonEnchereReferenceRelatedByIdenchereOrganisme relation CommonEnchereReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonEnchereReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereReferenceRelatedByIdenchereOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereReferenceRelatedByIdenchereOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereReferenceRelatedByIdenchereOrganisme', 'CommonEnchereReferenceQuery');
    }

    /**
     * Filter the query by a related CommonEnchereTranchesBaremeNETC object
     *
     * @param   CommonEnchereTranchesBaremeNETC|PropelObjectCollection $commonEnchereTranchesBaremeNETC  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEncherePmiQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($commonEnchereTranchesBaremeNETC, $comparison = null)
    {
        if ($commonEnchereTranchesBaremeNETC instanceof CommonEnchereTranchesBaremeNETC) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereTranchesBaremeNETC->getIdenchere(), $comparison)
                ->addUsingAlias(CommonEncherePmiPeer::ORGANISME, $commonEnchereTranchesBaremeNETC->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme() only accepts arguments of type CommonEnchereTranchesBaremeNETC');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEncherePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme');
        }
    ...
    /**
     * Use the CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme relation CommonEnchereTranchesBaremeNETC object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonEnchereTranchesBaremeNETCQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme', 'CommonEnchereTranchesBaremeNETCQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereTranchesBaremeNETCRelatedByIdenchere($commonEnchereTranchesBaremeNETC, $comparison = null)
    {
        if ($commonEnchereTranchesBaremeNETC instanceof CommonEnchereTranchesBaremeNETC) {
            return $this
                ->addUsingAlias(CommonEncherePmiPeer::ID, $commonEnchereTranchesBaremeNETC->getIdenchere(), $comparison);
        } elseif ($commonEnchereTranchesBaremeNETC instanceof PropelObjectCollection) {
            return $this
                ->useCommonEnchereTranchesBaremeNETCRelatedByIdenchereQuery()
                ->filterByPrimaryKeys($commonEnchereTranchesBaremeNETC->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEnchereTranchesBaremeNETCRelatedByIdenchere() only accepts arguments of type CommonEnchereTranchesBaremeNETC or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereTranchesBaremeNETCRelatedByIdenchere relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEncherePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereTranchesBaremeNETCRelatedByIdenchere($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereTranchesBaremeNETCRelatedByIdenchere');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereTranchesBaremeNETCRelatedByIdenchere');
        }
    ...
    /**
     * Use the CommonEnchereTranchesBaremeNETCRelatedByIdenchere relation CommonEnchereTranchesBaremeNETC object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonEnchereTranchesBaremeNETCQuery A secondary query class using the current class as primary query
     */
    public function useCommonEnchereTranchesBaremeNETCRelatedByIdenchereQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereTranchesBaremeNETCRelatedByIdenchere($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereTranchesBaremeNETCRelatedByIdenchere', 'CommonEnchereTranchesBaremeNETCQuery');
    }
