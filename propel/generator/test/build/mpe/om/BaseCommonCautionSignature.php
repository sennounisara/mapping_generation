...
/**
 * Base class that represents a row from the 'caution_signature' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonCautionSignature extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonCautionSignaturePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonCautionSignaturePeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonCautionSignature object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonCautionSignature The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::ID;
        }
    ...
    public function setIdBlob($v)
    {
        ...
        if ($this->id_blob !== $v) {
            $this->id_blob = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::ID_BLOB;
        }
    ...
    public function setIdDemande($v)
    {
        ...
        if ($this->id_demande !== $v) {
            $this->id_demande = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::ID_DEMANDE;
        }
    ...
    public function setIdAgentSignataire($v)
    {
        ...
        if ($this->id_agent_signataire !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::ID_AGENT_SIGNATAIRE;
        }
    ...
    public function setRevision($v)
    {
        ...
        if ($this->revision !== $v) {
            $this->revision = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::REVISION;
        }
    ...
    public function setTypeDocument($v)
    {
        ...
        if ($this->type_document !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::TYPE_DOCUMENT;
        }
    ...
    public function setDateSignature($v)
    {
        ...
        if ($this->date_signature !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonCautionSignaturePeer::DATE_SIGNATURE;
            }
    ...
    public function setEmetteur($v)
    {
        ...
        if ($this->emetteur !== $v) {
            $this->emetteur = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::EMETTEUR;
        }
    ...
    public function setDetailEmetteur($v)
    {
        ...
        if ($this->detail_emetteur !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::DETAIL_EMETTEUR;
        }
    ...
    public function setSignataire($v)
    {
        ...
        if ($this->signataire !== $v) {
            $this->signataire = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::SIGNATAIRE;
        }
    ...
    public function setDetailSignataire($v)
    {
        ...
        if ($this->detail_signataire !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::DETAIL_SIGNATAIRE;
        }
    ...
    public function setRevoque($v)
    {
        ...
        if ($this->revoque !== $v) {
            $this->revoque = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::REVOQUE;
        }
    ...
    public function setNonRepudiation($v)
    {
        ...
        if ($this->non_repudiation !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::NON_REPUDIATION;
        }
    ...
    public function setChaineValide($v)
    {
        ...
        if ($this->chaine_valide !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::CHAINE_VALIDE;
        }
    ...
    public function setDateDebPeriodeValidite($v)
    {
        ...
        if ($this->date_deb_periode_validite !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonCautionSignaturePeer::DATE_DEB_PERIODE_VALIDITE;
            }
        } // if either are not null
    ...
    public function setDateFinPeriodeValidite($v)
    {
        ...
        if ($this->date_fin_periode_validite !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonCautionSignaturePeer::DATE_FIN_PERIODE_VALIDITE;
            }
        } // if either are not null
    ...
    public function setPeriodeValidite($v)
    {
        ...
        if ($this->periode_validite !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::PERIODE_VALIDITE;
        }
    ...
    public function setSignatureValide($v)
    {
        ...
        if ($this->signature_valide !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::SIGNATURE_VALIDE;
        }
    ...
    public function setTypeSignature($v)
    {
        ...
        if ($this->type_signature !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::TYPE_SIGNATURE;
        }
    ...
    public function setXmlSignature($v)
    {
        ...
        if ($this->xml_signature !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::XML_SIGNATURE;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::NOM_FICHIER;
        }
    ...
    public function setHash($v)
    {
        ...
        if ($this->hash !== $v) {
            $this->hash = $v;
            $this->modifiedColumns[] = CommonCautionSignaturePeer::HASH;
        }
    ...
    public function setAlgorithmeHash($v)
    {
        ...
        if ($this->algorithme_hash !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::ALGORITHME_HASH;
        }
    ...
    public function setDateDerniereVerification($v)
    {
        ...
        if ($this->date_derniere_verification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonCautionSignaturePeer::DATE_DERNIERE_VERIFICATION;
            }
        } // if either are not null
    ...
    public function setSignatureArchivee($v)
    {
        ...
        if ($this->signature_archivee !== $v) {
            ...
            $this->modifiedColumns[] = CommonCautionSignaturePeer::SIGNATURE_ARCHIVEE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 25; // 25 = CommonCautionSignaturePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonCautionSignature object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonCautionSignaturePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonCautionSignatureQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonCautionSignaturePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID_BLOB)) {
            $modifiedColumns[':p' . $index++]  = '`ID_BLOB`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID_DEMANDE)) {
            $modifiedColumns[':p' . $index++]  = '`ID_DEMANDE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID_AGENT_SIGNATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`ID_AGENT_SIGNATAIRE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::REVISION)) {
            $modifiedColumns[':p' . $index++]  = '`REVISION`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::TYPE_DOCUMENT)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE_DOCUMENT`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_SIGNATURE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::EMETTEUR)) {
            $modifiedColumns[':p' . $index++]  = '`EMETTEUR`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::DETAIL_EMETTEUR)) {
            $modifiedColumns[':p' . $index++]  = '`DETAIL_EMETTEUR`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::SIGNATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`SIGNATAIRE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::DETAIL_SIGNATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`DETAIL_SIGNATAIRE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::REVOQUE)) {
            $modifiedColumns[':p' . $index++]  = '`REVOQUE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::NON_REPUDIATION)) {
            $modifiedColumns[':p' . $index++]  = '`NON_REPUDIATION`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::CHAINE_VALIDE)) {
            $modifiedColumns[':p' . $index++]  = '`CHAINE_VALIDE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_DEB_PERIODE_VALIDITE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_DEB_PERIODE_VALIDITE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_FIN_PERIODE_VALIDITE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_FIN_PERIODE_VALIDITE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::PERIODE_VALIDITE)) {
            $modifiedColumns[':p' . $index++]  = '`PERIODE_VALIDITE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::SIGNATURE_VALIDE)) {
            $modifiedColumns[':p' . $index++]  = '`SIGNATURE_VALIDE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::TYPE_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE_SIGNATURE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::XML_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '`XML_SIGNATURE`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`NOM_FICHIER`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::HASH)) {
            $modifiedColumns[':p' . $index++]  = '`HASH`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::ALGORITHME_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`ALGORITHME_HASH`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_DERNIERE_VERIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_DERNIERE_VERIFICATION`';
        }
        if ($this->isColumnModified(CommonCautionSignaturePeer::SIGNATURE_ARCHIVEE)) {
            $modifiedColumns[':p' . $index++]  = '`SIGNATURE_ARCHIVEE`';
        }

        $sql = sprintf(
            'INSERT INTO `caution_signature` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonCautionSignaturePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonCautionSignaturePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonCautionSignature'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonCautionSignature'][$this->getPrimaryKey()] = true;
        $keys = CommonCautionSignaturePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID)) $criteria->add(CommonCautionSignaturePeer::ID, $this->id);
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID_BLOB)) $criteria->add(CommonCautionSignaturePeer::ID_BLOB, $this->id_blob);
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID_DEMANDE)) $criteria->add(CommonCautionSignaturePeer::ID_DEMANDE, $this->id_demande);
        if ($this->isColumnModified(CommonCautionSignaturePeer::ID_AGENT_SIGNATAIRE)) $criteria->add(CommonCautionSignaturePeer::ID_AGENT_SIGNATAIRE, $this->id_agent_signataire);
        if ($this->isColumnModified(CommonCautionSignaturePeer::REVISION)) $criteria->add(CommonCautionSignaturePeer::REVISION, $this->revision);
        if ($this->isColumnModified(CommonCautionSignaturePeer::TYPE_DOCUMENT)) $criteria->add(CommonCautionSignaturePeer::TYPE_DOCUMENT, $this->type_document);
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_SIGNATURE)) $criteria->add(CommonCautionSignaturePeer::DATE_SIGNATURE, $this->date_signature);
        if ($this->isColumnModified(CommonCautionSignaturePeer::EMETTEUR)) $criteria->add(CommonCautionSignaturePeer::EMETTEUR, $this->emetteur);
        if ($this->isColumnModified(CommonCautionSignaturePeer::DETAIL_EMETTEUR)) $criteria->add(CommonCautionSignaturePeer::DETAIL_EMETTEUR, $this->detail_emetteur);
        if ($this->isColumnModified(CommonCautionSignaturePeer::SIGNATAIRE)) $criteria->add(CommonCautionSignaturePeer::SIGNATAIRE, $this->signataire);
        if ($this->isColumnModified(CommonCautionSignaturePeer::DETAIL_SIGNATAIRE)) $criteria->add(CommonCautionSignaturePeer::DETAIL_SIGNATAIRE, $this->detail_signataire);
        if ($this->isColumnModified(CommonCautionSignaturePeer::REVOQUE)) $criteria->add(CommonCautionSignaturePeer::REVOQUE, $this->revoque);
        if ($this->isColumnModified(CommonCautionSignaturePeer::NON_REPUDIATION)) $criteria->add(CommonCautionSignaturePeer::NON_REPUDIATION, $this->non_repudiation);
        if ($this->isColumnModified(CommonCautionSignaturePeer::CHAINE_VALIDE)) $criteria->add(CommonCautionSignaturePeer::CHAINE_VALIDE, $this->chaine_valide);
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_DEB_PERIODE_VALIDITE)) $criteria->add(CommonCautionSignaturePeer::DATE_DEB_PERIODE_VALIDITE, $this->date_deb_periode_validite);
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_FIN_PERIODE_VALIDITE)) $criteria->add(CommonCautionSignaturePeer::DATE_FIN_PERIODE_VALIDITE, $this->date_fin_periode_validite);
        if ($this->isColumnModified(CommonCautionSignaturePeer::PERIODE_VALIDITE)) $criteria->add(CommonCautionSignaturePeer::PERIODE_VALIDITE, $this->periode_validite);
        if ($this->isColumnModified(CommonCautionSignaturePeer::SIGNATURE_VALIDE)) $criteria->add(CommonCautionSignaturePeer::SIGNATURE_VALIDE, $this->signature_valide);
        if ($this->isColumnModified(CommonCautionSignaturePeer::TYPE_SIGNATURE)) $criteria->add(CommonCautionSignaturePeer::TYPE_SIGNATURE, $this->type_signature);
        if ($this->isColumnModified(CommonCautionSignaturePeer::XML_SIGNATURE)) $criteria->add(CommonCautionSignaturePeer::XML_SIGNATURE, $this->xml_signature);
        if ($this->isColumnModified(CommonCautionSignaturePeer::NOM_FICHIER)) $criteria->add(CommonCautionSignaturePeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonCautionSignaturePeer::HASH)) $criteria->add(CommonCautionSignaturePeer::HASH, $this->hash);
        if ($this->isColumnModified(CommonCautionSignaturePeer::ALGORITHME_HASH)) $criteria->add(CommonCautionSignaturePeer::ALGORITHME_HASH, $this->algorithme_hash);
        if ($this->isColumnModified(CommonCautionSignaturePeer::DATE_DERNIERE_VERIFICATION)) $criteria->add(CommonCautionSignaturePeer::DATE_DERNIERE_VERIFICATION, $this->date_derniere_verification);
        if ($this->isColumnModified(CommonCautionSignaturePeer::SIGNATURE_ARCHIVEE)) $criteria->add(CommonCautionSignaturePeer::SIGNATURE_ARCHIVEE, $this->signature_archivee);
    ...
    {
        $criteria = new Criteria(CommonCautionSignaturePeer::DATABASE_NAME);
        $criteria->add(CommonCautionSignaturePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonCautionSignature (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonCautionSignature Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonCautionSignaturePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonCautionSignaturePeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonCautionSignaturePeer::DEFAULT_STRING_FORMAT);
    }
