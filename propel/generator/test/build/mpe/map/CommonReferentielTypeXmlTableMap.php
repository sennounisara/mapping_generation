...
class CommonReferentielTypeXmlTableMap extends TableMap
{
    ...
    {
        $this->addRelation('CommonReferentielFormXml', 'CommonReferentielFormXml', RelationMap::ONE_TO_MANY, array('id' => 'id_type_xml', ), 'CASCADE', 'CASCADE', 'CommonReferentielFormXmls');
    } // buildRelations()
