 ...
 */
class ReferentielTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.ReferentielTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('Referentiel');
        $this->setClassname('Referentiel');
