 ...
 *
 * @method CommonEnchereEntreprisePmiQuery leftJoinCommonEncherePmi($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEncherePmi relation
 * @method CommonEnchereEntreprisePmiQuery rightJoinCommonEncherePmi($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEncherePmi relation
 * @method CommonEnchereEntreprisePmiQuery innerJoinCommonEncherePmi($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEncherePmi relation
 *
 * @method CommonEnchereEntreprisePmiQuery leftJoinCommonEnchereOffre($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereOffre relation
 * @method CommonEnchereEntreprisePmiQuery rightJoinCommonEnchereOffre($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereOffre relation
 * @method CommonEnchereEntreprisePmiQuery innerJoinCommonEnchereOffre($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereOffre relation
 *
 * @method CommonEnchereEntreprisePmiQuery leftJoinCommonEnchereValeursInitiales($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereValeursInitiales relation
 * @method CommonEnchereEntreprisePmiQuery rightJoinCommonEnchereValeursInitiales($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereValeursInitiales relation
 * @method CommonEnchereEntreprisePmiQuery innerJoinCommonEnchereValeursInitiales($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereValeursInitiales relation
 *
...
abstract class BaseCommonEnchereEntreprisePmiQuery extends ModelCriteria
{
    ...
    public function filterByCommonEncherePmi($commonEncherePmi, $comparison = null)
    {
        if ($commonEncherePmi instanceof CommonEncherePmi) {
            return $this
                ->addUsingAlias(CommonEnchereEntreprisePmiPeer::IDENCHERE, $commonEncherePmi->getId(), $comparison)
                ->addUsingAlias(CommonEnchereEntreprisePmiPeer::ORGANISME, $commonEncherePmi->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEncherePmi() only accepts arguments of type CommonEncherePmi');
        }
    }
     ...
     * @return CommonEnchereEntreprisePmiQuery The current query, for fluid interface
     */
    public function joinCommonEncherePmi($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useCommonEncherePmiQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEncherePmi($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEncherePmi', 'CommonEncherePmiQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereOffre($commonEnchereOffre, $comparison = null)
    {
        if ($commonEnchereOffre instanceof CommonEnchereOffre) {
            return $this
                ->addUsingAlias(CommonEnchereEntreprisePmiPeer::ID, $commonEnchereOffre->getIdenchereentreprise(), $comparison)
                ->addUsingAlias(CommonEnchereEntreprisePmiPeer::ORGANISME, $commonEnchereOffre->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereOffre() only accepts arguments of type CommonEnchereOffre');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereOffre relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereEntreprisePmiQuery The current query, for fluid interface
     */
    public function joinCommonEnchereOffre($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereOffre');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereOffre');
        }
    ...
    /**
     * Use the CommonEnchereOffre relation CommonEnchereOffre object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonEnchereOffreQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereOffre($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereOffre', 'CommonEnchereOffreQuery');
    }
    ...
    public function filterByCommonEnchereValeursInitiales($commonEnchereValeursInitiales, $comparison = null)
    {
        if ($commonEnchereValeursInitiales instanceof CommonEnchereValeursInitiales) {
            return $this
                ->addUsingAlias(CommonEnchereEntreprisePmiPeer::ID, $commonEnchereValeursInitiales->getIdenchereentreprise(), $comparison)
                ->addUsingAlias(CommonEnchereEntreprisePmiPeer::ORGANISME, $commonEnchereValeursInitiales->getOrganisme(), $comparison);
        } else {
