 ...
 *
 * @method CommonExecPieceEvenementQuery leftJoinCommonAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgent relation
 * @method CommonExecPieceEvenementQuery rightJoinCommonAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgent relation
 * @method CommonExecPieceEvenementQuery innerJoinCommonAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgent relation
 *
...
abstract class BaseCommonExecPieceEvenementQuery extends ModelCriteria
{
    ...
    public function filterByCommonAgent($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecPieceEvenementPeer::ID_AGENT_CREA, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonExecPieceEvenementPeer::ID_AGENT_CREA, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
