...
abstract class BaseCommonParametrageEncherePeer
{
    ...
    {
        // Invalidate objects in CommonParametrageEnchereReferencePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonParametrageEnchereReferencePeer::clearInstancePool();
        // Invalidate objects in CommonParametrageEnchereReferencePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonParametrageEnchereReferencePeer::clearInstancePool();
        // Invalidate objects in CommonParametrageEnchereTranchesBaremeNETCPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function doCountJoinCommonOrganisme(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonParametrageEncherePeer::ORGANISME, CommonOrganismePeer::ACRONYME, $join_behavior);
    ...
    /**
     * Selects a collection of CommonParametrageEnchere objects pre-filled with their CommonOrganisme objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonParametrageEnchere objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonOrganisme(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonParametrageEncherePeer::addSelectColumns($criteria);
        $startcol = CommonParametrageEncherePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonParametrageEncherePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonParametrageEncherePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonParametrageEncherePeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonParametrageEnchere) to $obj2 (CommonOrganisme)
                $obj2->addCommonParametrageEnchere($obj1);
    ...
    /**
     * Selects a collection of CommonParametrageEnchere objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonParametrageEncherePeer::addSelectColumns($criteria);
        $startcol2 = CommonParametrageEncherePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonParametrageEnchere) to the collection in $obj2 (CommonOrganisme)
                $obj2->addCommonParametrageEnchere($obj1);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonParametrageEncherePeer::doOnDeleteCascade(new Criteria(CommonParametrageEncherePeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonParametrageEncherePeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonParametrageEncherePeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonParametrageEncherePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CommonParametrageEnchereReference objects
            $criteria = new Criteria(CommonParametrageEnchereReferencePeer::DATABASE_NAME);
            
            $criteria->add(CommonParametrageEnchereReferencePeer::IDENCHERE, $obj->getId());
            $affectedRows += CommonParametrageEnchereReferencePeer::doDelete($criteria, $con);

            // delete related CommonParametrageEnchereReference objects
            $criteria = new Criteria(CommonParametrageEnchereReferencePeer::DATABASE_NAME);
            
            $criteria->add(CommonParametrageEnchereReferencePeer::IDENCHERE, $obj->getId());
            $criteria->add(CommonParametrageEnchereReferencePeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonParametrageEnchereReferencePeer::doDelete($criteria, $con);

            // delete related CommonParametrageEnchereTranchesBaremeNETC objects
            $criteria = new Criteria(CommonParametrageEnchereTranchesBaremeNETCPeer::DATABASE_NAME);
            
            $criteria->add(CommonParametrageEnchereTranchesBaremeNETCPeer::IDENCHERE, $obj->getId());
            $affectedRows += CommonParametrageEnchereTranchesBaremeNETCPeer::doDelete($criteria, $con);

            // delete related CommonParametrageEnchereTranchesBaremeNETC objects
            $criteria = new Criteria(CommonParametrageEnchereTranchesBaremeNETCPeer::DATABASE_NAME);
            
            $criteria->add(CommonParametrageEnchereTranchesBaremeNETCPeer::IDENCHERE, $obj->getId());
            $criteria->add(CommonParametrageEnchereTranchesBaremeNETCPeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonParametrageEnchereTranchesBaremeNETCPeer::doDelete($criteria, $con);
        }
