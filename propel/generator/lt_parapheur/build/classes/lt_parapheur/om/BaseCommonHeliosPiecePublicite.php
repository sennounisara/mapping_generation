...
/**
 * Base class that represents a row from the 'Helios_piece_publicite' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonHeliosPiecePublicite extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonHeliosPiecePublicitePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonHeliosPiecePublicitePeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonHeliosPiecePublicite object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonHeliosPiecePublicite The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::ORGANISME;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::NOM_FICHIER;
        }
    ...
    public function setFichier($v)
    {
        ...
        if ($this->fichier !== $v) {
            $this->fichier = $v;
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::FICHIER;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::UNTRUSTEDDATE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::TAILLE;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonHeliosPiecePublicitePeer::CONSULTATION_REF;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fichier = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            if ($row[$startcol + 4] !== null) {
                $this->horodatage = fopen('php://memory', 'r+');
                fwrite($this->horodatage, $row[$startcol + 4]);
                rewind($this->horodatage);
            } else {
                $this->horodatage = null;
            }
            $this->untrusteddate = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->taille = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->consultation_ref = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = CommonHeliosPiecePublicitePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonHeliosPiecePublicite object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonHeliosPiecePublicitePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonHeliosPiecePubliciteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonHeliosPiecePublicitePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`fichier`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }

        $sql = sprintf(
            'INSERT INTO `Helios_piece_publicite` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonHeliosPiecePublicitePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonHeliosPiecePublicitePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonHeliosPiecePublicite'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonHeliosPiecePublicite'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonHeliosPiecePublicitePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrganisme(),
            $keys[2] => $this->getNomFichier(),
            $keys[3] => $this->getFichier(),
            $keys[4] => $this->getHorodatage(),
            $keys[5] => $this->getUntrusteddate(),
            $keys[6] => $this->getTaille(),
            $keys[7] => $this->getConsultationRef(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setHorodatage($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setUntrusteddate($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setTaille($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setConsultationRef($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::ID)) $criteria->add(CommonHeliosPiecePublicitePeer::ID, $this->id);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::ORGANISME)) $criteria->add(CommonHeliosPiecePublicitePeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::NOM_FICHIER)) $criteria->add(CommonHeliosPiecePublicitePeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::FICHIER)) $criteria->add(CommonHeliosPiecePublicitePeer::FICHIER, $this->fichier);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::HORODATAGE)) $criteria->add(CommonHeliosPiecePublicitePeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::UNTRUSTEDDATE)) $criteria->add(CommonHeliosPiecePublicitePeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::TAILLE)) $criteria->add(CommonHeliosPiecePublicitePeer::TAILLE, $this->taille);
        if ($this->isColumnModified(CommonHeliosPiecePublicitePeer::CONSULTATION_REF)) $criteria->add(CommonHeliosPiecePublicitePeer::CONSULTATION_REF, $this->consultation_ref);
    ...
    {
        $criteria = new Criteria(CommonHeliosPiecePublicitePeer::DATABASE_NAME);
        $criteria->add(CommonHeliosPiecePublicitePeer::ID, $this->id);
        $criteria->add(CommonHeliosPiecePublicitePeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonHeliosPiecePublicite (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonHeliosPiecePublicite Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonHeliosPiecePublicitePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonHeliosPiecePublicitePeer();
        }
    ...
    public function setCommonConsultation(CommonConsultation $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonHeliosPiecePublicite($this);
        }
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonHeliosPiecePublicites($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonHeliosPiecePublicitePeer::DEFAULT_STRING_FORMAT);
    }
