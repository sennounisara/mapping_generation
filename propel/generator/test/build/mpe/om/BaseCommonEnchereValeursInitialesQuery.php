 ...
 *
 * @method CommonEnchereValeursInitialesQuery leftJoinCommonEnchereEntreprisePmi($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereEntreprisePmi relation
 * @method CommonEnchereValeursInitialesQuery rightJoinCommonEnchereEntreprisePmi($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereEntreprisePmi relation
 * @method CommonEnchereValeursInitialesQuery innerJoinCommonEnchereEntreprisePmi($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereEntreprisePmi relation
 *
 * @method CommonEnchereValeursInitialesQuery leftJoinCommonEnchereReference($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEnchereReference relation
 * @method CommonEnchereValeursInitialesQuery rightJoinCommonEnchereReference($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEnchereReference relation
 * @method CommonEnchereValeursInitialesQuery innerJoinCommonEnchereReference($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEnchereReference relation
 *
...
abstract class BaseCommonEnchereValeursInitialesQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonEnchereReference()
     *
    ...
    public function filterByCommonEnchereEntreprisePmi($commonEnchereEntreprisePmi, $comparison = null)
    {
        if ($commonEnchereEntreprisePmi instanceof CommonEnchereEntreprisePmi) {
            return $this
                ->addUsingAlias(CommonEnchereValeursInitialesPeer::IDENCHEREENTREPRISE, $commonEnchereEntreprisePmi->getId(), $comparison)
                ->addUsingAlias(CommonEnchereValeursInitialesPeer::ORGANISME, $commonEnchereEntreprisePmi->getOrganisme(), $comparison);
        } else {
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEnchereReference($commonEnchereReference, $comparison = null)
    {
        if ($commonEnchereReference instanceof CommonEnchereReference) {
            return $this
                ->addUsingAlias(CommonEnchereValeursInitialesPeer::IDENCHEREREFERENCE, $commonEnchereReference->getId(), $comparison)
                ->addUsingAlias(CommonEnchereValeursInitialesPeer::ORGANISME, $commonEnchereReference->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonEnchereReference() only accepts arguments of type CommonEnchereReference');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEnchereReference relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEnchereValeursInitialesQuery The current query, for fluid interface
     */
    public function joinCommonEnchereReference($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEnchereReference');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEnchereReference');
        }
    ...
    /**
     * Use the CommonEnchereReference relation CommonEnchereReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonEnchereReferenceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEnchereReference($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEnchereReference', 'CommonEnchereReferenceQuery');
    }
