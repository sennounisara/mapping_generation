...
abstract class BaseCommonHeliosTeletransmissionLotPeer
{
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonHeliosTeletransmission table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonHeliosTeletransmission(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        array(CommonHeliosTeletransmissionLotPeer::ID_TELETRANSMISSION, CommonHeliosTeletransmissionPeer::ID),
        array(CommonHeliosTeletransmissionLotPeer::ORGANISME, CommonHeliosTeletransmissionPeer::ORGANISME),
      ), $join_behavior);
    ...
    /**
     * Selects a collection of CommonHeliosTeletransmissionLot objects pre-filled with their CommonHeliosTeletransmission objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonHeliosTeletransmissionLot objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonHeliosTeletransmission(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        CommonHeliosTeletransmissionLotPeer::addSelectColumns($criteria);
        $startcol = CommonHeliosTeletransmissionLotPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonHeliosTeletransmissionLotPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonHeliosTeletransmissionLotPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonHeliosTeletransmissionLotPeer::addInstanceToPool($obj1, $key1);
            } // if $obj1 already loaded

            $key2 = CommonHeliosTeletransmissionPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CommonHeliosTeletransmissionPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    CommonHeliosTeletransmissionPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (CommonHeliosTeletransmissionLot) to $obj2 (CommonHeliosTeletransmission)
                $obj2->addCommonHeliosTeletransmissionLot($obj1);
    ...
    /**
     * Selects a collection of CommonHeliosTeletransmissionLot objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonHeliosTeletransmissionLotPeer::addSelectColumns($criteria);
        $startcol2 = CommonHeliosTeletransmissionLotPeer::NUM_HYDRATE_COLUMNS;

        CommonHeliosTeletransmissionPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonHeliosTeletransmissionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined CommonHeliosTeletransmission rows

            $key2 = CommonHeliosTeletransmissionPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = CommonHeliosTeletransmissionPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (CommonHeliosTeletransmissionLot) to the collection in $obj2 (CommonHeliosTeletransmission)
                $obj2->addCommonHeliosTeletransmissionLot($obj1);
