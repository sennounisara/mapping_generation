...
/**
 * Base class that represents a row from the 'Complement' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonComplement extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonComplementPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonComplementPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonComplement object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonComplement The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonComplementPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonComplementPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonComplementPeer::CONSULTATION_REF;
        }
    ...
    public function setComplement($v)
    {
        ...
        if ($this->complement !== $v) {
            $this->complement = $v;
            $this->modifiedColumns[] = CommonComplementPeer::COMPLEMENT;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonComplementPeer::NOM_FICHIER;
        }
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[] = CommonComplementPeer::STATUT;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonComplementPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== $v) {
            ...
            $this->modifiedColumns[] = CommonComplementPeer::UNTRUSTEDDATE;
        }
    ...
    public function setAgentId($v)
    {
        ...
        if ($this->agent_id !== $v) {
            $this->agent_id = $v;
            $this->modifiedColumns[] = CommonComplementPeer::AGENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->complement = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            $this->agent_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = CommonComplementPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonComplement object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonComplementPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonComplementQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonComplementPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonComplementPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonComplementPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonComplementPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonComplementPeer::COMPLEMENT)) {
            $modifiedColumns[':p' . $index++]  = '`complement`';
        }
        if ($this->isColumnModified(CommonComplementPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonComplementPeer::STATUT)) {
            $modifiedColumns[':p' . $index++]  = '`statut`';
        }
        if ($this->isColumnModified(CommonComplementPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonComplementPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonComplementPeer::AGENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`agent_id`';
        }

        $sql = sprintf(
            'INSERT INTO `Complement` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`consultation_ref`':						
                        ...
                        break;
                    case '`complement`':						
                        $stmt->bindValue($identifier, $this->complement, PDO::PARAM_INT);
                        break;
                    case '`nom_fichier`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonComplementPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonComplementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonComplement'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonComplement'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonComplementPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrganisme(),
            $keys[2] => $this->getConsultationRef(),
            $keys[3] => $this->getComplement(),
            $keys[4] => $this->getNomFichier(),
            $keys[5] => $this->getStatut(),
            $keys[6] => $this->getHorodatage(),
            $keys[7] => $this->getUntrusteddate(),
            $keys[8] => $this->getAgentId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setComplement($arr[$keys[3]]);
        ...
        if (array_key_exists($keys[8], $arr)) $this->setAgentId($arr[$keys[8]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonComplementPeer::ID)) $criteria->add(CommonComplementPeer::ID, $this->id);
        if ($this->isColumnModified(CommonComplementPeer::ORGANISME)) $criteria->add(CommonComplementPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonComplementPeer::CONSULTATION_REF)) $criteria->add(CommonComplementPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonComplementPeer::COMPLEMENT)) $criteria->add(CommonComplementPeer::COMPLEMENT, $this->complement);
        if ($this->isColumnModified(CommonComplementPeer::NOM_FICHIER)) $criteria->add(CommonComplementPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonComplementPeer::STATUT)) $criteria->add(CommonComplementPeer::STATUT, $this->statut);
        if ($this->isColumnModified(CommonComplementPeer::HORODATAGE)) $criteria->add(CommonComplementPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonComplementPeer::UNTRUSTEDDATE)) $criteria->add(CommonComplementPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonComplementPeer::AGENT_ID)) $criteria->add(CommonComplementPeer::AGENT_ID, $this->agent_id);
    ...
    {
        $criteria = new Criteria(CommonComplementPeer::DATABASE_NAME);
        $criteria->add(CommonComplementPeer::ID, $this->id);
        $criteria->add(CommonComplementPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonComplement (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonComplement Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonComplementPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonComplementPeer();
        }
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonComplements($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonComplementPeer::DEFAULT_STRING_FORMAT);
    }
