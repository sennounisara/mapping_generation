 ...
 *
 * @method CommonTCAOCommissionIntervenantExterneQuery leftJoinCommonTCAOCommission($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOCommission relation
 * @method CommonTCAOCommissionIntervenantExterneQuery rightJoinCommonTCAOCommission($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOCommission relation
 * @method CommonTCAOCommissionIntervenantExterneQuery innerJoinCommonTCAOCommission($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOCommission relation
 *
 * @method CommonTCAOCommissionIntervenantExterneQuery leftJoinCommonTCAOIntervenantExterne($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonTCAOIntervenantExterne relation
 * @method CommonTCAOCommissionIntervenantExterneQuery rightJoinCommonTCAOIntervenantExterne($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonTCAOIntervenantExterne relation
 * @method CommonTCAOCommissionIntervenantExterneQuery innerJoinCommonTCAOIntervenantExterne($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonTCAOIntervenantExterne relation
 *
...
abstract class BaseCommonTCAOCommissionIntervenantExterneQuery extends ModelCriteria
{
    ...
    public function filterByCommonTCAOCommission($commonTCAOCommission, $comparison = null)
    {
        if ($commonTCAOCommission instanceof CommonTCAOCommission) {
            return $this
                ->addUsingAlias(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION, $commonTCAOCommission->getIdCommission(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION, $commonTCAOCommission->toKeyValue('IdCommission', 'IdCommission'), $comparison);
        } else {
    ...
    public function filterByCommonTCAOIntervenantExterne($commonTCAOIntervenantExterne, $comparison = null)
    {
        if ($commonTCAOIntervenantExterne instanceof CommonTCAOIntervenantExterne) {
            return $this
                ->addUsingAlias(CommonTCAOCommissionIntervenantExternePeer::ID_INTERVENANT_EXTERNE, $commonTCAOIntervenantExterne->getIdIntervenantExterne(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonTCAOCommissionIntervenantExternePeer::ID_INTERVENANT_EXTERNE, $commonTCAOIntervenantExterne->toKeyValue('IdIntervenantExterne', 'IdIntervenantExterne'), $comparison);
        } else {
