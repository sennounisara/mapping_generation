...
/**
 * Base class that represents a row from the 'ValeurReferentielOrg' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonValeurReferentielOrg extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonValeurReferentielOrgPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonValeurReferentielOrgPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonValeurReferentielOrg object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonValeurReferentielOrg The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::ORGANISME;
        }
    ...
    public function setIdReferentiel($v)
    {
        ...
        if ($this->id_referentiel !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::ID_REFERENTIEL;
        }
    ...
    public function setLibelleValeurReferentiel($v)
    {
        ...
        if ($this->libelle_valeur_referentiel !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL;
        }
    ...
    public function setLibelleValeurReferentielFr($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_fr !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_FR;
        }
    ...
    public function setLibelleValeurReferentielEn($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_en !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_EN;
        }
    ...
    public function setLibelleValeurReferentielEs($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_es !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_ES;
        }
    ...
    public function setLibelleValeurReferentielSu($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_su !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_SU;
        }
    ...
    public function setLibelleValeurReferentielDu($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_du !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_DU;
        }
    ...
    public function setLibelleValeurReferentielCz($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_cz !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_CZ;
        }
    ...
    public function setLibelleValeurReferentielAr($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_ar !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_AR;
        }
    ...
    public function setLibelleValeurReferentielIt($v)
    {
        ...
        if ($this->libelle_valeur_referentiel_it !== $v) {
            ...
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_IT;
        }
    ...
    public function setValeurSub($v)
    {
        ...
        if ($this->valeur_sub !== $v) {
            $this->valeur_sub = $v;
            $this->modifiedColumns[] = CommonValeurReferentielOrgPeer::VALEUR_SUB;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->libelle_valeur_referentiel = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->libelle_valeur_referentiel_fr = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->libelle_valeur_referentiel_en = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->libelle_valeur_referentiel_es = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->libelle_valeur_referentiel_su = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->libelle_valeur_referentiel_du = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->libelle_valeur_referentiel_cz = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->libelle_valeur_referentiel_ar = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            ...
            return $startcol + 13; // 13 = CommonValeurReferentielOrgPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonValeurReferentielOrg object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonValeurReferentielOrgPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonValeurReferentielOrgQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonValeurReferentielOrgPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::ID_REFERENTIEL)) {
            $modifiedColumns[':p' . $index++]  = '`id_referentiel`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_fr`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_en`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_es`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_su`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_du`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_cz`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_ar`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_valeur_referentiel_it`';
        }
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::VALEUR_SUB)) {
            $modifiedColumns[':p' . $index++]  = '`valeur_sub`';
        }

        $sql = sprintf(
            'INSERT INTO `ValeurReferentielOrg` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonValeurReferentielOrgPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonValeurReferentielOrgPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonValeurReferentielOrg'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonValeurReferentielOrg'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonValeurReferentielOrgPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrganisme(),
            $keys[2] => $this->getIdReferentiel(),
            $keys[3] => $this->getLibelleValeurReferentiel(),
            $keys[4] => $this->getLibelleValeurReferentielFr(),
            $keys[5] => $this->getLibelleValeurReferentielEn(),
            $keys[6] => $this->getLibelleValeurReferentielEs(),
            $keys[7] => $this->getLibelleValeurReferentielSu(),
            $keys[8] => $this->getLibelleValeurReferentielDu(),
            $keys[9] => $this->getLibelleValeurReferentielCz(),
            $keys[10] => $this->getLibelleValeurReferentielAr(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIdReferentiel($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setLibelleValeurReferentiel($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setLibelleValeurReferentielFr($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setLibelleValeurReferentielEn($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setLibelleValeurReferentielEs($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setLibelleValeurReferentielSu($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setLibelleValeurReferentielDu($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setLibelleValeurReferentielCz($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setLibelleValeurReferentielAr($arr[$keys[10]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::ID)) $criteria->add(CommonValeurReferentielOrgPeer::ID, $this->id);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::ORGANISME)) $criteria->add(CommonValeurReferentielOrgPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::ID_REFERENTIEL)) $criteria->add(CommonValeurReferentielOrgPeer::ID_REFERENTIEL, $this->id_referentiel);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL, $this->libelle_valeur_referentiel);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_FR)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_FR, $this->libelle_valeur_referentiel_fr);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_EN)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_EN, $this->libelle_valeur_referentiel_en);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_ES)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_ES, $this->libelle_valeur_referentiel_es);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_SU)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_SU, $this->libelle_valeur_referentiel_su);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_DU)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_DU, $this->libelle_valeur_referentiel_du);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_CZ)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_CZ, $this->libelle_valeur_referentiel_cz);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_AR)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_AR, $this->libelle_valeur_referentiel_ar);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_IT)) $criteria->add(CommonValeurReferentielOrgPeer::LIBELLE_VALEUR_REFERENTIEL_IT, $this->libelle_valeur_referentiel_it);
        if ($this->isColumnModified(CommonValeurReferentielOrgPeer::VALEUR_SUB)) $criteria->add(CommonValeurReferentielOrgPeer::VALEUR_SUB, $this->valeur_sub);
    ...
    {
        $criteria = new Criteria(CommonValeurReferentielOrgPeer::DATABASE_NAME);
        $criteria->add(CommonValeurReferentielOrgPeer::ID, $this->id);
        $criteria->add(CommonValeurReferentielOrgPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonValeurReferentielOrg (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonValeurReferentielOrg Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonValeurReferentielOrgPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonValeurReferentielOrgPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonValeurReferentielOrgPeer::DEFAULT_STRING_FORMAT);
    }
