 ...
 *
 * @method CommonResultatAnalyseHistoriqueQuery leftJoinCommonAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgent relation
 * @method CommonResultatAnalyseHistoriqueQuery rightJoinCommonAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgent relation
 * @method CommonResultatAnalyseHistoriqueQuery innerJoinCommonAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgent relation
 *
...
abstract class BaseCommonResultatAnalyseHistoriqueQuery extends ModelCriteria
{
    ...
    public function filterByCommonAgent($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonResultatAnalyseHistoriquePeer::AGENT_ID, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonResultatAnalyseHistoriquePeer::AGENT_ID, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
