...
/**
 * Base class that represents a row from the 'exec_facture_signature' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecFactureSignature extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecFactureSignaturePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecFactureSignaturePeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonExecFactureSignature object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonExecFactureSignature The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::ID;
        }
    ...
    public function setIdBlob($v)
    {
        ...
        if ($this->id_blob !== $v) {
            $this->id_blob = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::ID_BLOB;
        }
    ...
    public function setIdFacture($v)
    {
        ...
        if ($this->id_facture !== $v) {
            $this->id_facture = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::ID_FACTURE;
        }
    ...
    public function setTypeDocument($v)
    {
        ...
        if ($this->type_document !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::TYPE_DOCUMENT;
        }
    ...
    public function setDateSignature($v)
    {
        ...
        if ($this->date_signature !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecFactureSignaturePeer::DATE_SIGNATURE;
            }
    ...
    public function setEmetteur($v)
    {
        ...
        if ($this->emetteur !== $v) {
            $this->emetteur = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::EMETTEUR;
        }
    ...
    public function setDetailEmetteur($v)
    {
        ...
        if ($this->detail_emetteur !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::DETAIL_EMETTEUR;
        }
    ...
    public function setSignataire($v)
    {
        ...
        if ($this->signataire !== $v) {
            $this->signataire = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::SIGNATAIRE;
        }
    ...
    public function setDetailSignataire($v)
    {
        ...
        if ($this->detail_signataire !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::DETAIL_SIGNATAIRE;
        }
    ...
    public function setRevoque($v)
    {
        ...
        if ($this->revoque !== $v) {
            $this->revoque = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::REVOQUE;
        }
    ...
    public function setNonRepudiation($v)
    {
        ...
        if ($this->non_repudiation !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::NON_REPUDIATION;
        }
    ...
    public function setChaineValide($v)
    {
        ...
        if ($this->chaine_valide !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::CHAINE_VALIDE;
        }
    ...
    public function setDateDebPeriodeValidite($v)
    {
        ...
        if ($this->date_deb_periode_validite !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecFactureSignaturePeer::DATE_DEB_PERIODE_VALIDITE;
            }
        } // if either are not null
    ...
    public function setDateFinPeriodeValidite($v)
    {
        ...
        if ($this->date_fin_periode_validite !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecFactureSignaturePeer::DATE_FIN_PERIODE_VALIDITE;
            }
        } // if either are not null
    ...
    public function setPeriodeValidite($v)
    {
        ...
        if ($this->periode_validite !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::PERIODE_VALIDITE;
        }
    ...
    public function setSignatureValide($v)
    {
        ...
        if ($this->signature_valide !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::SIGNATURE_VALIDE;
        }
    ...
    public function setTypeSignature($v)
    {
        ...
        if ($this->type_signature !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::TYPE_SIGNATURE;
        }
    ...
    public function setXmlSignature($v)
    {
        ...
        if ($this->xml_signature !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::XML_SIGNATURE;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::NOM_FICHIER;
        }
    ...
    public function setHash($v)
    {
        ...
        if ($this->hash !== $v) {
            $this->hash = $v;
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::HASH;
        }
    ...
    public function setAlgorithmeHash($v)
    {
        ...
        if ($this->algorithme_hash !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::ALGORITHME_HASH;
        }
    ...
    public function setDateDerniereVerification($v)
    {
        ...
        if ($this->date_derniere_verification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecFactureSignaturePeer::DATE_DERNIERE_VERIFICATION;
            }
        } // if either are not null
    ...
    public function setSignatureArchivee($v)
    {
        ...
        if ($this->signature_archivee !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecFactureSignaturePeer::SIGNATURE_ARCHIVEE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->type_document = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->date_signature = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->emetteur = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->detail_emetteur = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->signataire = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->detail_signataire = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->revoque = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->non_repudiation = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->chaine_valide = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->date_deb_periode_validite = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->date_fin_periode_validite = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->periode_validite = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->signature_valide = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->type_signature = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->xml_signature = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->nom_fichier = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->hash = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->algorithme_hash = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->date_derniere_verification = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->signature_archivee = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
            $this->resetModified();
            ...
            return $startcol + 23; // 23 = CommonExecFactureSignaturePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecFactureSignature object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecFactureSignaturePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecFactureSignatureQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecFactureSignaturePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ID_BLOB)) {
            $modifiedColumns[':p' . $index++]  = '`ID_BLOB`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ID_FACTURE)) {
            $modifiedColumns[':p' . $index++]  = '`ID_FACTURE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::TYPE_DOCUMENT)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE_DOCUMENT`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_SIGNATURE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::EMETTEUR)) {
            $modifiedColumns[':p' . $index++]  = '`EMETTEUR`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DETAIL_EMETTEUR)) {
            $modifiedColumns[':p' . $index++]  = '`DETAIL_EMETTEUR`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::SIGNATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`SIGNATAIRE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DETAIL_SIGNATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`DETAIL_SIGNATAIRE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::REVOQUE)) {
            $modifiedColumns[':p' . $index++]  = '`REVOQUE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::NON_REPUDIATION)) {
            $modifiedColumns[':p' . $index++]  = '`NON_REPUDIATION`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::CHAINE_VALIDE)) {
            $modifiedColumns[':p' . $index++]  = '`CHAINE_VALIDE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_DEB_PERIODE_VALIDITE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_DEB_PERIODE_VALIDITE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_FIN_PERIODE_VALIDITE)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_FIN_PERIODE_VALIDITE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::PERIODE_VALIDITE)) {
            $modifiedColumns[':p' . $index++]  = '`PERIODE_VALIDITE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::SIGNATURE_VALIDE)) {
            $modifiedColumns[':p' . $index++]  = '`SIGNATURE_VALIDE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::TYPE_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '`TYPE_SIGNATURE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::XML_SIGNATURE)) {
            $modifiedColumns[':p' . $index++]  = '`XML_SIGNATURE`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`NOM_FICHIER`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::HASH)) {
            $modifiedColumns[':p' . $index++]  = '`HASH`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ALGORITHME_HASH)) {
            $modifiedColumns[':p' . $index++]  = '`ALGORITHME_HASH`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_DERNIERE_VERIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`DATE_DERNIERE_VERIFICATION`';
        }
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::SIGNATURE_ARCHIVEE)) {
            $modifiedColumns[':p' . $index++]  = '`SIGNATURE_ARCHIVEE`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_facture_signature` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecFactureSignaturePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecFactureSignaturePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecFactureSignature'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecFactureSignature'][$this->getPrimaryKey()] = true;
        $keys = CommonExecFactureSignaturePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdBlob(),
            $keys[2] => $this->getIdFacture(),
            $keys[3] => $this->getTypeDocument(),
            $keys[4] => $this->getDateSignature(),
            $keys[5] => $this->getEmetteur(),
            $keys[6] => $this->getDetailEmetteur(),
            $keys[7] => $this->getSignataire(),
            $keys[8] => $this->getDetailSignataire(),
            $keys[9] => $this->getRevoque(),
            $keys[10] => $this->getNonRepudiation(),
            $keys[11] => $this->getChaineValide(),
            $keys[12] => $this->getDateDebPeriodeValidite(),
            $keys[13] => $this->getDateFinPeriodeValidite(),
            $keys[14] => $this->getPeriodeValidite(),
            $keys[15] => $this->getSignatureValide(),
            $keys[16] => $this->getTypeSignature(),
            $keys[17] => $this->getXmlSignature(),
            $keys[18] => $this->getNomFichier(),
            $keys[19] => $this->getHash(),
            $keys[20] => $this->getAlgorithmeHash(),
            $keys[21] => $this->getDateDerniereVerification(),
            $keys[22] => $this->getSignatureArchivee(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setTypeDocument($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setDateSignature($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setEmetteur($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setDetailEmetteur($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setSignataire($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setDetailSignataire($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setRevoque($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setNonRepudiation($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setChaineValide($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setDateDebPeriodeValidite($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setDateFinPeriodeValidite($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setPeriodeValidite($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setSignatureValide($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setTypeSignature($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setXmlSignature($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setNomFichier($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setHash($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setAlgorithmeHash($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setDateDerniereVerification($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setSignatureArchivee($arr[$keys[22]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ID)) $criteria->add(CommonExecFactureSignaturePeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ID_BLOB)) $criteria->add(CommonExecFactureSignaturePeer::ID_BLOB, $this->id_blob);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ID_FACTURE)) $criteria->add(CommonExecFactureSignaturePeer::ID_FACTURE, $this->id_facture);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::TYPE_DOCUMENT)) $criteria->add(CommonExecFactureSignaturePeer::TYPE_DOCUMENT, $this->type_document);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_SIGNATURE)) $criteria->add(CommonExecFactureSignaturePeer::DATE_SIGNATURE, $this->date_signature);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::EMETTEUR)) $criteria->add(CommonExecFactureSignaturePeer::EMETTEUR, $this->emetteur);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DETAIL_EMETTEUR)) $criteria->add(CommonExecFactureSignaturePeer::DETAIL_EMETTEUR, $this->detail_emetteur);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::SIGNATAIRE)) $criteria->add(CommonExecFactureSignaturePeer::SIGNATAIRE, $this->signataire);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DETAIL_SIGNATAIRE)) $criteria->add(CommonExecFactureSignaturePeer::DETAIL_SIGNATAIRE, $this->detail_signataire);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::REVOQUE)) $criteria->add(CommonExecFactureSignaturePeer::REVOQUE, $this->revoque);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::NON_REPUDIATION)) $criteria->add(CommonExecFactureSignaturePeer::NON_REPUDIATION, $this->non_repudiation);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::CHAINE_VALIDE)) $criteria->add(CommonExecFactureSignaturePeer::CHAINE_VALIDE, $this->chaine_valide);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_DEB_PERIODE_VALIDITE)) $criteria->add(CommonExecFactureSignaturePeer::DATE_DEB_PERIODE_VALIDITE, $this->date_deb_periode_validite);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_FIN_PERIODE_VALIDITE)) $criteria->add(CommonExecFactureSignaturePeer::DATE_FIN_PERIODE_VALIDITE, $this->date_fin_periode_validite);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::PERIODE_VALIDITE)) $criteria->add(CommonExecFactureSignaturePeer::PERIODE_VALIDITE, $this->periode_validite);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::SIGNATURE_VALIDE)) $criteria->add(CommonExecFactureSignaturePeer::SIGNATURE_VALIDE, $this->signature_valide);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::TYPE_SIGNATURE)) $criteria->add(CommonExecFactureSignaturePeer::TYPE_SIGNATURE, $this->type_signature);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::XML_SIGNATURE)) $criteria->add(CommonExecFactureSignaturePeer::XML_SIGNATURE, $this->xml_signature);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::NOM_FICHIER)) $criteria->add(CommonExecFactureSignaturePeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::HASH)) $criteria->add(CommonExecFactureSignaturePeer::HASH, $this->hash);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::ALGORITHME_HASH)) $criteria->add(CommonExecFactureSignaturePeer::ALGORITHME_HASH, $this->algorithme_hash);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::DATE_DERNIERE_VERIFICATION)) $criteria->add(CommonExecFactureSignaturePeer::DATE_DERNIERE_VERIFICATION, $this->date_derniere_verification);
        if ($this->isColumnModified(CommonExecFactureSignaturePeer::SIGNATURE_ARCHIVEE)) $criteria->add(CommonExecFactureSignaturePeer::SIGNATURE_ARCHIVEE, $this->signature_archivee);
    ...
    {
        $criteria = new Criteria(CommonExecFactureSignaturePeer::DATABASE_NAME);
        $criteria->add(CommonExecFactureSignaturePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecFactureSignature (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecFactureSignature Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecFactureSignaturePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecFactureSignaturePeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonExecFactureSignaturePeer::DEFAULT_STRING_FORMAT);
    }
