...
class CommonBlobOrganismeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonBlobOrganismeTableMap';
    ...
    {
        $this->addRelation('CommonDocumentExterne', 'CommonDocumentExterne', RelationMap::ONE_TO_MANY, array('id' => 'idBlob', ), 'CASCADE', 'CASCADE', 'CommonDocumentExternes');
    } // buildRelations()
