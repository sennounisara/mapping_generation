...
class CommonAnnoncePressTableMap extends TableMap
{
    ...
    {
        $this->addRelation('CommonAnnoncePressPieceJointe', 'CommonAnnoncePressPieceJointe', RelationMap::ONE_TO_MANY, array('id' => 'id_annonce_press', ), 'CASCADE', 'CASCADE', 'CommonAnnoncePressPieceJointes');
    } // buildRelations()
