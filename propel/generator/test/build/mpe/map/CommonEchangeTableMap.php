...
class CommonEchangeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonEchangeTableMap';
    ...
    {
        $this->addRelation('CommonEchangeDestinataire', 'CommonEchangeDestinataire', RelationMap::ONE_TO_MANY, array('id' => 'id_echange', ), 'CASCADE', null, 'CommonEchangeDestinataires');
        $this->addRelation('CommonEchangePieceJointe', 'CommonEchangePieceJointe', RelationMap::ONE_TO_MANY, array('id' => 'id_message', ), 'CASCADE', null, 'CommonEchangePieceJointes');
    } // buildRelations()
