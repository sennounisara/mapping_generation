...
abstract class BaseCommonHeliosTeletransmissionLot extends BaseObject implements Persistent
{
    ...
    /**
     * @var        CommonHeliosTeletransmission
     */
    protected $aCommonHeliosTeletransmission;
    ...
    public function setIdTeletransmission($v)
    {
        ...
        if ($this->aCommonHeliosTeletransmission !== null && $this->aCommonHeliosTeletransmission->getId() !== $v) {
            $this->aCommonHeliosTeletransmission = null;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->aCommonHeliosTeletransmission !== null && $this->aCommonHeliosTeletransmission->getOrganisme() !== $v) {
            $this->aCommonHeliosTeletransmission = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonHeliosTeletransmission !== null && $this->id_teletransmission !== $this->aCommonHeliosTeletransmission->getId()) {
            $this->aCommonHeliosTeletransmission = null;
        }
        if ($this->aCommonHeliosTeletransmission !== null && $this->organisme !== $this->aCommonHeliosTeletransmission->getOrganisme()) {
            $this->aCommonHeliosTeletransmission = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonHeliosTeletransmission !== null) {
                if ($this->aCommonHeliosTeletransmission->isModified() || $this->aCommonHeliosTeletransmission->isNew()) {
                    $affectedRows += $this->aCommonHeliosTeletransmission->save($con);
                }
                $this->setCommonHeliosTeletransmission($this->aCommonHeliosTeletransmission);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonHeliosTeletransmission !== null) {
                if (!$this->aCommonHeliosTeletransmission->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonHeliosTeletransmission->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonHeliosTeletransmission) {
                $result['CommonHeliosTeletransmission'] = $this->aCommonHeliosTeletransmission->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a CommonHeliosTeletransmission object.
     *
     * @param   CommonHeliosTeletransmission $v
     * @return CommonHeliosTeletransmissionLot The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonHeliosTeletransmission(CommonHeliosTeletransmission $v = null)
    {
        if ($v === null) {
            $this->setIdTeletransmission(0);
        } else {
            $this->setIdTeletransmission($v->getId());
        }
        ...
        $this->aCommonHeliosTeletransmission = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonHeliosTeletransmission object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonHeliosTeletransmissionLot($this);
        }
    ...
    /**
     * Get the associated CommonHeliosTeletransmission object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonHeliosTeletransmission The associated CommonHeliosTeletransmission object.
     * @throws PropelException
     */
    public function getCommonHeliosTeletransmission(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonHeliosTeletransmission === null && ($this->id_teletransmission !== null && ($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            $this->aCommonHeliosTeletransmission = CommonHeliosTeletransmissionQuery::create()->findPk(array($this->id_teletransmission, $this->organisme), $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonHeliosTeletransmission->addCommonHeliosTeletransmissionLots($this);
             */
        }

        return $this->aCommonHeliosTeletransmission;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonHeliosTeletransmission instanceof Persistent) {
              $this->aCommonHeliosTeletransmission->clearAllReferences($deep);
            }
