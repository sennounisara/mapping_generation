...
define ('__GENERATOR_ROOT__', __ROOT__."/propel/generator");
define ('__GENERATOR_LIB__', __GENERATOR_ROOT__."/lib");
set_include_path(
    __ROOT__.PATH_SEPARATOR.
    __GENERATOR_LIB__.PATH_SEPARATOR.
    __ROOT__.'/lib'.PATH_SEPARATOR.
    get_include_path());
