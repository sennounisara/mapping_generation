...
/**
 * Base class that represents a row from the 'exec_contact' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonExecContact extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecContactPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecContactPeer
     */
     ...
     * @return CommonExecContact The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecContactPeer::ID;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecContactPeer::ID_CONTRAT;
        }
    ...
    public function setIdContractant($v)
    {
        ...
        if ($this->id_contractant !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecContactPeer::ID_CONTRACTANT;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = CommonExecContactPeer::NOM;
        }
    ...
    public function setPrenom($v)
    {
        ...
        if ($this->prenom !== $v) {
            $this->prenom = $v;
            $this->modifiedColumns[] = CommonExecContactPeer::PRENOM;
        }
    ...
    public function setTelephone($v)
    {
        ...
        if ($this->telephone !== $v) {
            $this->telephone = $v;
            $this->modifiedColumns[] = CommonExecContactPeer::TELEPHONE;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = CommonExecContactPeer::EMAIL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_contractant = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 7; // 7 = CommonExecContactPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecContact object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecContactPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecContactQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecContactPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecContactPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecContactPeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(CommonExecContactPeer::ID_CONTRACTANT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contractant`';
        }
        if ($this->isColumnModified(CommonExecContactPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(CommonExecContactPeer::PRENOM)) {
            $modifiedColumns[':p' . $index++]  = '`prenom`';
        }
        if ($this->isColumnModified(CommonExecContactPeer::TELEPHONE)) {
            $modifiedColumns[':p' . $index++]  = '`telephone`';
        }
        if ($this->isColumnModified(CommonExecContactPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_contact` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecContactPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecContactPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecContact'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecContact'][$this->getPrimaryKey()] = true;
        $keys = CommonExecContactPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdContrat(),
            $keys[2] => $this->getIdContractant(),
            $keys[3] => $this->getNom(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIdContractant($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecContactPeer::ID)) $criteria->add(CommonExecContactPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecContactPeer::ID_CONTRAT)) $criteria->add(CommonExecContactPeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(CommonExecContactPeer::ID_CONTRACTANT)) $criteria->add(CommonExecContactPeer::ID_CONTRACTANT, $this->id_contractant);
        if ($this->isColumnModified(CommonExecContactPeer::NOM)) $criteria->add(CommonExecContactPeer::NOM, $this->nom);
        if ($this->isColumnModified(CommonExecContactPeer::PRENOM)) $criteria->add(CommonExecContactPeer::PRENOM, $this->prenom);
        if ($this->isColumnModified(CommonExecContactPeer::TELEPHONE)) $criteria->add(CommonExecContactPeer::TELEPHONE, $this->telephone);
        if ($this->isColumnModified(CommonExecContactPeer::EMAIL)) $criteria->add(CommonExecContactPeer::EMAIL, $this->email);
    ...
    {
        $criteria = new Criteria(CommonExecContactPeer::DATABASE_NAME);
        $criteria->add(CommonExecContactPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecContact (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecContact Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecContactPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecContactPeer();
        }
    ...
    public function getCommonExecContractant(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContractant === null && ($this->id_contractant !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonExecContractant->addCommonExecContacts($this);
             */
        }
    ...
    public function getCommonExecContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContrat === null && ($this->id_contrat !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecContrat->addCommonExecContacts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonExecContactPeer::DEFAULT_STRING_FORMAT);
    }
