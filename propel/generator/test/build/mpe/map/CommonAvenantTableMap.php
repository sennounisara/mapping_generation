...
class CommonAvenantTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_contrat', 'IdContrat', 'INTEGER', 'Contrat', 'id_contrat', true, null, null);
    ...
    {
        $this->addRelation('CommonContrat', 'CommonContrat', RelationMap::MANY_TO_ONE, array('id_contrat' => 'id_contrat', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
