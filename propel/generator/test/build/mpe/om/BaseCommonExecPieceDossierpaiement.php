...
/**
 * Base class that represents a row from the 'exec_piece_dossierpaiement' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecPieceDossierpaiement extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecPieceDossierpaiementPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecPieceDossierpaiementPeer
     */
     ...
     * @return CommonExecPieceDossierpaiement The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::ID;
        }
    ...
    public function setIdDossierPaiement($v)
    {
        ...
        if ($this->id_dossier_paiement !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::ID_DOSSIER_PAIEMENT;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::LIBELLE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::TAILLE;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::ID_CONTRAT;
        }
    ...
    public function setIdAgentCreat($v)
    {
        ...
        if ($this->id_agent_creat !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::ID_AGENT_CREAT;
        }
    ...
    public function setDateCreat($v)
    {
        ...
        if ($this->date_creat !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::DATE_CREAT;
            }
    ...
    public function setIdBlob($v)
    {
        ...
        if ($this->id_blob !== $v) {
            $this->id_blob = $v;
            $this->modifiedColumns[] = CommonExecPieceDossierpaiementPeer::ID_BLOB;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_contrat = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->id_agent_creat = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            ...
            return $startcol + 8; // 8 = CommonExecPieceDossierpaiementPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecPieceDossierpaiement object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonAgent !== null && $this->id_agent_creat !== $this->aCommonAgent->getId()) {
            $this->aCommonAgent = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecPieceDossierpaiementPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecPieceDossierpaiementQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecPieceDossierpaiementPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_DOSSIER_PAIEMENT)) {
            $modifiedColumns[':p' . $index++]  = '`id_dossier_paiement`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_AGENT_CREAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_creat`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::DATE_CREAT)) {
            $modifiedColumns[':p' . $index++]  = '`date_creat`';
        }
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_BLOB)) {
            $modifiedColumns[':p' . $index++]  = '`id_blob`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_piece_dossierpaiement` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecPieceDossierpaiementPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecPieceDossierpaiementPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecPieceDossierpaiement'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecPieceDossierpaiement'][$this->getPrimaryKey()] = true;
        $keys = CommonExecPieceDossierpaiementPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdDossierPaiement(),
            $keys[2] => $this->getLibelle(),
            $keys[3] => $this->getTaille(),
            $keys[4] => $this->getIdContrat(),
            $keys[5] => $this->getIdAgentCreat(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setIdContrat($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setIdAgentCreat($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID)) $criteria->add(CommonExecPieceDossierpaiementPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_DOSSIER_PAIEMENT)) $criteria->add(CommonExecPieceDossierpaiementPeer::ID_DOSSIER_PAIEMENT, $this->id_dossier_paiement);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::LIBELLE)) $criteria->add(CommonExecPieceDossierpaiementPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::TAILLE)) $criteria->add(CommonExecPieceDossierpaiementPeer::TAILLE, $this->taille);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_CONTRAT)) $criteria->add(CommonExecPieceDossierpaiementPeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_AGENT_CREAT)) $criteria->add(CommonExecPieceDossierpaiementPeer::ID_AGENT_CREAT, $this->id_agent_creat);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::DATE_CREAT)) $criteria->add(CommonExecPieceDossierpaiementPeer::DATE_CREAT, $this->date_creat);
        if ($this->isColumnModified(CommonExecPieceDossierpaiementPeer::ID_BLOB)) $criteria->add(CommonExecPieceDossierpaiementPeer::ID_BLOB, $this->id_blob);
    ...
    {
        $criteria = new Criteria(CommonExecPieceDossierpaiementPeer::DATABASE_NAME);
        $criteria->add(CommonExecPieceDossierpaiementPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecPieceDossierpaiement (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecPieceDossierpaiement Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecPieceDossierpaiementPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecPieceDossierpaiementPeer();
        }
    ...
    public function setCommonExecDossierPaiement(CommonExecDossierPaiement $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonExecPieceDossierpaiement($this);
        }
    ...
    public function getCommonExecDossierPaiement(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecDossierPaiement === null && ($this->id_dossier_paiement !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonExecDossierPaiement->addCommonExecPieceDossierpaiements($this);
             */
        }
    ...
    public function getCommonExecContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContrat === null && ($this->id_contrat !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecContrat->addCommonExecPieceDossierpaiements($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setIdAgentCreat(NULL);
        } else {
            $this->setIdAgentCreat($v->getId());
        }
    ...
    {
        if ($this->aCommonAgent === null && ($this->id_agent_creat !== null) && $doQuery) {
            $this->aCommonAgent = CommonAgentQuery::create()->findPk($this->id_agent_creat, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonAgent->addCommonExecPieceDossierpaiements($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonExecPieceDossierpaiementPeer::DEFAULT_STRING_FORMAT);
    }
