...
abstract class BaseCommonBlobFile extends BaseObject implements Persistent
{
    ...
    public function setRevision($v)
    {
        ...
        if ($this->revision !== $v) {
            $this->revision = $v;
            $this->modifiedColumns[] = CommonBlobFilePeer::REVISION;
        }
    ...
    public function setDateAjout($v)
    {
        ...
        if ($this->date_ajout !== $v) {
            $this->date_ajout = $v;
            $this->modifiedColumns[] = CommonBlobFilePeer::DATE_AJOUT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = CommonBlobFilePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonBlobFilePeer::REVISION)) {
        ...
        if ($this->isColumnModified(CommonBlobFilePeer::DATE_AJOUT)) {
    ...
    {
        if (isset($alreadyDumpedObjects['CommonBlobFile'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonBlobFile'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonBlobFilePeer::REVISION)) $criteria->add(CommonBlobFilePeer::REVISION, $this->revision);
        ...
        if ($this->isColumnModified(CommonBlobFilePeer::DATE_AJOUT)) $criteria->add(CommonBlobFilePeer::DATE_AJOUT, $this->date_ajout);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(CommonBlobFilePeer::REVISION, $this->revision);
