...
/**
 * Base class that represents a row from the 'EnchereTranchesBaremeNETC' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonEnchereTranchesBaremeNETC extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonEnchereTranchesBaremeNETCPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonEnchereTranchesBaremeNETCPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonEnchereTranchesBaremeNETC object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonEnchereTranchesBaremeNETC The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonEnchereTranchesBaremeNETCPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonEnchereTranchesBaremeNETCPeer::ORGANISME;
        }
    ...
    public function setIdenchere($v)
    {
        ...
        if ($this->idenchere !== $v) {
            $this->idenchere = $v;
            $this->modifiedColumns[] = CommonEnchereTranchesBaremeNETCPeer::IDENCHERE;
        }
    ...
    public function setBorneinf($v)
    {
        ...
        if ($this->borneinf !== $v) {
            $this->borneinf = $v;
            $this->modifiedColumns[] = CommonEnchereTranchesBaremeNETCPeer::BORNEINF;
        }
    ...
    public function setBornesup($v)
    {
        ...
        if ($this->bornesup !== $v) {
            $this->bornesup = $v;
            $this->modifiedColumns[] = CommonEnchereTranchesBaremeNETCPeer::BORNESUP;
        }
    ...
    public function setNote($v)
    {
        ...
        if ($this->note !== $v) {
            $this->note = $v;
            $this->modifiedColumns[] = CommonEnchereTranchesBaremeNETCPeer::NOTE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = CommonEnchereTranchesBaremeNETCPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonEnchereTranchesBaremeNETC object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonEnchereTranchesBaremeNETCPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonEnchereTranchesBaremeNETCQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonEnchereTranchesBaremeNETCPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::IDENCHERE)) {
            $modifiedColumns[':p' . $index++]  = '`idEnchere`';
        }
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::BORNEINF)) {
            $modifiedColumns[':p' . $index++]  = '`borneInf`';
        }
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::BORNESUP)) {
            $modifiedColumns[':p' . $index++]  = '`borneSup`';
        }
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::NOTE)) {
            $modifiedColumns[':p' . $index++]  = '`note`';
        }

        $sql = sprintf(
            'INSERT INTO `EnchereTranchesBaremeNETC` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonEnchereTranchesBaremeNETCPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonEnchereTranchesBaremeNETCPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonEnchereTranchesBaremeNETC'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonEnchereTranchesBaremeNETC'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonEnchereTranchesBaremeNETCPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::ID)) $criteria->add(CommonEnchereTranchesBaremeNETCPeer::ID, $this->id);
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::ORGANISME)) $criteria->add(CommonEnchereTranchesBaremeNETCPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::IDENCHERE)) $criteria->add(CommonEnchereTranchesBaremeNETCPeer::IDENCHERE, $this->idenchere);
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::BORNEINF)) $criteria->add(CommonEnchereTranchesBaremeNETCPeer::BORNEINF, $this->borneinf);
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::BORNESUP)) $criteria->add(CommonEnchereTranchesBaremeNETCPeer::BORNESUP, $this->bornesup);
        if ($this->isColumnModified(CommonEnchereTranchesBaremeNETCPeer::NOTE)) $criteria->add(CommonEnchereTranchesBaremeNETCPeer::NOTE, $this->note);
    ...
    {
        $criteria = new Criteria(CommonEnchereTranchesBaremeNETCPeer::DATABASE_NAME);
        $criteria->add(CommonEnchereTranchesBaremeNETCPeer::ID, $this->id);
        $criteria->add(CommonEnchereTranchesBaremeNETCPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonEnchereTranchesBaremeNETC (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonEnchereTranchesBaremeNETC Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonEnchereTranchesBaremeNETCPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonEnchereTranchesBaremeNETCPeer();
        }
    ...
    public function setCommonEncherePmiRelatedByIdenchereOrganisme(CommonEncherePmi $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme($this);
        }
    ...
    public function getCommonEncherePmiRelatedByIdenchereOrganisme(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEncherePmiRelatedByIdenchereOrganisme === null && ($this->idenchere !== null && ($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonEncherePmiRelatedByIdenchereOrganisme->addCommonEnchereTranchesBaremeNETCsRelatedByIdenchereOrganisme($this);
             */
        }
    ...
    public function setCommonEncherePmiRelatedByIdenchere(CommonEncherePmi $v = null)
    {
        ...
        // If this object has already been added to the CommonEncherePmi object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonEnchereTranchesBaremeNETCRelatedByIdenchere($this);
        }
    ...
    public function getCommonEncherePmiRelatedByIdenchere(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEncherePmiRelatedByIdenchere === null && ($this->idenchere !== null) && $doQuery) {
            $this->aCommonEncherePmiRelatedByIdenchere = CommonEncherePmiQuery::create()
                ->filterByCommonEnchereTranchesBaremeNETCRelatedByIdenchere($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonEncherePmiRelatedByIdenchere->addCommonEnchereTranchesBaremeNETCsRelatedByIdenchere($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonEnchereTranchesBaremeNETCPeer::DEFAULT_STRING_FORMAT);
    }
