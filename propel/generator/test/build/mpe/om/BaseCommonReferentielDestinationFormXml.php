...
/**
 * Base class that represents a row from the 'ReferentielDestinationFormXml' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonReferentielDestinationFormXml extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonReferentielDestinationFormXmlPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonReferentielDestinationFormXmlPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonReferentielDestinationFormXml object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonReferentielDestinationFormXml The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonReferentielDestinationFormXmlPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonReferentielDestinationFormXmlPeer::ORGANISME;
        }
    ...
    public function setDestinataire($v)
    {
        ...
        if ($this->destinataire !== $v) {
            $this->destinataire = $v;
            $this->modifiedColumns[] = CommonReferentielDestinationFormXmlPeer::DESTINATAIRE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->destinataire = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CommonReferentielDestinationFormXmlPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonReferentielDestinationFormXml object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonReferentielDestinationFormXmlPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonReferentielDestinationFormXmlQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonReferentielDestinationFormXmlPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonReferentielDestinationFormXmlPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonReferentielDestinationFormXmlPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonReferentielDestinationFormXmlPeer::DESTINATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`destinataire`';
        }

        $sql = sprintf(
            'INSERT INTO `ReferentielDestinationFormXml` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonReferentielDestinationFormXmlPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonReferentielDestinationFormXmlPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonReferentielDestinationFormXml'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonReferentielDestinationFormXml'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonReferentielDestinationFormXmlPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrganisme(),
            $keys[2] => $this->getDestinataire(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setDestinataire($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonReferentielDestinationFormXmlPeer::ID)) $criteria->add(CommonReferentielDestinationFormXmlPeer::ID, $this->id);
        if ($this->isColumnModified(CommonReferentielDestinationFormXmlPeer::ORGANISME)) $criteria->add(CommonReferentielDestinationFormXmlPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonReferentielDestinationFormXmlPeer::DESTINATAIRE)) $criteria->add(CommonReferentielDestinationFormXmlPeer::DESTINATAIRE, $this->destinataire);
    ...
    {
        $criteria = new Criteria(CommonReferentielDestinationFormXmlPeer::DATABASE_NAME);
        $criteria->add(CommonReferentielDestinationFormXmlPeer::ID, $this->id);
        $criteria->add(CommonReferentielDestinationFormXmlPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonReferentielDestinationFormXml (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonReferentielDestinationFormXml Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonReferentielDestinationFormXmlPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonReferentielDestinationFormXmlPeer();
        }
     ...
     * If this CommonReferentielDestinationFormXml is new, it will return
        ...
        if (null === $this->collCommonAnnonceMoniteurs || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonAnnonceMoniteurs) {
                ...
                $collCommonAnnonceMoniteurs = CommonAnnonceMoniteurQuery::create(null, $criteria)
                    ->filterByCommonReferentielDestinationFormXml($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCommonAnnonceMoniteurs(PropelCollection $commonAnnonceMoniteurs, PropelPDO $con = null)
    {
        ...
        foreach ($commonAnnonceMoniteursToDelete as $commonAnnonceMoniteurRemoved) {
            $commonAnnonceMoniteurRemoved->setCommonReferentielDestinationFormXml(null);
        }
    ...
    protected function doAddCommonAnnonceMoniteur($commonAnnonceMoniteur)
    {
        ...
        $commonAnnonceMoniteur->setCommonReferentielDestinationFormXml($this);
    }
    ...
    public function removeCommonAnnonceMoniteur($commonAnnonceMoniteur)
    {
        if ($this->getCommonAnnonceMoniteurs()->contains($commonAnnonceMoniteur)) {
            ...
            $commonAnnonceMoniteur->setCommonReferentielDestinationFormXml(null);
        }
     ...
     * Otherwise if this CommonReferentielDestinationFormXml is new, it will return
     * an empty collection; or if this CommonReferentielDestinationFormXml has previously
     * been saved, it will retrieve related CommonAnnonceMoniteurs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonReferentielDestinationFormXml.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CommonAnnonceMoniteur[] List of CommonAnnonceMoniteur objects
     */
    public function getCommonAnnonceMoniteursJoinCommonReferentielFormXml($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommonAnnonceMoniteurQuery::create(null, $criteria);
        $query->joinWith('CommonReferentielFormXml', $join_behavior);
    ...
    {
        return (string) $this->exportTo(CommonReferentielDestinationFormXmlPeer::DEFAULT_STRING_FORMAT);
    }
