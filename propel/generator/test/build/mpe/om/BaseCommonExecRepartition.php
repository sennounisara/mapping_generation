...
abstract class BaseCommonExecRepartition extends BaseObject implements Persistent
{
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonEntreprise !== null && $this->id_entreprise_crea !== $this->aCommonEntreprise->getId()) {
            $this->aCommonEntreprise = null;
        }
    ...
    public function setCommonAgentRelatedByIdAgentCrea(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonExecRepartitionRelatedByIdAgentCrea($this);
        }
    ...
    public function getCommonAgentRelatedByIdAgentCrea(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgentRelatedByIdAgentCrea === null && ($this->id_agent_crea !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgentRelatedByIdAgentCrea->addCommonExecRepartitionsRelatedByIdAgentCrea($this);
             */
        }
    ...
    public function setCommonAgentRelatedByIdAgentModif(CommonAgent $v = null)
    {
        ...
        // If this object has already been added to the CommonAgent object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonExecRepartitionRelatedByIdAgentModif($this);
        }
    ...
    public function getCommonAgentRelatedByIdAgentModif(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgentRelatedByIdAgentModif === null && ($this->id_agent_modif !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonAgentRelatedByIdAgentModif->addCommonExecRepartitionsRelatedByIdAgentModif($this);
             */
        }
    ...
    {
        if ($this->aCommonEntreprise === null && ($this->id_entreprise_crea !== null) && $doQuery) {
            $this->aCommonEntreprise = CommonEntrepriseQuery::create()->findPk($this->id_entreprise_crea, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonEntreprise->addCommonExecRepartitions($this);
             */
        }
