...
abstract class BaseRegionPeer
{
    ...
    const ID_PAYS = 'region.ID_PAYS';

    /** the column name for the NOM_REGION_AR field */
    const NOM_REGION_AR = 'region.NOM_REGION_AR';

    /** the column name for the NOM_REGION_FR field */
    const NOM_REGION_FR = 'region.NOM_REGION_FR';

    /** the column name for the ID_ENTITE field */
    const ID_ENTITE = 'region.ID_ENTITE';

    /** the column name for the ID_EXTERNE field */
    const ID_EXTERNE = 'region.ID_EXTERNE';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'IdPays', 'NomRegionAr', 'NomRegionFr', 'IdEntite', 'IdExterne', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idPays', 'nomRegionAr', 'nomRegionFr', 'idEntite', 'idExterne', ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID, RegionPeer::ID_PAYS, RegionPeer::NOM_REGION_AR, RegionPeer::NOM_REGION_FR, RegionPeer::ID_ENTITE, RegionPeer::ID_EXTERNE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ID_PAYS', 'NOM_REGION_AR', 'NOM_REGION_FR', 'ID_ENTITE', 'ID_EXTERNE', ),
        BasePeer::TYPE_FIELDNAME => array ('ID', 'ID_PAYS', 'NOM_REGION_AR', 'NOM_REGION_FR', 'ID_ENTITE', 'ID_EXTERNE', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdPays' => 1, 'NomRegionAr' => 2, 'NomRegionFr' => 3, 'IdEntite' => 4, 'IdExterne' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idPays' => 1, 'nomRegionAr' => 2, 'nomRegionFr' => 3, 'idEntite' => 4, 'idExterne' => 5, ),
        BasePeer::TYPE_COLNAME => array (RegionPeer::ID => 0, RegionPeer::ID_PAYS => 1, RegionPeer::NOM_REGION_AR => 2, RegionPeer::NOM_REGION_FR => 3, RegionPeer::ID_ENTITE => 4, RegionPeer::ID_EXTERNE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ID_PAYS' => 1, 'NOM_REGION_AR' => 2, 'NOM_REGION_FR' => 3, 'ID_ENTITE' => 4, 'ID_EXTERNE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'ID_PAYS' => 1, 'NOM_REGION_AR' => 2, 'NOM_REGION_FR' => 3, 'ID_ENTITE' => 4, 'ID_EXTERNE' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RegionPeer::ID_PAYS);
            $criteria->addSelectColumn(RegionPeer::NOM_REGION_AR);
            $criteria->addSelectColumn(RegionPeer::NOM_REGION_FR);
            $criteria->addSelectColumn(RegionPeer::ID_ENTITE);
            $criteria->addSelectColumn(RegionPeer::ID_EXTERNE);
        } else {
