...
abstract class BaseCommonPassationMarcheAVenirPeer
{
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonPassationConsultation table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonPassationConsultation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonPassationMarcheAVenirPeer::ID_PASSATION_CONSULTATION, CommonPassationConsultationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonPassationMarcheAVenir objects pre-filled with their CommonPassationConsultation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonPassationMarcheAVenir objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonPassationConsultation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        CommonPassationMarcheAVenirPeer::addSelectColumns($criteria);
        $startcol = CommonPassationMarcheAVenirPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonPassationMarcheAVenirPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonPassationMarcheAVenirPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonPassationMarcheAVenirPeer::addInstanceToPool($obj1, $key1);
            } // if $obj1 already loaded

            $key2 = CommonPassationConsultationPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CommonPassationConsultationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    CommonPassationConsultationPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (CommonPassationMarcheAVenir) to $obj2 (CommonPassationConsultation)
                $obj2->addCommonPassationMarcheAVenir($obj1);
    ...
    /**
     * Selects a collection of CommonPassationMarcheAVenir objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonPassationMarcheAVenirPeer::addSelectColumns($criteria);
        $startcol2 = CommonPassationMarcheAVenirPeer::NUM_HYDRATE_COLUMNS;

        CommonPassationConsultationPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonPassationConsultationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined CommonPassationConsultation rows

            $key2 = CommonPassationConsultationPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = CommonPassationConsultationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (CommonPassationMarcheAVenir) to the collection in $obj2 (CommonPassationConsultation)
                $obj2->addCommonPassationMarcheAVenir($obj1);
