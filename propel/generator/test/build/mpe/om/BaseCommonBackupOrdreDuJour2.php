...
/**
 * Base class that represents a row from the 'backup_Ordre_Du_Jour_2' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonBackupOrdreDuJour2 extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonBackupOrdreDuJour2Peer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonBackupOrdreDuJour2Peer
     */
    ...
    /**
     * Initializes internal state of BaseCommonBackupOrdreDuJour2 object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonBackupOrdreDuJour2 The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ORGANISME;
        }
    ...
    public function setIdSeance($v)
    {
        ...
        if ($this->id_seance !== $v) {
            $this->id_seance = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ID_SEANCE;
        }
    ...
    public function setRefConsultation($v)
    {
        ...
        if ($this->ref_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::REF_CONSULTATION;
        }
    ...
    public function setRefLibre($v)
    {
        ...
        if ($this->ref_libre !== $v) {
            $this->ref_libre = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::REF_LIBRE;
        }
    ...
    public function setIdEtape($v)
    {
        ...
        if ($this->id_etape !== $v) {
            $this->id_etape = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ID_ETAPE;
        }
    ...
    public function setIntituleOrdreDuJour($v)
    {
        ...
        if ($this->intitule_ordre_du_jour !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::INTITULE_ORDRE_DU_JOUR;
        }
    ...
    public function setLotsOdjLibre($v)
    {
        ...
        if ($this->lots_odj_libre !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::LOTS_ODJ_LIBRE;
        }
    ...
    public function setIdTypeProcedure($v)
    {
        ...
        if ($this->id_type_procedure !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ID_TYPE_PROCEDURE;
        }
    ...
    public function setTypeProcedureLibre($v)
    {
        ...
        if ($this->type_procedure_libre !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::TYPE_PROCEDURE_LIBRE;
        }
    ...
    public function setDateCloture($v)
    {
        ...
        if ($this->date_cloture !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::DATE_CLOTURE;
            }
    ...
    public function setTypeEnv($v)
    {
        ...
        if ($this->type_env !== $v) {
            $this->type_env = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::TYPE_ENV;
        }
    ...
    public function setSousPli($v)
    {
        ...
        if ($this->sous_pli !== $v) {
            $this->sous_pli = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::SOUS_PLI;
        }
    ...
    public function setHeure($v)
    {
        ...
        if ($this->heure !== $v) {
            $this->heure = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::HEURE;
        }
    ...
    public function setEtapeConsultation($v)
    {
        ...
        if ($this->etape_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ETAPE_CONSULTATION;
        }
    ...
    public function setTypeConsultation($v)
    {
        ...
        if ($this->type_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::TYPE_CONSULTATION;
        }
    ...
    public function setMinutes($v)
    {
        ...
        if ($this->minutes !== $v) {
            $this->minutes = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::MINUTES;
        }
    ...
    public function setService($v)
    {
        ...
        if ($this->service !== $v) {
            $this->service = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::SERVICE;
        }
    ...
    public function setIdService($v)
    {
        ...
        if ($this->id_service !== $v) {
            $this->id_service = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::ID_SERVICE;
        }
    ...
    public function setDateDebut($v)
    {
        ...
        if ($this->date_debut !== $v) {
            $this->date_debut = $v;
            $this->modifiedColumns[] = CommonBackupOrdreDuJour2Peer::DATE_DEBUT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_seance = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 20; // 20 = CommonBackupOrdreDuJour2Peer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonBackupOrdreDuJour2 object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonBackupOrdreDuJour2Peer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonBackupOrdreDuJour2Query::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonBackupOrdreDuJour2Peer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_SEANCE)) {
            $modifiedColumns[':p' . $index++]  = '`id_seance`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::REF_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`ref_consultation`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::REF_LIBRE)) {
            $modifiedColumns[':p' . $index++]  = '`ref_libre`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_ETAPE)) {
            $modifiedColumns[':p' . $index++]  = '`id_etape`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::INTITULE_ORDRE_DU_JOUR)) {
            $modifiedColumns[':p' . $index++]  = '`intitule_ordre_du_jour`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::LOTS_ODJ_LIBRE)) {
            $modifiedColumns[':p' . $index++]  = '`lots_odj_libre`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_TYPE_PROCEDURE)) {
            $modifiedColumns[':p' . $index++]  = '`id_type_procedure`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::TYPE_PROCEDURE_LIBRE)) {
            $modifiedColumns[':p' . $index++]  = '`type_procedure_libre`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::DATE_CLOTURE)) {
            $modifiedColumns[':p' . $index++]  = '`date_cloture`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::TYPE_ENV)) {
            $modifiedColumns[':p' . $index++]  = '`type_env`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::SOUS_PLI)) {
            $modifiedColumns[':p' . $index++]  = '`sous_pli`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::HEURE)) {
            $modifiedColumns[':p' . $index++]  = '`heure`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ETAPE_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`etape_consultation`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::TYPE_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`type_consultation`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::MINUTES)) {
            $modifiedColumns[':p' . $index++]  = '`minutes`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::SERVICE)) {
            $modifiedColumns[':p' . $index++]  = '`service`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_SERVICE)) {
            $modifiedColumns[':p' . $index++]  = '`id_service`';
        }
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::DATE_DEBUT)) {
            $modifiedColumns[':p' . $index++]  = '`date_debut`';
        }

        $sql = sprintf(
            'INSERT INTO `backup_Ordre_Du_Jour_2` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonBackupOrdreDuJour2Peer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonBackupOrdreDuJour2Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonBackupOrdreDuJour2'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonBackupOrdreDuJour2'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonBackupOrdreDuJour2Peer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID)) $criteria->add(CommonBackupOrdreDuJour2Peer::ID, $this->id);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ORGANISME)) $criteria->add(CommonBackupOrdreDuJour2Peer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_SEANCE)) $criteria->add(CommonBackupOrdreDuJour2Peer::ID_SEANCE, $this->id_seance);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::REF_CONSULTATION)) $criteria->add(CommonBackupOrdreDuJour2Peer::REF_CONSULTATION, $this->ref_consultation);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::REF_LIBRE)) $criteria->add(CommonBackupOrdreDuJour2Peer::REF_LIBRE, $this->ref_libre);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_ETAPE)) $criteria->add(CommonBackupOrdreDuJour2Peer::ID_ETAPE, $this->id_etape);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::INTITULE_ORDRE_DU_JOUR)) $criteria->add(CommonBackupOrdreDuJour2Peer::INTITULE_ORDRE_DU_JOUR, $this->intitule_ordre_du_jour);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::LOTS_ODJ_LIBRE)) $criteria->add(CommonBackupOrdreDuJour2Peer::LOTS_ODJ_LIBRE, $this->lots_odj_libre);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_TYPE_PROCEDURE)) $criteria->add(CommonBackupOrdreDuJour2Peer::ID_TYPE_PROCEDURE, $this->id_type_procedure);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::TYPE_PROCEDURE_LIBRE)) $criteria->add(CommonBackupOrdreDuJour2Peer::TYPE_PROCEDURE_LIBRE, $this->type_procedure_libre);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::DATE_CLOTURE)) $criteria->add(CommonBackupOrdreDuJour2Peer::DATE_CLOTURE, $this->date_cloture);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::TYPE_ENV)) $criteria->add(CommonBackupOrdreDuJour2Peer::TYPE_ENV, $this->type_env);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::SOUS_PLI)) $criteria->add(CommonBackupOrdreDuJour2Peer::SOUS_PLI, $this->sous_pli);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::HEURE)) $criteria->add(CommonBackupOrdreDuJour2Peer::HEURE, $this->heure);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ETAPE_CONSULTATION)) $criteria->add(CommonBackupOrdreDuJour2Peer::ETAPE_CONSULTATION, $this->etape_consultation);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::TYPE_CONSULTATION)) $criteria->add(CommonBackupOrdreDuJour2Peer::TYPE_CONSULTATION, $this->type_consultation);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::MINUTES)) $criteria->add(CommonBackupOrdreDuJour2Peer::MINUTES, $this->minutes);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::SERVICE)) $criteria->add(CommonBackupOrdreDuJour2Peer::SERVICE, $this->service);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::ID_SERVICE)) $criteria->add(CommonBackupOrdreDuJour2Peer::ID_SERVICE, $this->id_service);
        if ($this->isColumnModified(CommonBackupOrdreDuJour2Peer::DATE_DEBUT)) $criteria->add(CommonBackupOrdreDuJour2Peer::DATE_DEBUT, $this->date_debut);
    ...
    {
        $criteria = new Criteria(CommonBackupOrdreDuJour2Peer::DATABASE_NAME);
        $criteria->add(CommonBackupOrdreDuJour2Peer::ID, $this->id);
        $criteria->add(CommonBackupOrdreDuJour2Peer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonBackupOrdreDuJour2 (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonBackupOrdreDuJour2 Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonBackupOrdreDuJour2Peer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonBackupOrdreDuJour2Peer();
        }
    ...
    {
        return (string) $this->exportTo(CommonBackupOrdreDuJour2Peer::DEFAULT_STRING_FORMAT);
    }
