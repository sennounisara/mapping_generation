 ...
 *
 * @method CommonMarcheQuery leftJoinCommonCategorieConsultation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonCategorieConsultation relation
 * @method CommonMarcheQuery rightJoinCommonCategorieConsultation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonCategorieConsultation relation
 * @method CommonMarcheQuery innerJoinCommonCategorieConsultation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonCategorieConsultation relation
 *
...
abstract class BaseCommonMarcheQuery extends ModelCriteria
{
    ...
    public function filterByCommonCategorieConsultation($commonCategorieConsultation, $comparison = null)
    {
        if ($commonCategorieConsultation instanceof CommonCategorieConsultation) {
            return $this
                ->addUsingAlias(CommonMarchePeer::NATUREMARCHE, $commonCategorieConsultation->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonMarchePeer::NATUREMARCHE, $commonCategorieConsultation->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @return CommonMarcheQuery The current query, for fluid interface
     */
    public function joinCommonCategorieConsultation($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     */
    public function useCommonCategorieConsultationQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
