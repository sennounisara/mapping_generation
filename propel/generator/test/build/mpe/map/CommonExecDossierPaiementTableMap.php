...
class CommonExecDossierPaiementTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonExecDossierPaiementTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_agent_creat', 'IdAgentCreat', 'INTEGER', 'Agent', 'id', false, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CommonAgent', 'CommonAgent', RelationMap::MANY_TO_ONE, array('id_agent_creat' => 'id', ), null, null);
