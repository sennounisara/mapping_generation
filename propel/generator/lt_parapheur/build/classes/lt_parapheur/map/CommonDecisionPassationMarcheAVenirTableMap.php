...
/**
 * This class defines the structure of the 'DecisionPassationMarcheAVenir' table.
 *
 *
 *
 ...
 */
class CommonDecisionPassationMarcheAVenirTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonDecisionPassationMarcheAVenirTableMap';
    ...
    {
        // attributes
        $this->setName('DecisionPassationMarcheAVenir');
        $this->setPhpName('CommonDecisionPassationMarcheAVenir');
        $this->setClassname('CommonDecisionPassationMarcheAVenir');
...
} // CommonDecisionPassationMarcheAVenirTableMap
