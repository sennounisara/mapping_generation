...
abstract class BaseRegion extends BaseObject implements Persistent
{
    ...
    public function setIdPays($v)
    {
        ...
        if ($this->id_pays !== $v) {
            $this->id_pays = $v;
            $this->modifiedColumns[] = RegionPeer::ID_PAYS;
        }
    ...
    public function setNomRegionAr($v)
    {
        ...
        if ($this->nom_region_ar !== $v) {
            ...
            $this->modifiedColumns[] = RegionPeer::NOM_REGION_AR;
        }
    ...
    public function setNomRegionFr($v)
    {
        ...
        if ($this->nom_region_fr !== $v) {
            ...
            $this->modifiedColumns[] = RegionPeer::NOM_REGION_FR;
        }
    ...
    public function setIdEntite($v)
    {
        ...
        if ($this->id_entite !== $v) {
            $this->id_entite = $v;
            $this->modifiedColumns[] = RegionPeer::ID_ENTITE;
        }
    ...
    public function setIdExterne($v)
    {
        ...
        if ($this->id_externe !== $v) {
            $this->id_externe = $v;
            $this->modifiedColumns[] = RegionPeer::ID_EXTERNE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nom_region_ar = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->nom_region_fr = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RegionPeer::ID_PAYS)) {
            $modifiedColumns[':p' . $index++]  = '`ID_PAYS`';
        }
        if ($this->isColumnModified(RegionPeer::NOM_REGION_AR)) {
            $modifiedColumns[':p' . $index++]  = '`NOM_REGION_AR`';
        }
        if ($this->isColumnModified(RegionPeer::NOM_REGION_FR)) {
            $modifiedColumns[':p' . $index++]  = '`NOM_REGION_FR`';
        }
        if ($this->isColumnModified(RegionPeer::ID_ENTITE)) {
            $modifiedColumns[':p' . $index++]  = '`ID_ENTITE`';
        }
        if ($this->isColumnModified(RegionPeer::ID_EXTERNE)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getNomRegionAr(),
            $keys[3] => $this->getNomRegionFr(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setNomRegionAr($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setNomRegionFr($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionPeer::ID_PAYS)) $criteria->add(RegionPeer::ID_PAYS, $this->id_pays);
        if ($this->isColumnModified(RegionPeer::NOM_REGION_AR)) $criteria->add(RegionPeer::NOM_REGION_AR, $this->nom_region_ar);
        if ($this->isColumnModified(RegionPeer::NOM_REGION_FR)) $criteria->add(RegionPeer::NOM_REGION_FR, $this->nom_region_fr);
        if ($this->isColumnModified(RegionPeer::ID_ENTITE)) $criteria->add(RegionPeer::ID_ENTITE, $this->id_entite);
        if ($this->isColumnModified(RegionPeer::ID_EXTERNE)) $criteria->add(RegionPeer::ID_EXTERNE, $this->id_externe);
