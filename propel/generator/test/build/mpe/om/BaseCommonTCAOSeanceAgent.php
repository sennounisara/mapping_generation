...
abstract class BaseCommonTCAOSeanceAgent extends BaseObject implements Persistent
{
    ...
    public function setCommonAgent(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonTCAOSeanceAgent($this);
        }
    ...
    public function getCommonAgent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgent === null && ($this->id_agent !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgent->addCommonTCAOSeanceAgents($this);
             */
        }
    ...
    public function getCommonTCAOSeance(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonTCAOSeance === null && (($this->id_seance !== "" && $this->id_seance !== null)) && $doQuery) {
            $this->aCommonTCAOSeance = CommonTCAOSeanceQuery::create()
                ->filterByCommonTCAOSeanceAgent($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonTCAOSeance->addCommonTCAOSeanceAgents($this);
             */
        }
