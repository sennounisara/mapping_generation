...
/**
 * This class defines the structure of the 'TypeAvenant' table.
 *
 *
 *
 ...
 */
class CommonTypeAvenantTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonTypeAvenantTableMap';
    ...
    {
        // attributes
        $this->setName('TypeAvenant');
        $this->setPhpName('CommonTypeAvenant');
        $this->setClassname('CommonTypeAvenant');
