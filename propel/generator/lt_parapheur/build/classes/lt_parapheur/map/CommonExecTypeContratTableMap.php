...
class CommonExecTypeContratTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonExecTypeContratTableMap';
    ...
    {
        $this->addRelation('CommonExecConfigurationFormulaireRelatedByIdTypeContrat', 'CommonExecConfigurationFormulaire', RelationMap::ONE_TO_MANY, array('id' => 'id_type_contrat', ), null, null, 'CommonExecConfigurationFormulairesRelatedByIdTypeContrat');
        $this->addRelation('CommonExecConfigurationFormulaireRelatedByIdTypeContrat', 'CommonExecConfigurationFormulaire', RelationMap::ONE_TO_MANY, array('id' => 'id_type_contrat', ), null, null, 'CommonExecConfigurationFormulairesRelatedByIdTypeContrat');
        $this->addRelation('CommonExecConfigurationFormulaireRelatedByIdTypeContrat', 'CommonExecConfigurationFormulaire', RelationMap::ONE_TO_MANY, array('id' => 'id_type_contrat', ), null, null, 'CommonExecConfigurationFormulairesRelatedByIdTypeContrat');
