...
abstract class BaseCommonReponseInscritItemFormulaireConsultationValuesPeer
{
    ...
    public static function doCountJoinCommonItemFormulaireConsultation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonReponseInscritItemFormulaireConsultationValuesPeer::IDITEMFORMULAIRECONSULTATION, CommonItemFormulaireConsultationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonReponseInscritItemFormulaireConsultationValues objects pre-filled with their CommonItemFormulaireConsultation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonReponseInscritItemFormulaireConsultationValues objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonItemFormulaireConsultation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonReponseInscritItemFormulaireConsultationValuesPeer::addSelectColumns($criteria);
        $startcol = CommonReponseInscritItemFormulaireConsultationValuesPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonReponseInscritItemFormulaireConsultationValuesPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonReponseInscritItemFormulaireConsultationValuesPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonReponseInscritItemFormulaireConsultationValuesPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonReponseInscritItemFormulaireConsultationValues) to $obj2 (CommonItemFormulaireConsultation)
                $obj2->addCommonReponseInscritItemFormulaireConsultationValues($obj1);
    ...
    /**
     * Selects a collection of CommonReponseInscritItemFormulaireConsultationValues objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonReponseInscritItemFormulaireConsultationValuesPeer::addSelectColumns($criteria);
        $startcol2 = CommonReponseInscritItemFormulaireConsultationValuesPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonReponseInscritItemFormulaireConsultationValues) to the collection in $obj2 (CommonItemFormulaireConsultation)
                $obj2->addCommonReponseInscritItemFormulaireConsultationValues($obj1);
