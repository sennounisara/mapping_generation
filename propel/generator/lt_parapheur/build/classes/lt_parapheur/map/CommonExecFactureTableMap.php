...
class CommonExecFactureTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonExecFactureTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('id_entreprise_crea', 'IdEntrepriseCrea', 'INTEGER', false, null, null);
        ...
        $this->addColumn('id_entreprise_modif', 'IdEntrepriseModif', 'INTEGER', false, null, null);
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CommonExecReception', 'CommonExecReception', RelationMap::ONE_TO_MANY, array('id' => 'id_facture', ), null, null, 'CommonExecReceptions');
