...
/**
 * Base class that represents a row from the 'EnchereValeursInitiales' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonEnchereValeursInitiales extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonEnchereValeursInitialesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonEnchereValeursInitialesPeer
     */
     ...
     */
    protected $aCommonEnchereReference;
    ...
    /**
     * Initializes internal state of BaseCommonEnchereValeursInitiales object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonEnchereValeursInitiales The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonEnchereValeursInitialesPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonEnchereValeursInitialesPeer::ORGANISME;
        }
        ...
        if ($this->aCommonEnchereReference !== null && $this->aCommonEnchereReference->getOrganisme() !== $v) {
            $this->aCommonEnchereReference = null;
        }
    ...
    public function setIdenchereentreprise($v)
    {
        ...
        if ($this->idenchereentreprise !== $v) {
            ...
            $this->modifiedColumns[] = CommonEnchereValeursInitialesPeer::IDENCHEREENTREPRISE;
        }
    ...
    public function setIdencherereference($v)
    {
        ...
        if ($this->idencherereference !== $v) {
            ...
            $this->modifiedColumns[] = CommonEnchereValeursInitialesPeer::IDENCHEREREFERENCE;
        }

        if ($this->aCommonEnchereReference !== null && $this->aCommonEnchereReference->getId() !== $v) {
            $this->aCommonEnchereReference = null;
        }
    ...
    public function setValeur($v)
    {
        ...
        if ($this->valeur !== $v) {
            $this->valeur = $v;
            $this->modifiedColumns[] = CommonEnchereValeursInitialesPeer::VALEUR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idenchereentreprise = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = CommonEnchereValeursInitialesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonEnchereValeursInitiales object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonEnchereReference !== null && $this->organisme !== $this->aCommonEnchereReference->getOrganisme()) {
            $this->aCommonEnchereReference = null;
        }
        if ($this->aCommonEnchereEntreprisePmi !== null && $this->idenchereentreprise !== $this->aCommonEnchereEntreprisePmi->getId()) {
            $this->aCommonEnchereEntreprisePmi = null;
        }
        if ($this->aCommonEnchereReference !== null && $this->idencherereference !== $this->aCommonEnchereReference->getId()) {
            $this->aCommonEnchereReference = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonEnchereValeursInitialesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonEnchereValeursInitialesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonEnchereValeursInitialesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonEnchereReference !== null) {
                if ($this->aCommonEnchereReference->isModified() || $this->aCommonEnchereReference->isNew()) {
                    $affectedRows += $this->aCommonEnchereReference->save($con);
                }
                $this->setCommonEnchereReference($this->aCommonEnchereReference);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::IDENCHEREENTREPRISE)) {
            $modifiedColumns[':p' . $index++]  = '`idEnchereEntreprise`';
        }
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::IDENCHEREREFERENCE)) {
            $modifiedColumns[':p' . $index++]  = '`idEnchereReference`';
        }
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::VALEUR)) {
            $modifiedColumns[':p' . $index++]  = '`valeur`';
        }

        $sql = sprintf(
            'INSERT INTO `EnchereValeursInitiales` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonEnchereReference !== null) {
                if (!$this->aCommonEnchereReference->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonEnchereReference->getValidationFailures());
                }
            }


            if (($retval = CommonEnchereValeursInitialesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonEnchereValeursInitialesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonEnchereValeursInitiales'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonEnchereValeursInitiales'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonEnchereValeursInitialesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getOrganisme(),
            $keys[2] => $this->getIdenchereentreprise(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aCommonEnchereReference) {
                $result['CommonEnchereReference'] = $this->aCommonEnchereReference->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIdenchereentreprise($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::ID)) $criteria->add(CommonEnchereValeursInitialesPeer::ID, $this->id);
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::ORGANISME)) $criteria->add(CommonEnchereValeursInitialesPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::IDENCHEREENTREPRISE)) $criteria->add(CommonEnchereValeursInitialesPeer::IDENCHEREENTREPRISE, $this->idenchereentreprise);
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::IDENCHEREREFERENCE)) $criteria->add(CommonEnchereValeursInitialesPeer::IDENCHEREREFERENCE, $this->idencherereference);
        if ($this->isColumnModified(CommonEnchereValeursInitialesPeer::VALEUR)) $criteria->add(CommonEnchereValeursInitialesPeer::VALEUR, $this->valeur);
    ...
    {
        $criteria = new Criteria(CommonEnchereValeursInitialesPeer::DATABASE_NAME);
        $criteria->add(CommonEnchereValeursInitialesPeer::ID, $this->id);
        $criteria->add(CommonEnchereValeursInitialesPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonEnchereValeursInitiales (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonEnchereValeursInitiales Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonEnchereValeursInitialesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonEnchereValeursInitialesPeer();
        }
    ...
    public function setCommonEnchereEntreprisePmi(CommonEnchereEntreprisePmi $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonEnchereValeursInitiales($this);
        }
    ...
    public function getCommonEnchereEntreprisePmi(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEnchereEntreprisePmi === null && ($this->idenchereentreprise !== null && ($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonEnchereEntreprisePmi->addCommonEnchereValeursInitialess($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setCommonEnchereReference(CommonEnchereReference $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getCommonEnchereReference(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEnchereReference === null && ($this->idencherereference !== null && ($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            $this->aCommonEnchereReference = CommonEnchereReferenceQuery::create()->findPk(array($this->idencherereference, $this->organisme), $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonEnchereReference->addCommonEnchereValeursInitialess($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonEnchereReference instanceof Persistent) {
              $this->aCommonEnchereReference->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(CommonEnchereValeursInitialesPeer::DEFAULT_STRING_FORMAT);
    }
