...
abstract class BaseCommonRPA extends BaseObject implements Persistent
{
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonOrganisme !== null && $this->acronymeorg !== $this->aCommonOrganisme->getAcronyme()) {
            $this->aCommonOrganisme = null;
        }
    } // ensureConsistency
    ...
    {
        if ($v === null) {
            $this->setAcronymeorg(NULL);
        } else {
            $this->setAcronymeorg($v->getAcronyme());
        }
    ...
    {
        if ($this->aCommonOrganisme === null && (($this->acronymeorg !== "" && $this->acronymeorg !== null)) && $doQuery) {
            $this->aCommonOrganisme = CommonOrganismeQuery::create()
                ->filterByCommonRPA($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonOrganisme->addCommonRPAs($this);
             */
        }
