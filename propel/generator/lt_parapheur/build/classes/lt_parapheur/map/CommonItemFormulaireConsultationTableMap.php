...
class CommonItemFormulaireConsultationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonItemFormulaireConsultationTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('idFormulaireConsultation', 'Idformulaireconsultation', 'INTEGER', true, null, null);
