...
class CommonEchangeDestinataireTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonEchangeDestinataireTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_echange', 'IdEchange', 'INTEGER', 'Echange', 'id', true, null, 0);
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonEchange', 'CommonEchange', RelationMap::MANY_TO_ONE, array('id_echange' => 'id', ), 'CASCADE', null);
    } // buildRelations()
