...
/**
 * Base class that represents a row from the 't_CAO_Commission_Intervenant_Externe' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonTCAOCommissionIntervenantExterne extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonTCAOCommissionIntervenantExternePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonTCAOCommissionIntervenantExternePeer
     */
    ...
    /**
     * The value for the id_commission_intervenant_externe field.
     * @var        string
     */
    protected $id_commission_intervenant_externe;
    ...
    /**
     * Get the [id_commission_intervenant_externe] column value.
     * 
     * @return string
     */
    public function getIdCommissionIntervenantExterne()
    {

        return $this->id_commission_intervenant_externe;
    }
    ...
    /**
     * Set the value of [id_commission_intervenant_externe] column.
     * 
     * @param string $v new value
     * @return CommonTCAOCommissionIntervenantExterne The current object (for fluent API support)
     */
    public function setIdCommissionIntervenantExterne($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->id_commission_intervenant_externe !== $v) {
            $this->id_commission_intervenant_externe = $v;
            $this->modifiedColumns[] = CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION_INTERVENANT_EXTERNE;
        }


        return $this;
    } // setIdCommissionIntervenantExterne()
    ...
    public function setIdIntervenantExterne($v)
    {
        ...
        if ($this->id_intervenant_externe !== $v) {
            ...
            $this->modifiedColumns[] = CommonTCAOCommissionIntervenantExternePeer::ID_INTERVENANT_EXTERNE;
        }
    ...
    public function setIdCommission($v)
    {
        ...
        if ($this->id_commission !== $v) {
            ...
            $this->modifiedColumns[] = CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonTCAOCommissionIntervenantExternePeer::ORGANISME;
        }
    ...
    public function setIdRefValTypeVoixDefaut($v)
    {
        ...
        if ($this->id_ref_val_type_voix_defaut !== $v) {
            ...
            $this->modifiedColumns[] = CommonTCAOCommissionIntervenantExternePeer::ID_REF_VAL_TYPE_VOIX_DEFAUT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_commission_intervenant_externe = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
            $this->id_intervenant_externe = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 5; // 5 = CommonTCAOCommissionIntervenantExternePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonTCAOCommissionIntervenantExterne object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonTCAOCommissionIntervenantExternePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonTCAOCommissionIntervenantExterneQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonTCAOCommissionIntervenantExternePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION_INTERVENANT_EXTERNE;
        if (null !== $this->id_commission_intervenant_externe) {
        ...
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION_INTERVENANT_EXTERNE)) {
            $modifiedColumns[':p' . $index++]  = '`id_commission_intervenant_externe`';
        }
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_INTERVENANT_EXTERNE)) {
            $modifiedColumns[':p' . $index++]  = '`id_intervenant_externe`';
        }
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION)) {
            $modifiedColumns[':p' . $index++]  = '`id_commission`';
        }
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_REF_VAL_TYPE_VOIX_DEFAUT)) {
            $modifiedColumns[':p' . $index++]  = '`id_ref_val_type_voix_defaut`';
        }

        $sql = sprintf(
            'INSERT INTO `t_CAO_Commission_Intervenant_Externe` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_commission_intervenant_externe`':						
                        $stmt->bindValue($identifier, $this->id_commission_intervenant_externe, PDO::PARAM_STR);
                        break;
        ...
        $this->setIdCommissionIntervenantExterne($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonTCAOCommissionIntervenantExternePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonTCAOCommissionIntervenantExternePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdCommissionIntervenantExterne();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['CommonTCAOCommissionIntervenantExterne'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonTCAOCommissionIntervenantExterne'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonTCAOCommissionIntervenantExternePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdCommissionIntervenantExterne(),
            $keys[1] => $this->getIdIntervenantExterne(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdCommissionIntervenantExterne($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdCommissionIntervenantExterne($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setIdIntervenantExterne($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION_INTERVENANT_EXTERNE)) $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION_INTERVENANT_EXTERNE, $this->id_commission_intervenant_externe);
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_INTERVENANT_EXTERNE)) $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ID_INTERVENANT_EXTERNE, $this->id_intervenant_externe);
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION)) $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION, $this->id_commission);
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ORGANISME)) $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonTCAOCommissionIntervenantExternePeer::ID_REF_VAL_TYPE_VOIX_DEFAUT)) $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ID_REF_VAL_TYPE_VOIX_DEFAUT, $this->id_ref_val_type_voix_defaut);
    ...
    {
        $criteria = new Criteria(CommonTCAOCommissionIntervenantExternePeer::DATABASE_NAME);
        $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ID_COMMISSION_INTERVENANT_EXTERNE, $this->id_commission_intervenant_externe);
        $criteria->add(CommonTCAOCommissionIntervenantExternePeer::ORGANISME, $this->organisme);
    ...
    {
        $pks = array();
        $pks[0] = $this->getIdCommissionIntervenantExterne();
    ...
    {
        $this->setIdCommissionIntervenantExterne($keys[0]);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdCommissionIntervenantExterne()) && (null === $this->getOrganisme());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonTCAOCommissionIntervenantExterne (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdCommissionIntervenantExterne(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonTCAOCommissionIntervenantExterne Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonTCAOCommissionIntervenantExternePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonTCAOCommissionIntervenantExternePeer();
        }
    ...
    public function setCommonTCAOCommission(CommonTCAOCommission $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonTCAOCommissionIntervenantExterne($this);
        }
    ...
    public function getCommonTCAOCommission(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonTCAOCommission === null && (($this->id_commission !== "" && $this->id_commission !== null)) && $doQuery) {
            $this->aCommonTCAOCommission = CommonTCAOCommissionQuery::create()
                ->filterByCommonTCAOCommissionIntervenantExterne($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonTCAOCommission->addCommonTCAOCommissionIntervenantExternes($this);
             */
        }
    ...
    public function getCommonTCAOIntervenantExterne(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonTCAOIntervenantExterne === null && (($this->id_intervenant_externe !== "" && $this->id_intervenant_externe !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonTCAOIntervenantExterne->addCommonTCAOCommissionIntervenantExternes($this);
             */
        }
    ...
    {
        $this->id_commission_intervenant_externe = null;
    ...
    {
        return (string) $this->exportTo(CommonTCAOCommissionIntervenantExternePeer::DEFAULT_STRING_FORMAT);
    }
