...
class CommonEnveloppeItemCritereEvaluationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonEnveloppeItemCritereEvaluationTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('idEnveloppeCritereEvaluation', 'Idenveloppecritereevaluation', 'INTEGER', 'EnveloppeCritereEvaluation', 'id', true, null, null);
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonEnveloppeCritereEvaluation', 'CommonEnveloppeCritereEvaluation', RelationMap::MANY_TO_ONE, array('idEnveloppeCritereEvaluation' => 'id', ), null, null);
    } // buildRelations()
