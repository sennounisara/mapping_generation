...
/**
 * This class defines the structure of the 'DecisionPassationConsultation' table.
 *
 *
 *
 ...
 */
class CommonDecisionPassationConsultationTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonDecisionPassationConsultationTableMap';
    ...
    {
        // attributes
        $this->setName('DecisionPassationConsultation');
        $this->setPhpName('CommonDecisionPassationConsultation');
        $this->setClassname('CommonDecisionPassationConsultation');
...
} // CommonDecisionPassationConsultationTableMap
