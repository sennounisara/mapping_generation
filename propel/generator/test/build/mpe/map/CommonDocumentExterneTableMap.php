...
class CommonDocumentExterneTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonDocumentExterneTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('idBlob', 'Idblob', 'INTEGER', 'blobOrganisme', 'id', false, null, null);
    ...
    {
        $this->addRelation('CommonBlobOrganisme', 'CommonBlobOrganisme', RelationMap::MANY_TO_ONE, array('idBlob' => 'id', ), 'CASCADE', 'CASCADE');
