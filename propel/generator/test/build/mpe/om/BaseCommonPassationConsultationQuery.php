 ...
 *
 * @method CommonPassationConsultationQuery leftJoinCommonPassationMarcheAVenir($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonPassationMarcheAVenir relation
 * @method CommonPassationConsultationQuery rightJoinCommonPassationMarcheAVenir($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonPassationMarcheAVenir relation
 * @method CommonPassationConsultationQuery innerJoinCommonPassationMarcheAVenir($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonPassationMarcheAVenir relation
 *
...
abstract class BaseCommonPassationConsultationQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related CommonPassationMarcheAVenir object
     *
     * @param   CommonPassationMarcheAVenir|PropelObjectCollection $commonPassationMarcheAVenir  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonPassationConsultationQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonPassationMarcheAVenir($commonPassationMarcheAVenir, $comparison = null)
    {
        if ($commonPassationMarcheAVenir instanceof CommonPassationMarcheAVenir) {
            return $this
                ->addUsingAlias(CommonPassationConsultationPeer::ID, $commonPassationMarcheAVenir->getIdPassationConsultation(), $comparison);
        } elseif ($commonPassationMarcheAVenir instanceof PropelObjectCollection) {
            return $this
                ->useCommonPassationMarcheAVenirQuery()
                ->filterByPrimaryKeys($commonPassationMarcheAVenir->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonPassationMarcheAVenir() only accepts arguments of type CommonPassationMarcheAVenir or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonPassationMarcheAVenir relation
     *
     ...
     * @return CommonPassationConsultationQuery The current query, for fluid interface
     */
    public function joinCommonPassationMarcheAVenir($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonPassationMarcheAVenir');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonPassationMarcheAVenir');
        }
    ...
    /**
     * Use the CommonPassationMarcheAVenir relation CommonPassationMarcheAVenir object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonPassationMarcheAVenirQuery A secondary query class using the current class as primary query
     */
    public function useCommonPassationMarcheAVenirQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonPassationMarcheAVenir($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonPassationMarcheAVenir', 'CommonPassationMarcheAVenirQuery');
    }
