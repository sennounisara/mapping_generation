 ...
 *
 * @method CommonDecisionEnveloppeQuery leftJoinCommonChorusEchange($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonChorusEchange relation
 * @method CommonDecisionEnveloppeQuery rightJoinCommonChorusEchange($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonChorusEchange relation
 * @method CommonDecisionEnveloppeQuery innerJoinCommonChorusEchange($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonChorusEchange relation
 *
...
abstract class BaseCommonDecisionEnveloppeQuery extends ModelCriteria
{
     ...
     *
     * @param   CommonChorusEchange|PropelObjectCollection $commonChorusEchange  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonDecisionEnveloppeQuery The current query, for fluid interface
    ...
    public function filterByCommonChorusEchange($commonChorusEchange, $comparison = null)
    {
        if ($commonChorusEchange instanceof CommonChorusEchange) {
            return $this
                ->addUsingAlias(CommonDecisionEnveloppePeer::ID_DECISION_ENVELOPPE, $commonChorusEchange->getIdDecision(), $comparison)
                ->addUsingAlias(CommonDecisionEnveloppePeer::ORGANISME, $commonChorusEchange->getOrganisme(), $comparison);
        } else {
     ...
     * @return CommonDecisionEnveloppeQuery The current query, for fluid interface
     */
    public function joinCommonChorusEchange($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
     ...
     */
    public function useCommonChorusEchangeQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
