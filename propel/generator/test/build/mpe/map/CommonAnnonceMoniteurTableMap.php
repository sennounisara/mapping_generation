...
class CommonAnnonceMoniteurTableMap extends TableMap
{
  ...
  5 => '5',
        ...
        $this->addForeignKey('id_form_xml', 'IdFormXml', 'INTEGER', 'ReferentielFormXml', 'id', true, null, null);
        $this->addColumn('accuse_reception', 'AccuseReception', 'CHAR', true, null, null);
        $this->addForeignKey('id_destination_form_xml', 'IdDestinationFormXml', 'INTEGER', 'ReferentielDestinationFormXml', 'id', true, null, null);
    ...
    {
        $this->addRelation('CommonReferentielDestinationFormXml', 'CommonReferentielDestinationFormXml', RelationMap::MANY_TO_ONE, array('id_destination_form_xml' => 'id', ), null, null);
        $this->addRelation('CommonReferentielFormXml', 'CommonReferentielFormXml', RelationMap::MANY_TO_ONE, array('id_form_xml' => 'id', ), null, null);
    } // buildRelations()
