...
/**
 * Base class that represents a row from the 'ModeleFormulaire' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonModeleFormulaire extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonModeleFormulairePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonModeleFormulairePeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonModeleFormulaire object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonModeleFormulaire The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::ID;
        }
    ...
    public function setReference($v)
    {
        ...
        if ($this->reference !== $v) {
            $this->reference = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::REFERENCE;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::NOM;
        }
    ...
    public function setTypeFormulaire($v)
    {
        ...
        if ($this->type_formulaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonModeleFormulairePeer::TYPE_FORMULAIRE;
        }
    ...
    public function setIdTypeProcedure($v)
    {
        ...
        if ($this->id_type_procedure !== $v) {
            ...
            $this->modifiedColumns[] = CommonModeleFormulairePeer::ID_TYPE_PROCEDURE;
        }
    ...
    public function setIdCategorie($v)
    {
        ...
        if ($this->id_categorie !== $v) {
            $this->id_categorie = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::ID_CATEGORIE;
        }
    ...
    public function setCodeCpv1($v)
    {
        ...
        if ($this->code_cpv_1 !== $v) {
            $this->code_cpv_1 = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::CODE_CPV_1;
        }
    ...
    public function setCodeCpv2($v)
    {
        ...
        if ($this->code_cpv_2 !== $v) {
            $this->code_cpv_2 = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::CODE_CPV_2;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::ORGANISME;
        }
    ...
    public function setServiceId($v)
    {
        ...
        if ($this->service_id !== $v) {
            $this->service_id = $v;
            $this->modifiedColumns[] = CommonModeleFormulairePeer::SERVICE_ID;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== $v) {
            ...
            $this->modifiedColumns[] = CommonModeleFormulairePeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== $v) {
            ...
            $this->modifiedColumns[] = CommonModeleFormulairePeer::DATE_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = CommonModeleFormulairePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonModeleFormulaire object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonModeleFormulairePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonModeleFormulaireQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonModeleFormulairePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonModeleFormulairePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::REFERENCE)) {
            $modifiedColumns[':p' . $index++]  = '`reference`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::TYPE_FORMULAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`type_formulaire`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::ID_TYPE_PROCEDURE)) {
            $modifiedColumns[':p' . $index++]  = '`id_type_procedure`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::ID_CATEGORIE)) {
            $modifiedColumns[':p' . $index++]  = '`id_categorie`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::CODE_CPV_1)) {
            $modifiedColumns[':p' . $index++]  = '`code_cpv_1`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::CODE_CPV_2)) {
            $modifiedColumns[':p' . $index++]  = '`code_cpv_2`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::SERVICE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`service_id`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(CommonModeleFormulairePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `ModeleFormulaire` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonModeleFormulairePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonModeleFormulairePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonModeleFormulaire'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonModeleFormulaire'][$this->getPrimaryKey()] = true;
        $keys = CommonModeleFormulairePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonModeleFormulairePeer::ID)) $criteria->add(CommonModeleFormulairePeer::ID, $this->id);
        if ($this->isColumnModified(CommonModeleFormulairePeer::REFERENCE)) $criteria->add(CommonModeleFormulairePeer::REFERENCE, $this->reference);
        if ($this->isColumnModified(CommonModeleFormulairePeer::NOM)) $criteria->add(CommonModeleFormulairePeer::NOM, $this->nom);
        if ($this->isColumnModified(CommonModeleFormulairePeer::TYPE_FORMULAIRE)) $criteria->add(CommonModeleFormulairePeer::TYPE_FORMULAIRE, $this->type_formulaire);
        if ($this->isColumnModified(CommonModeleFormulairePeer::ID_TYPE_PROCEDURE)) $criteria->add(CommonModeleFormulairePeer::ID_TYPE_PROCEDURE, $this->id_type_procedure);
        if ($this->isColumnModified(CommonModeleFormulairePeer::ID_CATEGORIE)) $criteria->add(CommonModeleFormulairePeer::ID_CATEGORIE, $this->id_categorie);
        if ($this->isColumnModified(CommonModeleFormulairePeer::CODE_CPV_1)) $criteria->add(CommonModeleFormulairePeer::CODE_CPV_1, $this->code_cpv_1);
        if ($this->isColumnModified(CommonModeleFormulairePeer::CODE_CPV_2)) $criteria->add(CommonModeleFormulairePeer::CODE_CPV_2, $this->code_cpv_2);
        if ($this->isColumnModified(CommonModeleFormulairePeer::ORGANISME)) $criteria->add(CommonModeleFormulairePeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonModeleFormulairePeer::SERVICE_ID)) $criteria->add(CommonModeleFormulairePeer::SERVICE_ID, $this->service_id);
        if ($this->isColumnModified(CommonModeleFormulairePeer::DATE_CREATION)) $criteria->add(CommonModeleFormulairePeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(CommonModeleFormulairePeer::DATE_MODIFICATION)) $criteria->add(CommonModeleFormulairePeer::DATE_MODIFICATION, $this->date_modification);
    ...
    {
        $criteria = new Criteria(CommonModeleFormulairePeer::DATABASE_NAME);
        $criteria->add(CommonModeleFormulairePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonModeleFormulaire (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonModeleFormulaire Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonModeleFormulairePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonModeleFormulairePeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonModeleFormulairePeer::DEFAULT_STRING_FORMAT);
    }
