 ...
 *
 * @method CommonBlobOrganismeQuery leftJoinCommonDocumentExterne($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonDocumentExterne relation
 * @method CommonBlobOrganismeQuery rightJoinCommonDocumentExterne($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonDocumentExterne relation
 * @method CommonBlobOrganismeQuery innerJoinCommonDocumentExterne($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonDocumentExterne relation
 *
...
abstract class BaseCommonBlobOrganismeQuery extends ModelCriteria
{
    ...
    public function filterByCommonDocumentExterne($commonDocumentExterne, $comparison = null)
    {
        if ($commonDocumentExterne instanceof CommonDocumentExterne) {
            return $this
                ->addUsingAlias(CommonBlobOrganismePeer::ID, $commonDocumentExterne->getIdblob(), $comparison);
