 ...
 *
 * @method CommonAnnoncePressPieceJointeQuery leftJoinCommonAnnoncePress($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAnnoncePress relation
 * @method CommonAnnoncePressPieceJointeQuery rightJoinCommonAnnoncePress($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAnnoncePress relation
 * @method CommonAnnoncePressPieceJointeQuery innerJoinCommonAnnoncePress($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAnnoncePress relation
 *
...
abstract class BaseCommonAnnoncePressPieceJointeQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonAnnoncePress()
     *
    ...
    /**
     * Filter the query by a related CommonAnnoncePress object
     *
     * @param   CommonAnnoncePress|PropelObjectCollection $commonAnnoncePress The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonAnnoncePressPieceJointeQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonAnnoncePress($commonAnnoncePress, $comparison = null)
    {
        if ($commonAnnoncePress instanceof CommonAnnoncePress) {
            return $this
                ->addUsingAlias(CommonAnnoncePressPieceJointePeer::ID_ANNONCE_PRESS, $commonAnnoncePress->getId(), $comparison);
        } elseif ($commonAnnoncePress instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonAnnoncePressPieceJointePeer::ID_ANNONCE_PRESS, $commonAnnoncePress->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonAnnoncePress() only accepts arguments of type CommonAnnoncePress or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonAnnoncePress relation
     *
     ...
     * @return CommonAnnoncePressPieceJointeQuery The current query, for fluid interface
     */
    public function joinCommonAnnoncePress($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonAnnoncePress');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonAnnoncePress');
        }
    ...
    /**
     * Use the CommonAnnoncePress relation CommonAnnoncePress object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonAnnoncePressQuery A secondary query class using the current class as primary query
     */
    public function useCommonAnnoncePressQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonAnnoncePress($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonAnnoncePress', 'CommonAnnoncePressQuery');
    }
