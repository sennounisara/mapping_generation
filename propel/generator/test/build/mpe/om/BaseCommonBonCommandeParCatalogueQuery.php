 ...
 *
 * @method CommonBonCommandeParCatalogueQuery leftJoinCommonEntreprise($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonBonCommandeParCatalogueQuery rightJoinCommonEntreprise($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonBonCommandeParCatalogueQuery innerJoinCommonEntreprise($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEntreprise relation
 *
...
abstract class BaseCommonBonCommandeParCatalogueQuery extends ModelCriteria
{
    ...
    public function filterByCommonEntreprise($commonEntreprise, $comparison = null)
    {
        if ($commonEntreprise instanceof CommonEntreprise) {
            return $this
                ->addUsingAlias(CommonBonCommandeParCataloguePeer::ID_ENTREPRISE, $commonEntreprise->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonBonCommandeParCataloguePeer::ID_ENTREPRISE, $commonEntreprise->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
