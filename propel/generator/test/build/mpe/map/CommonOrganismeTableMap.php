...
class CommonOrganismeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonOrganismeTableMap';
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonAdministrateur', 'CommonAdministrateur', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonAdministrateurs');
        $this->addRelation('CommonAffiliationService', 'CommonAffiliationService', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonAffiliationServices');
        $this->addRelation('CommonAgent', 'CommonAgent', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonAgents');
        $this->addRelation('CommonDAConsultation', 'CommonDAConsultation', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), null, null, 'CommonDAConsultations');
        $this->addRelation('CommonOrganismeServiceMetier', 'CommonOrganismeServiceMetier', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonOrganismeServiceMetiers');
        $this->addRelation('CommonParametrageEnchere', 'CommonParametrageEnchere', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonParametrageEncheres');
        $this->addRelation('CommonRPA', 'CommonRPA', RelationMap::ONE_TO_MANY, array('acronyme' => 'acronymeOrg', ), 'CASCADE', 'CASCADE', 'CommonRPAs');
        $this->addRelation('CommonConsultation', 'CommonConsultation', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonConsultations');
        $this->addRelation('CommonDemandeAchatParCatalogue', 'CommonDemandeAchatParCatalogue', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), null, null, 'CommonDemandeAchatParCatalogues');
        $this->addRelation('CommonDestinataireMiseDisposition', 'CommonDestinataireMiseDisposition', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonDestinataireMiseDispositions');
        $this->addRelation('CommonTCAOCommissionConsultation', 'CommonTCAOCommissionConsultation', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), null, null, 'CommonTCAOCommissionConsultations');
        $this->addRelation('CommonTCAOOrdreDePassage', 'CommonTCAOOrdreDePassage', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), null, null, 'CommonTCAOOrdreDePassages');
        $this->addRelation('CommonTCAOSeanceInvite', 'CommonTCAOSeanceInvite', RelationMap::ONE_TO_MANY, array('acronyme' => 'organisme', ), null, null, 'CommonTCAOSeanceInvites');
    } // buildRelations()
