...
class CommonCertificatsEntreprisesTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_inscrit', 'IdInscrit', 'INTEGER', 'Inscrit', 'id', true, 20, null);
    ...
    {
        $this->addRelation('CommonInscrit', 'CommonInscrit', RelationMap::MANY_TO_ONE, array('id_inscrit' => 'id', ), 'CASCADE', null);
    } // buildRelations()
