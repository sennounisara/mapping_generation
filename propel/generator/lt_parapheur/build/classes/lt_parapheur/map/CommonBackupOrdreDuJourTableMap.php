...
/**
 * This class defines the structure of the 'backup_Ordre_Du_Jour' table.
 *
 *
 *
 ...
 */
class CommonBackupOrdreDuJourTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonBackupOrdreDuJourTableMap';
    ...
    {
        // attributes
        $this->setName('backup_Ordre_Du_Jour');
        $this->setPhpName('CommonBackupOrdreDuJour');
        $this->setClassname('CommonBackupOrdreDuJour');
        $this->setPackage('lt_parapheur');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addPrimaryKey('organisme', 'Organisme', 'VARCHAR', true, 30, null);
        $this->addColumn('id_commission', 'IdCommission', 'INTEGER', true, null, 0);
...
} // CommonBackupOrdreDuJourTableMap
