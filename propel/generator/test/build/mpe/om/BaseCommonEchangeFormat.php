...
/**
 * Base class that represents a row from the 'EchangeFormat' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonEchangeFormat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonEchangeFormatPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonEchangeFormatPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonEchangeFormat object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonEchangeFormat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonEchangeFormatPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonEchangeFormatPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonEchangeFormat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonEchangeFormatPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonEchangeFormatQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonEchangeFormatPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonEchangeFormatPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `EchangeFormat` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonEchangeFormatPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonEchangeFormatPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonEchangeFormat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonEchangeFormat'][$this->getPrimaryKey()] = true;
        $keys = CommonEchangeFormatPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonEchangeFormatPeer::ID)) $criteria->add(CommonEchangeFormatPeer::ID, $this->id);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE)) $criteria->add(CommonEchangeFormatPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_FR)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_EN)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_ES)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_SU)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_DU)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_CZ)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_AR)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonEchangeFormatPeer::LIBELLE_IT)) $criteria->add(CommonEchangeFormatPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonEchangeFormatPeer::DATABASE_NAME);
        $criteria->add(CommonEchangeFormatPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonEchangeFormat (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonEchangeFormat Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonEchangeFormatPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonEchangeFormatPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonEchangeFormatPeer::DEFAULT_STRING_FORMAT);
    }
