...
class CommonNewsletterPieceJointeTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('id_newsletter', 'IdNewsletter', 'INTEGER', 'Newsletter', 'id', true, null, 0);
    ...
    {
        $this->addRelation('CommonNewsletter', 'CommonNewsletter', RelationMap::MANY_TO_ONE, array('id_newsletter' => 'id', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
