...
abstract class BaseCommonPassationMarcheAVenir extends BaseObject implements Persistent
{
    ...
    /**
     * @var        CommonPassationConsultation
     */
    protected $aCommonPassationConsultation;
    ...
    public function setIdPassationConsultation($v)
    {
        ...
        if ($this->aCommonPassationConsultation !== null && $this->aCommonPassationConsultation->getId() !== $v) {
            $this->aCommonPassationConsultation = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCommonPassationConsultation !== null && $this->id_passation_consultation !== $this->aCommonPassationConsultation->getId()) {
            $this->aCommonPassationConsultation = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aCommonPassationConsultation !== null) {
                if ($this->aCommonPassationConsultation->isModified() || $this->aCommonPassationConsultation->isNew()) {
                    $affectedRows += $this->aCommonPassationConsultation->save($con);
                }
                $this->setCommonPassationConsultation($this->aCommonPassationConsultation);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aCommonPassationConsultation !== null) {
                if (!$this->aCommonPassationConsultation->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aCommonPassationConsultation->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aCommonPassationConsultation) {
                $result['CommonPassationConsultation'] = $this->aCommonPassationConsultation->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    /**
     * Declares an association between this object and a CommonPassationConsultation object.
     *
     * @param   CommonPassationConsultation $v
     * @return CommonPassationMarcheAVenir The current object (for fluent API support)
     * @throws PropelException
     */
    public function setCommonPassationConsultation(CommonPassationConsultation $v = null)
    {
        if ($v === null) {
            $this->setIdPassationConsultation(0);
        } else {
            $this->setIdPassationConsultation($v->getId());
        }

        $this->aCommonPassationConsultation = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the CommonPassationConsultation object, it will not be re-added.
        if ($v !== null) {
            $v->addCommonPassationMarcheAVenir($this);
        }
    ...
    /**
     * Get the associated CommonPassationConsultation object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return CommonPassationConsultation The associated CommonPassationConsultation object.
     * @throws PropelException
     */
    public function getCommonPassationConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonPassationConsultation === null && ($this->id_passation_consultation !== null) && $doQuery) {
            $this->aCommonPassationConsultation = CommonPassationConsultationQuery::create()
                ->filterByCommonPassationMarcheAVenir($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonPassationConsultation->addCommonPassationMarcheAVenirs($this);
             */
        }

        return $this->aCommonPassationConsultation;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aCommonPassationConsultation instanceof Persistent) {
              $this->aCommonPassationConsultation->clearAllReferences($deep);
            }
