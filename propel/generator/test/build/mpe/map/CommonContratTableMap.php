...
class CommonContratTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonContratTableMap';
    ...
    {
        $this->addRelation('CommonAvenant', 'CommonAvenant', RelationMap::ONE_TO_MANY, array('id_contrat' => 'id_contrat', ), 'CASCADE', 'CASCADE', 'CommonAvenants');
    } // buildRelations()
