 ...
 *
 * @method CommonAnnonceJALQuery leftJoinCommonAnnonceJALPieceJointe($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAnnonceJALPieceJointe relation
 * @method CommonAnnonceJALQuery rightJoinCommonAnnonceJALPieceJointe($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAnnonceJALPieceJointe relation
 * @method CommonAnnonceJALQuery innerJoinCommonAnnonceJALPieceJointe($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAnnonceJALPieceJointe relation
 *
 * @method CommonAnnonceJALQuery leftJoinCommonDestinataireAnnonceJAL($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonDestinataireAnnonceJAL relation
 * @method CommonAnnonceJALQuery rightJoinCommonDestinataireAnnonceJAL($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonDestinataireAnnonceJAL relation
 * @method CommonAnnonceJALQuery innerJoinCommonDestinataireAnnonceJAL($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonDestinataireAnnonceJAL relation
 *
...
abstract class BaseCommonAnnonceJALQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related CommonAnnonceJALPieceJointe object
     *
     * @param   CommonAnnonceJALPieceJointe|PropelObjectCollection $commonAnnonceJALPieceJointe  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonAnnonceJALQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonAnnonceJALPieceJointe($commonAnnonceJALPieceJointe, $comparison = null)
    {
        if ($commonAnnonceJALPieceJointe instanceof CommonAnnonceJALPieceJointe) {
            return $this
                ->addUsingAlias(CommonAnnonceJALPeer::ID, $commonAnnonceJALPieceJointe->getIdAnnonceJal(), $comparison);
        } elseif ($commonAnnonceJALPieceJointe instanceof PropelObjectCollection) {
            return $this
                ->useCommonAnnonceJALPieceJointeQuery()
                ->filterByPrimaryKeys($commonAnnonceJALPieceJointe->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonAnnonceJALPieceJointe() only accepts arguments of type CommonAnnonceJALPieceJointe or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonAnnonceJALPieceJointe relation
     *
     ...
     * @return CommonAnnonceJALQuery The current query, for fluid interface
     */
    public function joinCommonAnnonceJALPieceJointe($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonAnnonceJALPieceJointe');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonAnnonceJALPieceJointe');
        }
    ...
    /**
     * Use the CommonAnnonceJALPieceJointe relation CommonAnnonceJALPieceJointe object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonAnnonceJALPieceJointeQuery A secondary query class using the current class as primary query
     */
    public function useCommonAnnonceJALPieceJointeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonAnnonceJALPieceJointe($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonAnnonceJALPieceJointe', 'CommonAnnonceJALPieceJointeQuery');
    }

    /**
     * Filter the query by a related CommonDestinataireAnnonceJAL object
     *
     * @param   CommonDestinataireAnnonceJAL|PropelObjectCollection $commonDestinataireAnnonceJAL  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonAnnonceJALQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonDestinataireAnnonceJAL($commonDestinataireAnnonceJAL, $comparison = null)
    {
        if ($commonDestinataireAnnonceJAL instanceof CommonDestinataireAnnonceJAL) {
            return $this
                ->addUsingAlias(CommonAnnonceJALPeer::ID, $commonDestinataireAnnonceJAL->getIdannoncejal(), $comparison);
        } elseif ($commonDestinataireAnnonceJAL instanceof PropelObjectCollection) {
            return $this
                ->useCommonDestinataireAnnonceJALQuery()
                ->filterByPrimaryKeys($commonDestinataireAnnonceJAL->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonDestinataireAnnonceJAL() only accepts arguments of type CommonDestinataireAnnonceJAL or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonDestinataireAnnonceJAL relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonAnnonceJALQuery The current query, for fluid interface
     */
    public function joinCommonDestinataireAnnonceJAL($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonDestinataireAnnonceJAL');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonDestinataireAnnonceJAL');
        }
    ...
    /**
     * Use the CommonDestinataireAnnonceJAL relation CommonDestinataireAnnonceJAL object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonDestinataireAnnonceJALQuery A secondary query class using the current class as primary query
     */
    public function useCommonDestinataireAnnonceJALQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonDestinataireAnnonceJAL($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonDestinataireAnnonceJAL', 'CommonDestinataireAnnonceJALQuery');
    }
