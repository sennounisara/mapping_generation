...
abstract class BaseCommonTCAOCommissionAgent extends BaseObject implements Persistent
{
    ...
    public function setCommonAgent(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonTCAOCommissionAgent($this);
        }
    ...
    public function getCommonAgent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgent === null && ($this->id_agent !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgent->addCommonTCAOCommissionAgents($this);
             */
        }
    ...
    public function getCommonTCAOCommission(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonTCAOCommission === null && (($this->id_commission !== "" && $this->id_commission !== null)) && $doQuery) {
            $this->aCommonTCAOCommission = CommonTCAOCommissionQuery::create()
                ->filterByCommonTCAOCommissionAgent($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonTCAOCommission->addCommonTCAOCommissionAgents($this);
             */
        }
