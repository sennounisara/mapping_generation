...
abstract class BaseCommonFacturePeer
{
    ...
    public static function doCountJoinCommonInscrit(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonFacturePeer::ID_INSCRIT, CommonInscritPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonEntreprise(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonFacturePeer::ID_ENTREPRISE, CommonEntreprisePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonFacture objects pre-filled with their CommonInscrit objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonFacture objects.
    ...
    public static function doSelectJoinCommonInscrit(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonFacture) to $obj2 (CommonInscrit)
                $obj2->addCommonFacture($obj1);
    ...
    /**
     * Selects a collection of CommonFacture objects pre-filled with their CommonEntreprise objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonFacture objects.
    ...
    public static function doSelectJoinCommonEntreprise(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonFacture) to $obj2 (CommonEntreprise)
                $obj2->addCommonFacture($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CommonFacture) to the collection in $obj4 (CommonInscrit)
                $obj4->addCommonFacture($obj1);
            } // if joined row not null
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (CommonFacture) to the collection in $obj5 (CommonEntreprise)
                $obj5->addCommonFacture($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptCommonTypeFacture(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonFacturePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonFacture) to the collection in $obj3 (CommonInscrit)
                $obj3->addCommonFacture($obj1);
                ...
                // Add the $obj1 (CommonFacture) to the collection in $obj4 (CommonEntreprise)
                $obj4->addCommonFacture($obj1);
    ...
    /**
     * Selects a collection of CommonFacture objects pre-filled with all related objects except CommonInscrit.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonFacture objects pre-filled with all related objects except CommonEntreprise.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
