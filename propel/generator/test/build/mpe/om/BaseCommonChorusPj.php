...
/**
 * Base class that represents a row from the 'Chorus_pj' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonChorusPj extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonChorusPjPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonChorusPjPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonChorusPj object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonChorusPj The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonChorusPjPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonChorusPjPeer::ORGANISME;
        }
    ...
    public function setIdEchange($v)
    {
        ...
        if ($this->id_echange !== $v) {
            $this->id_echange = $v;
            $this->modifiedColumns[] = CommonChorusPjPeer::ID_ECHANGE;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonChorusPjPeer::NOM_FICHIER;
        }
    ...
    public function setFichier($v)
    {
        ...
        if ($this->fichier !== $v) {
            $this->fichier = $v;
            $this->modifiedColumns[] = CommonChorusPjPeer::FICHIER;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonChorusPjPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== $v) {
            ...
            $this->modifiedColumns[] = CommonChorusPjPeer::UNTRUSTEDDATE;
        }
    ...
    public function setTaille($v)
    {
        ...
        if ($this->taille !== $v) {
            $this->taille = $v;
            $this->modifiedColumns[] = CommonChorusPjPeer::TAILLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fichier = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 8; // 8 = CommonChorusPjPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonChorusPj object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonChorusPjPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonChorusPjQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonChorusPjPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonChorusPjPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::ID_ECHANGE)) {
            $modifiedColumns[':p' . $index++]  = '`id_echange`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`fichier`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonChorusPjPeer::TAILLE)) {
            $modifiedColumns[':p' . $index++]  = '`taille`';
        }

        $sql = sprintf(
            'INSERT INTO `Chorus_pj` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonChorusPjPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonChorusPjPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonChorusPj'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonChorusPj'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonChorusPjPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonChorusPjPeer::ID)) $criteria->add(CommonChorusPjPeer::ID, $this->id);
        if ($this->isColumnModified(CommonChorusPjPeer::ORGANISME)) $criteria->add(CommonChorusPjPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonChorusPjPeer::ID_ECHANGE)) $criteria->add(CommonChorusPjPeer::ID_ECHANGE, $this->id_echange);
        if ($this->isColumnModified(CommonChorusPjPeer::NOM_FICHIER)) $criteria->add(CommonChorusPjPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonChorusPjPeer::FICHIER)) $criteria->add(CommonChorusPjPeer::FICHIER, $this->fichier);
        if ($this->isColumnModified(CommonChorusPjPeer::HORODATAGE)) $criteria->add(CommonChorusPjPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonChorusPjPeer::UNTRUSTEDDATE)) $criteria->add(CommonChorusPjPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonChorusPjPeer::TAILLE)) $criteria->add(CommonChorusPjPeer::TAILLE, $this->taille);
    ...
    {
        $criteria = new Criteria(CommonChorusPjPeer::DATABASE_NAME);
        $criteria->add(CommonChorusPjPeer::ID, $this->id);
        $criteria->add(CommonChorusPjPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonChorusPj (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonChorusPj Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonChorusPjPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonChorusPjPeer();
        }
    ...
    public function getCommonChorusEchange(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonChorusEchange === null && ($this->id_echange !== null && ($this->organisme !== "" && $this->organisme !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonChorusEchange->addCommonChorusPjs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonChorusPjPeer::DEFAULT_STRING_FORMAT);
    }
