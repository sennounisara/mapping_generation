 ...
 *
 * @method CommonExecContratQuery leftJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 * @method CommonExecContratQuery rightJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 * @method CommonExecContratQuery innerJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 *
 * @method CommonExecContratQuery leftJoinCommonAgentRelatedByIdAgentGestion($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentGestion relation
 * @method CommonExecContratQuery rightJoinCommonAgentRelatedByIdAgentGestion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentGestion relation
 * @method CommonExecContratQuery innerJoinCommonAgentRelatedByIdAgentGestion($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentGestion relation
 *
 * @method CommonExecContratQuery leftJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 * @method CommonExecContratQuery rightJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 * @method CommonExecContratQuery innerJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 *
 * @method CommonExecContratQuery leftJoinCommonCategorieConsultation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonCategorieConsultation relation
 * @method CommonExecContratQuery rightJoinCommonCategorieConsultation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonCategorieConsultation relation
 * @method CommonExecContratQuery innerJoinCommonCategorieConsultation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonCategorieConsultation relation
 *
...
abstract class BaseCommonExecContratQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonAgentRelatedByIdAgentGestion()
     *
    ...
    public function filterByCommonAgentRelatedByIdAgentCrea($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_AGENT_CREA, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_AGENT_CREA, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonAgentRelatedByIdAgentGestion($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_AGENT_GESTION, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_AGENT_GESTION, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonAgentRelatedByIdAgentGestion() only accepts arguments of type CommonAgent or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonAgentRelatedByIdAgentGestion relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonExecContratQuery The current query, for fluid interface
     */
    public function joinCommonAgentRelatedByIdAgentGestion($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonAgentRelatedByIdAgentGestion');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonAgentRelatedByIdAgentGestion');
        }
    ...
    /**
     * Use the CommonAgentRelatedByIdAgentGestion relation CommonAgent object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonAgentQuery A secondary query class using the current class as primary query
     */
    public function useCommonAgentRelatedByIdAgentGestionQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCommonAgentRelatedByIdAgentGestion($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonAgentRelatedByIdAgentGestion', 'CommonAgentQuery');
    }
    ...
    public function filterByCommonAgentRelatedByIdAgentModif($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_AGENT_MODIF, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_AGENT_MODIF, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Filter the query by a related CommonCategorieConsultation object
     *
     * @param   CommonCategorieConsultation|PropelObjectCollection $commonCategorieConsultation The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonExecContratQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonCategorieConsultation($commonCategorieConsultation, $comparison = null)
    {
        if ($commonCategorieConsultation instanceof CommonCategorieConsultation) {
            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_NATURE_PRESTATION, $commonCategorieConsultation->getId(), $comparison);
        } elseif ($commonCategorieConsultation instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }

            return $this
                ->addUsingAlias(CommonExecContratPeer::ID_NATURE_PRESTATION, $commonCategorieConsultation->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonCategorieConsultation() only accepts arguments of type CommonCategorieConsultation or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonCategorieConsultation relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonExecContratQuery The current query, for fluid interface
     */
    public function joinCommonCategorieConsultation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonCategorieConsultation');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonCategorieConsultation');
        }
    ...
    /**
     * Use the CommonCategorieConsultation relation CommonCategorieConsultation object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonCategorieConsultationQuery A secondary query class using the current class as primary query
     */
    public function useCommonCategorieConsultationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonCategorieConsultation($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonCategorieConsultation', 'CommonCategorieConsultationQuery');
    }
