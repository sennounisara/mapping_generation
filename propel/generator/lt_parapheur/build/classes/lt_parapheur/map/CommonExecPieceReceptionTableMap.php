 ...
 */
class CommonExecPieceReceptionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonExecPieceReceptionTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CommonExecPieceReception');
        $this->setClassname('CommonExecPieceReception');
...
} // CommonExecPieceReceptionTableMap
