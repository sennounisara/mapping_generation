...
class CommonRPATableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonRPATableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('acronymeOrg', 'Acronymeorg', 'VARCHAR' , 'Organisme', 'acronyme', true, 200, null);
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonOrganisme', 'CommonOrganisme', RelationMap::MANY_TO_ONE, array('acronymeOrg' => 'acronyme', ), 'CASCADE', 'CASCADE');
    } // buildRelations()
