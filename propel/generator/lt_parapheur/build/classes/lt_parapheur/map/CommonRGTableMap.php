...
/**
 * This class defines the structure of the 'RG' table.
 *
 *
 *
 ...
 */
class CommonRGTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonRGTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('RG');
        $this->setPhpName('CommonRG');
        $this->setClassname('CommonRG');
        ...
        $this->addColumn('rg', 'Rg', 'INTEGER', true, null, 0);
        $this->addColumn('nom_fichier', 'NomFichier', 'VARCHAR', true, 150, null);
