 ...
 */
class CommonTTraductionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonTTraductionTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CommonTTraduction');
        $this->setClassname('CommonTTraduction');
