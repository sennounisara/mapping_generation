...
class CommonMarcheTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('natureMarche', 'Naturemarche', 'VARCHAR', 'CategorieConsultation', 'id', false, 30, '1');
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonCategorieConsultation', 'CommonCategorieConsultation', RelationMap::MANY_TO_ONE, array('natureMarche' => 'id', ), null, null);
    } // buildRelations()
