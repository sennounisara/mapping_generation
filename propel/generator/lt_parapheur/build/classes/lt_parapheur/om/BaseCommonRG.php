...
/**
 * Base class that represents a row from the 'RG' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonRG extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonRGPeer';
    ...
    /**
     * Initializes internal state of BaseCommonRG object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonRG The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonRGPeer::ID;
        }
    ...
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonRGPeer::ORGANISME;
        }
    ...
    public function setConsultationRef($v)
    {
        ...
        if ($this->consultation_ref !== $v) {
            ...
            $this->modifiedColumns[] = CommonRGPeer::CONSULTATION_REF;
        }
    ...
    public function setRg($v)
    {
        ...
        if ($this->rg !== $v) {
            $this->rg = $v;
            $this->modifiedColumns[] = CommonRGPeer::RG;
        }
    ...
    public function setNomFichier($v)
    {
        ...
        if ($this->nom_fichier !== $v) {
            $this->nom_fichier = $v;
            $this->modifiedColumns[] = CommonRGPeer::NOM_FICHIER;
        }
    ...
    public function setStatut($v)
    {
        ...
        if ($this->statut !== $v) {
            $this->statut = $v;
            $this->modifiedColumns[] = CommonRGPeer::STATUT;
        }
    ...
    public function setHorodatage($v)
    {
        ...
        $this->modifiedColumns[] = CommonRGPeer::HORODATAGE;
    ...
    public function setUntrusteddate($v)
    {
        ...
        if ($this->untrusteddate !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = CommonRGPeer::UNTRUSTEDDATE;
            }
    ...
    public function setAgentId($v)
    {
        ...
        if ($this->agent_id !== $v) {
            $this->agent_id = $v;
            $this->modifiedColumns[] = CommonRGPeer::AGENT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->rg = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 9; // 9 = CommonRGPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonRG object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonRGPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonRGQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonRGPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonRGPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonRGPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonRGPeer::CONSULTATION_REF)) {
            $modifiedColumns[':p' . $index++]  = '`consultation_ref`';
        }
        if ($this->isColumnModified(CommonRGPeer::RG)) {
            $modifiedColumns[':p' . $index++]  = '`rg`';
        }
        if ($this->isColumnModified(CommonRGPeer::NOM_FICHIER)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier`';
        }
        if ($this->isColumnModified(CommonRGPeer::STATUT)) {
            $modifiedColumns[':p' . $index++]  = '`statut`';
        }
        if ($this->isColumnModified(CommonRGPeer::HORODATAGE)) {
            $modifiedColumns[':p' . $index++]  = '`horodatage`';
        }
        if ($this->isColumnModified(CommonRGPeer::UNTRUSTEDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`untrusteddate`';
        }
        if ($this->isColumnModified(CommonRGPeer::AGENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`agent_id`';
        }

        $sql = sprintf(
            'INSERT INTO `RG` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`consultation_ref`':						
                        ...
                        break;
                    case '`rg`':						
                        $stmt->bindValue($identifier, $this->rg, PDO::PARAM_INT);
                        break;
                    case '`nom_fichier`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonRGPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonRGPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonRG'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonRG'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonRGPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonRGPeer::ID)) $criteria->add(CommonRGPeer::ID, $this->id);
        if ($this->isColumnModified(CommonRGPeer::ORGANISME)) $criteria->add(CommonRGPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonRGPeer::CONSULTATION_REF)) $criteria->add(CommonRGPeer::CONSULTATION_REF, $this->consultation_ref);
        if ($this->isColumnModified(CommonRGPeer::RG)) $criteria->add(CommonRGPeer::RG, $this->rg);
        if ($this->isColumnModified(CommonRGPeer::NOM_FICHIER)) $criteria->add(CommonRGPeer::NOM_FICHIER, $this->nom_fichier);
        if ($this->isColumnModified(CommonRGPeer::STATUT)) $criteria->add(CommonRGPeer::STATUT, $this->statut);
        if ($this->isColumnModified(CommonRGPeer::HORODATAGE)) $criteria->add(CommonRGPeer::HORODATAGE, $this->horodatage);
        if ($this->isColumnModified(CommonRGPeer::UNTRUSTEDDATE)) $criteria->add(CommonRGPeer::UNTRUSTEDDATE, $this->untrusteddate);
        if ($this->isColumnModified(CommonRGPeer::AGENT_ID)) $criteria->add(CommonRGPeer::AGENT_ID, $this->agent_id);
    ...
    {
        $criteria = new Criteria(CommonRGPeer::DATABASE_NAME);
        $criteria->add(CommonRGPeer::ID, $this->id);
        $criteria->add(CommonRGPeer::ORGANISME, $this->organisme);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonRG (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonRG Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCommonConsultation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonConsultation === null && (($this->organisme !== "" && $this->organisme !== null) && $this->consultation_ref !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonConsultation->addCommonRGs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonRGPeer::DEFAULT_STRING_FORMAT);
    }
