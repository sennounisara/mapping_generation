...
/**
 * Base class that represents a row from the 'exec_inscrit_contrat' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecInscritContrat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecInscritContratPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecInscritContratPeer
     */
     ...
     * @return CommonExecInscritContrat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecInscritContratPeer::ID;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecInscritContratPeer::ID_CONTRAT;
        }
    ...
    public function setIdInscrit($v)
    {
        ...
        if ($this->id_inscrit !== $v) {
            $this->id_inscrit = $v;
            $this->modifiedColumns[] = CommonExecInscritContratPeer::ID_INSCRIT;
        }
    ...
    public function setIdEntreprise($v)
    {
        ...
        if ($this->id_entreprise !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecInscritContratPeer::ID_ENTREPRISE;
        }
    ...
    public function setIdContractant($v)
    {
        ...
        if ($this->id_contractant !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecInscritContratPeer::ID_CONTRACTANT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = CommonExecInscritContratPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecInscritContrat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecInscritContratPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecInscritContratQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecInscritContratPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_INSCRIT)) {
            $modifiedColumns[':p' . $index++]  = '`id_inscrit`';
        }
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_ENTREPRISE)) {
            $modifiedColumns[':p' . $index++]  = '`id_entreprise`';
        }
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_CONTRACTANT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contractant`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_inscrit_contrat` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecInscritContratPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecInscritContratPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecInscritContrat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecInscritContrat'][$this->getPrimaryKey()] = true;
        $keys = CommonExecInscritContratPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID)) $criteria->add(CommonExecInscritContratPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_CONTRAT)) $criteria->add(CommonExecInscritContratPeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_INSCRIT)) $criteria->add(CommonExecInscritContratPeer::ID_INSCRIT, $this->id_inscrit);
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_ENTREPRISE)) $criteria->add(CommonExecInscritContratPeer::ID_ENTREPRISE, $this->id_entreprise);
        if ($this->isColumnModified(CommonExecInscritContratPeer::ID_CONTRACTANT)) $criteria->add(CommonExecInscritContratPeer::ID_CONTRACTANT, $this->id_contractant);
    ...
    {
        $criteria = new Criteria(CommonExecInscritContratPeer::DATABASE_NAME);
        $criteria->add(CommonExecInscritContratPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecInscritContrat (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecInscritContrat Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecInscritContratPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecInscritContratPeer();
        }
    ...
    public function setCommonExecContractant(CommonExecContractant $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonExecInscritContrat($this);
        }
    ...
    public function getCommonExecContractant(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContractant === null && ($this->id_contractant !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonExecContractant->addCommonExecInscritContrats($this);
             */
        }
    ...
    public function getCommonExecContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContrat === null && ($this->id_contrat !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecContrat->addCommonExecInscritContrats($this);
             */
        }
    ...
    public function getCommonEntreprise(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonEntreprise === null && ($this->id_entreprise !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonEntreprise->addCommonExecInscritContrats($this);
             */
        }
    ...
    public function getCommonInscrit(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonInscrit === null && ($this->id_inscrit !== null) && $doQuery) {
            $this->aCommonInscrit = CommonInscritQuery::create()
                ->filterByCommonExecInscritContrat($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonInscrit->addCommonExecInscritContrats($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonExecInscritContratPeer::DEFAULT_STRING_FORMAT);
    }
