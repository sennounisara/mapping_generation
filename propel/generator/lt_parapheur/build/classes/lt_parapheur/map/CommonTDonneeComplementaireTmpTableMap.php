...
/**
 * This class defines the structure of the 't_donnee_complementaire_tmp' table.
 *
 *
 *
 ...
 */
class CommonTDonneeComplementaireTmpTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonTDonneeComplementaireTmpTableMap';
    ...
    {
        // attributes
        $this->setName('t_donnee_complementaire_tmp');
        $this->setPhpName('CommonTDonneeComplementaireTmp');
        $this->setClassname('CommonTDonneeComplementaireTmp');
...
} // CommonTDonneeComplementaireTmpTableMap
