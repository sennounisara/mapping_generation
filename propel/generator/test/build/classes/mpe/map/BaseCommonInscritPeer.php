...
abstract class BaseCommonInscritPeer
{
    ...
    const TENTATIVE_RECUP_MDP = 'Inscrit.tentative_recup_mdp';

    /** the column name for the date_tentative_recup_mdp field */
    const DATE_TENTATIVE_RECUP_MDP = 'Inscrit.date_tentative_recup_mdp';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommonInscritPeer::TENTATIVE_RECUP_MDP);
            $criteria->addSelectColumn(CommonInscritPeer::DATE_TENTATIVE_RECUP_MDP);
        } else {
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                ...
                CommonInscritPeer::removeInstanceFromPool($value);
            }
        }
