...
abstract class BaseCommonEntreprisePeer
{
    ...
    const GUID = 'entreprise.guid';

    /** the column name for the geo_id field */
    const GEO_ID = 'entreprise.geo_id';
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommonEntreprisePeer::GUID);
            $criteria->addSelectColumn(CommonEntreprisePeer::GEO_ID);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.geo_id');
        }
    }
