...
abstract class BaseCommonHeliosTeletransmissionPeer
{
    ...
    {
        // Invalidate objects in CommonHeliosTeletransmissionLotPeer instance pool,
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonHeliosTeletransmissionPeer::doOnDeleteCascade(new Criteria(CommonHeliosTeletransmissionPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonHeliosTeletransmissionPeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonHeliosTeletransmissionPeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonHeliosTeletransmissionPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CommonHeliosTeletransmissionLot objects
            $criteria = new Criteria(CommonHeliosTeletransmissionLotPeer::DATABASE_NAME);
            
            $criteria->add(CommonHeliosTeletransmissionLotPeer::ID_TELETRANSMISSION, $obj->getId());
            $criteria->add(CommonHeliosTeletransmissionLotPeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonHeliosTeletransmissionLotPeer::doDelete($criteria, $con);
        }
