...
/**
 * This class defines the structure of the 'EchangeTypeAR' table.
 *
 *
 *
 ...
 */
class CommonEchangeTypeARTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonEchangeTypeARTableMap';
    ...
    {
        // attributes
        $this->setName('EchangeTypeAR');
        $this->setPhpName('CommonEchangeTypeAR');
        $this->setClassname('CommonEchangeTypeAR');
