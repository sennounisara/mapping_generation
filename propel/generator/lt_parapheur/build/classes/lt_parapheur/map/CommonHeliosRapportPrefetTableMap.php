...
/**
 * This class defines the structure of the 'Helios_rapport_prefet' table.
 *
 *
 *
 ...
 */
class CommonHeliosRapportPrefetTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonHeliosRapportPrefetTableMap';
    ...
    {
        // attributes
        $this->setName('Helios_rapport_prefet');
        $this->setPhpName('CommonHeliosRapportPrefet');
        $this->setClassname('CommonHeliosRapportPrefet');
...
} // CommonHeliosRapportPrefetTableMap
