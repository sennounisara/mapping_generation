...
abstract class BaseCommonAgentPeer
{
    ...
    {
        // Invalidate objects in CommonResultatAnalyseHistoriquePeer instance pool,
    ...
    public static function doCountJoinCommonOrganisme(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonAgentPeer::ORGANISME, CommonOrganismePeer::ACRONYME, $join_behavior);
    ...
    /**
     * Selects a collection of CommonAgent objects pre-filled with their CommonOrganisme objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonAgent objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonOrganisme(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonAgentPeer::addSelectColumns($criteria);
        $startcol = CommonAgentPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonAgentPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonAgentPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonAgentPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonAgent) to $obj2 (CommonOrganisme)
                $obj2->addCommonAgent($obj1);
    ...
    /**
     * Selects a collection of CommonAgent objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonAgentPeer::addSelectColumns($criteria);
        $startcol2 = CommonAgentPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonAgent) to the collection in $obj2 (CommonOrganisme)
                $obj2->addCommonAgent($obj1);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonAgentPeer::doOnDeleteCascade(new Criteria(CommonAgentPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonAgentPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonAgentPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CommonResultatAnalyseHistorique objects
            $criteria = new Criteria(CommonResultatAnalyseHistoriquePeer::DATABASE_NAME);
            
            $criteria->add(CommonResultatAnalyseHistoriquePeer::AGENT_ID, $obj->getId());
            $affectedRows += CommonResultatAnalyseHistoriquePeer::doDelete($criteria, $con);
        }
