...
/**
 * Base class that represents a row from the 'Inscrit_Sub' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonInscritSub extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonInscritSubPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonInscritSubPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonInscritSub object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonInscritSub The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::ID;
        }
    ...
    public function setEntrepriseId($v)
    {
        ...
        if ($this->entreprise_id !== $v) {
            ...
            $this->modifiedColumns[] = CommonInscritSubPeer::ENTREPRISE_ID;
        }
    ...
    public function setLogin($v)
    {
        ...
        if ($this->login !== $v) {
            $this->login = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::LOGIN;
        }
    ...
    public function setMdp($v)
    {
        ...
        if ($this->mdp !== $v) {
            $this->mdp = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::MDP;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::NOM;
        }
    ...
    public function setPrenom($v)
    {
        ...
        if ($this->prenom !== $v) {
            $this->prenom = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::PRENOM;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::EMAIL;
        }
    ...
    public function setProfil($v)
    {
        ...
        if ($this->profil !== $v) {
            $this->profil = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::PROFIL;
        }
    ...
    public function setIdInscrit($v)
    {
        ...
        if ($this->id_inscrit !== $v) {
            $this->id_inscrit = $v;
            $this->modifiedColumns[] = CommonInscritSubPeer::ID_INSCRIT;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== $v) {
            ...
            $this->modifiedColumns[] = CommonInscritSubPeer::DATE_CREATION;
        }
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== $v) {
            ...
            $this->modifiedColumns[] = CommonInscritSubPeer::DATE_MODIFICATION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->profil = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            ...
            return $startcol + 11; // 11 = CommonInscritSubPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonInscritSub object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonInscritSubPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonInscritSubQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonInscritSubPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonInscritSubPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::ENTREPRISE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`entreprise_id`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::LOGIN)) {
            $modifiedColumns[':p' . $index++]  = '`login`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::MDP)) {
            $modifiedColumns[':p' . $index++]  = '`mdp`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::PRENOM)) {
            $modifiedColumns[':p' . $index++]  = '`prenom`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::EMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`email`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::PROFIL)) {
            $modifiedColumns[':p' . $index++]  = '`profil`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::ID_INSCRIT)) {
            $modifiedColumns[':p' . $index++]  = '`id_inscrit`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(CommonInscritSubPeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `Inscrit_Sub` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonInscritSubPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonInscritSubPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonInscritSub'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonInscritSub'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonInscritSubPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setProfil($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonInscritSubPeer::ID)) $criteria->add(CommonInscritSubPeer::ID, $this->id);
        if ($this->isColumnModified(CommonInscritSubPeer::ENTREPRISE_ID)) $criteria->add(CommonInscritSubPeer::ENTREPRISE_ID, $this->entreprise_id);
        if ($this->isColumnModified(CommonInscritSubPeer::LOGIN)) $criteria->add(CommonInscritSubPeer::LOGIN, $this->login);
        if ($this->isColumnModified(CommonInscritSubPeer::MDP)) $criteria->add(CommonInscritSubPeer::MDP, $this->mdp);
        if ($this->isColumnModified(CommonInscritSubPeer::NOM)) $criteria->add(CommonInscritSubPeer::NOM, $this->nom);
        if ($this->isColumnModified(CommonInscritSubPeer::PRENOM)) $criteria->add(CommonInscritSubPeer::PRENOM, $this->prenom);
        if ($this->isColumnModified(CommonInscritSubPeer::EMAIL)) $criteria->add(CommonInscritSubPeer::EMAIL, $this->email);
        if ($this->isColumnModified(CommonInscritSubPeer::PROFIL)) $criteria->add(CommonInscritSubPeer::PROFIL, $this->profil);
        if ($this->isColumnModified(CommonInscritSubPeer::ID_INSCRIT)) $criteria->add(CommonInscritSubPeer::ID_INSCRIT, $this->id_inscrit);
        if ($this->isColumnModified(CommonInscritSubPeer::DATE_CREATION)) $criteria->add(CommonInscritSubPeer::DATE_CREATION, $this->date_creation);
        if ($this->isColumnModified(CommonInscritSubPeer::DATE_MODIFICATION)) $criteria->add(CommonInscritSubPeer::DATE_MODIFICATION, $this->date_modification);
    ...
    {
        $criteria = new Criteria(CommonInscritSubPeer::DATABASE_NAME);
        $criteria->add(CommonInscritSubPeer::ID, $this->id);
        $criteria->add(CommonInscritSubPeer::ENTREPRISE_ID, $this->entreprise_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonInscritSub (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonInscritSub Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonInscritSubPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonInscritSubPeer();
        }
    ...
    public function getCommonInscrit(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonInscrit === null && ($this->id_inscrit !== null) && $doQuery) {
            $this->aCommonInscrit = CommonInscritQuery::create()
                ->filterByCommonInscritSub($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aCommonInscrit->addCommonInscritSubs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonInscritSubPeer::DEFAULT_STRING_FORMAT);
    }
