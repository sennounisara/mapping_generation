...
abstract class BaseServicePeer
{
    ...
    const ID_COMMUNE = 'service.ID_COMMUNE';

    /** the column name for the NOM_SERVICE_FR field */
    const NOM_SERVICE_FR = 'service.NOM_SERVICE_FR';

    /** the column name for the ETAT_SERVICE field */
    const ETAT_SERVICE = 'service.ETAT_SERVICE';

    /** the column name for the NOM_SERVICE_AR field */
    const NOM_SERVICE_AR = 'service.NOM_SERVICE_AR';

    /** The enumerated values for the ETAT_SERVICE field */
    const ETAT_SERVICE_0 = '0';
    const ETAT_SERVICE_1 = '1';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'IdCommune', 'NomServiceFr', 'EtatService', 'NomServiceAr', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'idCommune', 'nomServiceFr', 'etatService', 'nomServiceAr', ),
        BasePeer::TYPE_COLNAME => array (ServicePeer::ID, ServicePeer::ID_COMMUNE, ServicePeer::NOM_SERVICE_FR, ServicePeer::ETAT_SERVICE, ServicePeer::NOM_SERVICE_AR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ID_COMMUNE', 'NOM_SERVICE_FR', 'ETAT_SERVICE', 'NOM_SERVICE_AR', ),
        BasePeer::TYPE_FIELDNAME => array ('ID', 'ID_COMMUNE', 'NOM_SERVICE_FR', 'ETAT_SERVICE', 'NOM_SERVICE_AR', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'IdCommune' => 1, 'NomServiceFr' => 2, 'EtatService' => 3, 'NomServiceAr' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'idCommune' => 1, 'nomServiceFr' => 2, 'etatService' => 3, 'nomServiceAr' => 4, ),
        BasePeer::TYPE_COLNAME => array (ServicePeer::ID => 0, ServicePeer::ID_COMMUNE => 1, ServicePeer::NOM_SERVICE_FR => 2, ServicePeer::ETAT_SERVICE => 3, ServicePeer::NOM_SERVICE_AR => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ID_COMMUNE' => 1, 'NOM_SERVICE_FR' => 2, 'ETAT_SERVICE' => 3, 'NOM_SERVICE_AR' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'ID_COMMUNE' => 1, 'NOM_SERVICE_FR' => 2, 'ETAT_SERVICE' => 3, 'NOM_SERVICE_AR' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );

    /** The enumerated values for this table */
    protected static $enumValueSets = array(
        ServicePeer::ETAT_SERVICE => array(
            ServicePeer::ETAT_SERVICE_0,
            ServicePeer::ETAT_SERVICE_1,
        ),
    );
    ...
    {
      return ServicePeer::$enumValueSets;
    }
    ...
    {
        $valueSets = ServicePeer::getValueSets();
    ...
    {
        $values = ServicePeer::getValueSet($colname);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ServicePeer::ID_COMMUNE);
            $criteria->addSelectColumn(ServicePeer::NOM_SERVICE_FR);
            $criteria->addSelectColumn(ServicePeer::ETAT_SERVICE);
            $criteria->addSelectColumn(ServicePeer::NOM_SERVICE_AR);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.ID_COMMUNE');
            $criteria->addSelectColumn($alias . '.NOM_SERVICE_FR');
            $criteria->addSelectColumn($alias . '.ETAT_SERVICE');
            $criteria->addSelectColumn($alias . '.NOM_SERVICE_AR');
        }
    }
