...
class CommonTypeProcedureOrganismeTableMap extends TableMap
{
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonTCalendrierEtapeReferentiel', 'CommonTCalendrierEtapeReferentiel', RelationMap::ONE_TO_MANY, array('id_type_procedure' => 'ID_TYPE_PROCEDURE', 'organisme' => 'ORGANISME', ), 'CASCADE', 'CASCADE', 'CommonTCalendrierEtapeReferentiels');
    } // buildRelations()
