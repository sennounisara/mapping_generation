...
abstract class BaseCommonExecDossierPaiementPeer
{
    ...
    public static function doCountJoinCommonAgent(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecDossierPaiementPeer::ID_AGENT_CREAT, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecDossierPaiement objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonExecDossierPaiement objects.
    ...
    public static function doSelectJoinCommonAgent(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecDossierPaiement) to $obj2 (CommonAgent)
                $obj2->addCommonExecDossierPaiement($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecDossierPaiement) to the collection in $obj3 (CommonAgent)
                $obj3->addCommonExecDossierPaiement($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonExecDossierPaiement objects pre-filled with all related objects except CommonExecContrat.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonExecContrat(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecDossierPaiementPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonExecDossierPaiement) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecDossierPaiement($obj1);
    ...
    /**
     * Selects a collection of CommonExecDossierPaiement objects pre-filled with all related objects except CommonAgent.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
