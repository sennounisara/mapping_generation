...
class CommonExecPrixTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonExecPrixTableMap';
  ...
  1 => '1',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CommonExecReceptionPrix', 'CommonExecReceptionPrix', RelationMap::ONE_TO_MANY, array('id' => 'id_prix', ), null, null, 'CommonExecReceptionPrixs');
