 ...
 *
 * @method CommonRPAQuery leftJoinCommonOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonRPAQuery rightJoinCommonOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonRPAQuery innerJoinCommonOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonOrganisme relation
 *
...
abstract class BaseCommonRPAQuery extends ModelCriteria
{
    ...
    public function filterByCommonOrganisme($commonOrganisme, $comparison = null)
    {
        if ($commonOrganisme instanceof CommonOrganisme) {
            return $this
                ->addUsingAlias(CommonRPAPeer::ACRONYMEORG, $commonOrganisme->getAcronyme(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonRPAPeer::ACRONYMEORG, $commonOrganisme->toKeyValue('PrimaryKey', 'Acronyme'), $comparison);
        } else {
