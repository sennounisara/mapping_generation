 ...
 */
class CommonExecReceptionPrixTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonExecReceptionPrixTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CommonExecReceptionPrix');
        $this->setClassname('CommonExecReceptionPrix');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('CommonExecReception', 'CommonExecReception', RelationMap::MANY_TO_ONE, array('id_reception' => 'id', ), null, null);
    } // buildRelations()

} // CommonExecReceptionPrixTableMap
