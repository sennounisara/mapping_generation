 ...
 *
 * @method CommonParametrageEnchereReferenceQuery leftJoinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
 * @method CommonParametrageEnchereReferenceQuery rightJoinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
 * @method CommonParametrageEnchereReferenceQuery innerJoinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
 *
 * @method CommonParametrageEnchereReferenceQuery leftJoinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
 * @method CommonParametrageEnchereReferenceQuery rightJoinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
 * @method CommonParametrageEnchereReferenceQuery innerJoinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
 *
 * @method CommonParametrageEnchereReferenceQuery leftJoinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference relation
 * @method CommonParametrageEnchereReferenceQuery rightJoinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference relation
 * @method CommonParametrageEnchereReferenceQuery innerJoinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference relation
 *
 * @method CommonParametrageEnchereReferenceQuery leftJoinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
 * @method CommonParametrageEnchereReferenceQuery rightJoinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
 * @method CommonParametrageEnchereReferenceQuery innerJoinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
 *
...
abstract class BaseCommonParametrageEnchereReferenceQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonParametrageEnchereRelatedByIdenchere()
     *
     * @see       filterByCommonParametrageEnchereRelatedByIdenchereOrganisme()
     *
     ...
     *
     * @param   CommonParametrageEnchere|PropelObjectCollection $commonParametrageEnchere The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonParametrageEnchereRelatedByIdenchere($commonParametrageEnchere, $comparison = null)
    {
        if ($commonParametrageEnchere instanceof CommonParametrageEnchere) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::IDENCHERE, $commonParametrageEnchere->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::IDENCHERE, $commonParametrageEnchere->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonParametrageEnchereRelatedByIdenchere() only accepts arguments of type CommonParametrageEnchere or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchere relation
     *
     ...
     * @return CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonParametrageEnchereRelatedByIdenchere($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonParametrageEnchereRelatedByIdenchere');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonParametrageEnchereRelatedByIdenchere');
        }
    ...
    /**
     * Use the CommonParametrageEnchereRelatedByIdenchere relation CommonParametrageEnchere object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonParametrageEnchereRelatedByIdenchereQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonParametrageEnchereRelatedByIdenchere($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonParametrageEnchereRelatedByIdenchere', 'CommonParametrageEnchereQuery');
    }

    /**
     * Filter the query by a related CommonParametrageEnchere object
     *
     * @param   CommonParametrageEnchere $commonParametrageEnchere The related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonParametrageEnchereRelatedByIdenchereOrganisme($commonParametrageEnchere, $comparison = null)
    {
        if ($commonParametrageEnchere instanceof CommonParametrageEnchere) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::IDENCHERE, $commonParametrageEnchere->getId(), $comparison)
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::ORGANISME, $commonParametrageEnchere->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonParametrageEnchereRelatedByIdenchereOrganisme() only accepts arguments of type CommonParametrageEnchere');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonParametrageEnchereRelatedByIdenchereOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonParametrageEnchereRelatedByIdenchereOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonParametrageEnchereRelatedByIdenchereOrganisme');
        }
    ...
    /**
     * Use the CommonParametrageEnchereRelatedByIdenchereOrganisme relation CommonParametrageEnchere object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonParametrageEnchereQuery A secondary query class using the current class as primary query
     */
    public function useCommonParametrageEnchereRelatedByIdenchereOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonParametrageEnchereRelatedByIdenchereOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonParametrageEnchereRelatedByIdenchereOrganisme', 'CommonParametrageEnchereQuery');
    }

    /**
     * Filter the query by a related CommonParametrageEnchereTrancheBaremeReference object
     *
     * @param   CommonParametrageEnchereTrancheBaremeReference|PropelObjectCollection $commonParametrageEnchereTrancheBaremeReference  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference($commonParametrageEnchereTrancheBaremeReference, $comparison = null)
    {
        if ($commonParametrageEnchereTrancheBaremeReference instanceof CommonParametrageEnchereTrancheBaremeReference) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::ID, $commonParametrageEnchereTrancheBaremeReference->getIdreference(), $comparison);
        } elseif ($commonParametrageEnchereTrancheBaremeReference instanceof PropelObjectCollection) {
            return $this
                ->useCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceQuery()
                ->filterByPrimaryKeys($commonParametrageEnchereTrancheBaremeReference->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference() only accepts arguments of type CommonParametrageEnchereTrancheBaremeReference or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference');
        }
    ...
    /**
     * Use the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference relation CommonParametrageEnchereTrancheBaremeReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonParametrageEnchereTrancheBaremeReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreference', 'CommonParametrageEnchereTrancheBaremeReferenceQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($commonParametrageEnchereTrancheBaremeReference, $comparison = null)
    {
        if ($commonParametrageEnchereTrancheBaremeReference instanceof CommonParametrageEnchereTrancheBaremeReference) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::ID, $commonParametrageEnchereTrancheBaremeReference->getIdreference(), $comparison)
                ->addUsingAlias(CommonParametrageEnchereReferencePeer::ORGANISME, $commonParametrageEnchereTrancheBaremeReference->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme() only accepts arguments of type CommonParametrageEnchereTrancheBaremeReference');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonParametrageEnchereReferenceQuery The current query, for fluid interface
     */
    public function joinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme');
        }
    ...
    /**
     * Use the CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme relation CommonParametrageEnchereTrancheBaremeReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonParametrageEnchereTrancheBaremeReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonParametrageEnchereTrancheBaremeReferenceRelatedByIdreferenceOrganisme', 'CommonParametrageEnchereTrancheBaremeReferenceQuery');
    }
