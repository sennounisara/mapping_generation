...
abstract class BaseCommonTCAOSeancePeer
{
    ...
    public static function doCountJoinCommonTCAOCommission(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonTCAOSeancePeer::ID_COMMISSION, CommonTCAOCommissionPeer::ID_COMMISSION, $join_behavior);
    ...
    /**
     * Selects a collection of CommonTCAOSeance objects pre-filled with their CommonTCAOCommission objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonTCAOSeance objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonTCAOCommission(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonTCAOSeancePeer::addSelectColumns($criteria);
        $startcol = CommonTCAOSeancePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonTCAOSeancePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonTCAOSeancePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonTCAOSeancePeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonTCAOSeance) to $obj2 (CommonTCAOCommission)
                $obj2->addCommonTCAOSeance($obj1);
    ...
    /**
     * Selects a collection of CommonTCAOSeance objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonTCAOSeancePeer::addSelectColumns($criteria);
        $startcol2 = CommonTCAOSeancePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonTCAOSeance) to the collection in $obj2 (CommonTCAOCommission)
                $obj2->addCommonTCAOSeance($obj1);
