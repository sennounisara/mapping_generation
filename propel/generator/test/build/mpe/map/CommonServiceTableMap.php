...
class CommonServiceTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonServiceTableMap';
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonAffiliationServiceRelatedByIdPoleOrganisme', 'CommonAffiliationService', RelationMap::ONE_TO_MANY, array('id' => 'id_pole', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonAffiliationServicesRelatedByIdPoleOrganisme');
        $this->addRelation('CommonAffiliationServiceRelatedByIdServiceOrganisme', 'CommonAffiliationService', RelationMap::ONE_TO_MANY, array('id' => 'id_service', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonAffiliationServicesRelatedByIdServiceOrganisme');
    } // buildRelations()
