 ...
 *
 * @method CommonDemandeAchatParCatalogueQuery leftJoinCommonAgent($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgent relation
 * @method CommonDemandeAchatParCatalogueQuery rightJoinCommonAgent($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgent relation
 * @method CommonDemandeAchatParCatalogueQuery innerJoinCommonAgent($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgent relation
 *
 * @method CommonDemandeAchatParCatalogueQuery leftJoinCommonOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonDemandeAchatParCatalogueQuery rightJoinCommonOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonOrganisme relation
 * @method CommonDemandeAchatParCatalogueQuery innerJoinCommonOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonOrganisme relation
 *
...
abstract class BaseCommonDemandeAchatParCatalogueQuery extends ModelCriteria
{
    ...
    public function filterByCommonAgent($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonDemandeAchatParCataloguePeer::ID_AGENT, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonDemandeAchatParCataloguePeer::ID_AGENT, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonOrganisme($commonOrganisme, $comparison = null)
    {
        if ($commonOrganisme instanceof CommonOrganisme) {
            return $this
                ->addUsingAlias(CommonDemandeAchatParCataloguePeer::ORGANISME, $commonOrganisme->getAcronyme(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonDemandeAchatParCataloguePeer::ORGANISME, $commonOrganisme->toKeyValue('PrimaryKey', 'Acronyme'), $comparison);
        } else {
