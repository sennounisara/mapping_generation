 ...
 *
 * @method CommonCriteresEvaluationQuery leftJoinCommonItemCritereEvaluation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonItemCritereEvaluation relation
 * @method CommonCriteresEvaluationQuery rightJoinCommonItemCritereEvaluation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonItemCritereEvaluation relation
 * @method CommonCriteresEvaluationQuery innerJoinCommonItemCritereEvaluation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonItemCritereEvaluation relation
 *
...
abstract class BaseCommonCriteresEvaluationQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related CommonItemCritereEvaluation object
     *
     * @param   CommonItemCritereEvaluation|PropelObjectCollection $commonItemCritereEvaluation  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonCriteresEvaluationQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonItemCritereEvaluation($commonItemCritereEvaluation, $comparison = null)
    {
        if ($commonItemCritereEvaluation instanceof CommonItemCritereEvaluation) {
            return $this
                ->addUsingAlias(CommonCriteresEvaluationPeer::ID, $commonItemCritereEvaluation->getIdcritereevaluation(), $comparison);
        } elseif ($commonItemCritereEvaluation instanceof PropelObjectCollection) {
            return $this
                ->useCommonItemCritereEvaluationQuery()
                ->filterByPrimaryKeys($commonItemCritereEvaluation->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonItemCritereEvaluation() only accepts arguments of type CommonItemCritereEvaluation or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonItemCritereEvaluation relation
     *
     ...
     * @return CommonCriteresEvaluationQuery The current query, for fluid interface
     */
    public function joinCommonItemCritereEvaluation($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonItemCritereEvaluation');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonItemCritereEvaluation');
        }
    ...
    /**
     * Use the CommonItemCritereEvaluation relation CommonItemCritereEvaluation object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonItemCritereEvaluationQuery A secondary query class using the current class as primary query
     */
    public function useCommonItemCritereEvaluationQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonItemCritereEvaluation($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonItemCritereEvaluation', 'CommonItemCritereEvaluationQuery');
    }
