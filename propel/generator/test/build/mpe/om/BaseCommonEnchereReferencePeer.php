...
abstract class BaseCommonEnchereReferencePeer
{
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonEnchereOffreReferencePeer::clearInstancePool();
        // Invalidate objects in CommonEnchereTrancheBaremeReferencePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function doCountJoinCommonEncherePmiRelatedByIdenchere(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonEnchereReferencePeer::IDENCHERE, CommonEncherePmiPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonEncherePmiRelatedByIdenchereOrganisme(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        array(CommonEnchereReferencePeer::IDENCHERE, CommonEncherePmiPeer::ID),
        array(CommonEnchereReferencePeer::ORGANISME, CommonEncherePmiPeer::ORGANISME),
      ), $join_behavior);
    ...
    /**
     * Selects a collection of CommonEnchereReference objects pre-filled with their CommonEncherePmi objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonEnchereReference objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonEncherePmiRelatedByIdenchere(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonEnchereReferencePeer::addSelectColumns($criteria);
        $startcol = CommonEnchereReferencePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonEnchereReferencePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonEnchereReferencePeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonEnchereReferencePeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonEnchereReference) to $obj2 (CommonEncherePmi)
                $obj2->addCommonEnchereReferenceRelatedByIdenchere($obj1);
    ...
    public static function doSelectJoinCommonEncherePmiRelatedByIdenchereOrganisme(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonEnchereReference) to $obj2 (CommonEncherePmi)
                $obj2->addCommonEnchereReferenceRelatedByIdenchereOrganisme($obj1);
    ...
    /**
     * Selects a collection of CommonEnchereReference objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonEnchereReferencePeer::addSelectColumns($criteria);
        $startcol2 = CommonEnchereReferencePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonEnchereReference) to the collection in $obj2 (CommonEncherePmi)
                $obj2->addCommonEnchereReferenceRelatedByIdenchere($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonEnchereReference) to the collection in $obj3 (CommonEncherePmi)
                $obj3->addCommonEnchereReferenceRelatedByIdenchereOrganisme($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonEnchereReference objects pre-filled with all related objects except CommonEncherePmiRelatedByIdenchere.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonEnchereReference objects pre-filled with all related objects except CommonEncherePmiRelatedByIdenchereOrganisme.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonEnchereReferencePeer::doOnDeleteCascade(new Criteria(CommonEnchereReferencePeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonEnchereReferencePeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonEnchereReferencePeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonEnchereReferencePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(CommonEnchereOffreReferencePeer::IDENCHEREREFERENCE, $obj->getId());
            ...
            // delete related CommonEnchereTrancheBaremeReference objects
            $criteria = new Criteria(CommonEnchereTrancheBaremeReferencePeer::DATABASE_NAME);
            
            $criteria->add(CommonEnchereTrancheBaremeReferencePeer::IDREFERENCE, $obj->getId());
            $affectedRows += CommonEnchereTrancheBaremeReferencePeer::doDelete($criteria, $con);

            // delete related CommonEnchereTrancheBaremeReference objects
            $criteria = new Criteria(CommonEnchereTrancheBaremeReferencePeer::DATABASE_NAME);
            
            $criteria->add(CommonEnchereTrancheBaremeReferencePeer::IDREFERENCE, $obj->getId());
            $criteria->add(CommonEnchereTrancheBaremeReferencePeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonEnchereTrancheBaremeReferencePeer::doDelete($criteria, $con);
            ...
            $criteria->add(CommonEnchereValeursInitialesPeer::IDENCHEREREFERENCE, $obj->getId());
