...
abstract class BaseCommonExecContratPeer
{
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecContratPeer::ID_AGENT_CREA, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonAgentRelatedByIdAgentGestion table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonAgentRelatedByIdAgentGestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(CommonExecContratPeer::ID_AGENT_GESTION, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecContratPeer::ID_AGENT_MODIF, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonCategorieConsultation table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonCategorieConsultation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(CommonExecContratPeer::ID_NATURE_PRESTATION, CommonCategorieConsultationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecContrat objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecContrat) to $obj2 (CommonAgent)
                $obj2->addCommonExecContratRelatedByIdAgentCrea($obj1);
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonAgentRelatedByIdAgentGestion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecContrat) to $obj2 (CommonAgent)
                $obj2->addCommonExecContratRelatedByIdAgentGestion($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecContrat) to $obj2 (CommonAgent)
                $obj2->addCommonExecContratRelatedByIdAgentModif($obj1);
    ...
    /**
     * Selects a collection of CommonExecContrat objects pre-filled with their CommonCategorieConsultation objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonExecContrat objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonCategorieConsultation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = CommonCategorieConsultationPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CommonCategorieConsultationPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    CommonCategorieConsultationPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (CommonExecContrat) to $obj2 (CommonCategorieConsultation)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonCategorieConsultationPeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CommonCategorieConsultationPeer::NUM_HYDRATE_COLUMNS;

        CommonExecTypeContratPeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + CommonExecTypeContratPeer::NUM_HYDRATE_COLUMNS;

        CommonExecTypeStructurePeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonExecTypeStructurePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecContratRelatedByIdAgentCrea($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj3 (CommonAgent)
                $obj3->addCommonExecContratRelatedByIdAgentGestion($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj4 (CommonAgent)
                $obj4->addCommonExecContratRelatedByIdAgentModif($obj1);
            } // if joined row not null

            // Add objects for joined CommonCategorieConsultation rows

            $key5 = CommonCategorieConsultationPeer::getPrimaryKeyHashFromRow($row, $startcol5);
            if ($key5 !== null) {
                $obj5 = CommonCategorieConsultationPeer::getInstanceFromPool($key5);
                if (!$obj5) {
                    ...
                    CommonCategorieConsultationPeer::addInstanceToPool($obj5, $key5);
                } // if obj5 loaded

                // Add the $obj1 (CommonExecContrat) to the collection in $obj5 (CommonCategorieConsultation)
                $obj5->addCommonExecContrat($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecTypeContrat rows

            $key6 = CommonExecTypeContratPeer::getPrimaryKeyHashFromRow($row, $startcol6);
            if ($key6 !== null) {
                $obj6 = CommonExecTypeContratPeer::getInstanceFromPool($key6);
                if (!$obj6) {
                    ...
                    CommonExecTypeContratPeer::addInstanceToPool($obj6, $key6);
                } // if obj6 loaded

                // Add the $obj1 (CommonExecContrat) to the collection in $obj6 (CommonExecTypeContrat)
                $obj6->addCommonExecContrat($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecTypeStructure rows

            $key7 = CommonExecTypeStructurePeer::getPrimaryKeyHashFromRow($row, $startcol7);
            if ($key7 !== null) {
                $obj7 = CommonExecTypeStructurePeer::getInstanceFromPool($key7);
                if (!$obj7) {
                    ...
                    CommonExecTypeStructurePeer::addInstanceToPool($obj7, $key7);
                } // if obj7 loaded

                // Add the $obj1 (CommonExecContrat) to the collection in $obj7 (CommonExecTypeStructure)
                $obj7->addCommonExecContrat($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptCommonAgentRelatedByIdAgentGestion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptCommonCategorieConsultation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of CommonExecContrat objects pre-filled with all related objects except CommonAgentRelatedByIdAgentCrea.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonCategorieConsultationPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonCategorieConsultationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecContratPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = CommonCategorieConsultationPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = CommonCategorieConsultationPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj2 (CommonCategorieConsultation)
                $obj2->addCommonExecContrat($obj1);
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj3 (CommonExecTypeContrat)
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj4 (CommonExecTypeStructure)
                $obj4->addCommonExecContrat($obj1);
    ...
    /**
     * Selects a collection of CommonExecContrat objects pre-filled with all related objects except CommonAgentRelatedByIdAgentGestion.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptCommonAgentRelatedByIdAgentGestion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of CommonExecContrat objects pre-filled with all related objects except CommonAgentRelatedByIdAgentModif.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecContrat objects pre-filled with all related objects except CommonCategorieConsultation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptCommonCategorieConsultation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        CommonExecTypeContratPeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CommonExecTypeContratPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecContratPeer::getInstanceFromPool($key1))) {
                ...
                $key5 = CommonExecTypeContratPeer::getPrimaryKeyHashFromRow($row, $startcol5);
                if ($key5 !== null) {
                    $obj5 = CommonExecTypeContratPeer::getInstanceFromPool($key5);
                    if (!$obj5) {
                    ...
                    $obj5 = new $cls();
                    $obj5->hydrate($row, $startcol5);
                    CommonExecTypeContratPeer::addInstanceToPool($obj5, $key5);
                } // if $obj5 already loaded

                // Add the $obj1 (CommonExecContrat) to the collection in $obj5 (CommonExecTypeContrat)
                $obj5->addCommonExecContrat($obj1);
                ...
                // Add the $obj1 (CommonExecContrat) to the collection in $obj6 (CommonExecTypeStructure)
                $obj6->addCommonExecContrat($obj1);
