...
abstract class BaseCommonEncherePmiPeer
{
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonEnchereOffrePeer::clearInstancePool();
        // Invalidate objects in CommonEnchereReferencePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonEnchereReferencePeer::clearInstancePool();
        // Invalidate objects in CommonEnchereReferencePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonEnchereReferencePeer::clearInstancePool();
        // Invalidate objects in CommonEnchereTranchesBaremeNETCPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonEncherePmiPeer::doOnDeleteCascade(new Criteria(CommonEncherePmiPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonEncherePmiPeer::doOnDeleteCascade($c, $con);
            ...
            if ($values instanceof Criteria) {
                ...
                foreach ((array) $values as $singleval) {
                    CommonEncherePmiPeer::removeInstanceFromPool($singleval);
                }
            }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonEncherePmiPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(CommonEnchereOffrePeer::IDENCHERE, $obj->getId());
            ...
            // delete related CommonEnchereReference objects
            $criteria = new Criteria(CommonEnchereReferencePeer::DATABASE_NAME);
            
            $criteria->add(CommonEnchereReferencePeer::IDENCHERE, $obj->getId());
            $affectedRows += CommonEnchereReferencePeer::doDelete($criteria, $con);

            // delete related CommonEnchereReference objects
            $criteria = new Criteria(CommonEnchereReferencePeer::DATABASE_NAME);
            
            $criteria->add(CommonEnchereReferencePeer::IDENCHERE, $obj->getId());
            $criteria->add(CommonEnchereReferencePeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonEnchereReferencePeer::doDelete($criteria, $con);

            // delete related CommonEnchereTranchesBaremeNETC objects
            $criteria = new Criteria(CommonEnchereTranchesBaremeNETCPeer::DATABASE_NAME);
            
            $criteria->add(CommonEnchereTranchesBaremeNETCPeer::IDENCHERE, $obj->getId());
            $criteria->add(CommonEnchereTranchesBaremeNETCPeer::ORGANISME, $obj->getOrganisme());
            $affectedRows += CommonEnchereTranchesBaremeNETCPeer::doDelete($criteria, $con);
