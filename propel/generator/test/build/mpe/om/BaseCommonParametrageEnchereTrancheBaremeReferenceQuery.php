 ...
 *
 * @method CommonParametrageEnchereTrancheBaremeReferenceQuery leftJoinCommonParametrageEnchereReferenceRelatedByIdreference($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreference relation
 * @method CommonParametrageEnchereTrancheBaremeReferenceQuery rightJoinCommonParametrageEnchereReferenceRelatedByIdreference($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreference relation
 * @method CommonParametrageEnchereTrancheBaremeReferenceQuery innerJoinCommonParametrageEnchereReferenceRelatedByIdreference($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreference relation
 *
 * @method CommonParametrageEnchereTrancheBaremeReferenceQuery leftJoinCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme relation
 * @method CommonParametrageEnchereTrancheBaremeReferenceQuery rightJoinCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme relation
 * @method CommonParametrageEnchereTrancheBaremeReferenceQuery innerJoinCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme relation
 *
...
abstract class BaseCommonParametrageEnchereTrancheBaremeReferenceQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonParametrageEnchereReferenceRelatedByIdreference()
     *
     * @see       filterByCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme()
     *
     ...
     *
     * @param   CommonParametrageEnchereReference|PropelObjectCollection $commonParametrageEnchereReference The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonParametrageEnchereTrancheBaremeReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonParametrageEnchereReferenceRelatedByIdreference($commonParametrageEnchereReference, $comparison = null)
    {
        if ($commonParametrageEnchereReference instanceof CommonParametrageEnchereReference) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereTrancheBaremeReferencePeer::IDREFERENCE, $commonParametrageEnchereReference->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonParametrageEnchereTrancheBaremeReferencePeer::IDREFERENCE, $commonParametrageEnchereReference->toKeyValue('Id', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonParametrageEnchereReferenceRelatedByIdreference() only accepts arguments of type CommonParametrageEnchereReference or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreference relation
     *
     ...
     * @return CommonParametrageEnchereTrancheBaremeReferenceQuery The current query, for fluid interface
     */
    public function joinCommonParametrageEnchereReferenceRelatedByIdreference($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonParametrageEnchereReferenceRelatedByIdreference');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonParametrageEnchereReferenceRelatedByIdreference');
        }
    ...
    /**
     * Use the CommonParametrageEnchereReferenceRelatedByIdreference relation CommonParametrageEnchereReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonParametrageEnchereReferenceRelatedByIdreferenceQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonParametrageEnchereReferenceRelatedByIdreference($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonParametrageEnchereReferenceRelatedByIdreference', 'CommonParametrageEnchereReferenceQuery');
    }

    /**
     * Filter the query by a related CommonParametrageEnchereReference object
     *
     * @param   CommonParametrageEnchereReference $commonParametrageEnchereReference The related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonParametrageEnchereTrancheBaremeReferenceQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme($commonParametrageEnchereReference, $comparison = null)
    {
        if ($commonParametrageEnchereReference instanceof CommonParametrageEnchereReference) {
            return $this
                ->addUsingAlias(CommonParametrageEnchereTrancheBaremeReferencePeer::IDREFERENCE, $commonParametrageEnchereReference->getId(), $comparison)
                ->addUsingAlias(CommonParametrageEnchereTrancheBaremeReferencePeer::ORGANISME, $commonParametrageEnchereReference->getOrganisme(), $comparison);
        } else {
            throw new PropelException('filterByCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme() only accepts arguments of type CommonParametrageEnchereReference');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonParametrageEnchereTrancheBaremeReferenceQuery The current query, for fluid interface
     */
    public function joinCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme');
        }
    ...
    /**
     * Use the CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme relation CommonParametrageEnchereReference object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonParametrageEnchereReferenceQuery A secondary query class using the current class as primary query
     */
    public function useCommonParametrageEnchereReferenceRelatedByIdreferenceOrganismeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonParametrageEnchereReferenceRelatedByIdreferenceOrganisme', 'CommonParametrageEnchereReferenceQuery');
    }
