 ...
 */
class CommonTModeleDocumentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonTModeleDocumentTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CommonTModeleDocument');
        $this->setClassname('CommonTModeleDocument');
