 ...
 *
 * @method CommonEchangeQuery leftJoinCommonEchangeDestinataire($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEchangeDestinataire relation
 * @method CommonEchangeQuery rightJoinCommonEchangeDestinataire($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEchangeDestinataire relation
 * @method CommonEchangeQuery innerJoinCommonEchangeDestinataire($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEchangeDestinataire relation
 *
 * @method CommonEchangeQuery leftJoinCommonEchangePieceJointe($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEchangePieceJointe relation
 * @method CommonEchangeQuery rightJoinCommonEchangePieceJointe($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEchangePieceJointe relation
 * @method CommonEchangeQuery innerJoinCommonEchangePieceJointe($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEchangePieceJointe relation
 *
...
abstract class BaseCommonEchangeQuery extends ModelCriteria
{
    ...
    public function filterByCommonEchangeDestinataire($commonEchangeDestinataire, $comparison = null)
    {
        if ($commonEchangeDestinataire instanceof CommonEchangeDestinataire) {
            return $this
                ->addUsingAlias(CommonEchangePeer::ID, $commonEchangeDestinataire->getIdEchange(), $comparison);
     ...
     * @return CommonEchangeQuery The current query, for fluid interface
     */
    public function joinCommonEchangeDestinataire($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonEchangeDestinataireQuery A secondary query class using the current class as primary query
     */
    public function useCommonEchangeDestinataireQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEchangeDestinataire($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEchangeDestinataire', 'CommonEchangeDestinataireQuery');
    }

    /**
     * Filter the query by a related CommonEchangePieceJointe object
     *
     * @param   CommonEchangePieceJointe|PropelObjectCollection $commonEchangePieceJointe  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 CommonEchangeQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEchangePieceJointe($commonEchangePieceJointe, $comparison = null)
    {
        if ($commonEchangePieceJointe instanceof CommonEchangePieceJointe) {
            return $this
                ->addUsingAlias(CommonEchangePeer::ID, $commonEchangePieceJointe->getIdMessage(), $comparison);
        } elseif ($commonEchangePieceJointe instanceof PropelObjectCollection) {
            return $this
                ->useCommonEchangePieceJointeQuery()
                ->filterByPrimaryKeys($commonEchangePieceJointe->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByCommonEchangePieceJointe() only accepts arguments of type CommonEchangePieceJointe or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEchangePieceJointe relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonEchangeQuery The current query, for fluid interface
     */
    public function joinCommonEchangePieceJointe($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEchangePieceJointe');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEchangePieceJointe');
        }
    ...
    /**
     * Use the CommonEchangePieceJointe relation CommonEchangePieceJointe object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   CommonEchangePieceJointeQuery A secondary query class using the current class as primary query
     */
    public function useCommonEchangePieceJointeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCommonEchangePieceJointe($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEchangePieceJointe', 'CommonEchangePieceJointeQuery');
    }
