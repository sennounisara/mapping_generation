 ...
 *
 * @method CommonPanierEntrepriseQuery leftJoinCommonEntreprise($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonPanierEntrepriseQuery rightJoinCommonEntreprise($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEntreprise relation
 * @method CommonPanierEntrepriseQuery innerJoinCommonEntreprise($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEntreprise relation
 *
 * @method CommonPanierEntrepriseQuery leftJoinCommonInscrit($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonInscrit relation
 * @method CommonPanierEntrepriseQuery rightJoinCommonInscrit($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonInscrit relation
 * @method CommonPanierEntrepriseQuery innerJoinCommonInscrit($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonInscrit relation
 *
...
abstract class BaseCommonPanierEntrepriseQuery extends ModelCriteria
{
    ...
    public function filterByCommonEntreprise($commonEntreprise, $comparison = null)
    {
        if ($commonEntreprise instanceof CommonEntreprise) {
            return $this
                ->addUsingAlias(CommonPanierEntreprisePeer::ID_ENTREPRISE, $commonEntreprise->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonPanierEntreprisePeer::ID_ENTREPRISE, $commonEntreprise->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonInscrit($commonInscrit, $comparison = null)
    {
        if ($commonInscrit instanceof CommonInscrit) {
            return $this
                ->addUsingAlias(CommonPanierEntreprisePeer::ID_INSCRIT, $commonInscrit->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonPanierEntreprisePeer::ID_INSCRIT, $commonInscrit->toKeyValue('Id', 'Id'), $comparison);
        } else {
