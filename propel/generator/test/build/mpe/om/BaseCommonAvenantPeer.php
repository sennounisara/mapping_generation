...
abstract class BaseCommonAvenantPeer
{
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonContrat table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonContrat(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonAvenantPeer::ID_CONTRAT, CommonContratPeer::ID_CONTRAT, $join_behavior);
    ...
    /**
     * Selects a collection of CommonAvenant objects pre-filled with their CommonContrat objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonAvenant objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonContrat(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        CommonAvenantPeer::addSelectColumns($criteria);
        $startcol = CommonAvenantPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CommonAvenantPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CommonAvenantPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CommonAvenantPeer::addInstanceToPool($obj1, $key1);
            } // if $obj1 already loaded

            $key2 = CommonContratPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = CommonContratPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    CommonContratPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (CommonAvenant) to $obj2 (CommonContrat)
                $obj2->addCommonAvenant($obj1);
    ...
    /**
     * Selects a collection of CommonAvenant objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonAvenantPeer::addSelectColumns($criteria);
        $startcol2 = CommonAvenantPeer::NUM_HYDRATE_COLUMNS;

        CommonContratPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + CommonContratPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined CommonContrat rows

            $key2 = CommonContratPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = CommonContratPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (CommonAvenant) to the collection in $obj2 (CommonContrat)
                $obj2->addCommonAvenant($obj1);
