...
/**
 * Base class that represents a row from the 'exec_type_structure' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecTypeStructure extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecTypeStructurePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecTypeStructurePeer
     */
    ...
    /**
     * @var        PropelObjectCollection|CommonExecTypeContractant[] Collection to store aggregation of CommonExecTypeContractant objects.
     */
    protected $collCommonExecTypeContractants;
    protected $collCommonExecTypeContractantsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $commonExecTypeContractantsScheduledForDeletion = null;
     ...
     * @return CommonExecTypeStructure The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecTypeStructurePeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecTypeStructurePeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonExecTypeStructurePeer::LIBELLE_FR;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonExecTypeStructurePeer::LIBELLE_AR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonExecTypeStructurePeer::LIBELLE_EN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = CommonExecTypeStructurePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecTypeStructure object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecTypeStructurePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collCommonExecTypeContractants = null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(CommonExecTypeStructurePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = CommonExecTypeStructureQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecTypeStructurePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commonExecTypeContractantsScheduledForDeletion !== null) {
                if (!$this->commonExecTypeContractantsScheduledForDeletion->isEmpty()) {
                    foreach ($this->commonExecTypeContractantsScheduledForDeletion as $commonExecTypeContractant) {
                        // need to save related object because we set the relation to null
                        $commonExecTypeContractant->save($con);
                    }
                    $this->commonExecTypeContractantsScheduledForDeletion = null;
                }
            }

            if ($this->collCommonExecTypeContractants !== null) {
                foreach ($this->collCommonExecTypeContractants as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CommonExecTypeStructurePeer::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CommonExecTypeStructurePeer::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CommonExecTypeStructurePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_type_structure` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecTypeStructurePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecTypeStructurePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecTypeStructure'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecTypeStructure'][$this->getPrimaryKey()] = true;
        $keys = CommonExecTypeStructurePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collCommonExecTypeContractants) {
                $result['CommonExecTypeContractants'] = $this->collCommonExecTypeContractants->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    {
        $criteria = new Criteria(CommonExecTypeStructurePeer::DATABASE_NAME);

        if ($this->isColumnModified(CommonExecTypeStructurePeer::ID)) $criteria->add(CommonExecTypeStructurePeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE)) $criteria->add(CommonExecTypeStructurePeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE_FR)) $criteria->add(CommonExecTypeStructurePeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE_AR)) $criteria->add(CommonExecTypeStructurePeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonExecTypeStructurePeer::LIBELLE_EN)) $criteria->add(CommonExecTypeStructurePeer::LIBELLE_EN, $this->libelle_en);
    ...
    {
        $criteria = new Criteria(CommonExecTypeStructurePeer::DATABASE_NAME);
        $criteria->add(CommonExecTypeStructurePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecTypeStructure (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getCommonExecTypeContractants() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addCommonExecTypeContractant($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecTypeStructure Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecTypeStructurePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecTypeStructurePeer();
        }
    ...
    public function initRelation($relationName)
    {
        ...
        if ('CommonExecTypeContractant' == $relationName) {
            $this->initCommonExecTypeContractants();
        }
    }
     ...
     * If this CommonExecTypeStructure is new, it will return
        ...
        if (null === $this->collCommonExecContractants || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonExecContractants) {
                ...
                $collCommonExecContractants = CommonExecContractantQuery::create(null, $criteria)
                    ->filterByCommonExecTypeStructure($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCommonExecContractants(PropelCollection $commonExecContractants, PropelPDO $con = null)
    {
        ...
        foreach ($commonExecContractantsToDelete as $commonExecContractantRemoved) {
            $commonExecContractantRemoved->setCommonExecTypeStructure(null);
        }
    ...
    protected function doAddCommonExecContractant($commonExecContractant)
    {
        ...
        $commonExecContractant->setCommonExecTypeStructure($this);
    }
    ...
    public function removeCommonExecContractant($commonExecContractant)
    {
        if ($this->getCommonExecContractants()->contains($commonExecContractant)) {
            ...
            $commonExecContractant->setCommonExecTypeStructure(null);
        }
     ...
     * Otherwise if this CommonExecTypeStructure is new, it will return
     * an empty collection; or if this CommonExecTypeStructure has previously
     * been saved, it will retrieve related CommonExecContractants from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonExecTypeStructure.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setCommonExecContrats(PropelCollection $commonExecContrats, PropelPDO $con = null)
    {
        ...
        foreach ($commonExecContratsToDelete as $commonExecContratRemoved) {
            $commonExecContratRemoved->setCommonExecTypeStructure(null);
        }
    ...
    protected function doAddCommonExecContrat($commonExecContrat)
    {
        ...
        $commonExecContrat->setCommonExecTypeStructure($this);
    }
    ...
    public function removeCommonExecContrat($commonExecContrat)
    {
        if ($this->getCommonExecContrats()->contains($commonExecContrat)) {
            ...
            $this->commonExecContratsScheduledForDeletion[]= $commonExecContrat;
            $commonExecContrat->setCommonExecTypeStructure(null);
        }
     ...
     * @return PropelObjectCollection|CommonExecContrat[] List of CommonExecContrat objects
     */
    public function getCommonExecContratsJoinCommonCategorieConsultation($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommonExecContratQuery::create(null, $criteria);
    ...
    /**
     * Clears out the collCommonExecTypeContractants collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return CommonExecTypeStructure The current object (for fluent API support)
     * @see        addCommonExecTypeContractants()
     */
    public function clearCommonExecTypeContractants()
    {
        $this->collCommonExecTypeContractants = null; // important to set this to null since that means it is uninitialized
        $this->collCommonExecTypeContractantsPartial = null;

        return $this;
    }

    /**
     * reset is the collCommonExecTypeContractants collection loaded partially
     *
     * @return void
     */
    public function resetPartialCommonExecTypeContractants($v = true)
    {
        $this->collCommonExecTypeContractantsPartial = $v;
    }

    /**
     * Initializes the collCommonExecTypeContractants collection.
     *
     * By default this just sets the collCommonExecTypeContractants collection to an empty array (like clearcollCommonExecTypeContractants());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initCommonExecTypeContractants($overrideExisting = true)
    {
        if (null !== $this->collCommonExecTypeContractants && !$overrideExisting) {
            return;
        }
        $this->collCommonExecTypeContractants = new PropelObjectCollection();
        $this->collCommonExecTypeContractants->setModel('CommonExecTypeContractant');
    }

    /**
     * Gets an array of CommonExecTypeContractant objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|CommonExecTypeContractant[] List of CommonExecTypeContractant objects
     * @throws PropelException
     */
    public function getCommonExecTypeContractants($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collCommonExecTypeContractantsPartial && !$this->isNew();
        if (null === $this->collCommonExecTypeContractants || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonExecTypeContractants) {
                // return empty collection
                $this->initCommonExecTypeContractants();
            } else {
                $collCommonExecTypeContractants = CommonExecTypeContractantQuery::create(null, $criteria)
                    ->filterByCommonExecTypeStructure($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collCommonExecTypeContractantsPartial && count($collCommonExecTypeContractants)) {
                      $this->initCommonExecTypeContractants(false);

                      foreach ($collCommonExecTypeContractants as $obj) {
                        if (false == $this->collCommonExecTypeContractants->contains($obj)) {
                          $this->collCommonExecTypeContractants->append($obj);
                        }
                      }

                      $this->collCommonExecTypeContractantsPartial = true;
                    }

                    $collCommonExecTypeContractants->getInternalIterator()->rewind();

                    return $collCommonExecTypeContractants;
                }

                if ($partial && $this->collCommonExecTypeContractants) {
                    foreach ($this->collCommonExecTypeContractants as $obj) {
                        if ($obj->isNew()) {
                            $collCommonExecTypeContractants[] = $obj;
                        }
                    }
                }

                $this->collCommonExecTypeContractants = $collCommonExecTypeContractants;
                $this->collCommonExecTypeContractantsPartial = false;
            }
        }

        return $this->collCommonExecTypeContractants;
    }

    /**
     * Sets a collection of CommonExecTypeContractant objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $commonExecTypeContractants A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return CommonExecTypeStructure The current object (for fluent API support)
     */
    public function setCommonExecTypeContractants(PropelCollection $commonExecTypeContractants, PropelPDO $con = null)
    {
        $commonExecTypeContractantsToDelete = $this->getCommonExecTypeContractants(new Criteria(), $con)->diff($commonExecTypeContractants);


        $this->commonExecTypeContractantsScheduledForDeletion = $commonExecTypeContractantsToDelete;

        foreach ($commonExecTypeContractantsToDelete as $commonExecTypeContractantRemoved) {
            $commonExecTypeContractantRemoved->setCommonExecTypeStructure(null);
        }

        $this->collCommonExecTypeContractants = null;
        foreach ($commonExecTypeContractants as $commonExecTypeContractant) {
            $this->addCommonExecTypeContractant($commonExecTypeContractant);
        }

        $this->collCommonExecTypeContractants = $commonExecTypeContractants;
        $this->collCommonExecTypeContractantsPartial = false;
    ...
    /**
     * Returns the number of related CommonExecTypeContractant objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related CommonExecTypeContractant objects.
     * @throws PropelException
     */
    public function countCommonExecTypeContractants(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collCommonExecTypeContractantsPartial && !$this->isNew();
        if (null === $this->collCommonExecTypeContractants || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collCommonExecTypeContractants) {
            ...
            if ($partial && !$criteria) {
                return count($this->getCommonExecTypeContractants());
            }
            $query = CommonExecTypeContractantQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collCommonExecTypeContractants);
    }

    /**
     * Method called to associate a CommonExecTypeContractant object to this object
     * through the CommonExecTypeContractant foreign key attribute.
     *
     * @param   CommonExecTypeContractant $l CommonExecTypeContractant
     * @return CommonExecTypeStructure The current object (for fluent API support)
     */
    public function addCommonExecTypeContractant(CommonExecTypeContractant $l)
    {
        if ($this->collCommonExecTypeContractants === null) {
            $this->initCommonExecTypeContractants();
            $this->collCommonExecTypeContractantsPartial = true;
        }
        if (!in_array($l, $this->collCommonExecTypeContractants->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddCommonExecTypeContractant($l);
        }
    ...
    /**
     * @param	CommonExecTypeContractant $commonExecTypeContractant The commonExecTypeContractant object to add.
     */
    protected function doAddCommonExecTypeContractant($commonExecTypeContractant)
    {
        $this->collCommonExecTypeContractants[]= $commonExecTypeContractant;
        $commonExecTypeContractant->setCommonExecTypeStructure($this);
    }

    /**
     * @param	CommonExecTypeContractant $commonExecTypeContractant The commonExecTypeContractant object to remove.
     * @return CommonExecTypeStructure The current object (for fluent API support)
     */
    public function removeCommonExecTypeContractant($commonExecTypeContractant)
    {
        if ($this->getCommonExecTypeContractants()->contains($commonExecTypeContractant)) {
            $this->collCommonExecTypeContractants->remove($this->collCommonExecTypeContractants->search($commonExecTypeContractant));
            if (null === $this->commonExecTypeContractantsScheduledForDeletion) {
                $this->commonExecTypeContractantsScheduledForDeletion = clone $this->collCommonExecTypeContractants;
                $this->commonExecTypeContractantsScheduledForDeletion->clear();
            }
            $this->commonExecTypeContractantsScheduledForDeletion[]= clone $commonExecTypeContractant;
            $commonExecTypeContractant->setCommonExecTypeStructure(null);
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collCommonExecTypeContractants) {
                foreach ($this->collCommonExecTypeContractants as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collCommonExecContrats = null;
        if ($this->collCommonExecTypeContractants instanceof PropelCollection) {
            $this->collCommonExecTypeContractants->clearIterator();
        }
        $this->collCommonExecTypeContractants = null;
    }
    ...
    {
        return (string) $this->exportTo(CommonExecTypeStructurePeer::DEFAULT_STRING_FORMAT);
    }
