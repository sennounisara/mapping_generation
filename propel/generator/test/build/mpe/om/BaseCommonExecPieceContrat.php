...
/**
 * Base class that represents a row from the 'exec_piece_contrat' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonExecPieceContrat extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecPieceContratPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecPieceContratPeer
     */
    ...
    /**
     * The value for the attached field.
    ...
    /**
     * Initializes internal state of BaseCommonExecPieceContrat object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonExecPieceContrat The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecPieceContratPeer::ID;
        }
    ...
    public function setIdContrat($v)
    {
        ...
        if ($this->id_contrat !== $v) {
            $this->id_contrat = $v;
            $this->modifiedColumns[] = CommonExecPieceContratPeer::ID_CONTRAT;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecPieceContratPeer::LIBELLE;
        }
    ...
    public function setIdAgentCrea($v)
    {
        ...
        if ($this->id_agent_crea !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceContratPeer::ID_AGENT_CREA;
        }
    ...
    public function setDateCreat($v)
    {
        ...
        if ($this->date_creat !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonExecPieceContratPeer::DATE_CREAT;
            }
    ...
    public function setIdAgentModif($v)
    {
        ...
        if ($this->id_agent_modif !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecPieceContratPeer::ID_AGENT_MODIF;
        }
    ...
    public function setDateModif($v)
    {
        ...
        if ($this->date_modif !== $v) {
            $this->date_modif = $v;
            $this->modifiedColumns[] = CommonExecPieceContratPeer::DATE_MODIF;
        }
    ...
    /**
     * Set the value of [attached] column.
     * 
     * @param string $v new value
     * @return CommonExecPieceContrat The current object (for fluent API support)
     */
    public function setAttached($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->attached !== $v) {
            $this->attached = $v;
            $this->modifiedColumns[] = CommonExecPieceContratPeer::ATTACHED;
        }
    ...
    public function setOriginal($v)
    {
        ...
        if ($this->original !== $v) {
            $this->original = $v;
            $this->modifiedColumns[] = CommonExecPieceContratPeer::ORIGINAL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_agent_crea = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->date_creat = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->id_agent_modif = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->date_modif = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->attached = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            return $startcol + 9; // 9 = CommonExecPieceContratPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecPieceContrat object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecPieceContratPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecPieceContratQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecPieceContratPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID_CONTRAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_contrat`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID_AGENT_CREA)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_crea`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::DATE_CREAT)) {
            $modifiedColumns[':p' . $index++]  = '`date_creat`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID_AGENT_MODIF)) {
            $modifiedColumns[':p' . $index++]  = '`id_agent_modif`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::DATE_MODIF)) {
            $modifiedColumns[':p' . $index++]  = '`date_modif`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::ATTACHED)) {
            $modifiedColumns[':p' . $index++]  = '`attached`';
        }
        if ($this->isColumnModified(CommonExecPieceContratPeer::ORIGINAL)) {
            $modifiedColumns[':p' . $index++]  = '`original`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_piece_contrat` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`date_modif`':						
                        ...
                        break;
                    case '`attached`':						
                        $stmt->bindValue($identifier, $this->attached, PDO::PARAM_STR);
                        break;
                    case '`original`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecPieceContratPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecPieceContratPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecPieceContrat'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecPieceContrat'][$this->getPrimaryKey()] = true;
        $keys = CommonExecPieceContratPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getIdContrat(),
            $keys[2] => $this->getLibelle(),
            $keys[3] => $this->getIdAgentCrea(),
            $keys[4] => $this->getDateCreat(),
            $keys[5] => $this->getIdAgentModif(),
            $keys[6] => $this->getDateModif(),
            $keys[7] => $this->getAttached(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIdAgentCrea($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setDateCreat($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setIdAgentModif($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setDateModif($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setAttached($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID)) $criteria->add(CommonExecPieceContratPeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID_CONTRAT)) $criteria->add(CommonExecPieceContratPeer::ID_CONTRAT, $this->id_contrat);
        if ($this->isColumnModified(CommonExecPieceContratPeer::LIBELLE)) $criteria->add(CommonExecPieceContratPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID_AGENT_CREA)) $criteria->add(CommonExecPieceContratPeer::ID_AGENT_CREA, $this->id_agent_crea);
        if ($this->isColumnModified(CommonExecPieceContratPeer::DATE_CREAT)) $criteria->add(CommonExecPieceContratPeer::DATE_CREAT, $this->date_creat);
        if ($this->isColumnModified(CommonExecPieceContratPeer::ID_AGENT_MODIF)) $criteria->add(CommonExecPieceContratPeer::ID_AGENT_MODIF, $this->id_agent_modif);
        if ($this->isColumnModified(CommonExecPieceContratPeer::DATE_MODIF)) $criteria->add(CommonExecPieceContratPeer::DATE_MODIF, $this->date_modif);
        if ($this->isColumnModified(CommonExecPieceContratPeer::ATTACHED)) $criteria->add(CommonExecPieceContratPeer::ATTACHED, $this->attached);
        if ($this->isColumnModified(CommonExecPieceContratPeer::ORIGINAL)) $criteria->add(CommonExecPieceContratPeer::ORIGINAL, $this->original);
    ...
    {
        $criteria = new Criteria(CommonExecPieceContratPeer::DATABASE_NAME);
        $criteria->add(CommonExecPieceContratPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecPieceContrat (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAttached($this->getAttached());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecPieceContrat Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecPieceContratPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecPieceContratPeer();
        }
    ...
    public function setCommonAgent(CommonAgent $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCommonExecPieceContrat($this);
        }
    ...
    public function getCommonAgent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonAgent === null && ($this->id_agent_crea !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCommonAgent->addCommonExecPieceContrats($this);
             */
        }
    ...
    public function getCommonExecContrat(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCommonExecContrat === null && ($this->id_contrat !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCommonExecContrat->addCommonExecPieceContrats($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CommonExecPieceContratPeer::DEFAULT_STRING_FORMAT);
    }
