...
abstract class BaseCommonExecFacturePeer
{
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecFacturePeer::ID_AGENT_CREA, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecFacturePeer::ID_AGENT_MODIF, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonAgentRelatedByIdAgentRejet table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(CommonExecFacturePeer::ID_AGENT_REJET, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonAgentRelatedByIdAgentValidation table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(CommonExecFacturePeer::ID_AGENT_VALIDATION, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonEntrepriseRelatedByIdEntrepriseCrea table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonEntrepriseRelatedByIdEntrepriseCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(CommonExecFacturePeer::ID_ENTREPRISE_CREA, CommonEntreprisePeer::ID, $join_behavior);
    ...
    /**
     * Returns the number of rows matching criteria, joining the related CommonEntrepriseRelatedByIdEntrepriseModif table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinCommonEntrepriseRelatedByIdEntrepriseModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(CommonExecFacturePeer::ID_ENTREPRISE_MODIF, CommonEntreprisePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to $obj2 (CommonAgent)
                $obj2->addCommonExecFactureRelatedByIdAgentCrea($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to $obj2 (CommonAgent)
                $obj2->addCommonExecFactureRelatedByIdAgentModif($obj1);
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to $obj2 (CommonAgent)
                $obj2->addCommonExecFactureRelatedByIdAgentRejet($obj1);
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to $obj2 (CommonAgent)
                $obj2->addCommonExecFactureRelatedByIdAgentValidation($obj1);
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with their CommonEntreprise objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CommonExecFacture objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonEntrepriseRelatedByIdEntrepriseCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to $obj2 (CommonEntreprise)
                $obj2->addCommonExecFactureRelatedByIdEntrepriseCrea($obj1);
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinCommonEntrepriseRelatedByIdEntrepriseModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to $obj2 (CommonEntreprise)
                $obj2->addCommonExecFactureRelatedByIdEntrepriseModif($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonAgentPeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CommonAgentPeer::NUM_HYDRATE_COLUMNS;

        CommonExecContractantPeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + CommonExecContractantPeer::NUM_HYDRATE_COLUMNS;

        CommonExecContratPeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonExecContratPeer::NUM_HYDRATE_COLUMNS;

        CommonEntreprisePeer::addSelectColumns($criteria);
        $startcol9 = $startcol8 + CommonEntreprisePeer::NUM_HYDRATE_COLUMNS;

        CommonEntreprisePeer::addSelectColumns($criteria);
        $startcol10 = $startcol9 + CommonEntreprisePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecFactureRelatedByIdAgentCrea($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to the collection in $obj3 (CommonAgent)
                $obj3->addCommonExecFactureRelatedByIdAgentModif($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CommonExecFacture) to the collection in $obj4 (CommonAgent)
                $obj4->addCommonExecFactureRelatedByIdAgentRejet($obj1);
            } // if joined row not null

            // Add objects for joined CommonAgent rows

            $key5 = CommonAgentPeer::getPrimaryKeyHashFromRow($row, $startcol5);
            if ($key5 !== null) {
                $obj5 = CommonAgentPeer::getInstanceFromPool($key5);
                if (!$obj5) {
                    ...
                    CommonAgentPeer::addInstanceToPool($obj5, $key5);
                } // if obj5 loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj5 (CommonAgent)
                $obj5->addCommonExecFactureRelatedByIdAgentValidation($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecContractant rows

            $key6 = CommonExecContractantPeer::getPrimaryKeyHashFromRow($row, $startcol6);
            if ($key6 !== null) {
                $obj6 = CommonExecContractantPeer::getInstanceFromPool($key6);
                if (!$obj6) {
                    ...
                    CommonExecContractantPeer::addInstanceToPool($obj6, $key6);
                } // if obj6 loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj6 (CommonExecContractant)
                $obj6->addCommonExecFacture($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecContrat rows

            $key7 = CommonExecContratPeer::getPrimaryKeyHashFromRow($row, $startcol7);
            if ($key7 !== null) {
                $obj7 = CommonExecContratPeer::getInstanceFromPool($key7);
                if (!$obj7) {
                    ...
                    CommonExecContratPeer::addInstanceToPool($obj7, $key7);
                } // if obj7 loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj7 (CommonExecContrat)
                $obj7->addCommonExecFacture($obj1);
            } // if joined row not null

            // Add objects for joined CommonEntreprise rows

            $key8 = CommonEntreprisePeer::getPrimaryKeyHashFromRow($row, $startcol8);
            if ($key8 !== null) {
                $obj8 = CommonEntreprisePeer::getInstanceFromPool($key8);
                if (!$obj8) {
                    ...
                    CommonEntreprisePeer::addInstanceToPool($obj8, $key8);
                } // if obj8 loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj8 (CommonEntreprise)
                $obj8->addCommonExecFactureRelatedByIdEntrepriseCrea($obj1);
            } // if joined row not null

            // Add objects for joined CommonEntreprise rows

            $key9 = CommonEntreprisePeer::getPrimaryKeyHashFromRow($row, $startcol9);
            if ($key9 !== null) {
                $obj9 = CommonEntreprisePeer::getInstanceFromPool($key9);
                if (!$obj9) {
                    ...
                    CommonEntreprisePeer::addInstanceToPool($obj9, $key9);
                } // if obj9 loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj9 (CommonEntreprise)
                $obj9->addCommonExecFactureRelatedByIdEntrepriseModif($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptCommonEntrepriseRelatedByIdEntrepriseCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptCommonEntrepriseRelatedByIdEntrepriseModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with all related objects except CommonAgentRelatedByIdAgentCrea.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonEntreprisePeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CommonEntreprisePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecFacturePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CommonExecFacture) to the collection in $obj4 (CommonEntreprise)
                $obj4->addCommonExecFactureRelatedByIdEntrepriseCrea($obj1);

            } // if joined row is not null

                // Add objects for joined CommonEntreprise rows

                $key5 = CommonEntreprisePeer::getPrimaryKeyHashFromRow($row, $startcol5);
                if ($key5 !== null) {
                    $obj5 = CommonEntreprisePeer::getInstanceFromPool($key5);
                    if (!$obj5) {
                    ...
                    $obj5 = new $cls();
                    $obj5->hydrate($row, $startcol5);
                    CommonEntreprisePeer::addInstanceToPool($obj5, $key5);
                } // if $obj5 already loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj5 (CommonEntreprise)
                $obj5->addCommonExecFactureRelatedByIdEntrepriseModif($obj1);
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with all related objects except CommonAgentRelatedByIdAgentModif.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with all related objects except CommonAgentRelatedByIdAgentRejet.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with all related objects except CommonAgentRelatedByIdAgentValidation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptCommonExecContractant(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecContratPeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + CommonExecContratPeer::NUM_HYDRATE_COLUMNS;

        CommonEntreprisePeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonEntreprisePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecFacturePeer::getInstanceFromPool($key1))) {
                ...
                $key6 = CommonExecContratPeer::getPrimaryKeyHashFromRow($row, $startcol6);
                if ($key6 !== null) {
                    $obj6 = CommonExecContratPeer::getInstanceFromPool($key6);
                    if (!$obj6) {
                    ...
                    $obj6 = new $cls();
                    $obj6->hydrate($row, $startcol6);
                    CommonExecContratPeer::addInstanceToPool($obj6, $key6);
                } // if $obj6 already loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj6 (CommonExecContrat)
                $obj6->addCommonExecFacture($obj1);
                ...
                $key7 = CommonEntreprisePeer::getPrimaryKeyHashFromRow($row, $startcol7);
                if ($key7 !== null) {
                    $obj7 = CommonEntreprisePeer::getInstanceFromPool($key7);
                    if (!$obj7) {
                    ...
                    $obj7 = new $cls();
                    $obj7->hydrate($row, $startcol7);
                    CommonEntreprisePeer::addInstanceToPool($obj7, $key7);
                } // if $obj7 already loaded

                // Add the $obj1 (CommonExecFacture) to the collection in $obj7 (CommonEntreprise)
                $obj7->addCommonExecFactureRelatedByIdEntrepriseCrea($obj1);
                ...
                // Add the $obj1 (CommonExecFacture) to the collection in $obj8 (CommonEntreprise)
                $obj8->addCommonExecFactureRelatedByIdEntrepriseModif($obj1);
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with all related objects except CommonEntrepriseRelatedByIdEntrepriseCrea.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptCommonEntrepriseRelatedByIdEntrepriseCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of CommonExecFacture objects pre-filled with all related objects except CommonEntrepriseRelatedByIdEntrepriseModif.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptCommonEntrepriseRelatedByIdEntrepriseModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
