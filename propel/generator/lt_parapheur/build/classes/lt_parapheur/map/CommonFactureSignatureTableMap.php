...
/**
 * This class defines the structure of the 'facture_signature' table.
 *
 *
 *
 ...
 */
class CommonFactureSignatureTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonFactureSignatureTableMap';
    ...
    {
        // attributes
        $this->setName('facture_signature');
        $this->setPhpName('CommonFactureSignature');
        $this->setClassname('CommonFactureSignature');
...
} // CommonFactureSignatureTableMap
