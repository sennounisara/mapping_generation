 ...
 *
 * @method CommonExecFactureQuery leftJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 * @method CommonExecFactureQuery rightJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 * @method CommonExecFactureQuery innerJoinCommonAgentRelatedByIdAgentCrea($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentCrea relation
 *
 * @method CommonExecFactureQuery leftJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 * @method CommonExecFactureQuery rightJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 * @method CommonExecFactureQuery innerJoinCommonAgentRelatedByIdAgentModif($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentModif relation
 *
 * @method CommonExecFactureQuery leftJoinCommonAgentRelatedByIdAgentRejet($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentRejet relation
 * @method CommonExecFactureQuery rightJoinCommonAgentRelatedByIdAgentRejet($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentRejet relation
 * @method CommonExecFactureQuery innerJoinCommonAgentRelatedByIdAgentRejet($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentRejet relation
 *
 * @method CommonExecFactureQuery leftJoinCommonAgentRelatedByIdAgentValidation($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonAgentRelatedByIdAgentValidation relation
 * @method CommonExecFactureQuery rightJoinCommonAgentRelatedByIdAgentValidation($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonAgentRelatedByIdAgentValidation relation
 * @method CommonExecFactureQuery innerJoinCommonAgentRelatedByIdAgentValidation($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonAgentRelatedByIdAgentValidation relation
 *
 ...
 *
 * @method CommonExecFactureQuery leftJoinCommonEntrepriseRelatedByIdEntrepriseCrea($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseCrea relation
 * @method CommonExecFactureQuery rightJoinCommonEntrepriseRelatedByIdEntrepriseCrea($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseCrea relation
 * @method CommonExecFactureQuery innerJoinCommonEntrepriseRelatedByIdEntrepriseCrea($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseCrea relation
 *
 * @method CommonExecFactureQuery leftJoinCommonEntrepriseRelatedByIdEntrepriseModif($relationAlias = null) Adds a LEFT JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseModif relation
 * @method CommonExecFactureQuery rightJoinCommonEntrepriseRelatedByIdEntrepriseModif($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseModif relation
 * @method CommonExecFactureQuery innerJoinCommonEntrepriseRelatedByIdEntrepriseModif($relationAlias = null) Adds a INNER JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseModif relation
 *
...
abstract class BaseCommonExecFactureQuery extends ModelCriteria
{
     ...
     * </code>
     *
     * @see       filterByCommonEntrepriseRelatedByIdEntrepriseCrea()
     *
     ...
     * </code>
     *
     * @see       filterByCommonEntrepriseRelatedByIdEntrepriseModif()
     *
    ...
    public function filterByCommonAgentRelatedByIdAgentCrea($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_CREA, $commonAgent->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_CREA, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonAgentRelatedByIdAgentModif($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_MODIF, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_MODIF, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonAgentRelatedByIdAgentRejet($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_REJET, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_REJET, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCommonAgentRelatedByIdAgentValidation($commonAgent, $comparison = null)
    {
        if ($commonAgent instanceof CommonAgent) {
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_VALIDATION, $commonAgent->getId(), $comparison);
        } elseif ($commonAgent instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_AGENT_VALIDATION, $commonAgent->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEntrepriseRelatedByIdEntrepriseCrea($commonEntreprise, $comparison = null)
    {
        if ($commonEntreprise instanceof CommonEntreprise) {
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_ENTREPRISE_CREA, $commonEntreprise->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_ENTREPRISE_CREA, $commonEntreprise->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonEntrepriseRelatedByIdEntrepriseCrea() only accepts arguments of type CommonEntreprise or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseCrea relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonExecFactureQuery The current query, for fluid interface
     */
    public function joinCommonEntrepriseRelatedByIdEntrepriseCrea($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEntrepriseRelatedByIdEntrepriseCrea');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEntrepriseRelatedByIdEntrepriseCrea');
        }
    ...
    /**
     * Use the CommonEntrepriseRelatedByIdEntrepriseCrea relation CommonEntreprise object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useCommonEntrepriseRelatedByIdEntrepriseCreaQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCommonEntrepriseRelatedByIdEntrepriseCrea($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEntrepriseRelatedByIdEntrepriseCrea', 'CommonEntrepriseQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByCommonEntrepriseRelatedByIdEntrepriseModif($commonEntreprise, $comparison = null)
    {
        if ($commonEntreprise instanceof CommonEntreprise) {
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_ENTREPRISE_MODIF, $commonEntreprise->getId(), $comparison);
        } elseif ($commonEntreprise instanceof PropelObjectCollection) {
            if (null === $comparison) {
                $comparison = Criteria::IN;
            }
            ...
            return $this
                ->addUsingAlias(CommonExecFacturePeer::ID_ENTREPRISE_MODIF, $commonEntreprise->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
            throw new PropelException('filterByCommonEntrepriseRelatedByIdEntrepriseModif() only accepts arguments of type CommonEntreprise or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the CommonEntrepriseRelatedByIdEntrepriseModif relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CommonExecFactureQuery The current query, for fluid interface
     */
    public function joinCommonEntrepriseRelatedByIdEntrepriseModif($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('CommonEntrepriseRelatedByIdEntrepriseModif');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'CommonEntrepriseRelatedByIdEntrepriseModif');
        }
    ...
    /**
     * Use the CommonEntrepriseRelatedByIdEntrepriseModif relation CommonEntreprise object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   CommonEntrepriseQuery A secondary query class using the current class as primary query
     */
    public function useCommonEntrepriseRelatedByIdEntrepriseModifQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCommonEntrepriseRelatedByIdEntrepriseModif($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CommonEntrepriseRelatedByIdEntrepriseModif', 'CommonEntrepriseQuery');
    }
