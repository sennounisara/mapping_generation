...
/**
 * Base class that represents a row from the 'pf_commune' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BasePfCommune extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PfCommunePeer';
     ...
     * @return PfCommune The current object (for fluent API support)
     */
    public function setIdCommune($v)
    {
        ...
        if ($this->id_commune !== $v) {
            $this->id_commune = $v;
            $this->modifiedColumns[] = PfCommunePeer::ID_COMMUNE;
        }
    ...
    public function setIdProvince($v)
    {
        ...
        if ($this->id_province !== $v) {
            $this->id_province = $v;
            $this->modifiedColumns[] = PfCommunePeer::ID_PROVINCE;
        }
    ...
    public function setNomCommuneFr($v)
    {
        ...
        if ($this->nom_commune_fr !== $v) {
            ...
            $this->modifiedColumns[] = PfCommunePeer::NOM_COMMUNE_FR;
        }
    ...
    public function setNomCommuneAr($v)
    {
        ...
        if ($this->nom_commune_ar !== $v) {
            ...
            $this->modifiedColumns[] = PfCommunePeer::NOM_COMMUNE_AR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_commune = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = PfCommunePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PfCommune object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PfCommunePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PfCommuneQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PfCommunePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PfCommunePeer::ID_COMMUNE)) {
            $modifiedColumns[':p' . $index++]  = '`ID_COMMUNE`';
        }
        if ($this->isColumnModified(PfCommunePeer::ID_PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = '`ID_PROVINCE`';
        }
        if ($this->isColumnModified(PfCommunePeer::NOM_COMMUNE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`NOM_COMMUNE_FR`';
        }
        if ($this->isColumnModified(PfCommunePeer::NOM_COMMUNE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`NOM_COMMUNE_AR`';
        }

        $sql = sprintf(
            'INSERT INTO `pf_commune` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PfCommunePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PfCommunePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PfCommune'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PfCommune'][$this->getPrimaryKey()] = true;
        $keys = PfCommunePeer::getFieldNames($keyType);
        $result = array(
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdCommune($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PfCommunePeer::ID_COMMUNE)) $criteria->add(PfCommunePeer::ID_COMMUNE, $this->id_commune);
        if ($this->isColumnModified(PfCommunePeer::ID_PROVINCE)) $criteria->add(PfCommunePeer::ID_PROVINCE, $this->id_province);
        if ($this->isColumnModified(PfCommunePeer::NOM_COMMUNE_FR)) $criteria->add(PfCommunePeer::NOM_COMMUNE_FR, $this->nom_commune_fr);
        if ($this->isColumnModified(PfCommunePeer::NOM_COMMUNE_AR)) $criteria->add(PfCommunePeer::NOM_COMMUNE_AR, $this->nom_commune_ar);
    ...
    {
        $criteria = new Criteria(PfCommunePeer::DATABASE_NAME);
        $criteria->add(PfCommunePeer::ID_COMMUNE, $this->id_commune);
     ...
     * objects.
     *
     * @param object $copyObj An object of PfCommune (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PfCommune Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PfCommunePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PfCommunePeer();
        }
    ...
    {
        return (string) $this->exportTo(PfCommunePeer::DEFAULT_STRING_FORMAT);
    }
