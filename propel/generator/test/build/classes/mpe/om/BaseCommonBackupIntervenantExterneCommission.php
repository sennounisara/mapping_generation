...
/**
 * Base class that represents a row from the 'backup_Intervenant_Externe_Commission' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonBackupIntervenantExterneCommission extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonBackupIntervenantExterneCommissionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonBackupIntervenantExterneCommissionPeer
     */
    ...
    public function applyDefaultValues()
    {
        ...
        $this->id_intervenant_externe = 0;
        $this->convoc_send = '0';
    }

    /**
     * Initializes internal state of BaseCommonBackupIntervenantExterneCommission object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonBackupIntervenantExterneCommission The current object (for fluent API support)
     */
    public function setOrganisme($v)
    {
        ...
        if ($this->organisme !== $v) {
            $this->organisme = $v;
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::ORGANISME;
        }
    ...
    public function setIdCommission($v)
    {
        ...
        if ($this->id_commission !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::ID_COMMISSION;
        }
    ...
    public function setIdIntervenantExterne($v)
    {
        ...
        if ($this->id_intervenant_externe !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::ID_INTERVENANT_EXTERNE;
        }
    ...
    public function setConvocation($v)
    {
        ...
        $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::CONVOCATION;
    ...
    public function setConvocSend($v)
    {
        ...
        if ($this->convoc_send !== $v) {
            $this->convoc_send = $v;
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::CONVOC_SEND;
        }
    ...
    public function setNomConvoc($v)
    {
        ...
        if ($this->nom_convoc !== $v) {
            $this->nom_convoc = $v;
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::NOM_CONVOC;
        }
    ...
    public function setContenuEnvoi($v)
    {
        ...
        if ($this->contenu_envoi !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::CONTENU_ENVOI;
        }
    ...
    public function setNomFichierEnvoye($v)
    {
        ...
        if ($this->nom_fichier_envoye !== $v) {
            ...
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::NOM_FICHIER_ENVOYE;
        }
    ...
    public function setFichierEnvoye($v)
    {
        ...
        $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::FICHIER_ENVOYE;
    ...
    public function setDateEnvoi($v)
    {
        ...
        if ($this->date_envoi !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::DATE_ENVOI;
            }
    ...
    public function setTypeVoix($v)
    {
        ...
        if ($this->type_voix !== $v) {
            $this->type_voix = $v;
            $this->modifiedColumns[] = CommonBackupIntervenantExterneCommissionPeer::TYPE_VOIX;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->id_intervenant_externe !== 0) {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_intervenant_externe = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            $this->nom_fichier_envoye = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            if ($row[$startcol + 8] !== null) {
                $this->fichier_envoye = fopen('php://memory', 'r+');
                fwrite($this->fichier_envoye, $row[$startcol + 8]);
                rewind($this->fichier_envoye);
            } else {
            ...
            return $startcol + 11; // 11 = CommonBackupIntervenantExterneCommissionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonBackupIntervenantExterneCommission object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonBackupIntervenantExterneCommissionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonBackupIntervenantExterneCommissionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonBackupIntervenantExterneCommissionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`organisme`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::ID_COMMISSION)) {
            $modifiedColumns[':p' . $index++]  = '`id_commission`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::ID_INTERVENANT_EXTERNE)) {
            $modifiedColumns[':p' . $index++]  = '`id_intervenant_externe`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::CONVOCATION)) {
            $modifiedColumns[':p' . $index++]  = '`convocation`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::CONVOC_SEND)) {
            $modifiedColumns[':p' . $index++]  = '`convoc_send`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::NOM_CONVOC)) {
            $modifiedColumns[':p' . $index++]  = '`nom_convoc`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::CONTENU_ENVOI)) {
            $modifiedColumns[':p' . $index++]  = '`contenu_envoi`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::NOM_FICHIER_ENVOYE)) {
            $modifiedColumns[':p' . $index++]  = '`nom_fichier_envoye`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::FICHIER_ENVOYE)) {
            $modifiedColumns[':p' . $index++]  = '`fichier_envoye`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::DATE_ENVOI)) {
            $modifiedColumns[':p' . $index++]  = '`date_envoi`';
        }
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::TYPE_VOIX)) {
            $modifiedColumns[':p' . $index++]  = '`type_voix`';
        }

        $sql = sprintf(
            'INSERT INTO `backup_Intervenant_Externe_Commission` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`id_intervenant_externe`':						
                        $stmt->bindValue($identifier, $this->id_intervenant_externe, PDO::PARAM_INT);
                        break;
                    case '`convocation`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonBackupIntervenantExterneCommissionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonBackupIntervenantExterneCommissionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonBackupIntervenantExterneCommission'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonBackupIntervenantExterneCommission'][serialize($this->getPrimaryKey())] = true;
        $keys = CommonBackupIntervenantExterneCommissionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getOrganisme(),
            $keys[1] => $this->getIdCommission(),
            $keys[2] => $this->getIdIntervenantExterne(),
            $keys[3] => $this->getConvocation(),
            $keys[4] => $this->getConvocSend(),
            $keys[5] => $this->getNomConvoc(),
            $keys[6] => $this->getContenuEnvoi(),
            $keys[7] => $this->getNomFichierEnvoye(),
            $keys[8] => $this->getFichierEnvoye(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIdIntervenantExterne($arr[$keys[2]]);
        ...
        if (array_key_exists($keys[7], $arr)) $this->setNomFichierEnvoye($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setFichierEnvoye($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::ORGANISME)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::ORGANISME, $this->organisme);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::ID_COMMISSION)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::ID_COMMISSION, $this->id_commission);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::ID_INTERVENANT_EXTERNE)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::ID_INTERVENANT_EXTERNE, $this->id_intervenant_externe);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::CONVOCATION)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::CONVOCATION, $this->convocation);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::CONVOC_SEND)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::CONVOC_SEND, $this->convoc_send);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::NOM_CONVOC)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::NOM_CONVOC, $this->nom_convoc);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::CONTENU_ENVOI)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::CONTENU_ENVOI, $this->contenu_envoi);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::NOM_FICHIER_ENVOYE)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::NOM_FICHIER_ENVOYE, $this->nom_fichier_envoye);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::FICHIER_ENVOYE)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::FICHIER_ENVOYE, $this->fichier_envoye);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::DATE_ENVOI)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::DATE_ENVOI, $this->date_envoi);
        if ($this->isColumnModified(CommonBackupIntervenantExterneCommissionPeer::TYPE_VOIX)) $criteria->add(CommonBackupIntervenantExterneCommissionPeer::TYPE_VOIX, $this->type_voix);
    ...
    {
        $criteria = new Criteria(CommonBackupIntervenantExterneCommissionPeer::DATABASE_NAME);
        $criteria->add(CommonBackupIntervenantExterneCommissionPeer::ORGANISME, $this->organisme);
        $criteria->add(CommonBackupIntervenantExterneCommissionPeer::ID_COMMISSION, $this->id_commission);
        $criteria->add(CommonBackupIntervenantExterneCommissionPeer::ID_INTERVENANT_EXTERNE, $this->id_intervenant_externe);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[2] = $this->getIdIntervenantExterne();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setIdIntervenantExterne($keys[2]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOrganisme()) && (null === $this->getIdCommission()) && (null === $this->getIdIntervenantExterne());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonBackupIntervenantExterneCommission (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonBackupIntervenantExterneCommission Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonBackupIntervenantExterneCommissionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonBackupIntervenantExterneCommissionPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonBackupIntervenantExterneCommissionPeer::DEFAULT_STRING_FORMAT);
    }
