...
abstract class BaseCommonExecContrat extends BaseObject implements Persistent
{
    ...
    public function setDevise($v)
    {
        ...
        if ($this->devise !== $v) {
            $this->devise = $v;
            $this->modifiedColumns[] = CommonExecContratPeer::DEVISE;
        }
    ...
    public function setIdContratSource($v)
    {
        ...
        if ($this->id_contrat_source !== $v) {
            ...
            $this->modifiedColumns[] = CommonExecContratPeer::ID_CONTRAT_SOURCE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 70; // 70 = CommonExecContratPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecContratPeer::DEVISE)) {
            $modifiedColumns[':p' . $index++]  = '`devise`';
        }
        if ($this->isColumnModified(CommonExecContratPeer::ID_CONTRAT_SOURCE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecContratPeer::DEVISE)) $criteria->add(CommonExecContratPeer::DEVISE, $this->devise);
        if ($this->isColumnModified(CommonExecContratPeer::ID_CONTRAT_SOURCE)) $criteria->add(CommonExecContratPeer::ID_CONTRAT_SOURCE, $this->id_contrat_source);
