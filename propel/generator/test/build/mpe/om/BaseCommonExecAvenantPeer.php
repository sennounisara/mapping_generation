...
abstract class BaseCommonExecAvenantPeer
{
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecAvenantPeer::ID_AGENT_CREA, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecAvenantPeer::ID_AGENT_MODIF, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecAvenantPeer::ID_AGENT_REJET, CommonAgentPeer::ID, $join_behavior);
    ...
    public static function doCountJoinCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonExecAvenantPeer::ID_AGENT_VALIDATION, CommonAgentPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CommonExecAvenant objects pre-filled with their CommonAgent objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentCrea(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to $obj2 (CommonAgent)
                $obj2->addCommonExecAvenantRelatedByIdAgentCrea($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentModif(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to $obj2 (CommonAgent)
                $obj2->addCommonExecAvenantRelatedByIdAgentModif($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentRejet(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to $obj2 (CommonAgent)
                $obj2->addCommonExecAvenantRelatedByIdAgentRejet($obj1);
    ...
    public static function doSelectJoinCommonAgentRelatedByIdAgentValidation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to $obj2 (CommonAgent)
                $obj2->addCommonExecAvenantRelatedByIdAgentValidation($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecTypeAvenantPeer::addSelectColumns($criteria);
        $startcol8 = $startcol7 + CommonExecTypeAvenantPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to the collection in $obj2 (CommonAgent)
                $obj2->addCommonExecAvenantRelatedByIdAgentCrea($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to the collection in $obj3 (CommonAgent)
                $obj3->addCommonExecAvenantRelatedByIdAgentModif($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to the collection in $obj4 (CommonAgent)
                $obj4->addCommonExecAvenantRelatedByIdAgentRejet($obj1);
            } // if joined row not null
            ...
            if ($key5 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to the collection in $obj5 (CommonAgent)
                $obj5->addCommonExecAvenantRelatedByIdAgentValidation($obj1);
            } // if joined row not null
            ...
            if ($key6 !== null) {
                ...
                // Add the $obj1 (CommonExecAvenant) to the collection in $obj6 (CommonExecContrat)
                $obj6->addCommonExecAvenant($obj1);
            } // if joined row not null

            // Add objects for joined CommonExecTypeAvenant rows

            $key7 = CommonExecTypeAvenantPeer::getPrimaryKeyHashFromRow($row, $startcol7);
            if ($key7 !== null) {
                $obj7 = CommonExecTypeAvenantPeer::getInstanceFromPool($key7);
                if (!$obj7) {
                    ...
                    CommonExecTypeAvenantPeer::addInstanceToPool($obj7, $key7);
                } // if obj7 loaded

                // Add the $obj1 (CommonExecAvenant) to the collection in $obj7 (CommonExecTypeAvenant)
                $obj7->addCommonExecAvenant($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonExecAvenant objects pre-filled with all related objects except CommonAgentRelatedByIdAgentCrea.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecAvenant objects pre-filled with all related objects except CommonAgentRelatedByIdAgentModif.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecAvenant objects pre-filled with all related objects except CommonAgentRelatedByIdAgentRejet.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonExecAvenant objects pre-filled with all related objects except CommonAgentRelatedByIdAgentValidation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCommonExecContrat(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommonExecTypeAvenantPeer::addSelectColumns($criteria);
        $startcol7 = $startcol6 + CommonExecTypeAvenantPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommonExecAvenantPeer::getInstanceFromPool($key1))) {
                ...
                $key6 = CommonExecTypeAvenantPeer::getPrimaryKeyHashFromRow($row, $startcol6);
                if ($key6 !== null) {
                    $obj6 = CommonExecTypeAvenantPeer::getInstanceFromPool($key6);
                    if (!$obj6) {
                    ...
                    $obj6 = new $cls();
                    $obj6->hydrate($row, $startcol6);
                    CommonExecTypeAvenantPeer::addInstanceToPool($obj6, $key6);
                } // if $obj6 already loaded

                // Add the $obj1 (CommonExecAvenant) to the collection in $obj6 (CommonExecTypeAvenant)
                $obj6->addCommonExecAvenant($obj1);
