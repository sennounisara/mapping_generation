...
/**
 * Base class that represents a row from the 'DecisionPassationConsultation' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonDecisionPassationConsultation extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonDecisionPassationConsultationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonDecisionPassationConsultationPeer
     */
     ...
     * @return CommonDecisionPassationConsultation The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonDecisionPassationConsultationPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonDecisionPassationConsultationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonDecisionPassationConsultation object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonDecisionPassationConsultationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonDecisionPassationConsultationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonDecisionPassationConsultationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `DecisionPassationConsultation` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonDecisionPassationConsultationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonDecisionPassationConsultationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonDecisionPassationConsultation'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonDecisionPassationConsultation'][$this->getPrimaryKey()] = true;
        $keys = CommonDecisionPassationConsultationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::ID)) $criteria->add(CommonDecisionPassationConsultationPeer::ID, $this->id);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_FR)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_EN)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_ES)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_SU)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_DU)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_CZ)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_AR)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonDecisionPassationConsultationPeer::LIBELLE_IT)) $criteria->add(CommonDecisionPassationConsultationPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonDecisionPassationConsultationPeer::DATABASE_NAME);
        $criteria->add(CommonDecisionPassationConsultationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonDecisionPassationConsultation (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonDecisionPassationConsultation Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonDecisionPassationConsultationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonDecisionPassationConsultationPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonDecisionPassationConsultationPeer::DEFAULT_STRING_FORMAT);
    }
