...
/**
 * Base class that represents a row from the 'CategorieINSEE' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonCategorieINSEE extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonCategorieINSEEPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonCategorieINSEEPeer
     */
    ...
    /**
     * Initializes internal state of BaseCommonCategorieINSEE object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonCategorieINSEE The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonCategorieINSEEPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonCategorieINSEEPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonCategorieINSEE object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonCategorieINSEEPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonCategorieINSEEQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonCategorieINSEEPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonCategorieINSEEPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `CategorieINSEE` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonCategorieINSEEPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonCategorieINSEEPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonCategorieINSEE'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonCategorieINSEE'][$this->getPrimaryKey()] = true;
        $keys = CommonCategorieINSEEPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonCategorieINSEEPeer::ID)) $criteria->add(CommonCategorieINSEEPeer::ID, $this->id);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_FR)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_EN)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_ES)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_SU)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_DU)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_CZ)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_AR)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonCategorieINSEEPeer::LIBELLE_IT)) $criteria->add(CommonCategorieINSEEPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonCategorieINSEEPeer::DATABASE_NAME);
        $criteria->add(CommonCategorieINSEEPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonCategorieINSEE (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonCategorieINSEE Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonCategorieINSEEPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonCategorieINSEEPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonCategorieINSEEPeer::DEFAULT_STRING_FORMAT);
    }
