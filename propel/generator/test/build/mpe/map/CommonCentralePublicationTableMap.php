...
class CommonCentralePublicationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonCentralePublicationTableMap';
    ...
    {
        $this->addRelation('CommonCompteCentrale', 'CommonCompteCentrale', RelationMap::ONE_TO_MANY, array('id' => 'ID_CENTRALE', ), null, null, 'CommonCompteCentrales');
    } // buildRelations()
