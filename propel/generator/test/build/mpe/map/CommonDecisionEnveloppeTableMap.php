...
class CommonDecisionEnveloppeTableMap extends TableMap
{
  ...
  3 => '3',
    ...
    {
        $this->addRelation('CommonChorusEchange', 'CommonChorusEchange', RelationMap::ONE_TO_MANY, array('id_decision_enveloppe' => 'id_decision', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonChorusEchanges');
    } // buildRelations()
