...
/**
 * This class defines the structure of the 'fichiers_liste_marches' table.
 *
 *
 *
 ...
 */
class CommonFichiersListeMarchesTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'lt_parapheur.map.CommonFichiersListeMarchesTableMap';
    ...
    {
        // attributes
        $this->setName('fichiers_liste_marches');
        $this->setPhpName('CommonFichiersListeMarches');
        $this->setClassname('CommonFichiersListeMarches');
...
} // CommonFichiersListeMarchesTableMap
