...
/**
 * Base class that represents a row from the 'HabilitationProfil' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonHabilitationProfil extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonHabilitationProfilPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonHabilitationProfilPeer
     */
    ...
    public function applyDefaultValues()
    {
        ...
        $this->utiliser_client_cao = '1';
        $this->notification_boamp = '1';
        ...
        $this->modifier_consultation_mapa_inferieur_montant_apres_validation = '1';
        $this->modifier_consultation_mapa_superieur_montant_apres_validation = '1';
        $this->modifier_consultation_procedures_formalisees_apres_validation = '1';
    ...
    /**
     * Initializes internal state of BaseCommonHabilitationProfil object.
     * @see        applyDefaults()
     */
     ...
     * @return CommonHabilitationProfil The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::LIBELLE;
        }
    ...
    public function setGestionAgentPole($v)
    {
        ...
        if ($this->gestion_agent_pole !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_AGENT_POLE;
        }
    ...
    public function setGestionFournisseursEnvoisPostaux($v)
    {
        ...
        if ($this->gestion_fournisseurs_envois_postaux !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_FOURNISSEURS_ENVOIS_POSTAUX;
        }
    ...
    public function setGestionBiCles($v)
    {
        ...
        if ($this->gestion_bi_cles !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_BI_CLES;
        }
    ...
    public function setCreerConsultation($v)
    {
        ...
        if ($this->creer_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_CONSULTATION;
        }
    ...
    public function setModifierConsultation($v)
    {
        ...
        if ($this->modifier_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_CONSULTATION;
        }
    ...
    public function setValiderConsultation($v)
    {
        ...
        if ($this->valider_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDER_CONSULTATION;
        }
    ...
    public function setPublierConsultation($v)
    {
        ...
        if ($this->publier_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::PUBLIER_CONSULTATION;
        }
    ...
    public function setSuivreConsultation($v)
    {
        ...
        if ($this->suivre_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVRE_CONSULTATION;
        }
    ...
    public function setSuivreConsultationPole($v)
    {
        ...
        if ($this->suivre_consultation_pole !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_POLE;
        }
    ...
    public function setSupprimerEnveloppe($v)
    {
        ...
        if ($this->supprimer_enveloppe !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUPPRIMER_ENVELOPPE;
        }
    ...
    public function setSupprimerConsultation($v)
    {
        ...
        if ($this->supprimer_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUPPRIMER_CONSULTATION;
        }
    ...
    public function setDepouillerCandidature($v)
    {
        ...
        if ($this->depouiller_candidature !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DEPOUILLER_CANDIDATURE;
        }
    ...
    public function setDepouillerOffre($v)
    {
        ...
        if ($this->depouiller_offre !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DEPOUILLER_OFFRE;
        }
    ...
    public function setMessagerieSecurisee($v)
    {
        ...
        if ($this->messagerie_securisee !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MESSAGERIE_SECURISEE;
        }
    ...
    public function setAccesRegistreDepotsPapier($v)
    {
        ...
        if ($this->acces_registre_depots_papier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_PAPIER;
        }
    ...
    public function setAccesRegistreRetraitsPapier($v)
    {
        ...
        if ($this->acces_registre_retraits_papier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_PAPIER;
        }
    ...
    public function setAccesRegistreQuestionsPapier($v)
    {
        ...
        if ($this->acces_registre_questions_papier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_PAPIER;
        }
    ...
    public function setGererEncheres($v)
    {
        ...
        if ($this->gerer_encheres !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_ENCHERES;
        }
    ...
    public function setSuivreEncheres($v)
    {
        ...
        if ($this->suivre_encheres !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVRE_ENCHERES;
        }
    ...
    public function setSuiviEntreprise($v)
    {
        ...
        if ($this->suivi_entreprise !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_ENTREPRISE;
        }
    ...
    public function setEnvoiBoamp($v)
    {
        ...
        if ($this->envoi_boamp !== $v) {
            $this->envoi_boamp = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ENVOI_BOAMP;
        }
    ...
    public function setAccesClassementLot($v)
    {
        ...
        if ($this->acces_classement_lot !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_CLASSEMENT_LOT;
        }
    ...
    public function setConnecteurSis($v)
    {
        ...
        if ($this->connecteur_sis !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CONNECTEUR_SIS;
        }
    ...
    public function setConnecteurMarco($v)
    {
        ...
        if ($this->connecteur_marco !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CONNECTEUR_MARCO;
        }
    ...
    public function setRepondreAuxQuestions($v)
    {
        ...
        if ($this->repondre_aux_questions !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::REPONDRE_AUX_QUESTIONS;
        }
    ...
    public function setAppelProjetFormation($v)
    {
        ...
        if ($this->appel_projet_formation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::APPEL_PROJET_FORMATION;
        }
    ...
    public function setUtiliserClientCao($v)
    {
        ...
        if ($this->utiliser_client_cao !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::UTILISER_CLIENT_CAO;
        }
    ...
    public function setNotificationBoamp($v)
    {
        ...
        if ($this->notification_boamp !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::NOTIFICATION_BOAMP;
        }
    ...
    public function setAdministrerCompte($v)
    {
        ...
        if ($this->administrer_compte !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_COMPTE;
        }
    ...
    public function setGestionMapa($v)
    {
        ...
        if ($this->gestion_mapa !== $v) {
            $this->gestion_mapa = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_MAPA;
        }
    ...
    public function setGestionTypeValidation($v)
    {
        ...
        if ($this->gestion_type_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_TYPE_VALIDATION;
        }
    ...
    public function setApprouverConsultation($v)
    {
        ...
        if ($this->approuver_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::APPROUVER_CONSULTATION;
        }
    ...
    public function setAdministrerProcedure($v)
    {
        ...
        if ($this->administrer_procedure !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURE;
        }
    ...
    public function setRestreindreCreation($v)
    {
        ...
        if ($this->restreindre_creation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::RESTREINDRE_CREATION;
        }
    ...
    public function setCreerListeMarches($v)
    {
        ...
        if ($this->creer_liste_marches !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_LISTE_MARCHES;
        }
    ...
    public function setGestionCommissions($v)
    {
        ...
        if ($this->gestion_commissions !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_COMMISSIONS;
        }
    ...
    public function setSuiviSeulConsultation($v)
    {
        ...
        if ($this->suivi_seul_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_CONSULTATION;
        }
    ...
    public function setAttributionMarche($v)
    {
        ...
        if ($this->attribution_marche !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ATTRIBUTION_MARCHE;
        }
    ...
    public function setFicheRecensement($v)
    {
        ...
        if ($this->fiche_recensement !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::FICHE_RECENSEMENT;
        }
    ...
    public function setDeclarerInfructueux($v)
    {
        ...
        if ($this->declarer_infructueux !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DECLARER_INFRUCTUEUX;
        }
    ...
    public function setDeclarerSansSuite($v)
    {
        ...
        if ($this->declarer_sans_suite !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DECLARER_SANS_SUITE;
        }
    ...
    public function setCreerConsultationTransverse($v)
    {
        ...
        if ($this->creer_consultation_transverse !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_CONSULTATION_TRANSVERSE;
        }
    ...
    public function setOuvrirCandidatureEnLigne($v)
    {
        ...
        if ($this->ouvrir_candidature_en_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_EN_LIGNE;
        }
    ...
    public function setOuvrirCandidatureADistance($v)
    {
        ...
        if ($this->ouvrir_candidature_a_distance !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_A_DISTANCE;
        }
    ...
    public function setRefuserEnveloppe($v)
    {
        ...
        if ($this->refuser_enveloppe !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::REFUSER_ENVELOPPE;
        }
    ...
    public function setGererAdmissibilite($v)
    {
        ...
        if ($this->gerer_admissibilite !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_ADMISSIBILITE;
        }
    ...
    public function setRestaurerEnveloppe($v)
    {
        ...
        if ($this->restaurer_enveloppe !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::RESTAURER_ENVELOPPE;
        }
    ...
    public function setOuvrirOffreEnLigne($v)
    {
        ...
        if ($this->ouvrir_offre_en_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_OFFRE_EN_LIGNE;
        }
    ...
    public function setOuvrirAnonymatEnLigne($v)
    {
        ...
        if ($this->ouvrir_anonymat_en_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_EN_LIGNE;
        }
    ...
    public function setGestionCompteBoamp($v)
    {
        ...
        if ($this->gestion_compte_boamp !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_COMPTE_BOAMP;
        }
    ...
    public function setGestionAgents($v)
    {
        ...
        if ($this->gestion_agents !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_AGENTS;
        }
    ...
    public function setGestionHabilitations($v)
    {
        ...
        if ($this->gestion_habilitations !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_HABILITATIONS;
        }
    ...
    public function setGererMapaInferieurMontant($v)
    {
        ...
        if ($this->gerer_mapa_inferieur_montant !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_MAPA_INFERIEUR_MONTANT;
        }
    ...
    public function setGererMapaSuperieurMontant($v)
    {
        ...
        if ($this->gerer_mapa_superieur_montant !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_MAPA_SUPERIEUR_MONTANT;
        }
    ...
    public function setModifierConsultationAvantValidation($v)
    {
        ...
        if ($this->modifier_consultation_avant_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_AVANT_VALIDATION;
        }
    ...
    public function setModifierConsultationApresValidation($v)
    {
        ...
        if ($this->modifier_consultation_apres_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_APRES_VALIDATION;
        }
    ...
    public function setAccesReponses($v)
    {
        ...
        if ($this->acces_reponses !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REPONSES;
        }
    ...
    public function setTelechargementGroupeAnticipePlisChiffres($v)
    {
        ...
        if ($this->telechargement_groupe_anticipe_plis_chiffres !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::TELECHARGEMENT_GROUPE_ANTICIPE_PLIS_CHIFFRES;
        }
    ...
    public function setTelechargementUnitairePlisChiffres($v)
    {
        ...
        if ($this->telechargement_unitaire_plis_chiffres !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::TELECHARGEMENT_UNITAIRE_PLIS_CHIFFRES;
        }
    ...
    public function setOuvrirOffreADistance($v)
    {
        ...
        if ($this->ouvrir_offre_a_distance !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_OFFRE_A_DISTANCE;
        }
    ...
    public function setCreerAnnonceInformation($v)
    {
        ...
        if ($this->creer_annonce_information !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_ANNONCE_INFORMATION;
        }
    ...
    public function setSaisieMarches($v)
    {
        ...
        if ($this->saisie_marches !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SAISIE_MARCHES;
        }
    ...
    public function setValidationMarches($v)
    {
        ...
        if ($this->validation_marches !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDATION_MARCHES;
        }
    ...
    public function setPublicationMarches($v)
    {
        ...
        if ($this->publication_marches !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::PUBLICATION_MARCHES;
        }
    ...
    public function setGererStatistiquesMetier($v)
    {
        ...
        if ($this->gerer_statistiques_metier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_STATISTIQUES_METIER;
        }
    ...
    public function setGererArchives($v)
    {
        ...
        if ($this->gerer_archives !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_ARCHIVES;
        }
    ...
    public function setAdministrerProceduresFormalisees($v)
    {
        ...
        if ($this->administrer_procedures_formalisees !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURES_FORMALISEES;
        }
    ...
    public function setCreerAnnonceAttribution($v)
    {
        ...
        if ($this->creer_annonce_attribution !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_ANNONCE_ATTRIBUTION;
        }
    ...
    public function setAccesRegistreRetraitsElectronique($v)
    {
        ...
        if ($this->acces_registre_retraits_electronique !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_ELECTRONIQUE;
        }
    ...
    public function setAccesRegistreQuestionsElectronique($v)
    {
        ...
        if ($this->acces_registre_questions_electronique !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_ELECTRONIQUE;
        }
    ...
    public function setAccesRegistreDepotsElectronique($v)
    {
        ...
        if ($this->acces_registre_depots_electronique !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_ELECTRONIQUE;
        }
    ...
    public function setValidationSimple($v)
    {
        ...
        if ($this->validation_simple !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDATION_SIMPLE;
        }
    ...
    public function setValidationIntermediaire($v)
    {
        ...
        if ($this->validation_intermediaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDATION_INTERMEDIAIRE;
        }
    ...
    public function setValidationFinale($v)
    {
        ...
        if ($this->validation_finale !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDATION_FINALE;
        }
    ...
    public function setCreerSuiteConsultation($v)
    {
        ...
        if ($this->creer_suite_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_SUITE_CONSULTATION;
        }
    ...
    public function setHyperAdmin($v)
    {
        ...
        if ($this->hyper_admin !== $v) {
            $this->hyper_admin = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::HYPER_ADMIN;
        }
    ...
    public function setDroitGestionServices($v)
    {
        ...
        if ($this->droit_gestion_services !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DROIT_GESTION_SERVICES;
        }
    ...
    public function setSuiviAcces($v)
    {
        ...
        if ($this->suivi_acces !== $v) {
            $this->suivi_acces = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_ACCES;
        }
    ...
    public function setStatistiquesSite($v)
    {
        ...
        if ($this->statistiques_site !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::STATISTIQUES_SITE;
        }
    ...
    public function setStatistiquesQos($v)
    {
        ...
        if ($this->statistiques_qos !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::STATISTIQUES_QOS;
        }
    ...
    public function setOuvrirAnonymatADistance($v)
    {
        ...
        if ($this->ouvrir_anonymat_a_distance !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_A_DISTANCE;
        }
    ...
    public function setGestionCompteJal($v)
    {
        ...
        if ($this->gestion_compte_jal !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_COMPTE_JAL;
        }
    ...
    public function setGestionCentralePub($v)
    {
        ...
        if ($this->gestion_centrale_pub !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_CENTRALE_PUB;
        }
    ...
    public function setGestionCompteGroupeMoniteur($v)
    {
        ...
        if ($this->gestion_compte_groupe_moniteur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_COMPTE_GROUPE_MONITEUR;
        }
    ...
    public function setOuvrirOffreTechniqueEnLigne($v)
    {
        ...
        if ($this->ouvrir_offre_technique_en_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_EN_LIGNE;
        }
    ...
    public function setOuvrirOffreTechniqueADistance($v)
    {
        ...
        if ($this->ouvrir_offre_technique_a_distance !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_A_DISTANCE;
        }
    ...
    public function setActivationCompteEntreprise($v)
    {
        ...
        if ($this->activation_compte_entreprise !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ACTIVATION_COMPTE_ENTREPRISE;
        }
    ...
    public function setImporterEnveloppe($v)
    {
        ...
        if ($this->importer_enveloppe !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::IMPORTER_ENVELOPPE;
        }
    ...
    public function setSuiviSeulRegistreDepotsPapier($v)
    {
        ...
        if ($this->suivi_seul_registre_depots_papier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_PAPIER;
        }
    ...
    public function setSuiviSeulRegistreRetraitsPapier($v)
    {
        ...
        if ($this->suivi_seul_registre_retraits_papier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_PAPIER;
        }
    ...
    public function setSuiviSeulRegistreQuestionsPapier($v)
    {
        ...
        if ($this->suivi_seul_registre_questions_papier !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_PAPIER;
        }
    ...
    public function setSuiviSeulRegistreDepotsElectronique($v)
    {
        ...
        if ($this->suivi_seul_registre_depots_electronique !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_ELECTRONIQUE;
        }
    ...
    public function setSuiviSeulRegistreRetraitsElectronique($v)
    {
        ...
        if ($this->suivi_seul_registre_retraits_electronique !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_ELECTRONIQUE;
        }
    ...
    public function setSuiviSeulRegistreQuestionsElectronique($v)
    {
        ...
        if ($this->suivi_seul_registre_questions_electronique !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_ELECTRONIQUE;
        }
    ...
    public function setModifierConsultationMapaInferieurMontantApresValidation($v)
    {
        ...
        if ($this->modifier_consultation_mapa_inferieur_montant_apres_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_INFERIEUR_MONTANT_APRES_VALIDATION;
        }
    ...
    public function setModifierConsultationMapaSuperieurMontantApresValidation($v)
    {
        ...
        if ($this->modifier_consultation_mapa_superieur_montant_apres_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_SUPERIEUR_MONTANT_APRES_VALIDATION;
        }
    ...
    public function setModifierConsultationProceduresFormaliseesApresValidation($v)
    {
        ...
        if ($this->modifier_consultation_procedures_formalisees_apres_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_PROCEDURES_FORMALISEES_APRES_VALIDATION;
        }
    ...
    public function setGererLesEntreprises($v)
    {
        ...
        if ($this->gerer_les_entreprises !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_LES_ENTREPRISES;
        }
    ...
    public function setPorteeSocietesExclues($v)
    {
        ...
        if ($this->portee_societes_exclues !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES;
        }
    ...
    public function setPorteeSocietesExcluesTousOrganismes($v)
    {
        ...
        if ($this->portee_societes_exclues_tous_organismes !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES_TOUS_ORGANISMES;
        }
    ...
    public function setModifierSocietesExclues($v)
    {
        ...
        if ($this->modifier_societes_exclues !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODIFIER_SOCIETES_EXCLUES;
        }
    ...
    public function setSupprimerSocietesExclues($v)
    {
        ...
        if ($this->supprimer_societes_exclues !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUPPRIMER_SOCIETES_EXCLUES;
        }
    ...
    public function setResultatAnalyse($v)
    {
        ...
        if ($this->resultat_analyse !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::RESULTAT_ANALYSE;
        }
    ...
    public function setGererAdressesService($v)
    {
        ...
        if ($this->gerer_adresses_service !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_ADRESSES_SERVICE;
        }
    ...
    public function setGererMonService($v)
    {
        ...
        if ($this->gerer_mon_service !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_MON_SERVICE;
        }
    ...
    public function setDownloadArchives($v)
    {
        ...
        if ($this->download_archives !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DOWNLOAD_ARCHIVES;
        }
    ...
    public function setCreerAnnonceExtraitPv($v)
    {
        ...
        if ($this->creer_annonce_extrait_pv !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_ANNONCE_EXTRAIT_PV;
        }
    ...
    public function setCreerAnnonceRapportAchevement($v)
    {
        ...
        if ($this->creer_annonce_rapport_achevement !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_ANNONCE_RAPPORT_ACHEVEMENT;
        }
    ...
    public function setGestionCertificatsAgent($v)
    {
        ...
        if ($this->gestion_certificats_agent !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_CERTIFICATS_AGENT;
        }
    ...
    public function setCreerAvisProgrammePrevisionnel($v)
    {
        ...
        if ($this->creer_avis_programme_previsionnel !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_AVIS_PROGRAMME_PREVISIONNEL;
        }
    ...
    public function setAnnulerConsultation($v)
    {
        ...
        if ($this->annuler_consultation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ANNULER_CONSULTATION;
        }
    ...
    public function setEnvoyerPublicite($v)
    {
        ...
        if ($this->envoyer_publicite !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ENVOYER_PUBLICITE;
        }
    ...
    public function setListeMarchesNotifies($v)
    {
        ...
        if ($this->liste_marches_notifies !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::LISTE_MARCHES_NOTIFIES;
        }
    ...
    public function setSuivreMessage($v)
    {
        ...
        if ($this->suivre_message !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVRE_MESSAGE;
        }
    ...
    public function setEnvoyerMessage($v)
    {
        ...
        if ($this->envoyer_message !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ENVOYER_MESSAGE;
        }
    ...
    public function setSuiviFluxChorusTransversal($v)
    {
        ...
        if ($this->suivi_flux_chorus_transversal !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVI_FLUX_CHORUS_TRANSVERSAL;
        }
    ...
    public function setGestionMandataire($v)
    {
        ...
        if ($this->gestion_mandataire !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_MANDATAIRE;
        }
    ...
    public function setGererNewsletter($v)
    {
        ...
        if ($this->gerer_newsletter !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_NEWSLETTER;
        }
    ...
    public function setGestionModelesFormulaire($v)
    {
        ...
        if ($this->gestion_modeles_formulaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_MODELES_FORMULAIRE;
        }
    ...
    public function setGestionAdressesFacturationJal($v)
    {
        ...
        if ($this->gestion_adresses_facturation_jal !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_ADRESSES_FACTURATION_JAL;
        }
    ...
    public function setAdministrerAdressesFacturationJal($v)
    {
        ...
        if ($this->administrer_adresses_facturation_jal !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_ADRESSES_FACTURATION_JAL;
        }
    ...
    public function setRedactionDocumentsRedac($v)
    {
        ...
        if ($this->redaction_documents_redac !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::REDACTION_DOCUMENTS_REDAC;
        }
    ...
    public function setValidationDocumentsRedac($v)
    {
        ...
        if ($this->validation_documents_redac !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDATION_DOCUMENTS_REDAC;
        }
    ...
    public function setGestionMiseDispositionPiecesMarche($v)
    {
        ...
        if ($this->gestion_mise_disposition_pieces_marche !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_MISE_DISPOSITION_PIECES_MARCHE;
        }
    ...
    public function setAnnuaireAcheteur($v)
    {
        ...
        if ($this->annuaire_acheteur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ANNUAIRE_ACHETEUR;
        }
    ...
    public function setReprendreIntegralementArticle($v)
    {
        ...
        if ($this->reprendre_integralement_article !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::REPRENDRE_INTEGRALEMENT_ARTICLE;
        }
    ...
    public function setAdministrerClauses($v)
    {
        ...
        if ($this->administrer_clauses !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES;
        }
    ...
    public function setValiderClauses($v)
    {
        ...
        if ($this->valider_clauses !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDER_CLAUSES;
        }
    ...
    public function setAdministrerCanevas($v)
    {
        ...
        if ($this->administrer_canevas !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS;
        }
    ...
    public function setValiderCanevas($v)
    {
        ...
        if ($this->valider_canevas !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDER_CANEVAS;
        }
    ...
    public function setAdministrerClausesEntiteAchats($v)
    {
        ...
        if ($this->administrer_clauses_entite_achats !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_ENTITE_ACHATS;
        }
    ...
    public function setGenererPiecesFormatOdt($v)
    {
        ...
        if ($this->generer_pieces_format_odt !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GENERER_PIECES_FORMAT_ODT;
        }
    ...
    public function setPublierVersionClausierEditeur($v)
    {
        ...
        if ($this->publier_version_clausier_editeur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::PUBLIER_VERSION_CLAUSIER_EDITEUR;
        }
    ...
    public function setAdministrerClausesEditeur($v)
    {
        ...
        if ($this->administrer_clauses_editeur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_EDITEUR;
        }
    ...
    public function setValiderClausesEditeur($v)
    {
        ...
        if ($this->valider_clauses_editeur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDER_CLAUSES_EDITEUR;
        }
    ...
    public function setAdministrerCanevasEditeur($v)
    {
        ...
        if ($this->administrer_canevas_editeur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS_EDITEUR;
        }
    ...
    public function setValiderCanevasEditeur($v)
    {
        ...
        if ($this->valider_canevas_editeur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDER_CANEVAS_EDITEUR;
        }
    ...
    public function setDecisionSuiviSeul($v)
    {
        ...
        if ($this->decision_suivi_seul !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::DECISION_SUIVI_SEUL;
        }
    ...
    public function setOuvrirCandidatureHorsLigne($v)
    {
        ...
        if ($this->ouvrir_candidature_hors_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_HORS_LIGNE;
        }
    ...
    public function setOuvrirOffreHorsLigne($v)
    {
        ...
        if ($this->ouvrir_offre_hors_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_OFFRE_HORS_LIGNE;
        }
    ...
    public function setOuvrirOffreTechniqueHorsLigne($v)
    {
        ...
        if ($this->ouvrir_offre_technique_hors_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_HORS_LIGNE;
        }
    ...
    public function setOuvrirAnonymatHorsLigne($v)
    {
        ...
        if ($this->ouvrir_anonymat_hors_ligne !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_HORS_LIGNE;
        }
    ...
    public function setEspaceCollaboratifGestionnaire($v)
    {
        ...
        if ($this->espace_collaboratif_gestionnaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_GESTIONNAIRE;
        }
    ...
    public function setEspaceCollaboratifContributeur($v)
    {
        ...
        if ($this->espace_collaboratif_contributeur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_CONTRIBUTEUR;
        }
    ...
    public function setGererOrganismes($v)
    {
        ...
        if ($this->gerer_organismes !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_ORGANISMES;
        }
    ...
    public function setGererAssociationsAgents($v)
    {
        ...
        if ($this->gerer_associations_agents !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_ASSOCIATIONS_AGENTS;
        }
    ...
    public function setModuleRedactionUniquement($v)
    {
        ...
        if ($this->module_redaction_uniquement !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::MODULE_REDACTION_UNIQUEMENT;
        }
    ...
    public function setHistoriqueNavigationInscrits($v)
    {
        ...
        if ($this->historique_navigation_inscrits !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::HISTORIQUE_NAVIGATION_INSCRITS;
        }
    ...
    public function setTelechargerAccordsCadres($v)
    {
        ...
        if ($this->telecharger_accords_cadres !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::TELECHARGER_ACCORDS_CADRES;
        }
    ...
    public function setCreerAnnonceDecisionResiliation($v)
    {
        ...
        if ($this->creer_annonce_decision_resiliation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_ANNONCE_DECISION_RESILIATION;
        }
    ...
    public function setCreerAnnonceSyntheseRapportAudit($v)
    {
        ...
        if ($this->creer_annonce_synthese_rapport_audit !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::CREER_ANNONCE_SYNTHESE_RAPPORT_AUDIT;
        }
    ...
    public function setGererOperations($v)
    {
        ...
        if ($this->gerer_operations !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_OPERATIONS;
        }
    ...
    public function setTelechargerSiretAcheteur($v)
    {
        ...
        if ($this->telecharger_siret_acheteur !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::TELECHARGER_SIRET_ACHETEUR;
        }
    ...
    public function setGererReouverturesModification($v)
    {
        ...
        if ($this->gerer_reouvertures_modification !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_REOUVERTURES_MODIFICATION;
        }
    ...
    public function setEnvoyerDemandeValidation($v)
    {
        ...
        if ($this->envoyer_demande_validation !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::ENVOYER_DEMANDE_VALIDATION;
        }
    ...
    public function setSuivreConsultationOrganisme($v)
    {
        ...
        if ($this->suivre_consultation_organisme !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_ORGANISME;
        }
    ...
    public function setRenseignerMontant($v)
    {
        ...
        if ($this->renseigner_montant !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::RENSEIGNER_MONTANT;
        }
    ...
    public function setGestionReferentielContact($v)
    {
        ...
        if ($this->gestion_referentiel_contact !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_REFERENTIEL_CONTACT;
        }
    ...
    public function setValidationAccesFacture($v)
    {
        ...
        if ($this->validation_acces_facture !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::VALIDATION_ACCES_FACTURE;
        }
    ...
    public function setGererCao($v)
    {
        ...
        if ($this->gerer_cao !== $v) {
            $this->gerer_cao = $v;
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GERER_CAO;
        }
    ...
    public function setGestionTravauxCao($v)
    {
        ...
        if ($this->gestion_travaux_cao !== $v) {
            ...
            $this->modifiedColumns[] = CommonHabilitationProfilPeer::GESTION_TRAVAUX_CAO;
        }
    ...
    public function hasOnlyDefaultValues()
    {
            ...
            if ($this->utiliser_client_cao !== '1') {
                return false;
            }

            if ($this->notification_boamp !== '1') {
                return false;
            }
            ...
            if ($this->modifier_consultation_mapa_inferieur_montant_apres_validation !== '1') {
                return false;
            }

            if ($this->modifier_consultation_mapa_superieur_montant_apres_validation !== '1') {
                return false;
            }

            if ($this->modifier_consultation_procedures_formalisees_apres_validation !== '1') {
                return false;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->gestion_agent_pole = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->gestion_fournisseurs_envois_postaux = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->gestion_bi_cles = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->creer_consultation = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->modifier_consultation = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->valider_consultation = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->publier_consultation = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->suivre_consultation = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->suivre_consultation_pole = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->supprimer_enveloppe = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->supprimer_consultation = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->depouiller_candidature = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->depouiller_offre = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->messagerie_securisee = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->acces_registre_depots_papier = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->acces_registre_retraits_papier = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->acces_registre_questions_papier = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->gerer_encheres = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->suivre_encheres = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->suivi_entreprise = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->envoi_boamp = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->acces_classement_lot = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->connecteur_sis = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->connecteur_marco = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->repondre_aux_questions = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->appel_projet_formation = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->utiliser_client_cao = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->notification_boamp = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->administrer_compte = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->gestion_mapa = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->gestion_type_validation = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->approuver_consultation = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
            $this->administrer_procedure = ($row[$startcol + 34] !== null) ? (string) $row[$startcol + 34] : null;
            $this->restreindre_creation = ($row[$startcol + 35] !== null) ? (string) $row[$startcol + 35] : null;
            $this->creer_liste_marches = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
            $this->gestion_commissions = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
            $this->suivi_seul_consultation = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
            $this->attribution_marche = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
            $this->fiche_recensement = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
            $this->declarer_infructueux = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
            $this->declarer_sans_suite = ($row[$startcol + 42] !== null) ? (string) $row[$startcol + 42] : null;
            $this->creer_consultation_transverse = ($row[$startcol + 43] !== null) ? (string) $row[$startcol + 43] : null;
            $this->ouvrir_candidature_en_ligne = ($row[$startcol + 44] !== null) ? (string) $row[$startcol + 44] : null;
            $this->ouvrir_candidature_a_distance = ($row[$startcol + 45] !== null) ? (string) $row[$startcol + 45] : null;
            $this->refuser_enveloppe = ($row[$startcol + 46] !== null) ? (string) $row[$startcol + 46] : null;
            $this->gerer_admissibilite = ($row[$startcol + 47] !== null) ? (string) $row[$startcol + 47] : null;
            $this->restaurer_enveloppe = ($row[$startcol + 48] !== null) ? (string) $row[$startcol + 48] : null;
            $this->ouvrir_offre_en_ligne = ($row[$startcol + 49] !== null) ? (string) $row[$startcol + 49] : null;
            $this->ouvrir_anonymat_en_ligne = ($row[$startcol + 50] !== null) ? (string) $row[$startcol + 50] : null;
            $this->gestion_compte_boamp = ($row[$startcol + 51] !== null) ? (string) $row[$startcol + 51] : null;
            $this->gestion_agents = ($row[$startcol + 52] !== null) ? (string) $row[$startcol + 52] : null;
            $this->gestion_habilitations = ($row[$startcol + 53] !== null) ? (string) $row[$startcol + 53] : null;
            $this->gerer_mapa_inferieur_montant = ($row[$startcol + 54] !== null) ? (string) $row[$startcol + 54] : null;
            $this->gerer_mapa_superieur_montant = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
            $this->modifier_consultation_avant_validation = ($row[$startcol + 56] !== null) ? (string) $row[$startcol + 56] : null;
            $this->modifier_consultation_apres_validation = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
            $this->acces_reponses = ($row[$startcol + 58] !== null) ? (string) $row[$startcol + 58] : null;
            $this->telechargement_groupe_anticipe_plis_chiffres = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
            $this->telechargement_unitaire_plis_chiffres = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
            $this->ouvrir_offre_a_distance = ($row[$startcol + 61] !== null) ? (string) $row[$startcol + 61] : null;
            $this->creer_annonce_information = ($row[$startcol + 62] !== null) ? (string) $row[$startcol + 62] : null;
            $this->saisie_marches = ($row[$startcol + 63] !== null) ? (string) $row[$startcol + 63] : null;
            $this->validation_marches = ($row[$startcol + 64] !== null) ? (string) $row[$startcol + 64] : null;
            $this->publication_marches = ($row[$startcol + 65] !== null) ? (string) $row[$startcol + 65] : null;
            $this->gerer_statistiques_metier = ($row[$startcol + 66] !== null) ? (string) $row[$startcol + 66] : null;
            $this->gerer_archives = ($row[$startcol + 67] !== null) ? (string) $row[$startcol + 67] : null;
            $this->administrer_procedures_formalisees = ($row[$startcol + 68] !== null) ? (string) $row[$startcol + 68] : null;
            $this->creer_annonce_attribution = ($row[$startcol + 69] !== null) ? (string) $row[$startcol + 69] : null;
            $this->acces_registre_retraits_electronique = ($row[$startcol + 70] !== null) ? (string) $row[$startcol + 70] : null;
            $this->acces_registre_questions_electronique = ($row[$startcol + 71] !== null) ? (string) $row[$startcol + 71] : null;
            $this->acces_registre_depots_electronique = ($row[$startcol + 72] !== null) ? (string) $row[$startcol + 72] : null;
            $this->validation_simple = ($row[$startcol + 73] !== null) ? (string) $row[$startcol + 73] : null;
            $this->validation_intermediaire = ($row[$startcol + 74] !== null) ? (string) $row[$startcol + 74] : null;
            $this->validation_finale = ($row[$startcol + 75] !== null) ? (string) $row[$startcol + 75] : null;
            $this->creer_suite_consultation = ($row[$startcol + 76] !== null) ? (string) $row[$startcol + 76] : null;
            $this->hyper_admin = ($row[$startcol + 77] !== null) ? (string) $row[$startcol + 77] : null;
            $this->droit_gestion_services = ($row[$startcol + 78] !== null) ? (string) $row[$startcol + 78] : null;
            $this->suivi_acces = ($row[$startcol + 79] !== null) ? (string) $row[$startcol + 79] : null;
            $this->statistiques_site = ($row[$startcol + 80] !== null) ? (string) $row[$startcol + 80] : null;
            $this->statistiques_qos = ($row[$startcol + 81] !== null) ? (string) $row[$startcol + 81] : null;
            $this->ouvrir_anonymat_a_distance = ($row[$startcol + 82] !== null) ? (string) $row[$startcol + 82] : null;
            $this->gestion_compte_jal = ($row[$startcol + 83] !== null) ? (string) $row[$startcol + 83] : null;
            $this->gestion_centrale_pub = ($row[$startcol + 84] !== null) ? (string) $row[$startcol + 84] : null;
            $this->gestion_compte_groupe_moniteur = ($row[$startcol + 85] !== null) ? (string) $row[$startcol + 85] : null;
            $this->ouvrir_offre_technique_en_ligne = ($row[$startcol + 86] !== null) ? (string) $row[$startcol + 86] : null;
            $this->ouvrir_offre_technique_a_distance = ($row[$startcol + 87] !== null) ? (string) $row[$startcol + 87] : null;
            $this->activation_compte_entreprise = ($row[$startcol + 88] !== null) ? (string) $row[$startcol + 88] : null;
            $this->importer_enveloppe = ($row[$startcol + 89] !== null) ? (string) $row[$startcol + 89] : null;
            $this->suivi_seul_registre_depots_papier = ($row[$startcol + 90] !== null) ? (string) $row[$startcol + 90] : null;
            $this->suivi_seul_registre_retraits_papier = ($row[$startcol + 91] !== null) ? (string) $row[$startcol + 91] : null;
            $this->suivi_seul_registre_questions_papier = ($row[$startcol + 92] !== null) ? (string) $row[$startcol + 92] : null;
            $this->suivi_seul_registre_depots_electronique = ($row[$startcol + 93] !== null) ? (string) $row[$startcol + 93] : null;
            $this->suivi_seul_registre_retraits_electronique = ($row[$startcol + 94] !== null) ? (string) $row[$startcol + 94] : null;
            $this->suivi_seul_registre_questions_electronique = ($row[$startcol + 95] !== null) ? (string) $row[$startcol + 95] : null;
            $this->modifier_consultation_mapa_inferieur_montant_apres_validation = ($row[$startcol + 96] !== null) ? (string) $row[$startcol + 96] : null;
            $this->modifier_consultation_mapa_superieur_montant_apres_validation = ($row[$startcol + 97] !== null) ? (string) $row[$startcol + 97] : null;
            $this->modifier_consultation_procedures_formalisees_apres_validation = ($row[$startcol + 98] !== null) ? (string) $row[$startcol + 98] : null;
            $this->gerer_les_entreprises = ($row[$startcol + 99] !== null) ? (string) $row[$startcol + 99] : null;
            $this->portee_societes_exclues = ($row[$startcol + 100] !== null) ? (string) $row[$startcol + 100] : null;
            $this->portee_societes_exclues_tous_organismes = ($row[$startcol + 101] !== null) ? (string) $row[$startcol + 101] : null;
            $this->modifier_societes_exclues = ($row[$startcol + 102] !== null) ? (string) $row[$startcol + 102] : null;
            $this->supprimer_societes_exclues = ($row[$startcol + 103] !== null) ? (string) $row[$startcol + 103] : null;
            $this->resultat_analyse = ($row[$startcol + 104] !== null) ? (string) $row[$startcol + 104] : null;
            $this->gerer_adresses_service = ($row[$startcol + 105] !== null) ? (string) $row[$startcol + 105] : null;
            $this->gerer_mon_service = ($row[$startcol + 106] !== null) ? (string) $row[$startcol + 106] : null;
            $this->download_archives = ($row[$startcol + 107] !== null) ? (string) $row[$startcol + 107] : null;
            $this->creer_annonce_extrait_pv = ($row[$startcol + 108] !== null) ? (string) $row[$startcol + 108] : null;
            $this->creer_annonce_rapport_achevement = ($row[$startcol + 109] !== null) ? (string) $row[$startcol + 109] : null;
            $this->gestion_certificats_agent = ($row[$startcol + 110] !== null) ? (string) $row[$startcol + 110] : null;
            $this->creer_avis_programme_previsionnel = ($row[$startcol + 111] !== null) ? (string) $row[$startcol + 111] : null;
            $this->annuler_consultation = ($row[$startcol + 112] !== null) ? (string) $row[$startcol + 112] : null;
            $this->envoyer_publicite = ($row[$startcol + 113] !== null) ? (string) $row[$startcol + 113] : null;
            $this->liste_marches_notifies = ($row[$startcol + 114] !== null) ? (string) $row[$startcol + 114] : null;
            $this->suivre_message = ($row[$startcol + 115] !== null) ? (string) $row[$startcol + 115] : null;
            $this->envoyer_message = ($row[$startcol + 116] !== null) ? (string) $row[$startcol + 116] : null;
            $this->suivi_flux_chorus_transversal = ($row[$startcol + 117] !== null) ? (string) $row[$startcol + 117] : null;
            $this->gestion_mandataire = ($row[$startcol + 118] !== null) ? (string) $row[$startcol + 118] : null;
            $this->gerer_newsletter = ($row[$startcol + 119] !== null) ? (string) $row[$startcol + 119] : null;
            $this->gestion_modeles_formulaire = ($row[$startcol + 120] !== null) ? (string) $row[$startcol + 120] : null;
            $this->gestion_adresses_facturation_jal = ($row[$startcol + 121] !== null) ? (string) $row[$startcol + 121] : null;
            $this->administrer_adresses_facturation_jal = ($row[$startcol + 122] !== null) ? (string) $row[$startcol + 122] : null;
            $this->redaction_documents_redac = ($row[$startcol + 123] !== null) ? (string) $row[$startcol + 123] : null;
            $this->validation_documents_redac = ($row[$startcol + 124] !== null) ? (string) $row[$startcol + 124] : null;
            $this->gestion_mise_disposition_pieces_marche = ($row[$startcol + 125] !== null) ? (string) $row[$startcol + 125] : null;
            $this->annuaire_acheteur = ($row[$startcol + 126] !== null) ? (string) $row[$startcol + 126] : null;
            $this->reprendre_integralement_article = ($row[$startcol + 127] !== null) ? (string) $row[$startcol + 127] : null;
            $this->administrer_clauses = ($row[$startcol + 128] !== null) ? (string) $row[$startcol + 128] : null;
            $this->valider_clauses = ($row[$startcol + 129] !== null) ? (string) $row[$startcol + 129] : null;
            $this->administrer_canevas = ($row[$startcol + 130] !== null) ? (string) $row[$startcol + 130] : null;
            $this->valider_canevas = ($row[$startcol + 131] !== null) ? (string) $row[$startcol + 131] : null;
            $this->administrer_clauses_entite_achats = ($row[$startcol + 132] !== null) ? (string) $row[$startcol + 132] : null;
            $this->generer_pieces_format_odt = ($row[$startcol + 133] !== null) ? (string) $row[$startcol + 133] : null;
            $this->publier_version_clausier_editeur = ($row[$startcol + 134] !== null) ? (string) $row[$startcol + 134] : null;
            $this->administrer_clauses_editeur = ($row[$startcol + 135] !== null) ? (string) $row[$startcol + 135] : null;
            $this->valider_clauses_editeur = ($row[$startcol + 136] !== null) ? (string) $row[$startcol + 136] : null;
            $this->administrer_canevas_editeur = ($row[$startcol + 137] !== null) ? (string) $row[$startcol + 137] : null;
            $this->valider_canevas_editeur = ($row[$startcol + 138] !== null) ? (string) $row[$startcol + 138] : null;
            $this->decision_suivi_seul = ($row[$startcol + 139] !== null) ? (string) $row[$startcol + 139] : null;
            $this->ouvrir_candidature_hors_ligne = ($row[$startcol + 140] !== null) ? (string) $row[$startcol + 140] : null;
            $this->ouvrir_offre_hors_ligne = ($row[$startcol + 141] !== null) ? (string) $row[$startcol + 141] : null;
            $this->ouvrir_offre_technique_hors_ligne = ($row[$startcol + 142] !== null) ? (string) $row[$startcol + 142] : null;
            $this->ouvrir_anonymat_hors_ligne = ($row[$startcol + 143] !== null) ? (string) $row[$startcol + 143] : null;
            $this->espace_collaboratif_gestionnaire = ($row[$startcol + 144] !== null) ? (string) $row[$startcol + 144] : null;
            $this->espace_collaboratif_contributeur = ($row[$startcol + 145] !== null) ? (string) $row[$startcol + 145] : null;
            $this->gerer_organismes = ($row[$startcol + 146] !== null) ? (string) $row[$startcol + 146] : null;
            $this->gerer_associations_agents = ($row[$startcol + 147] !== null) ? (string) $row[$startcol + 147] : null;
            $this->module_redaction_uniquement = ($row[$startcol + 148] !== null) ? (string) $row[$startcol + 148] : null;
            $this->historique_navigation_inscrits = ($row[$startcol + 149] !== null) ? (string) $row[$startcol + 149] : null;
            $this->telecharger_accords_cadres = ($row[$startcol + 150] !== null) ? (string) $row[$startcol + 150] : null;
            $this->creer_annonce_decision_resiliation = ($row[$startcol + 151] !== null) ? (string) $row[$startcol + 151] : null;
            $this->creer_annonce_synthese_rapport_audit = ($row[$startcol + 152] !== null) ? (string) $row[$startcol + 152] : null;
            $this->gerer_operations = ($row[$startcol + 153] !== null) ? (string) $row[$startcol + 153] : null;
            $this->telecharger_siret_acheteur = ($row[$startcol + 154] !== null) ? (string) $row[$startcol + 154] : null;
            $this->gerer_reouvertures_modification = ($row[$startcol + 155] !== null) ? (string) $row[$startcol + 155] : null;
            $this->envoyer_demande_validation = ($row[$startcol + 156] !== null) ? (string) $row[$startcol + 156] : null;
            $this->suivre_consultation_organisme = ($row[$startcol + 157] !== null) ? (string) $row[$startcol + 157] : null;
            $this->renseigner_montant = ($row[$startcol + 158] !== null) ? (string) $row[$startcol + 158] : null;
            $this->gestion_referentiel_contact = ($row[$startcol + 159] !== null) ? (string) $row[$startcol + 159] : null;
            $this->validation_acces_facture = ($row[$startcol + 160] !== null) ? (string) $row[$startcol + 160] : null;
            $this->gerer_cao = ($row[$startcol + 161] !== null) ? (string) $row[$startcol + 161] : null;
            $this->gestion_travaux_cao = ($row[$startcol + 162] !== null) ? (string) $row[$startcol + 162] : null;
            $this->resetModified();
            ...
            return $startcol + 163; // 163 = CommonHabilitationProfilPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonHabilitationProfil object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonHabilitationProfilPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonHabilitationProfilQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonHabilitationProfilPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_AGENT_POLE)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_agent_pole`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_FOURNISSEURS_ENVOIS_POSTAUX)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_fournisseurs_envois_postaux`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_BI_CLES)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_bi_cles`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`creer_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`valider_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PUBLIER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`publier_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`suivre_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_POLE)) {
            $modifiedColumns[':p' . $index++]  = '`suivre_consultation_pole`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUPPRIMER_ENVELOPPE)) {
            $modifiedColumns[':p' . $index++]  = '`supprimer_enveloppe`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUPPRIMER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`supprimer_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DEPOUILLER_CANDIDATURE)) {
            $modifiedColumns[':p' . $index++]  = '`depouiller_candidature`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DEPOUILLER_OFFRE)) {
            $modifiedColumns[':p' . $index++]  = '`depouiller_offre`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MESSAGERIE_SECURISEE)) {
            $modifiedColumns[':p' . $index++]  = '`messagerie_securisee`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_PAPIER)) {
            $modifiedColumns[':p' . $index++]  = '`acces_registre_depots_papier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_PAPIER)) {
            $modifiedColumns[':p' . $index++]  = '`acces_registre_retraits_papier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_PAPIER)) {
            $modifiedColumns[':p' . $index++]  = '`acces_registre_questions_papier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ENCHERES)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_encheres`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_ENCHERES)) {
            $modifiedColumns[':p' . $index++]  = '`suivre_encheres`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_ENTREPRISE)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_entreprise`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOI_BOAMP)) {
            $modifiedColumns[':p' . $index++]  = '`envoi_boamp`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_CLASSEMENT_LOT)) {
            $modifiedColumns[':p' . $index++]  = '`acces_classement_lot`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CONNECTEUR_SIS)) {
            $modifiedColumns[':p' . $index++]  = '`connecteur_sis`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CONNECTEUR_MARCO)) {
            $modifiedColumns[':p' . $index++]  = '`connecteur_marco`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REPONDRE_AUX_QUESTIONS)) {
            $modifiedColumns[':p' . $index++]  = '`repondre_aux_questions`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::APPEL_PROJET_FORMATION)) {
            $modifiedColumns[':p' . $index++]  = '`appel_projet_formation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::UTILISER_CLIENT_CAO)) {
            $modifiedColumns[':p' . $index++]  = '`utiliser_client_CAO`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::NOTIFICATION_BOAMP)) {
            $modifiedColumns[':p' . $index++]  = '`notification_boamp`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_COMPTE)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_compte`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MAPA)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_mapa`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_TYPE_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_type_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::APPROUVER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`approuver_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURE)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_procedure`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RESTREINDRE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`restreindre_creation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_LISTE_MARCHES)) {
            $modifiedColumns[':p' . $index++]  = '`creer_liste_marches`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMMISSIONS)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_commissions`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ATTRIBUTION_MARCHE)) {
            $modifiedColumns[':p' . $index++]  = '`attribution_marche`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::FICHE_RECENSEMENT)) {
            $modifiedColumns[':p' . $index++]  = '`fiche_recensement`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DECLARER_INFRUCTUEUX)) {
            $modifiedColumns[':p' . $index++]  = '`declarer_infructueux`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DECLARER_SANS_SUITE)) {
            $modifiedColumns[':p' . $index++]  = '`declarer_sans_suite`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_CONSULTATION_TRANSVERSE)) {
            $modifiedColumns[':p' . $index++]  = '`creer_consultation_transverse`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_EN_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_candidature_en_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_A_DISTANCE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_candidature_a_distance`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REFUSER_ENVELOPPE)) {
            $modifiedColumns[':p' . $index++]  = '`refuser_enveloppe`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ADMISSIBILITE)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_admissibilite`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RESTAURER_ENVELOPPE)) {
            $modifiedColumns[':p' . $index++]  = '`restaurer_enveloppe`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_EN_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_offre_en_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_EN_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_anonymat_en_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMPTE_BOAMP)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_compte_boamp`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_AGENTS)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_agents`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_HABILITATIONS)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_habilitations`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_MAPA_INFERIEUR_MONTANT)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_mapa_inferieur_montant`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_MAPA_SUPERIEUR_MONTANT)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_mapa_superieur_montant`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_AVANT_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_consultation_avant_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_APRES_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_consultation_apres_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REPONSES)) {
            $modifiedColumns[':p' . $index++]  = '`acces_reponses`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGEMENT_GROUPE_ANTICIPE_PLIS_CHIFFRES)) {
            $modifiedColumns[':p' . $index++]  = '`telechargement_groupe_anticipe_plis_chiffres`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGEMENT_UNITAIRE_PLIS_CHIFFRES)) {
            $modifiedColumns[':p' . $index++]  = '`telechargement_unitaire_plis_chiffres`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_A_DISTANCE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_offre_a_distance`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_INFORMATION)) {
            $modifiedColumns[':p' . $index++]  = '`creer_annonce_information`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SAISIE_MARCHES)) {
            $modifiedColumns[':p' . $index++]  = '`saisie_marches`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_MARCHES)) {
            $modifiedColumns[':p' . $index++]  = '`validation_marches`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PUBLICATION_MARCHES)) {
            $modifiedColumns[':p' . $index++]  = '`publication_marches`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_STATISTIQUES_METIER)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_statistiques_metier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ARCHIVES)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_archives`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURES_FORMALISEES)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_procedures_formalisees`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_ATTRIBUTION)) {
            $modifiedColumns[':p' . $index++]  = '`creer_annonce_attribution`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_ELECTRONIQUE)) {
            $modifiedColumns[':p' . $index++]  = '`acces_registre_retraits_electronique`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_ELECTRONIQUE)) {
            $modifiedColumns[':p' . $index++]  = '`acces_registre_questions_electronique`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_ELECTRONIQUE)) {
            $modifiedColumns[':p' . $index++]  = '`acces_registre_depots_electronique`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_SIMPLE)) {
            $modifiedColumns[':p' . $index++]  = '`validation_simple`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_INTERMEDIAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`validation_intermediaire`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_FINALE)) {
            $modifiedColumns[':p' . $index++]  = '`validation_finale`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_SUITE_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`creer_suite_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::HYPER_ADMIN)) {
            $modifiedColumns[':p' . $index++]  = '`hyper_admin`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DROIT_GESTION_SERVICES)) {
            $modifiedColumns[':p' . $index++]  = '`droit_gestion_services`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_ACCES)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_acces`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::STATISTIQUES_SITE)) {
            $modifiedColumns[':p' . $index++]  = '`statistiques_site`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::STATISTIQUES_QOS)) {
            $modifiedColumns[':p' . $index++]  = '`statistiques_QoS`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_A_DISTANCE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_anonymat_a_distance`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMPTE_JAL)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_compte_jal`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_CENTRALE_PUB)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_centrale_pub`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMPTE_GROUPE_MONITEUR)) {
            $modifiedColumns[':p' . $index++]  = '`Gestion_Compte_Groupe_Moniteur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_EN_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_offre_technique_en_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_A_DISTANCE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_offre_technique_a_distance`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACTIVATION_COMPTE_ENTREPRISE)) {
            $modifiedColumns[':p' . $index++]  = '`activation_compte_entreprise`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::IMPORTER_ENVELOPPE)) {
            $modifiedColumns[':p' . $index++]  = '`importer_enveloppe`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_PAPIER)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_registre_depots_papier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_PAPIER)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_registre_retraits_papier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_PAPIER)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_registre_questions_papier`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_ELECTRONIQUE)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_registre_depots_electronique`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_ELECTRONIQUE)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_registre_retraits_electronique`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_ELECTRONIQUE)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_seul_registre_questions_electronique`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_INFERIEUR_MONTANT_APRES_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_consultation_mapa_inferieur_montant_apres_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_SUPERIEUR_MONTANT_APRES_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_consultation_mapa_superieur_montant_apres_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_PROCEDURES_FORMALISEES_APRES_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_consultation_procedures_formalisees_apres_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_LES_ENTREPRISES)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_les_entreprises`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES)) {
            $modifiedColumns[':p' . $index++]  = '`portee_societes_exclues`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES_TOUS_ORGANISMES)) {
            $modifiedColumns[':p' . $index++]  = '`portee_societes_exclues_tous_organismes`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_SOCIETES_EXCLUES)) {
            $modifiedColumns[':p' . $index++]  = '`modifier_societes_exclues`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUPPRIMER_SOCIETES_EXCLUES)) {
            $modifiedColumns[':p' . $index++]  = '`supprimer_societes_exclues`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RESULTAT_ANALYSE)) {
            $modifiedColumns[':p' . $index++]  = '`resultat_analyse`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ADRESSES_SERVICE)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_adresses_service`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_MON_SERVICE)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_mon_service`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DOWNLOAD_ARCHIVES)) {
            $modifiedColumns[':p' . $index++]  = '`download_archives`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_EXTRAIT_PV)) {
            $modifiedColumns[':p' . $index++]  = '`creer_annonce_extrait_pv`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_RAPPORT_ACHEVEMENT)) {
            $modifiedColumns[':p' . $index++]  = '`creer_annonce_rapport_achevement`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_CERTIFICATS_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_certificats_agent`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_AVIS_PROGRAMME_PREVISIONNEL)) {
            $modifiedColumns[':p' . $index++]  = '`creer_avis_programme_previsionnel`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ANNULER_CONSULTATION)) {
            $modifiedColumns[':p' . $index++]  = '`annuler_consultation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOYER_PUBLICITE)) {
            $modifiedColumns[':p' . $index++]  = '`envoyer_publicite`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::LISTE_MARCHES_NOTIFIES)) {
            $modifiedColumns[':p' . $index++]  = '`liste_marches_notifies`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`suivre_message`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOYER_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`envoyer_message`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_FLUX_CHORUS_TRANSVERSAL)) {
            $modifiedColumns[':p' . $index++]  = '`suivi_flux_chorus_transversal`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MANDATAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_mandataire`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_NEWSLETTER)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_newsletter`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MODELES_FORMULAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_modeles_formulaire`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_ADRESSES_FACTURATION_JAL)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_adresses_facturation_jal`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_ADRESSES_FACTURATION_JAL)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_adresses_facturation_jal`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REDACTION_DOCUMENTS_REDAC)) {
            $modifiedColumns[':p' . $index++]  = '`redaction_documents_redac`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_DOCUMENTS_REDAC)) {
            $modifiedColumns[':p' . $index++]  = '`validation_documents_redac`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MISE_DISPOSITION_PIECES_MARCHE)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_mise_disposition_pieces_marche`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ANNUAIRE_ACHETEUR)) {
            $modifiedColumns[':p' . $index++]  = '`annuaire_acheteur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REPRENDRE_INTEGRALEMENT_ARTICLE)) {
            $modifiedColumns[':p' . $index++]  = '`reprendre_integralement_article`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_clauses`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CLAUSES)) {
            $modifiedColumns[':p' . $index++]  = '`valider_clauses`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_canevas`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CANEVAS)) {
            $modifiedColumns[':p' . $index++]  = '`valider_canevas`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_ENTITE_ACHATS)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_clauses_entite_achats`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GENERER_PIECES_FORMAT_ODT)) {
            $modifiedColumns[':p' . $index++]  = '`generer_pieces_format_odt`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PUBLIER_VERSION_CLAUSIER_EDITEUR)) {
            $modifiedColumns[':p' . $index++]  = '`publier_version_clausier_editeur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_EDITEUR)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_clauses_editeur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CLAUSES_EDITEUR)) {
            $modifiedColumns[':p' . $index++]  = '`valider_clauses_editeur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS_EDITEUR)) {
            $modifiedColumns[':p' . $index++]  = '`administrer_canevas_editeur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CANEVAS_EDITEUR)) {
            $modifiedColumns[':p' . $index++]  = '`valider_canevas_editeur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DECISION_SUIVI_SEUL)) {
            $modifiedColumns[':p' . $index++]  = '`decision_suivi_seul`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_HORS_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_candidature_hors_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_HORS_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_offre_hors_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_HORS_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_offre_technique_hors_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_HORS_LIGNE)) {
            $modifiedColumns[':p' . $index++]  = '`ouvrir_anonymat_hors_ligne`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_GESTIONNAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`espace_collaboratif_gestionnaire`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_CONTRIBUTEUR)) {
            $modifiedColumns[':p' . $index++]  = '`espace_collaboratif_contributeur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ORGANISMES)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_organismes`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ASSOCIATIONS_AGENTS)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_associations_agents`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODULE_REDACTION_UNIQUEMENT)) {
            $modifiedColumns[':p' . $index++]  = '`module_redaction_uniquement`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::HISTORIQUE_NAVIGATION_INSCRITS)) {
            $modifiedColumns[':p' . $index++]  = '`historique_navigation_inscrits`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGER_ACCORDS_CADRES)) {
            $modifiedColumns[':p' . $index++]  = '`telecharger_accords_cadres`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_DECISION_RESILIATION)) {
            $modifiedColumns[':p' . $index++]  = '`creer_annonce_decision_resiliation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_SYNTHESE_RAPPORT_AUDIT)) {
            $modifiedColumns[':p' . $index++]  = '`creer_annonce_synthese_rapport_audit`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_OPERATIONS)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_operations`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGER_SIRET_ACHETEUR)) {
            $modifiedColumns[':p' . $index++]  = '`telecharger_siret_acheteur`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_REOUVERTURES_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_reouvertures_modification`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOYER_DEMANDE_VALIDATION)) {
            $modifiedColumns[':p' . $index++]  = '`envoyer_demande_validation`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_ORGANISME)) {
            $modifiedColumns[':p' . $index++]  = '`suivre_consultation_organisme`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RENSEIGNER_MONTANT)) {
            $modifiedColumns[':p' . $index++]  = '`renseigner_montant`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_REFERENTIEL_CONTACT)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_referentiel_contact`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_ACCES_FACTURE)) {
            $modifiedColumns[':p' . $index++]  = '`validation_acces_facture`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_CAO)) {
            $modifiedColumns[':p' . $index++]  = '`gerer_cao`';
        }
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_TRAVAUX_CAO)) {
            $modifiedColumns[':p' . $index++]  = '`gestion_travaux_cao`';
        }

        $sql = sprintf(
            'INSERT INTO `HabilitationProfil` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonHabilitationProfilPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonHabilitationProfilPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonHabilitationProfil'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonHabilitationProfil'][$this->getPrimaryKey()] = true;
        $keys = CommonHabilitationProfilPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getLibelle(),
            $keys[2] => $this->getGestionAgentPole(),
            $keys[3] => $this->getGestionFournisseursEnvoisPostaux(),
            $keys[4] => $this->getGestionBiCles(),
            $keys[5] => $this->getCreerConsultation(),
            $keys[6] => $this->getModifierConsultation(),
            $keys[7] => $this->getValiderConsultation(),
            $keys[8] => $this->getPublierConsultation(),
            $keys[9] => $this->getSuivreConsultation(),
            $keys[10] => $this->getSuivreConsultationPole(),
            $keys[11] => $this->getSupprimerEnveloppe(),
            $keys[12] => $this->getSupprimerConsultation(),
            $keys[13] => $this->getDepouillerCandidature(),
            $keys[14] => $this->getDepouillerOffre(),
            $keys[15] => $this->getMessagerieSecurisee(),
            $keys[16] => $this->getAccesRegistreDepotsPapier(),
            $keys[17] => $this->getAccesRegistreRetraitsPapier(),
            $keys[18] => $this->getAccesRegistreQuestionsPapier(),
            $keys[19] => $this->getGererEncheres(),
            $keys[20] => $this->getSuivreEncheres(),
            $keys[21] => $this->getSuiviEntreprise(),
            $keys[22] => $this->getEnvoiBoamp(),
            $keys[23] => $this->getAccesClassementLot(),
            $keys[24] => $this->getConnecteurSis(),
            $keys[25] => $this->getConnecteurMarco(),
            $keys[26] => $this->getRepondreAuxQuestions(),
            $keys[27] => $this->getAppelProjetFormation(),
            $keys[28] => $this->getUtiliserClientCao(),
            $keys[29] => $this->getNotificationBoamp(),
            $keys[30] => $this->getAdministrerCompte(),
            $keys[31] => $this->getGestionMapa(),
            $keys[32] => $this->getGestionTypeValidation(),
            $keys[33] => $this->getApprouverConsultation(),
            $keys[34] => $this->getAdministrerProcedure(),
            $keys[35] => $this->getRestreindreCreation(),
            $keys[36] => $this->getCreerListeMarches(),
            $keys[37] => $this->getGestionCommissions(),
            $keys[38] => $this->getSuiviSeulConsultation(),
            $keys[39] => $this->getAttributionMarche(),
            $keys[40] => $this->getFicheRecensement(),
            $keys[41] => $this->getDeclarerInfructueux(),
            $keys[42] => $this->getDeclarerSansSuite(),
            $keys[43] => $this->getCreerConsultationTransverse(),
            $keys[44] => $this->getOuvrirCandidatureEnLigne(),
            $keys[45] => $this->getOuvrirCandidatureADistance(),
            $keys[46] => $this->getRefuserEnveloppe(),
            $keys[47] => $this->getGererAdmissibilite(),
            $keys[48] => $this->getRestaurerEnveloppe(),
            $keys[49] => $this->getOuvrirOffreEnLigne(),
            $keys[50] => $this->getOuvrirAnonymatEnLigne(),
            $keys[51] => $this->getGestionCompteBoamp(),
            $keys[52] => $this->getGestionAgents(),
            $keys[53] => $this->getGestionHabilitations(),
            $keys[54] => $this->getGererMapaInferieurMontant(),
            $keys[55] => $this->getGererMapaSuperieurMontant(),
            $keys[56] => $this->getModifierConsultationAvantValidation(),
            $keys[57] => $this->getModifierConsultationApresValidation(),
            $keys[58] => $this->getAccesReponses(),
            $keys[59] => $this->getTelechargementGroupeAnticipePlisChiffres(),
            $keys[60] => $this->getTelechargementUnitairePlisChiffres(),
            $keys[61] => $this->getOuvrirOffreADistance(),
            $keys[62] => $this->getCreerAnnonceInformation(),
            $keys[63] => $this->getSaisieMarches(),
            $keys[64] => $this->getValidationMarches(),
            $keys[65] => $this->getPublicationMarches(),
            $keys[66] => $this->getGererStatistiquesMetier(),
            $keys[67] => $this->getGererArchives(),
            $keys[68] => $this->getAdministrerProceduresFormalisees(),
            $keys[69] => $this->getCreerAnnonceAttribution(),
            $keys[70] => $this->getAccesRegistreRetraitsElectronique(),
            $keys[71] => $this->getAccesRegistreQuestionsElectronique(),
            $keys[72] => $this->getAccesRegistreDepotsElectronique(),
            $keys[73] => $this->getValidationSimple(),
            $keys[74] => $this->getValidationIntermediaire(),
            $keys[75] => $this->getValidationFinale(),
            $keys[76] => $this->getCreerSuiteConsultation(),
            $keys[77] => $this->getHyperAdmin(),
            $keys[78] => $this->getDroitGestionServices(),
            $keys[79] => $this->getSuiviAcces(),
            $keys[80] => $this->getStatistiquesSite(),
            $keys[81] => $this->getStatistiquesQos(),
            $keys[82] => $this->getOuvrirAnonymatADistance(),
            $keys[83] => $this->getGestionCompteJal(),
            $keys[84] => $this->getGestionCentralePub(),
            $keys[85] => $this->getGestionCompteGroupeMoniteur(),
            $keys[86] => $this->getOuvrirOffreTechniqueEnLigne(),
            $keys[87] => $this->getOuvrirOffreTechniqueADistance(),
            $keys[88] => $this->getActivationCompteEntreprise(),
            $keys[89] => $this->getImporterEnveloppe(),
            $keys[90] => $this->getSuiviSeulRegistreDepotsPapier(),
            $keys[91] => $this->getSuiviSeulRegistreRetraitsPapier(),
            $keys[92] => $this->getSuiviSeulRegistreQuestionsPapier(),
            $keys[93] => $this->getSuiviSeulRegistreDepotsElectronique(),
            $keys[94] => $this->getSuiviSeulRegistreRetraitsElectronique(),
            $keys[95] => $this->getSuiviSeulRegistreQuestionsElectronique(),
            $keys[96] => $this->getModifierConsultationMapaInferieurMontantApresValidation(),
            $keys[97] => $this->getModifierConsultationMapaSuperieurMontantApresValidation(),
            $keys[98] => $this->getModifierConsultationProceduresFormaliseesApresValidation(),
            $keys[99] => $this->getGererLesEntreprises(),
            $keys[100] => $this->getPorteeSocietesExclues(),
            $keys[101] => $this->getPorteeSocietesExcluesTousOrganismes(),
            $keys[102] => $this->getModifierSocietesExclues(),
            $keys[103] => $this->getSupprimerSocietesExclues(),
            $keys[104] => $this->getResultatAnalyse(),
            $keys[105] => $this->getGererAdressesService(),
            $keys[106] => $this->getGererMonService(),
            $keys[107] => $this->getDownloadArchives(),
            $keys[108] => $this->getCreerAnnonceExtraitPv(),
            $keys[109] => $this->getCreerAnnonceRapportAchevement(),
            $keys[110] => $this->getGestionCertificatsAgent(),
            $keys[111] => $this->getCreerAvisProgrammePrevisionnel(),
            $keys[112] => $this->getAnnulerConsultation(),
            $keys[113] => $this->getEnvoyerPublicite(),
            $keys[114] => $this->getListeMarchesNotifies(),
            $keys[115] => $this->getSuivreMessage(),
            $keys[116] => $this->getEnvoyerMessage(),
            $keys[117] => $this->getSuiviFluxChorusTransversal(),
            $keys[118] => $this->getGestionMandataire(),
            $keys[119] => $this->getGererNewsletter(),
            $keys[120] => $this->getGestionModelesFormulaire(),
            $keys[121] => $this->getGestionAdressesFacturationJal(),
            $keys[122] => $this->getAdministrerAdressesFacturationJal(),
            $keys[123] => $this->getRedactionDocumentsRedac(),
            $keys[124] => $this->getValidationDocumentsRedac(),
            $keys[125] => $this->getGestionMiseDispositionPiecesMarche(),
            $keys[126] => $this->getAnnuaireAcheteur(),
            $keys[127] => $this->getReprendreIntegralementArticle(),
            $keys[128] => $this->getAdministrerClauses(),
            $keys[129] => $this->getValiderClauses(),
            $keys[130] => $this->getAdministrerCanevas(),
            $keys[131] => $this->getValiderCanevas(),
            $keys[132] => $this->getAdministrerClausesEntiteAchats(),
            $keys[133] => $this->getGenererPiecesFormatOdt(),
            $keys[134] => $this->getPublierVersionClausierEditeur(),
            $keys[135] => $this->getAdministrerClausesEditeur(),
            $keys[136] => $this->getValiderClausesEditeur(),
            $keys[137] => $this->getAdministrerCanevasEditeur(),
            $keys[138] => $this->getValiderCanevasEditeur(),
            $keys[139] => $this->getDecisionSuiviSeul(),
            $keys[140] => $this->getOuvrirCandidatureHorsLigne(),
            $keys[141] => $this->getOuvrirOffreHorsLigne(),
            $keys[142] => $this->getOuvrirOffreTechniqueHorsLigne(),
            $keys[143] => $this->getOuvrirAnonymatHorsLigne(),
            $keys[144] => $this->getEspaceCollaboratifGestionnaire(),
            $keys[145] => $this->getEspaceCollaboratifContributeur(),
            $keys[146] => $this->getGererOrganismes(),
            $keys[147] => $this->getGererAssociationsAgents(),
            $keys[148] => $this->getModuleRedactionUniquement(),
            $keys[149] => $this->getHistoriqueNavigationInscrits(),
            $keys[150] => $this->getTelechargerAccordsCadres(),
            $keys[151] => $this->getCreerAnnonceDecisionResiliation(),
            $keys[152] => $this->getCreerAnnonceSyntheseRapportAudit(),
            $keys[153] => $this->getGererOperations(),
            $keys[154] => $this->getTelechargerSiretAcheteur(),
            $keys[155] => $this->getGererReouverturesModification(),
            $keys[156] => $this->getEnvoyerDemandeValidation(),
            $keys[157] => $this->getSuivreConsultationOrganisme(),
            $keys[158] => $this->getRenseignerMontant(),
            $keys[159] => $this->getGestionReferentielContact(),
            $keys[160] => $this->getValidationAccesFacture(),
            $keys[161] => $this->getGererCao(),
            $keys[162] => $this->getGestionTravauxCao(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setGestionAgentPole($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setGestionFournisseursEnvoisPostaux($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setGestionBiCles($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setCreerConsultation($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setModifierConsultation($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setValiderConsultation($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setPublierConsultation($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setSuivreConsultation($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setSuivreConsultationPole($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setSupprimerEnveloppe($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setSupprimerConsultation($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setDepouillerCandidature($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setDepouillerOffre($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setMessagerieSecurisee($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setAccesRegistreDepotsPapier($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setAccesRegistreRetraitsPapier($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setAccesRegistreQuestionsPapier($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setGererEncheres($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setSuivreEncheres($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setSuiviEntreprise($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setEnvoiBoamp($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setAccesClassementLot($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setConnecteurSis($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setConnecteurMarco($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setRepondreAuxQuestions($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setAppelProjetFormation($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setUtiliserClientCao($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setNotificationBoamp($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setAdministrerCompte($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setGestionMapa($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setGestionTypeValidation($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setApprouverConsultation($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setAdministrerProcedure($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setRestreindreCreation($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setCreerListeMarches($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setGestionCommissions($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setSuiviSeulConsultation($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setAttributionMarche($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setFicheRecensement($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setDeclarerInfructueux($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setDeclarerSansSuite($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setCreerConsultationTransverse($arr[$keys[43]]);
        if (array_key_exists($keys[44], $arr)) $this->setOuvrirCandidatureEnLigne($arr[$keys[44]]);
        if (array_key_exists($keys[45], $arr)) $this->setOuvrirCandidatureADistance($arr[$keys[45]]);
        if (array_key_exists($keys[46], $arr)) $this->setRefuserEnveloppe($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setGererAdmissibilite($arr[$keys[47]]);
        if (array_key_exists($keys[48], $arr)) $this->setRestaurerEnveloppe($arr[$keys[48]]);
        if (array_key_exists($keys[49], $arr)) $this->setOuvrirOffreEnLigne($arr[$keys[49]]);
        if (array_key_exists($keys[50], $arr)) $this->setOuvrirAnonymatEnLigne($arr[$keys[50]]);
        if (array_key_exists($keys[51], $arr)) $this->setGestionCompteBoamp($arr[$keys[51]]);
        if (array_key_exists($keys[52], $arr)) $this->setGestionAgents($arr[$keys[52]]);
        if (array_key_exists($keys[53], $arr)) $this->setGestionHabilitations($arr[$keys[53]]);
        if (array_key_exists($keys[54], $arr)) $this->setGererMapaInferieurMontant($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setGererMapaSuperieurMontant($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setModifierConsultationAvantValidation($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setModifierConsultationApresValidation($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setAccesReponses($arr[$keys[58]]);
        if (array_key_exists($keys[59], $arr)) $this->setTelechargementGroupeAnticipePlisChiffres($arr[$keys[59]]);
        if (array_key_exists($keys[60], $arr)) $this->setTelechargementUnitairePlisChiffres($arr[$keys[60]]);
        if (array_key_exists($keys[61], $arr)) $this->setOuvrirOffreADistance($arr[$keys[61]]);
        if (array_key_exists($keys[62], $arr)) $this->setCreerAnnonceInformation($arr[$keys[62]]);
        if (array_key_exists($keys[63], $arr)) $this->setSaisieMarches($arr[$keys[63]]);
        if (array_key_exists($keys[64], $arr)) $this->setValidationMarches($arr[$keys[64]]);
        if (array_key_exists($keys[65], $arr)) $this->setPublicationMarches($arr[$keys[65]]);
        if (array_key_exists($keys[66], $arr)) $this->setGererStatistiquesMetier($arr[$keys[66]]);
        if (array_key_exists($keys[67], $arr)) $this->setGererArchives($arr[$keys[67]]);
        if (array_key_exists($keys[68], $arr)) $this->setAdministrerProceduresFormalisees($arr[$keys[68]]);
        if (array_key_exists($keys[69], $arr)) $this->setCreerAnnonceAttribution($arr[$keys[69]]);
        if (array_key_exists($keys[70], $arr)) $this->setAccesRegistreRetraitsElectronique($arr[$keys[70]]);
        if (array_key_exists($keys[71], $arr)) $this->setAccesRegistreQuestionsElectronique($arr[$keys[71]]);
        if (array_key_exists($keys[72], $arr)) $this->setAccesRegistreDepotsElectronique($arr[$keys[72]]);
        if (array_key_exists($keys[73], $arr)) $this->setValidationSimple($arr[$keys[73]]);
        if (array_key_exists($keys[74], $arr)) $this->setValidationIntermediaire($arr[$keys[74]]);
        if (array_key_exists($keys[75], $arr)) $this->setValidationFinale($arr[$keys[75]]);
        if (array_key_exists($keys[76], $arr)) $this->setCreerSuiteConsultation($arr[$keys[76]]);
        if (array_key_exists($keys[77], $arr)) $this->setHyperAdmin($arr[$keys[77]]);
        if (array_key_exists($keys[78], $arr)) $this->setDroitGestionServices($arr[$keys[78]]);
        if (array_key_exists($keys[79], $arr)) $this->setSuiviAcces($arr[$keys[79]]);
        if (array_key_exists($keys[80], $arr)) $this->setStatistiquesSite($arr[$keys[80]]);
        if (array_key_exists($keys[81], $arr)) $this->setStatistiquesQos($arr[$keys[81]]);
        if (array_key_exists($keys[82], $arr)) $this->setOuvrirAnonymatADistance($arr[$keys[82]]);
        if (array_key_exists($keys[83], $arr)) $this->setGestionCompteJal($arr[$keys[83]]);
        if (array_key_exists($keys[84], $arr)) $this->setGestionCentralePub($arr[$keys[84]]);
        if (array_key_exists($keys[85], $arr)) $this->setGestionCompteGroupeMoniteur($arr[$keys[85]]);
        if (array_key_exists($keys[86], $arr)) $this->setOuvrirOffreTechniqueEnLigne($arr[$keys[86]]);
        if (array_key_exists($keys[87], $arr)) $this->setOuvrirOffreTechniqueADistance($arr[$keys[87]]);
        if (array_key_exists($keys[88], $arr)) $this->setActivationCompteEntreprise($arr[$keys[88]]);
        if (array_key_exists($keys[89], $arr)) $this->setImporterEnveloppe($arr[$keys[89]]);
        if (array_key_exists($keys[90], $arr)) $this->setSuiviSeulRegistreDepotsPapier($arr[$keys[90]]);
        if (array_key_exists($keys[91], $arr)) $this->setSuiviSeulRegistreRetraitsPapier($arr[$keys[91]]);
        if (array_key_exists($keys[92], $arr)) $this->setSuiviSeulRegistreQuestionsPapier($arr[$keys[92]]);
        if (array_key_exists($keys[93], $arr)) $this->setSuiviSeulRegistreDepotsElectronique($arr[$keys[93]]);
        if (array_key_exists($keys[94], $arr)) $this->setSuiviSeulRegistreRetraitsElectronique($arr[$keys[94]]);
        if (array_key_exists($keys[95], $arr)) $this->setSuiviSeulRegistreQuestionsElectronique($arr[$keys[95]]);
        if (array_key_exists($keys[96], $arr)) $this->setModifierConsultationMapaInferieurMontantApresValidation($arr[$keys[96]]);
        if (array_key_exists($keys[97], $arr)) $this->setModifierConsultationMapaSuperieurMontantApresValidation($arr[$keys[97]]);
        if (array_key_exists($keys[98], $arr)) $this->setModifierConsultationProceduresFormaliseesApresValidation($arr[$keys[98]]);
        if (array_key_exists($keys[99], $arr)) $this->setGererLesEntreprises($arr[$keys[99]]);
        if (array_key_exists($keys[100], $arr)) $this->setPorteeSocietesExclues($arr[$keys[100]]);
        if (array_key_exists($keys[101], $arr)) $this->setPorteeSocietesExcluesTousOrganismes($arr[$keys[101]]);
        if (array_key_exists($keys[102], $arr)) $this->setModifierSocietesExclues($arr[$keys[102]]);
        if (array_key_exists($keys[103], $arr)) $this->setSupprimerSocietesExclues($arr[$keys[103]]);
        if (array_key_exists($keys[104], $arr)) $this->setResultatAnalyse($arr[$keys[104]]);
        if (array_key_exists($keys[105], $arr)) $this->setGererAdressesService($arr[$keys[105]]);
        if (array_key_exists($keys[106], $arr)) $this->setGererMonService($arr[$keys[106]]);
        if (array_key_exists($keys[107], $arr)) $this->setDownloadArchives($arr[$keys[107]]);
        if (array_key_exists($keys[108], $arr)) $this->setCreerAnnonceExtraitPv($arr[$keys[108]]);
        if (array_key_exists($keys[109], $arr)) $this->setCreerAnnonceRapportAchevement($arr[$keys[109]]);
        if (array_key_exists($keys[110], $arr)) $this->setGestionCertificatsAgent($arr[$keys[110]]);
        if (array_key_exists($keys[111], $arr)) $this->setCreerAvisProgrammePrevisionnel($arr[$keys[111]]);
        if (array_key_exists($keys[112], $arr)) $this->setAnnulerConsultation($arr[$keys[112]]);
        if (array_key_exists($keys[113], $arr)) $this->setEnvoyerPublicite($arr[$keys[113]]);
        if (array_key_exists($keys[114], $arr)) $this->setListeMarchesNotifies($arr[$keys[114]]);
        if (array_key_exists($keys[115], $arr)) $this->setSuivreMessage($arr[$keys[115]]);
        if (array_key_exists($keys[116], $arr)) $this->setEnvoyerMessage($arr[$keys[116]]);
        if (array_key_exists($keys[117], $arr)) $this->setSuiviFluxChorusTransversal($arr[$keys[117]]);
        if (array_key_exists($keys[118], $arr)) $this->setGestionMandataire($arr[$keys[118]]);
        if (array_key_exists($keys[119], $arr)) $this->setGererNewsletter($arr[$keys[119]]);
        if (array_key_exists($keys[120], $arr)) $this->setGestionModelesFormulaire($arr[$keys[120]]);
        if (array_key_exists($keys[121], $arr)) $this->setGestionAdressesFacturationJal($arr[$keys[121]]);
        if (array_key_exists($keys[122], $arr)) $this->setAdministrerAdressesFacturationJal($arr[$keys[122]]);
        if (array_key_exists($keys[123], $arr)) $this->setRedactionDocumentsRedac($arr[$keys[123]]);
        if (array_key_exists($keys[124], $arr)) $this->setValidationDocumentsRedac($arr[$keys[124]]);
        if (array_key_exists($keys[125], $arr)) $this->setGestionMiseDispositionPiecesMarche($arr[$keys[125]]);
        if (array_key_exists($keys[126], $arr)) $this->setAnnuaireAcheteur($arr[$keys[126]]);
        if (array_key_exists($keys[127], $arr)) $this->setReprendreIntegralementArticle($arr[$keys[127]]);
        if (array_key_exists($keys[128], $arr)) $this->setAdministrerClauses($arr[$keys[128]]);
        if (array_key_exists($keys[129], $arr)) $this->setValiderClauses($arr[$keys[129]]);
        if (array_key_exists($keys[130], $arr)) $this->setAdministrerCanevas($arr[$keys[130]]);
        if (array_key_exists($keys[131], $arr)) $this->setValiderCanevas($arr[$keys[131]]);
        if (array_key_exists($keys[132], $arr)) $this->setAdministrerClausesEntiteAchats($arr[$keys[132]]);
        if (array_key_exists($keys[133], $arr)) $this->setGenererPiecesFormatOdt($arr[$keys[133]]);
        if (array_key_exists($keys[134], $arr)) $this->setPublierVersionClausierEditeur($arr[$keys[134]]);
        if (array_key_exists($keys[135], $arr)) $this->setAdministrerClausesEditeur($arr[$keys[135]]);
        if (array_key_exists($keys[136], $arr)) $this->setValiderClausesEditeur($arr[$keys[136]]);
        if (array_key_exists($keys[137], $arr)) $this->setAdministrerCanevasEditeur($arr[$keys[137]]);
        if (array_key_exists($keys[138], $arr)) $this->setValiderCanevasEditeur($arr[$keys[138]]);
        if (array_key_exists($keys[139], $arr)) $this->setDecisionSuiviSeul($arr[$keys[139]]);
        if (array_key_exists($keys[140], $arr)) $this->setOuvrirCandidatureHorsLigne($arr[$keys[140]]);
        if (array_key_exists($keys[141], $arr)) $this->setOuvrirOffreHorsLigne($arr[$keys[141]]);
        if (array_key_exists($keys[142], $arr)) $this->setOuvrirOffreTechniqueHorsLigne($arr[$keys[142]]);
        if (array_key_exists($keys[143], $arr)) $this->setOuvrirAnonymatHorsLigne($arr[$keys[143]]);
        if (array_key_exists($keys[144], $arr)) $this->setEspaceCollaboratifGestionnaire($arr[$keys[144]]);
        if (array_key_exists($keys[145], $arr)) $this->setEspaceCollaboratifContributeur($arr[$keys[145]]);
        if (array_key_exists($keys[146], $arr)) $this->setGererOrganismes($arr[$keys[146]]);
        if (array_key_exists($keys[147], $arr)) $this->setGererAssociationsAgents($arr[$keys[147]]);
        if (array_key_exists($keys[148], $arr)) $this->setModuleRedactionUniquement($arr[$keys[148]]);
        if (array_key_exists($keys[149], $arr)) $this->setHistoriqueNavigationInscrits($arr[$keys[149]]);
        if (array_key_exists($keys[150], $arr)) $this->setTelechargerAccordsCadres($arr[$keys[150]]);
        if (array_key_exists($keys[151], $arr)) $this->setCreerAnnonceDecisionResiliation($arr[$keys[151]]);
        if (array_key_exists($keys[152], $arr)) $this->setCreerAnnonceSyntheseRapportAudit($arr[$keys[152]]);
        if (array_key_exists($keys[153], $arr)) $this->setGererOperations($arr[$keys[153]]);
        if (array_key_exists($keys[154], $arr)) $this->setTelechargerSiretAcheteur($arr[$keys[154]]);
        if (array_key_exists($keys[155], $arr)) $this->setGererReouverturesModification($arr[$keys[155]]);
        if (array_key_exists($keys[156], $arr)) $this->setEnvoyerDemandeValidation($arr[$keys[156]]);
        if (array_key_exists($keys[157], $arr)) $this->setSuivreConsultationOrganisme($arr[$keys[157]]);
        if (array_key_exists($keys[158], $arr)) $this->setRenseignerMontant($arr[$keys[158]]);
        if (array_key_exists($keys[159], $arr)) $this->setGestionReferentielContact($arr[$keys[159]]);
        if (array_key_exists($keys[160], $arr)) $this->setValidationAccesFacture($arr[$keys[160]]);
        if (array_key_exists($keys[161], $arr)) $this->setGererCao($arr[$keys[161]]);
        if (array_key_exists($keys[162], $arr)) $this->setGestionTravauxCao($arr[$keys[162]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ID)) $criteria->add(CommonHabilitationProfilPeer::ID, $this->id);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::LIBELLE)) $criteria->add(CommonHabilitationProfilPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_AGENT_POLE)) $criteria->add(CommonHabilitationProfilPeer::GESTION_AGENT_POLE, $this->gestion_agent_pole);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_FOURNISSEURS_ENVOIS_POSTAUX)) $criteria->add(CommonHabilitationProfilPeer::GESTION_FOURNISSEURS_ENVOIS_POSTAUX, $this->gestion_fournisseurs_envois_postaux);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_BI_CLES)) $criteria->add(CommonHabilitationProfilPeer::GESTION_BI_CLES, $this->gestion_bi_cles);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::CREER_CONSULTATION, $this->creer_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION, $this->modifier_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::VALIDER_CONSULTATION, $this->valider_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PUBLIER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::PUBLIER_CONSULTATION, $this->publier_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION, $this->suivre_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_POLE)) $criteria->add(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_POLE, $this->suivre_consultation_pole);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUPPRIMER_ENVELOPPE)) $criteria->add(CommonHabilitationProfilPeer::SUPPRIMER_ENVELOPPE, $this->supprimer_enveloppe);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUPPRIMER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::SUPPRIMER_CONSULTATION, $this->supprimer_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DEPOUILLER_CANDIDATURE)) $criteria->add(CommonHabilitationProfilPeer::DEPOUILLER_CANDIDATURE, $this->depouiller_candidature);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DEPOUILLER_OFFRE)) $criteria->add(CommonHabilitationProfilPeer::DEPOUILLER_OFFRE, $this->depouiller_offre);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MESSAGERIE_SECURISEE)) $criteria->add(CommonHabilitationProfilPeer::MESSAGERIE_SECURISEE, $this->messagerie_securisee);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_PAPIER)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_PAPIER, $this->acces_registre_depots_papier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_PAPIER)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_PAPIER, $this->acces_registre_retraits_papier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_PAPIER)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_PAPIER, $this->acces_registre_questions_papier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ENCHERES)) $criteria->add(CommonHabilitationProfilPeer::GERER_ENCHERES, $this->gerer_encheres);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_ENCHERES)) $criteria->add(CommonHabilitationProfilPeer::SUIVRE_ENCHERES, $this->suivre_encheres);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_ENTREPRISE)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_ENTREPRISE, $this->suivi_entreprise);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOI_BOAMP)) $criteria->add(CommonHabilitationProfilPeer::ENVOI_BOAMP, $this->envoi_boamp);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_CLASSEMENT_LOT)) $criteria->add(CommonHabilitationProfilPeer::ACCES_CLASSEMENT_LOT, $this->acces_classement_lot);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CONNECTEUR_SIS)) $criteria->add(CommonHabilitationProfilPeer::CONNECTEUR_SIS, $this->connecteur_sis);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CONNECTEUR_MARCO)) $criteria->add(CommonHabilitationProfilPeer::CONNECTEUR_MARCO, $this->connecteur_marco);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REPONDRE_AUX_QUESTIONS)) $criteria->add(CommonHabilitationProfilPeer::REPONDRE_AUX_QUESTIONS, $this->repondre_aux_questions);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::APPEL_PROJET_FORMATION)) $criteria->add(CommonHabilitationProfilPeer::APPEL_PROJET_FORMATION, $this->appel_projet_formation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::UTILISER_CLIENT_CAO)) $criteria->add(CommonHabilitationProfilPeer::UTILISER_CLIENT_CAO, $this->utiliser_client_cao);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::NOTIFICATION_BOAMP)) $criteria->add(CommonHabilitationProfilPeer::NOTIFICATION_BOAMP, $this->notification_boamp);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_COMPTE)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_COMPTE, $this->administrer_compte);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MAPA)) $criteria->add(CommonHabilitationProfilPeer::GESTION_MAPA, $this->gestion_mapa);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_TYPE_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::GESTION_TYPE_VALIDATION, $this->gestion_type_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::APPROUVER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::APPROUVER_CONSULTATION, $this->approuver_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURE)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURE, $this->administrer_procedure);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RESTREINDRE_CREATION)) $criteria->add(CommonHabilitationProfilPeer::RESTREINDRE_CREATION, $this->restreindre_creation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_LISTE_MARCHES)) $criteria->add(CommonHabilitationProfilPeer::CREER_LISTE_MARCHES, $this->creer_liste_marches);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMMISSIONS)) $criteria->add(CommonHabilitationProfilPeer::GESTION_COMMISSIONS, $this->gestion_commissions);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_CONSULTATION, $this->suivi_seul_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ATTRIBUTION_MARCHE)) $criteria->add(CommonHabilitationProfilPeer::ATTRIBUTION_MARCHE, $this->attribution_marche);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::FICHE_RECENSEMENT)) $criteria->add(CommonHabilitationProfilPeer::FICHE_RECENSEMENT, $this->fiche_recensement);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DECLARER_INFRUCTUEUX)) $criteria->add(CommonHabilitationProfilPeer::DECLARER_INFRUCTUEUX, $this->declarer_infructueux);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DECLARER_SANS_SUITE)) $criteria->add(CommonHabilitationProfilPeer::DECLARER_SANS_SUITE, $this->declarer_sans_suite);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_CONSULTATION_TRANSVERSE)) $criteria->add(CommonHabilitationProfilPeer::CREER_CONSULTATION_TRANSVERSE, $this->creer_consultation_transverse);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_EN_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_EN_LIGNE, $this->ouvrir_candidature_en_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_A_DISTANCE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_A_DISTANCE, $this->ouvrir_candidature_a_distance);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REFUSER_ENVELOPPE)) $criteria->add(CommonHabilitationProfilPeer::REFUSER_ENVELOPPE, $this->refuser_enveloppe);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ADMISSIBILITE)) $criteria->add(CommonHabilitationProfilPeer::GERER_ADMISSIBILITE, $this->gerer_admissibilite);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RESTAURER_ENVELOPPE)) $criteria->add(CommonHabilitationProfilPeer::RESTAURER_ENVELOPPE, $this->restaurer_enveloppe);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_EN_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_OFFRE_EN_LIGNE, $this->ouvrir_offre_en_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_EN_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_EN_LIGNE, $this->ouvrir_anonymat_en_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMPTE_BOAMP)) $criteria->add(CommonHabilitationProfilPeer::GESTION_COMPTE_BOAMP, $this->gestion_compte_boamp);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_AGENTS)) $criteria->add(CommonHabilitationProfilPeer::GESTION_AGENTS, $this->gestion_agents);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_HABILITATIONS)) $criteria->add(CommonHabilitationProfilPeer::GESTION_HABILITATIONS, $this->gestion_habilitations);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_MAPA_INFERIEUR_MONTANT)) $criteria->add(CommonHabilitationProfilPeer::GERER_MAPA_INFERIEUR_MONTANT, $this->gerer_mapa_inferieur_montant);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_MAPA_SUPERIEUR_MONTANT)) $criteria->add(CommonHabilitationProfilPeer::GERER_MAPA_SUPERIEUR_MONTANT, $this->gerer_mapa_superieur_montant);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_AVANT_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_AVANT_VALIDATION, $this->modifier_consultation_avant_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_APRES_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_APRES_VALIDATION, $this->modifier_consultation_apres_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REPONSES)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REPONSES, $this->acces_reponses);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGEMENT_GROUPE_ANTICIPE_PLIS_CHIFFRES)) $criteria->add(CommonHabilitationProfilPeer::TELECHARGEMENT_GROUPE_ANTICIPE_PLIS_CHIFFRES, $this->telechargement_groupe_anticipe_plis_chiffres);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGEMENT_UNITAIRE_PLIS_CHIFFRES)) $criteria->add(CommonHabilitationProfilPeer::TELECHARGEMENT_UNITAIRE_PLIS_CHIFFRES, $this->telechargement_unitaire_plis_chiffres);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_A_DISTANCE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_OFFRE_A_DISTANCE, $this->ouvrir_offre_a_distance);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_INFORMATION)) $criteria->add(CommonHabilitationProfilPeer::CREER_ANNONCE_INFORMATION, $this->creer_annonce_information);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SAISIE_MARCHES)) $criteria->add(CommonHabilitationProfilPeer::SAISIE_MARCHES, $this->saisie_marches);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_MARCHES)) $criteria->add(CommonHabilitationProfilPeer::VALIDATION_MARCHES, $this->validation_marches);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PUBLICATION_MARCHES)) $criteria->add(CommonHabilitationProfilPeer::PUBLICATION_MARCHES, $this->publication_marches);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_STATISTIQUES_METIER)) $criteria->add(CommonHabilitationProfilPeer::GERER_STATISTIQUES_METIER, $this->gerer_statistiques_metier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ARCHIVES)) $criteria->add(CommonHabilitationProfilPeer::GERER_ARCHIVES, $this->gerer_archives);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURES_FORMALISEES)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_PROCEDURES_FORMALISEES, $this->administrer_procedures_formalisees);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_ATTRIBUTION)) $criteria->add(CommonHabilitationProfilPeer::CREER_ANNONCE_ATTRIBUTION, $this->creer_annonce_attribution);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_ELECTRONIQUE)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REGISTRE_RETRAITS_ELECTRONIQUE, $this->acces_registre_retraits_electronique);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_ELECTRONIQUE)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REGISTRE_QUESTIONS_ELECTRONIQUE, $this->acces_registre_questions_electronique);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_ELECTRONIQUE)) $criteria->add(CommonHabilitationProfilPeer::ACCES_REGISTRE_DEPOTS_ELECTRONIQUE, $this->acces_registre_depots_electronique);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_SIMPLE)) $criteria->add(CommonHabilitationProfilPeer::VALIDATION_SIMPLE, $this->validation_simple);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_INTERMEDIAIRE)) $criteria->add(CommonHabilitationProfilPeer::VALIDATION_INTERMEDIAIRE, $this->validation_intermediaire);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_FINALE)) $criteria->add(CommonHabilitationProfilPeer::VALIDATION_FINALE, $this->validation_finale);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_SUITE_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::CREER_SUITE_CONSULTATION, $this->creer_suite_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::HYPER_ADMIN)) $criteria->add(CommonHabilitationProfilPeer::HYPER_ADMIN, $this->hyper_admin);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DROIT_GESTION_SERVICES)) $criteria->add(CommonHabilitationProfilPeer::DROIT_GESTION_SERVICES, $this->droit_gestion_services);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_ACCES)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_ACCES, $this->suivi_acces);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::STATISTIQUES_SITE)) $criteria->add(CommonHabilitationProfilPeer::STATISTIQUES_SITE, $this->statistiques_site);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::STATISTIQUES_QOS)) $criteria->add(CommonHabilitationProfilPeer::STATISTIQUES_QOS, $this->statistiques_qos);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_A_DISTANCE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_A_DISTANCE, $this->ouvrir_anonymat_a_distance);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMPTE_JAL)) $criteria->add(CommonHabilitationProfilPeer::GESTION_COMPTE_JAL, $this->gestion_compte_jal);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_CENTRALE_PUB)) $criteria->add(CommonHabilitationProfilPeer::GESTION_CENTRALE_PUB, $this->gestion_centrale_pub);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_COMPTE_GROUPE_MONITEUR)) $criteria->add(CommonHabilitationProfilPeer::GESTION_COMPTE_GROUPE_MONITEUR, $this->gestion_compte_groupe_moniteur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_EN_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_EN_LIGNE, $this->ouvrir_offre_technique_en_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_A_DISTANCE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_A_DISTANCE, $this->ouvrir_offre_technique_a_distance);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ACTIVATION_COMPTE_ENTREPRISE)) $criteria->add(CommonHabilitationProfilPeer::ACTIVATION_COMPTE_ENTREPRISE, $this->activation_compte_entreprise);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::IMPORTER_ENVELOPPE)) $criteria->add(CommonHabilitationProfilPeer::IMPORTER_ENVELOPPE, $this->importer_enveloppe);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_PAPIER)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_PAPIER, $this->suivi_seul_registre_depots_papier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_PAPIER)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_PAPIER, $this->suivi_seul_registre_retraits_papier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_PAPIER)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_PAPIER, $this->suivi_seul_registre_questions_papier);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_ELECTRONIQUE)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_DEPOTS_ELECTRONIQUE, $this->suivi_seul_registre_depots_electronique);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_ELECTRONIQUE)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_RETRAITS_ELECTRONIQUE, $this->suivi_seul_registre_retraits_electronique);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_ELECTRONIQUE)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_SEUL_REGISTRE_QUESTIONS_ELECTRONIQUE, $this->suivi_seul_registre_questions_electronique);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_INFERIEUR_MONTANT_APRES_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_INFERIEUR_MONTANT_APRES_VALIDATION, $this->modifier_consultation_mapa_inferieur_montant_apres_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_SUPERIEUR_MONTANT_APRES_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_MAPA_SUPERIEUR_MONTANT_APRES_VALIDATION, $this->modifier_consultation_mapa_superieur_montant_apres_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_PROCEDURES_FORMALISEES_APRES_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_CONSULTATION_PROCEDURES_FORMALISEES_APRES_VALIDATION, $this->modifier_consultation_procedures_formalisees_apres_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_LES_ENTREPRISES)) $criteria->add(CommonHabilitationProfilPeer::GERER_LES_ENTREPRISES, $this->gerer_les_entreprises);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES)) $criteria->add(CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES, $this->portee_societes_exclues);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES_TOUS_ORGANISMES)) $criteria->add(CommonHabilitationProfilPeer::PORTEE_SOCIETES_EXCLUES_TOUS_ORGANISMES, $this->portee_societes_exclues_tous_organismes);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODIFIER_SOCIETES_EXCLUES)) $criteria->add(CommonHabilitationProfilPeer::MODIFIER_SOCIETES_EXCLUES, $this->modifier_societes_exclues);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUPPRIMER_SOCIETES_EXCLUES)) $criteria->add(CommonHabilitationProfilPeer::SUPPRIMER_SOCIETES_EXCLUES, $this->supprimer_societes_exclues);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RESULTAT_ANALYSE)) $criteria->add(CommonHabilitationProfilPeer::RESULTAT_ANALYSE, $this->resultat_analyse);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ADRESSES_SERVICE)) $criteria->add(CommonHabilitationProfilPeer::GERER_ADRESSES_SERVICE, $this->gerer_adresses_service);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_MON_SERVICE)) $criteria->add(CommonHabilitationProfilPeer::GERER_MON_SERVICE, $this->gerer_mon_service);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DOWNLOAD_ARCHIVES)) $criteria->add(CommonHabilitationProfilPeer::DOWNLOAD_ARCHIVES, $this->download_archives);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_EXTRAIT_PV)) $criteria->add(CommonHabilitationProfilPeer::CREER_ANNONCE_EXTRAIT_PV, $this->creer_annonce_extrait_pv);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_RAPPORT_ACHEVEMENT)) $criteria->add(CommonHabilitationProfilPeer::CREER_ANNONCE_RAPPORT_ACHEVEMENT, $this->creer_annonce_rapport_achevement);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_CERTIFICATS_AGENT)) $criteria->add(CommonHabilitationProfilPeer::GESTION_CERTIFICATS_AGENT, $this->gestion_certificats_agent);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_AVIS_PROGRAMME_PREVISIONNEL)) $criteria->add(CommonHabilitationProfilPeer::CREER_AVIS_PROGRAMME_PREVISIONNEL, $this->creer_avis_programme_previsionnel);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ANNULER_CONSULTATION)) $criteria->add(CommonHabilitationProfilPeer::ANNULER_CONSULTATION, $this->annuler_consultation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOYER_PUBLICITE)) $criteria->add(CommonHabilitationProfilPeer::ENVOYER_PUBLICITE, $this->envoyer_publicite);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::LISTE_MARCHES_NOTIFIES)) $criteria->add(CommonHabilitationProfilPeer::LISTE_MARCHES_NOTIFIES, $this->liste_marches_notifies);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_MESSAGE)) $criteria->add(CommonHabilitationProfilPeer::SUIVRE_MESSAGE, $this->suivre_message);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOYER_MESSAGE)) $criteria->add(CommonHabilitationProfilPeer::ENVOYER_MESSAGE, $this->envoyer_message);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVI_FLUX_CHORUS_TRANSVERSAL)) $criteria->add(CommonHabilitationProfilPeer::SUIVI_FLUX_CHORUS_TRANSVERSAL, $this->suivi_flux_chorus_transversal);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MANDATAIRE)) $criteria->add(CommonHabilitationProfilPeer::GESTION_MANDATAIRE, $this->gestion_mandataire);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_NEWSLETTER)) $criteria->add(CommonHabilitationProfilPeer::GERER_NEWSLETTER, $this->gerer_newsletter);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MODELES_FORMULAIRE)) $criteria->add(CommonHabilitationProfilPeer::GESTION_MODELES_FORMULAIRE, $this->gestion_modeles_formulaire);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_ADRESSES_FACTURATION_JAL)) $criteria->add(CommonHabilitationProfilPeer::GESTION_ADRESSES_FACTURATION_JAL, $this->gestion_adresses_facturation_jal);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_ADRESSES_FACTURATION_JAL)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_ADRESSES_FACTURATION_JAL, $this->administrer_adresses_facturation_jal);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REDACTION_DOCUMENTS_REDAC)) $criteria->add(CommonHabilitationProfilPeer::REDACTION_DOCUMENTS_REDAC, $this->redaction_documents_redac);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_DOCUMENTS_REDAC)) $criteria->add(CommonHabilitationProfilPeer::VALIDATION_DOCUMENTS_REDAC, $this->validation_documents_redac);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_MISE_DISPOSITION_PIECES_MARCHE)) $criteria->add(CommonHabilitationProfilPeer::GESTION_MISE_DISPOSITION_PIECES_MARCHE, $this->gestion_mise_disposition_pieces_marche);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ANNUAIRE_ACHETEUR)) $criteria->add(CommonHabilitationProfilPeer::ANNUAIRE_ACHETEUR, $this->annuaire_acheteur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::REPRENDRE_INTEGRALEMENT_ARTICLE)) $criteria->add(CommonHabilitationProfilPeer::REPRENDRE_INTEGRALEMENT_ARTICLE, $this->reprendre_integralement_article);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES, $this->administrer_clauses);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CLAUSES)) $criteria->add(CommonHabilitationProfilPeer::VALIDER_CLAUSES, $this->valider_clauses);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS, $this->administrer_canevas);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CANEVAS)) $criteria->add(CommonHabilitationProfilPeer::VALIDER_CANEVAS, $this->valider_canevas);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_ENTITE_ACHATS)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_ENTITE_ACHATS, $this->administrer_clauses_entite_achats);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GENERER_PIECES_FORMAT_ODT)) $criteria->add(CommonHabilitationProfilPeer::GENERER_PIECES_FORMAT_ODT, $this->generer_pieces_format_odt);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::PUBLIER_VERSION_CLAUSIER_EDITEUR)) $criteria->add(CommonHabilitationProfilPeer::PUBLIER_VERSION_CLAUSIER_EDITEUR, $this->publier_version_clausier_editeur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_EDITEUR)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_CLAUSES_EDITEUR, $this->administrer_clauses_editeur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CLAUSES_EDITEUR)) $criteria->add(CommonHabilitationProfilPeer::VALIDER_CLAUSES_EDITEUR, $this->valider_clauses_editeur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS_EDITEUR)) $criteria->add(CommonHabilitationProfilPeer::ADMINISTRER_CANEVAS_EDITEUR, $this->administrer_canevas_editeur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDER_CANEVAS_EDITEUR)) $criteria->add(CommonHabilitationProfilPeer::VALIDER_CANEVAS_EDITEUR, $this->valider_canevas_editeur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::DECISION_SUIVI_SEUL)) $criteria->add(CommonHabilitationProfilPeer::DECISION_SUIVI_SEUL, $this->decision_suivi_seul);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_HORS_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_CANDIDATURE_HORS_LIGNE, $this->ouvrir_candidature_hors_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_HORS_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_OFFRE_HORS_LIGNE, $this->ouvrir_offre_hors_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_HORS_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_OFFRE_TECHNIQUE_HORS_LIGNE, $this->ouvrir_offre_technique_hors_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_HORS_LIGNE)) $criteria->add(CommonHabilitationProfilPeer::OUVRIR_ANONYMAT_HORS_LIGNE, $this->ouvrir_anonymat_hors_ligne);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_GESTIONNAIRE)) $criteria->add(CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_GESTIONNAIRE, $this->espace_collaboratif_gestionnaire);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_CONTRIBUTEUR)) $criteria->add(CommonHabilitationProfilPeer::ESPACE_COLLABORATIF_CONTRIBUTEUR, $this->espace_collaboratif_contributeur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ORGANISMES)) $criteria->add(CommonHabilitationProfilPeer::GERER_ORGANISMES, $this->gerer_organismes);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_ASSOCIATIONS_AGENTS)) $criteria->add(CommonHabilitationProfilPeer::GERER_ASSOCIATIONS_AGENTS, $this->gerer_associations_agents);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::MODULE_REDACTION_UNIQUEMENT)) $criteria->add(CommonHabilitationProfilPeer::MODULE_REDACTION_UNIQUEMENT, $this->module_redaction_uniquement);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::HISTORIQUE_NAVIGATION_INSCRITS)) $criteria->add(CommonHabilitationProfilPeer::HISTORIQUE_NAVIGATION_INSCRITS, $this->historique_navigation_inscrits);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGER_ACCORDS_CADRES)) $criteria->add(CommonHabilitationProfilPeer::TELECHARGER_ACCORDS_CADRES, $this->telecharger_accords_cadres);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_DECISION_RESILIATION)) $criteria->add(CommonHabilitationProfilPeer::CREER_ANNONCE_DECISION_RESILIATION, $this->creer_annonce_decision_resiliation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::CREER_ANNONCE_SYNTHESE_RAPPORT_AUDIT)) $criteria->add(CommonHabilitationProfilPeer::CREER_ANNONCE_SYNTHESE_RAPPORT_AUDIT, $this->creer_annonce_synthese_rapport_audit);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_OPERATIONS)) $criteria->add(CommonHabilitationProfilPeer::GERER_OPERATIONS, $this->gerer_operations);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::TELECHARGER_SIRET_ACHETEUR)) $criteria->add(CommonHabilitationProfilPeer::TELECHARGER_SIRET_ACHETEUR, $this->telecharger_siret_acheteur);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_REOUVERTURES_MODIFICATION)) $criteria->add(CommonHabilitationProfilPeer::GERER_REOUVERTURES_MODIFICATION, $this->gerer_reouvertures_modification);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::ENVOYER_DEMANDE_VALIDATION)) $criteria->add(CommonHabilitationProfilPeer::ENVOYER_DEMANDE_VALIDATION, $this->envoyer_demande_validation);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_ORGANISME)) $criteria->add(CommonHabilitationProfilPeer::SUIVRE_CONSULTATION_ORGANISME, $this->suivre_consultation_organisme);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::RENSEIGNER_MONTANT)) $criteria->add(CommonHabilitationProfilPeer::RENSEIGNER_MONTANT, $this->renseigner_montant);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_REFERENTIEL_CONTACT)) $criteria->add(CommonHabilitationProfilPeer::GESTION_REFERENTIEL_CONTACT, $this->gestion_referentiel_contact);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::VALIDATION_ACCES_FACTURE)) $criteria->add(CommonHabilitationProfilPeer::VALIDATION_ACCES_FACTURE, $this->validation_acces_facture);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GERER_CAO)) $criteria->add(CommonHabilitationProfilPeer::GERER_CAO, $this->gerer_cao);
        if ($this->isColumnModified(CommonHabilitationProfilPeer::GESTION_TRAVAUX_CAO)) $criteria->add(CommonHabilitationProfilPeer::GESTION_TRAVAUX_CAO, $this->gestion_travaux_cao);
    ...
    {
        $criteria = new Criteria(CommonHabilitationProfilPeer::DATABASE_NAME);
        $criteria->add(CommonHabilitationProfilPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonHabilitationProfil (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonHabilitationProfil Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonHabilitationProfilPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonHabilitationProfilPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonHabilitationProfilPeer::DEFAULT_STRING_FORMAT);
    }
