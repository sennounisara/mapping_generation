...
abstract class BaseCommonOrganismePeer
{
    ...
    {
        // Invalidate objects in CommonAdministrateurPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonAdministrateurPeer::clearInstancePool();
        // Invalidate objects in CommonAffiliationServicePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonAffiliationServicePeer::clearInstancePool();
        // Invalidate objects in CommonAgentPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonAgentPeer::clearInstancePool();
        // Invalidate objects in CommonOrganismeServiceMetierPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonOrganismeServiceMetierPeer::clearInstancePool();
        // Invalidate objects in CommonParametrageEncherePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonParametrageEncherePeer::clearInstancePool();
        // Invalidate objects in CommonRPAPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonRPAPeer::clearInstancePool();
        // Invalidate objects in CommonConsultationPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        CommonConsultationPeer::clearInstancePool();
        // Invalidate objects in CommonDestinataireMiseDispositionPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += CommonOrganismePeer::doOnDeleteCascade(new Criteria(CommonOrganismePeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += CommonOrganismePeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = CommonOrganismePeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {


            // delete related CommonAdministrateur objects
            $criteria = new Criteria(CommonAdministrateurPeer::DATABASE_NAME);
            
            $criteria->add(CommonAdministrateurPeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonAdministrateurPeer::doDelete($criteria, $con);

            // delete related CommonAffiliationService objects
            $criteria = new Criteria(CommonAffiliationServicePeer::DATABASE_NAME);
            
            $criteria->add(CommonAffiliationServicePeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonAffiliationServicePeer::doDelete($criteria, $con);

            // delete related CommonAgent objects
            $criteria = new Criteria(CommonAgentPeer::DATABASE_NAME);
            
            $criteria->add(CommonAgentPeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonAgentPeer::doDelete($criteria, $con);

            // delete related CommonOrganismeServiceMetier objects
            $criteria = new Criteria(CommonOrganismeServiceMetierPeer::DATABASE_NAME);
            
            $criteria->add(CommonOrganismeServiceMetierPeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonOrganismeServiceMetierPeer::doDelete($criteria, $con);

            // delete related CommonParametrageEnchere objects
            $criteria = new Criteria(CommonParametrageEncherePeer::DATABASE_NAME);
            
            $criteria->add(CommonParametrageEncherePeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonParametrageEncherePeer::doDelete($criteria, $con);

            // delete related CommonRPA objects
            $criteria = new Criteria(CommonRPAPeer::DATABASE_NAME);
            
            $criteria->add(CommonRPAPeer::ACRONYMEORG, $obj->getAcronyme());
            $affectedRows += CommonRPAPeer::doDelete($criteria, $con);

            // delete related CommonConsultation objects
            $criteria = new Criteria(CommonConsultationPeer::DATABASE_NAME);
            
            $criteria->add(CommonConsultationPeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonConsultationPeer::doDelete($criteria, $con);

            // delete related CommonDestinataireMiseDisposition objects
            $criteria = new Criteria(CommonDestinataireMiseDispositionPeer::DATABASE_NAME);
            
            $criteria->add(CommonDestinataireMiseDispositionPeer::ORGANISME, $obj->getAcronyme());
            $affectedRows += CommonDestinataireMiseDispositionPeer::doDelete($criteria, $con);
        }
