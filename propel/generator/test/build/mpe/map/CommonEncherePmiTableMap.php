...
class CommonEncherePmiTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'mpe.map.CommonEncherePmiTableMap';
  ...
  1 => '1',
    ...
    {
        $this->addRelation('CommonEnchereEntreprisePmi', 'CommonEnchereEntreprisePmi', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', 'organisme' => 'organisme', ), null, null, 'CommonEnchereEntreprisePmis');
        $this->addRelation('CommonEnchereOffreRelatedByIdenchereOrganisme', 'CommonEnchereOffre', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonEnchereOffresRelatedByIdenchereOrganisme');
        $this->addRelation('CommonEnchereOffreRelatedByIdenchere', 'CommonEnchereOffre', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', ), 'CASCADE', 'CASCADE', 'CommonEnchereOffresRelatedByIdenchere');
        $this->addRelation('CommonEnchereReferenceRelatedByIdenchere', 'CommonEnchereReference', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', ), 'CASCADE', 'CASCADE', 'CommonEnchereReferencesRelatedByIdenchere');
        $this->addRelation('CommonEnchereReferenceRelatedByIdenchereOrganisme', 'CommonEnchereReference', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonEnchereReferencesRelatedByIdenchereOrganisme');
        $this->addRelation('CommonEnchereTranchesBaremeNETCRelatedByIdenchereOrganisme', 'CommonEnchereTranchesBaremeNETC', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', 'organisme' => 'organisme', ), 'CASCADE', 'CASCADE', 'CommonEnchereTranchesBaremeNETCsRelatedByIdenchereOrganisme');
        $this->addRelation('CommonEnchereTranchesBaremeNETCRelatedByIdenchere', 'CommonEnchereTranchesBaremeNETC', RelationMap::ONE_TO_MANY, array('id' => 'idEnchere', ), 'CASCADE', 'CASCADE', 'CommonEnchereTranchesBaremeNETCsRelatedByIdenchere');
    } // buildRelations()
