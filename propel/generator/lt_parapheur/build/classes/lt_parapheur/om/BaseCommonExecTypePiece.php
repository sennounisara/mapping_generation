...
/**
 * Base class that represents a row from the 'exec_type_piece' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonExecTypePiece extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonExecTypePiecePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonExecTypePiecePeer
     */
     ...
     * @return CommonExecTypePiece The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonExecTypePiecePeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonExecTypePiecePeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonExecTypePiecePeer::LIBELLE_FR;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonExecTypePiecePeer::LIBELLE_AR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonExecTypePiecePeer::LIBELLE_EN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = CommonExecTypePiecePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonExecTypePiece object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonExecTypePiecePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonExecTypePieceQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonExecTypePiecePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonExecTypePiecePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }

        $sql = sprintf(
            'INSERT INTO `exec_type_piece` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonExecTypePiecePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonExecTypePiecePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonExecTypePiece'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonExecTypePiece'][$this->getPrimaryKey()] = true;
        $keys = CommonExecTypePiecePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonExecTypePiecePeer::ID)) $criteria->add(CommonExecTypePiecePeer::ID, $this->id);
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE)) $criteria->add(CommonExecTypePiecePeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE_FR)) $criteria->add(CommonExecTypePiecePeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE_AR)) $criteria->add(CommonExecTypePiecePeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonExecTypePiecePeer::LIBELLE_EN)) $criteria->add(CommonExecTypePiecePeer::LIBELLE_EN, $this->libelle_en);
    ...
    {
        $criteria = new Criteria(CommonExecTypePiecePeer::DATABASE_NAME);
        $criteria->add(CommonExecTypePiecePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonExecTypePiece (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonExecTypePiece Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonExecTypePiecePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonExecTypePiecePeer();
        }
     ...
     * If this CommonExecTypePiece is new, it will return
        ...
        if (null === $this->collCommonExecPieces || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonExecPieces) {
                ...
                $collCommonExecPieces = CommonExecPieceQuery::create(null, $criteria)
                    ->filterByCommonExecTypePiece($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setCommonExecPieces(PropelCollection $commonExecPieces, PropelPDO $con = null)
    {
        ...
        foreach ($commonExecPiecesToDelete as $commonExecPieceRemoved) {
            $commonExecPieceRemoved->setCommonExecTypePiece(null);
        }
    ...
    protected function doAddCommonExecPiece($commonExecPiece)
    {
        ...
        $commonExecPiece->setCommonExecTypePiece($this);
    }
    ...
    public function removeCommonExecPiece($commonExecPiece)
    {
        if ($this->getCommonExecPieces()->contains($commonExecPiece)) {
            ...
            $commonExecPiece->setCommonExecTypePiece(null);
        }
     ...
     * Otherwise if this CommonExecTypePiece is new, it will return
     * an empty collection; or if this CommonExecTypePiece has previously
     * been saved, it will retrieve related CommonExecPieces from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonExecTypePiece.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(CommonExecTypePiecePeer::DEFAULT_STRING_FORMAT);
    }
