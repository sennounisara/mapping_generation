...
abstract class BaseCommonDAConsultationPeer
{
    ...
    public static function doCountJoinCommonOrganisme(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommonDAConsultationPeer::ORGANISME, CommonOrganismePeer::ACRONYME, $join_behavior);
    ...
    /**
     * Selects a collection of CommonDAConsultation objects pre-filled with their CommonOrganisme objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCommonOrganisme(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonDAConsultation) to $obj2 (CommonOrganisme)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CommonDAConsultation) to the collection in $obj2 (CommonOrganisme)
                $obj2->addCommonDAConsultation($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CommonDAConsultation) to the collection in $obj3 (CommonConsultation)
                $obj3->addCommonDAConsultation($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CommonDAConsultation objects pre-filled with all related objects except CommonOrganisme.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CommonDAConsultation objects pre-filled with all related objects except CommonConsultation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
