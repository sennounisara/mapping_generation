...
/**
 * Base class that represents a row from the 't_donnee_complementaire' table.
 *
 * 
 *
 * @package    propel.generator.lt_parapheur.om
 */
abstract class BaseCommonTDonneeComplementaire extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonTDonneeComplementairePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonTDonneeComplementairePeer
     */
    ...
    /**
     * The value for the criteres_identiques field.
     * Note: this column has a database default value of: '0'
     * @var        string
     */
    protected $criteres_identiques;

    /**
     * The value for the date_expression_besoin field.
     * @var        string
     */
    protected $date_expression_besoin;

    /**
     * The value for the id_ref_contact_1 field.
     * @var        int
     */
    protected $id_ref_contact_1;

    /**
     * The value for the id_ref_contact_2 field.
     * @var        int
     */
    protected $id_ref_contact_2;

    /**
     * @var        PropelObjectCollection|CommonTLotTechnique[] Collection to store aggregation of CommonTLotTechnique objects.
     */
    protected $collCommonTLotTechniques;
    protected $collCommonTLotTechniquesPartial;
     ...
     */
    protected $commonTLotTechniquesScheduledForDeletion = null;
    ...
    public function applyDefaultValues()
    {
        ...
        $this->criteres_identiques = '0';
    }

    /**
     * Initializes internal state of BaseCommonTDonneeComplementaire object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [criteres_identiques] column value.
     * 
     * @return string
     */
    public function getCriteresIdentiques()
    {

        return $this->criteres_identiques;
    }

    /**
     * Get the [optionally formatted] temporal [date_expression_besoin] column value.
     * 
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getDateExpressionBesoin($format = 'Y-m-d H:i:s')
    {
        if ($this->date_expression_besoin === null) {
            return null;
        }

        if ($this->date_expression_besoin === '0000-00-00 00:00:00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        }
        ...
        try {
            $dt = new DateTime($this->date_expression_besoin);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->date_expression_besoin, true), $x);
        }
    ...
    /**
     * Get the [id_ref_contact_1] column value.
     * 
     * @return int
     */
    public function getIdRefContact1()
    {

        return $this->id_ref_contact_1;
    }

    /**
     * Get the [id_ref_contact_2] column value.
     * 
     * @return int
     */
    public function getIdRefContact2()
    {

        return $this->id_ref_contact_2;
    }
     ...
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function setIdDonneeComplementaire($v)
    {
        ...
        if ($this->id_donnee_complementaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_DONNEE_COMPLEMENTAIRE;
        }
    ...
    public function setIdTrancheTypePrix($v)
    {
        ...
        if ($this->id_tranche_type_prix !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TRANCHE_TYPE_PRIX;
        }
    ...
    public function setIdFormePrix($v)
    {
        ...
        if ($this->id_forme_prix !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_FORME_PRIX;
        }
    ...
    public function setIdCcagReference($v)
    {
        ...
        if ($this->id_ccag_reference !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_CCAG_REFERENCE;
        }
    ...
    public function setReconductible($v)
    {
        ...
        if ($this->reconductible !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::RECONDUCTIBLE;
        }
    ...
    public function setNombreReconductions($v)
    {
        ...
        if ($this->nombre_reconductions !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::NOMBRE_RECONDUCTIONS;
        }
    ...
    public function setModalitesReconduction($v)
    {
        ...
        if ($this->modalites_reconduction !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::MODALITES_RECONDUCTION;
        }
    ...
    public function setVariantesAutorisees($v)
    {
        ...
        if ($this->variantes_autorisees !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::VARIANTES_AUTORISEES;
        }
    ...
    public function setVariantesTechniquesObligatoires($v)
    {
        ...
        if ($this->variantes_techniques_obligatoires !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_OBLIGATOIRES;
        }
    ...
    public function setVariantesTechniquesDescription($v)
    {
        ...
        if ($this->variantes_techniques_description !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_DESCRIPTION;
        }
    ...
    public function setDecompositionLotsTechniques($v)
    {
        ...
        if ($this->decomposition_lots_techniques !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DECOMPOSITION_LOTS_TECHNIQUES;
        }
    ...
    public function setIdDureeDelaiDescription($v)
    {
        ...
        if ($this->id_duree_delai_description !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_DUREE_DELAI_DESCRIPTION;
        }
    ...
    public function setEstimationPfAttPressenti($v)
    {
        ...
        if ($this->estimation_pf_att_pressenti !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_PF_ATT_PRESSENTI;
        }
    ...
    public function setEstimationBcMinAttPressenti($v)
    {
        ...
        if ($this->estimation_bc_min_att_pressenti !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_ATT_PRESSENTI;
        }
    ...
    public function setEstimationBcMaxAttPressenti($v)
    {
        ...
        if ($this->estimation_bc_max_att_pressenti !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_ATT_PRESSENTI;
        }
    ...
    public function setEstimationPfTabOuvOffre($v)
    {
        ...
        if ($this->estimation_pf_tab_ouv_offre !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_PF_TAB_OUV_OFFRE;
        }
    ...
    public function setEstimationDqeTabOuvOffre($v)
    {
        ...
        if ($this->estimation_dqe_tab_ouv_offre !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_DQE_TAB_OUV_OFFRE;
        }
    ...
    public function setAvisAttributionPresent($v)
    {
        ...
        if ($this->avis_attribution_present !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::AVIS_ATTRIBUTION_PRESENT;
        }
    ...
    public function setEstimationPfPreinscription($v)
    {
        ...
        if ($this->estimation_pf_preinscription !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_PF_PREINSCRIPTION;
        }
    ...
    public function setEstimationBcMinPreinscription($v)
    {
        ...
        if ($this->estimation_bc_min_preinscription !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_PREINSCRIPTION;
        }
    ...
    public function setEstimationBcMaxPreinscription($v)
    {
        ...
        if ($this->estimation_bc_max_preinscription !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_PREINSCRIPTION;
        }
    ...
    public function setEstimationDateValeurPreinscription($v)
    {
        ...
        if ($this->estimation_date_valeur_preinscription !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ESTIMATION_DATE_VALEUR_PREINSCRIPTION;
            }
    ...
    public function setLieuExecution($v)
    {
        ...
        if ($this->lieu_execution !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::LIEU_EXECUTION;
        }
    ...
    public function setDureeMarche($v)
    {
        ...
        if ($this->duree_marche !== $v) {
            $this->duree_marche = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DUREE_MARCHE;
        }
    ...
    public function setDureeDateDebut($v)
    {
        ...
        if ($this->duree_date_debut !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DUREE_DATE_DEBUT;
            }
        } // if either are not null
    ...
    public function setDureeDateFin($v)
    {
        ...
        if ($this->duree_date_fin !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DUREE_DATE_FIN;
            }
        } // if either are not null
    ...
    public function setDureeDescription($v)
    {
        ...
        if ($this->duree_description !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DUREE_DESCRIPTION;
        }
    ...
    public function setIdChoixMoisJour($v)
    {
        ...
        if ($this->id_choix_mois_jour !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_CHOIX_MOIS_JOUR;
        }
    ...
    public function setIdUnite($v)
    {
        ...
        if ($this->id_unite !== $v) {
            $this->id_unite = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_UNITE;
        }
    ...
    public function setIdNbCandidatsAdmis($v)
    {
        ...
        if ($this->id_nb_candidats_admis !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_NB_CANDIDATS_ADMIS;
        }
    ...
    public function setNombreCandidatsFixe($v)
    {
        ...
        if ($this->nombre_candidats_fixe !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_FIXE;
        }
    ...
    public function setNombreCandidatsMin($v)
    {
        ...
        if ($this->nombre_candidats_min !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MIN;
        }
    ...
    public function setNombreCandidatsMax($v)
    {
        ...
        if ($this->nombre_candidats_max !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MAX;
        }
    ...
    public function setDelaiValiditeOffres($v)
    {
        ...
        if ($this->delai_validite_offres !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DELAI_VALIDITE_OFFRES;
        }
    ...
    public function setPhaseSuccessive($v)
    {
        ...
        if ($this->phase_successive !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::PHASE_SUCCESSIVE;
        }
    ...
    public function setIdGroupementAttributaire($v)
    {
        ...
        if ($this->id_groupement_attributaire !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_GROUPEMENT_ATTRIBUTAIRE;
        }
    ...
    public function setIdCritereAttribution($v)
    {
        ...
        if ($this->id_critere_attribution !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_CRITERE_ATTRIBUTION;
        }
    ...
    public function setTypePrestation($v)
    {
        ...
        if ($this->type_prestation !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::TYPE_PRESTATION;
        }
    ...
    public function setDelaiPartiel($v)
    {
        ...
        if ($this->delai_partiel !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DELAI_PARTIEL;
        }
    ...
    public function setAdresseRetraisDossiers($v)
    {
        ...
        if ($this->adresse_retrais_dossiers !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ADRESSE_RETRAIS_DOSSIERS;
        }
    ...
    public function setAdresseDepotOffres($v)
    {
        ...
        if ($this->adresse_depot_offres !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ADRESSE_DEPOT_OFFRES;
        }
    ...
    public function setLieuOuverturePlis($v)
    {
        ...
        if ($this->lieu_ouverture_plis !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::LIEU_OUVERTURE_PLIS;
        }
    ...
    public function setPiecesDossierAdmin($v)
    {
        ...
        if ($this->pieces_dossier_admin !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADMIN;
        }
    ...
    public function setIdTrPiecesDossierAdmin($v)
    {
        ...
        if ($this->id_tr_pieces_dossier_admin !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADMIN;
        }
    ...
    public function setPiecesDossierTech($v)
    {
        ...
        if ($this->pieces_dossier_tech !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::PIECES_DOSSIER_TECH;
        }
    ...
    public function setIdTrPiecesDossierTech($v)
    {
        ...
        if ($this->id_tr_pieces_dossier_tech !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_TECH;
        }
    ...
    public function setPiecesDossierAdditif($v)
    {
        ...
        if ($this->pieces_dossier_additif !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADDITIF;
        }
    ...
    public function setIdTrPiecesDossierAdditif($v)
    {
        ...
        if ($this->id_tr_pieces_dossier_additif !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADDITIF;
        }
    ...
    public function setIdTrAdresseRetraisDossiers($v)
    {
        ...
        if ($this->id_tr_adresse_retrais_dossiers !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_ADRESSE_RETRAIS_DOSSIERS;
        }
    ...
    public function setIdTrAdresseDepotOffres($v)
    {
        ...
        if ($this->id_tr_adresse_depot_offres !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_ADRESSE_DEPOT_OFFRES;
        }
    ...
    public function setIdTrLieuOuverturePlis($v)
    {
        ...
        if ($this->id_tr_lieu_ouverture_plis !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_LIEU_OUVERTURE_PLIS;
        }
    ...
    public function setCautionProvisoire($v)
    {
        ...
        if ($this->caution_provisoire !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::CAUTION_PROVISOIRE;
        }
    ...
    public function setPrixAquisitionPlans($v)
    {
        ...
        if ($this->prix_aquisition_plans !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::PRIX_AQUISITION_PLANS;
        }
    ...
    public function setAddEchantillon($v)
    {
        ...
        if ($this->add_echantillon !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ADD_ECHANTILLON;
        }
    ...
    public function setIdTrAddEchantillon($v)
    {
        ...
        if ($this->id_tr_add_echantillon !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_ADD_ECHANTILLON;
        }
    ...
    public function setDateLimiteEchantillon($v)
    {
        ...
        if ($this->date_limite_echantillon !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DATE_LIMITE_ECHANTILLON;
        }
    ...
    public function setAddReunion($v)
    {
        ...
        if ($this->add_reunion !== $v) {
            $this->add_reunion = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ADD_REUNION;
        }
    ...
    public function setIdTrAddReunion($v)
    {
        ...
        if ($this->id_tr_add_reunion !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_TR_ADD_REUNION;
        }
    ...
    public function setDateReunion($v)
    {
        ...
        if ($this->date_reunion !== $v) {
            $this->date_reunion = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DATE_REUNION;
        }
    ...
    public function setReunion($v)
    {
        ...
        if ($this->reunion !== $v) {
            $this->reunion = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::REUNION;
        }
    ...
    public function setVisitesLieux($v)
    {
        ...
        if ($this->visites_lieux !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::VISITES_LIEUX;
        }
    ...
    public function setEchantillon($v)
    {
        ...
        if ($this->echantillon !== $v) {
            $this->echantillon = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ECHANTILLON;
        }
    ...
    public function setVariantes($v)
    {
        ...
        if ($this->variantes !== $v) {
            $this->variantes = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::VARIANTES;
        }
    ...
    public function setVarianteCalcule($v)
    {
        ...
        if ($this->variante_calcule !== $v) {
            ...
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::VARIANTE_CALCULE;
        }
    ...
    /**
     * Set the value of [criteres_identiques] column.
     * 
     * @param string $v new value
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function setCriteresIdentiques($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->criteres_identiques !== $v) {
            $this->criteres_identiques = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::CRITERES_IDENTIQUES;
        }


        return $this;
    } // setCriteresIdentiques()

    /**
     * Sets the value of [date_expression_besoin] column to a normalized version of the date/time value specified.
     * 
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function setDateExpressionBesoin($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->date_expression_besoin !== null || $dt !== null) {
            $currentDateAsString = ($this->date_expression_besoin !== null && $tmpDt = new DateTime($this->date_expression_besoin)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->date_expression_besoin = $newDateAsString;
                $this->modifiedColumns[] = CommonTDonneeComplementairePeer::DATE_EXPRESSION_BESOIN;
            }
        } // if either are not null


        return $this;
    } // setDateExpressionBesoin()

    /**
     * Set the value of [id_ref_contact_1] column.
     * 
     * @param int $v new value
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function setIdRefContact1($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_ref_contact_1 !== $v) {
            $this->id_ref_contact_1 = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_REF_CONTACT_1;
        }
    ...
    /**
     * Set the value of [id_ref_contact_2] column.
     * 
     * @param int $v new value
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function setIdRefContact2($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_ref_contact_2 !== $v) {
            $this->id_ref_contact_2 = $v;
            $this->modifiedColumns[] = CommonTDonneeComplementairePeer::ID_REF_CONTACT_2;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->criteres_identiques = ($row[$startcol + 64] !== null) ? (string) $row[$startcol + 64] : null;
            $this->date_expression_besoin = ($row[$startcol + 65] !== null) ? (string) $row[$startcol + 65] : null;
            $this->id_ref_contact_1 = ($row[$startcol + 66] !== null) ? (int) $row[$startcol + 66] : null;
            $this->id_ref_contact_2 = ($row[$startcol + 67] !== null) ? (int) $row[$startcol + 67] : null;
            $this->resetModified();
            ...
            return $startcol + 68; // 68 = CommonTDonneeComplementairePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonTDonneeComplementaire object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonTDonneeComplementairePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collCommonTLotTechniques = null;
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonTDonneeComplementaireQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonTDonneeComplementairePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->commonTLotTechniquesScheduledForDeletion !== null) {
                if (!$this->commonTLotTechniquesScheduledForDeletion->isEmpty()) {
                    foreach ($this->commonTLotTechniquesScheduledForDeletion as $commonTLotTechnique) {
                        // need to save related object because we set the relation to null
                        $commonTLotTechnique->save($con);
                    }
                    $this->commonTLotTechniquesScheduledForDeletion = null;
                }
            }

            if ($this->collCommonTLotTechniques !== null) {
                foreach ($this->collCommonTLotTechniques as $referrerFK) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_DONNEE_COMPLEMENTAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`id_donnee_complementaire`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TRANCHE_TYPE_PRIX)) {
            $modifiedColumns[':p' . $index++]  = '`id_tranche_type_prix`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_FORME_PRIX)) {
            $modifiedColumns[':p' . $index++]  = '`id_forme_prix`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_CCAG_REFERENCE)) {
            $modifiedColumns[':p' . $index++]  = '`id_ccag_reference`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::RECONDUCTIBLE)) {
            $modifiedColumns[':p' . $index++]  = '`reconductible`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_RECONDUCTIONS)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_reconductions`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::MODALITES_RECONDUCTION)) {
            $modifiedColumns[':p' . $index++]  = '`modalites_reconduction`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES_AUTORISEES)) {
            $modifiedColumns[':p' . $index++]  = '`variantes_autorisees`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_OBLIGATOIRES)) {
            $modifiedColumns[':p' . $index++]  = '`variantes_techniques_obligatoires`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`variantes_techniques_description`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DECOMPOSITION_LOTS_TECHNIQUES)) {
            $modifiedColumns[':p' . $index++]  = '`decomposition_lots_techniques`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_DUREE_DELAI_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`id_duree_delai_description`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_PF_ATT_PRESSENTI)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_pf_att_pressenti`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_ATT_PRESSENTI)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_bc_min_att_pressenti`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_ATT_PRESSENTI)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_bc_max_att_pressenti`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_PF_TAB_OUV_OFFRE)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_pf_tab_ouv_offre`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_DQE_TAB_OUV_OFFRE)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_dqe_tab_ouv_offre`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::AVIS_ATTRIBUTION_PRESENT)) {
            $modifiedColumns[':p' . $index++]  = '`avis_attribution_present`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_PF_PREINSCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_pf_preinscription`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_PREINSCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_bc_min_preinscription`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_PREINSCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_bc_max_preinscription`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_DATE_VALEUR_PREINSCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`estimation_date_valeur_preinscription`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::LIEU_EXECUTION)) {
            $modifiedColumns[':p' . $index++]  = '`lieu_execution`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_MARCHE)) {
            $modifiedColumns[':p' . $index++]  = '`duree_marche`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_DATE_DEBUT)) {
            $modifiedColumns[':p' . $index++]  = '`duree_date_debut`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_DATE_FIN)) {
            $modifiedColumns[':p' . $index++]  = '`duree_date_fin`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`duree_description`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_CHOIX_MOIS_JOUR)) {
            $modifiedColumns[':p' . $index++]  = '`id_choix_mois_jour`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_UNITE)) {
            $modifiedColumns[':p' . $index++]  = '`id_unite`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_NB_CANDIDATS_ADMIS)) {
            $modifiedColumns[':p' . $index++]  = '`id_nb_candidats_admis`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_FIXE)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_candidats_fixe`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MIN)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_candidats_min`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MAX)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_candidats_max`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DELAI_VALIDITE_OFFRES)) {
            $modifiedColumns[':p' . $index++]  = '`delai_validite_offres`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PHASE_SUCCESSIVE)) {
            $modifiedColumns[':p' . $index++]  = '`phase_successive`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_GROUPEMENT_ATTRIBUTAIRE)) {
            $modifiedColumns[':p' . $index++]  = '`id_groupement_attributaire`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_CRITERE_ATTRIBUTION)) {
            $modifiedColumns[':p' . $index++]  = '`id_critere_attribution`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::TYPE_PRESTATION)) {
            $modifiedColumns[':p' . $index++]  = '`type_prestation`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DELAI_PARTIEL)) {
            $modifiedColumns[':p' . $index++]  = '`delai_partiel`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADRESSE_RETRAIS_DOSSIERS)) {
            $modifiedColumns[':p' . $index++]  = '`adresse_retrais_dossiers`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADRESSE_DEPOT_OFFRES)) {
            $modifiedColumns[':p' . $index++]  = '`adresse_depot_offres`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::LIEU_OUVERTURE_PLIS)) {
            $modifiedColumns[':p' . $index++]  = '`lieu_ouverture_plis`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADMIN)) {
            $modifiedColumns[':p' . $index++]  = '`pieces_dossier_admin`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADMIN)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_pieces_dossier_admin`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PIECES_DOSSIER_TECH)) {
            $modifiedColumns[':p' . $index++]  = '`pieces_dossier_tech`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_TECH)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_pieces_dossier_tech`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADDITIF)) {
            $modifiedColumns[':p' . $index++]  = '`pieces_dossier_additif`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADDITIF)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_pieces_dossier_additif`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADRESSE_RETRAIS_DOSSIERS)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_adresse_retrais_dossiers`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADRESSE_DEPOT_OFFRES)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_adresse_depot_offres`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_LIEU_OUVERTURE_PLIS)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_lieu_ouverture_plis`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::CAUTION_PROVISOIRE)) {
            $modifiedColumns[':p' . $index++]  = '`caution_provisoire`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PRIX_AQUISITION_PLANS)) {
            $modifiedColumns[':p' . $index++]  = '`prix_aquisition_plans`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADD_ECHANTILLON)) {
            $modifiedColumns[':p' . $index++]  = '`add_echantillon`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADD_ECHANTILLON)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_add_echantillon`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DATE_LIMITE_ECHANTILLON)) {
            $modifiedColumns[':p' . $index++]  = '`date_limite_echantillon`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADD_REUNION)) {
            $modifiedColumns[':p' . $index++]  = '`add_reunion`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADD_REUNION)) {
            $modifiedColumns[':p' . $index++]  = '`id_tr_add_reunion`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DATE_REUNION)) {
            $modifiedColumns[':p' . $index++]  = '`date_reunion`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::REUNION)) {
            $modifiedColumns[':p' . $index++]  = '`reunion`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VISITES_LIEUX)) {
            $modifiedColumns[':p' . $index++]  = '`visites_lieux`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ECHANTILLON)) {
            $modifiedColumns[':p' . $index++]  = '`echantillon`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES)) {
            $modifiedColumns[':p' . $index++]  = '`variantes`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTE_CALCULE)) {
            $modifiedColumns[':p' . $index++]  = '`variante_calcule`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::CRITERES_IDENTIQUES)) {
            $modifiedColumns[':p' . $index++]  = '`criteres_identiques`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DATE_EXPRESSION_BESOIN)) {
            $modifiedColumns[':p' . $index++]  = '`date_expression_besoin`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_REF_CONTACT_1)) {
            $modifiedColumns[':p' . $index++]  = '`id_ref_contact_1`';
        }
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_REF_CONTACT_2)) {
            $modifiedColumns[':p' . $index++]  = '`id_ref_contact_2`';
        }

        $sql = sprintf(
            'INSERT INTO `t_donnee_complementaire` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`variante_calcule`':						
                        ...
                        break;
                    case '`criteres_identiques`':						
                        $stmt->bindValue($identifier, $this->criteres_identiques, PDO::PARAM_STR);
                        break;
                    case '`date_expression_besoin`':						
                        $stmt->bindValue($identifier, $this->date_expression_besoin, PDO::PARAM_STR);
                        break;
                    case '`id_ref_contact_1`':						
                        $stmt->bindValue($identifier, $this->id_ref_contact_1, PDO::PARAM_INT);
                        break;
                    case '`id_ref_contact_2`':						
                        $stmt->bindValue($identifier, $this->id_ref_contact_2, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonTDonneeComplementairePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonTDonneeComplementairePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 63:
                ...
                break;
            case 64:
                return $this->getCriteresIdentiques();
                break;
            case 65:
                return $this->getDateExpressionBesoin();
                break;
            case 66:
                return $this->getIdRefContact1();
                break;
            case 67:
                return $this->getIdRefContact2();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['CommonTDonneeComplementaire'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonTDonneeComplementaire'][$this->getPrimaryKey()] = true;
        $keys = CommonTDonneeComplementairePeer::getFieldNames($keyType);
        $result = array(
            ...
            $keys[64] => $this->getCriteresIdentiques(),
            $keys[65] => $this->getDateExpressionBesoin(),
            $keys[66] => $this->getIdRefContact1(),
            $keys[67] => $this->getIdRefContact2(),
        );
        if ($includeForeignObjects) {
            if (null !== $this->collCommonTLotTechniques) {
                $result['CommonTLotTechniques'] = $this->collCommonTLotTechniques->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 63:
                ...
                break;
            case 64:
                $this->setCriteresIdentiques($value);
                break;
            case 65:
                $this->setDateExpressionBesoin($value);
                break;
            case 66:
                $this->setIdRefContact1($value);
                break;
            case 67:
                $this->setIdRefContact2($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[64], $arr)) $this->setCriteresIdentiques($arr[$keys[64]]);
        if (array_key_exists($keys[65], $arr)) $this->setDateExpressionBesoin($arr[$keys[65]]);
        if (array_key_exists($keys[66], $arr)) $this->setIdRefContact1($arr[$keys[66]]);
        if (array_key_exists($keys[67], $arr)) $this->setIdRefContact2($arr[$keys[67]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_DONNEE_COMPLEMENTAIRE)) $criteria->add(CommonTDonneeComplementairePeer::ID_DONNEE_COMPLEMENTAIRE, $this->id_donnee_complementaire);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TRANCHE_TYPE_PRIX)) $criteria->add(CommonTDonneeComplementairePeer::ID_TRANCHE_TYPE_PRIX, $this->id_tranche_type_prix);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_FORME_PRIX)) $criteria->add(CommonTDonneeComplementairePeer::ID_FORME_PRIX, $this->id_forme_prix);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_CCAG_REFERENCE)) $criteria->add(CommonTDonneeComplementairePeer::ID_CCAG_REFERENCE, $this->id_ccag_reference);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::RECONDUCTIBLE)) $criteria->add(CommonTDonneeComplementairePeer::RECONDUCTIBLE, $this->reconductible);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_RECONDUCTIONS)) $criteria->add(CommonTDonneeComplementairePeer::NOMBRE_RECONDUCTIONS, $this->nombre_reconductions);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::MODALITES_RECONDUCTION)) $criteria->add(CommonTDonneeComplementairePeer::MODALITES_RECONDUCTION, $this->modalites_reconduction);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES_AUTORISEES)) $criteria->add(CommonTDonneeComplementairePeer::VARIANTES_AUTORISEES, $this->variantes_autorisees);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_OBLIGATOIRES)) $criteria->add(CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_OBLIGATOIRES, $this->variantes_techniques_obligatoires);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_DESCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::VARIANTES_TECHNIQUES_DESCRIPTION, $this->variantes_techniques_description);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DECOMPOSITION_LOTS_TECHNIQUES)) $criteria->add(CommonTDonneeComplementairePeer::DECOMPOSITION_LOTS_TECHNIQUES, $this->decomposition_lots_techniques);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_DUREE_DELAI_DESCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::ID_DUREE_DELAI_DESCRIPTION, $this->id_duree_delai_description);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_PF_ATT_PRESSENTI)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_PF_ATT_PRESSENTI, $this->estimation_pf_att_pressenti);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_ATT_PRESSENTI)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_ATT_PRESSENTI, $this->estimation_bc_min_att_pressenti);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_ATT_PRESSENTI)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_ATT_PRESSENTI, $this->estimation_bc_max_att_pressenti);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_PF_TAB_OUV_OFFRE)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_PF_TAB_OUV_OFFRE, $this->estimation_pf_tab_ouv_offre);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_DQE_TAB_OUV_OFFRE)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_DQE_TAB_OUV_OFFRE, $this->estimation_dqe_tab_ouv_offre);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::AVIS_ATTRIBUTION_PRESENT)) $criteria->add(CommonTDonneeComplementairePeer::AVIS_ATTRIBUTION_PRESENT, $this->avis_attribution_present);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_PF_PREINSCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_PF_PREINSCRIPTION, $this->estimation_pf_preinscription);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_PREINSCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_BC_MIN_PREINSCRIPTION, $this->estimation_bc_min_preinscription);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_PREINSCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_BC_MAX_PREINSCRIPTION, $this->estimation_bc_max_preinscription);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ESTIMATION_DATE_VALEUR_PREINSCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::ESTIMATION_DATE_VALEUR_PREINSCRIPTION, $this->estimation_date_valeur_preinscription);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::LIEU_EXECUTION)) $criteria->add(CommonTDonneeComplementairePeer::LIEU_EXECUTION, $this->lieu_execution);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_MARCHE)) $criteria->add(CommonTDonneeComplementairePeer::DUREE_MARCHE, $this->duree_marche);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_DATE_DEBUT)) $criteria->add(CommonTDonneeComplementairePeer::DUREE_DATE_DEBUT, $this->duree_date_debut);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_DATE_FIN)) $criteria->add(CommonTDonneeComplementairePeer::DUREE_DATE_FIN, $this->duree_date_fin);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DUREE_DESCRIPTION)) $criteria->add(CommonTDonneeComplementairePeer::DUREE_DESCRIPTION, $this->duree_description);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_CHOIX_MOIS_JOUR)) $criteria->add(CommonTDonneeComplementairePeer::ID_CHOIX_MOIS_JOUR, $this->id_choix_mois_jour);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_UNITE)) $criteria->add(CommonTDonneeComplementairePeer::ID_UNITE, $this->id_unite);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_NB_CANDIDATS_ADMIS)) $criteria->add(CommonTDonneeComplementairePeer::ID_NB_CANDIDATS_ADMIS, $this->id_nb_candidats_admis);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_FIXE)) $criteria->add(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_FIXE, $this->nombre_candidats_fixe);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MIN)) $criteria->add(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MIN, $this->nombre_candidats_min);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MAX)) $criteria->add(CommonTDonneeComplementairePeer::NOMBRE_CANDIDATS_MAX, $this->nombre_candidats_max);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DELAI_VALIDITE_OFFRES)) $criteria->add(CommonTDonneeComplementairePeer::DELAI_VALIDITE_OFFRES, $this->delai_validite_offres);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PHASE_SUCCESSIVE)) $criteria->add(CommonTDonneeComplementairePeer::PHASE_SUCCESSIVE, $this->phase_successive);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_GROUPEMENT_ATTRIBUTAIRE)) $criteria->add(CommonTDonneeComplementairePeer::ID_GROUPEMENT_ATTRIBUTAIRE, $this->id_groupement_attributaire);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_CRITERE_ATTRIBUTION)) $criteria->add(CommonTDonneeComplementairePeer::ID_CRITERE_ATTRIBUTION, $this->id_critere_attribution);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::TYPE_PRESTATION)) $criteria->add(CommonTDonneeComplementairePeer::TYPE_PRESTATION, $this->type_prestation);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DELAI_PARTIEL)) $criteria->add(CommonTDonneeComplementairePeer::DELAI_PARTIEL, $this->delai_partiel);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADRESSE_RETRAIS_DOSSIERS)) $criteria->add(CommonTDonneeComplementairePeer::ADRESSE_RETRAIS_DOSSIERS, $this->adresse_retrais_dossiers);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADRESSE_DEPOT_OFFRES)) $criteria->add(CommonTDonneeComplementairePeer::ADRESSE_DEPOT_OFFRES, $this->adresse_depot_offres);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::LIEU_OUVERTURE_PLIS)) $criteria->add(CommonTDonneeComplementairePeer::LIEU_OUVERTURE_PLIS, $this->lieu_ouverture_plis);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADMIN)) $criteria->add(CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADMIN, $this->pieces_dossier_admin);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADMIN)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADMIN, $this->id_tr_pieces_dossier_admin);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PIECES_DOSSIER_TECH)) $criteria->add(CommonTDonneeComplementairePeer::PIECES_DOSSIER_TECH, $this->pieces_dossier_tech);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_TECH)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_TECH, $this->id_tr_pieces_dossier_tech);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADDITIF)) $criteria->add(CommonTDonneeComplementairePeer::PIECES_DOSSIER_ADDITIF, $this->pieces_dossier_additif);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADDITIF)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_PIECES_DOSSIER_ADDITIF, $this->id_tr_pieces_dossier_additif);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADRESSE_RETRAIS_DOSSIERS)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_ADRESSE_RETRAIS_DOSSIERS, $this->id_tr_adresse_retrais_dossiers);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADRESSE_DEPOT_OFFRES)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_ADRESSE_DEPOT_OFFRES, $this->id_tr_adresse_depot_offres);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_LIEU_OUVERTURE_PLIS)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_LIEU_OUVERTURE_PLIS, $this->id_tr_lieu_ouverture_plis);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::CAUTION_PROVISOIRE)) $criteria->add(CommonTDonneeComplementairePeer::CAUTION_PROVISOIRE, $this->caution_provisoire);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::PRIX_AQUISITION_PLANS)) $criteria->add(CommonTDonneeComplementairePeer::PRIX_AQUISITION_PLANS, $this->prix_aquisition_plans);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADD_ECHANTILLON)) $criteria->add(CommonTDonneeComplementairePeer::ADD_ECHANTILLON, $this->add_echantillon);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADD_ECHANTILLON)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_ADD_ECHANTILLON, $this->id_tr_add_echantillon);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DATE_LIMITE_ECHANTILLON)) $criteria->add(CommonTDonneeComplementairePeer::DATE_LIMITE_ECHANTILLON, $this->date_limite_echantillon);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ADD_REUNION)) $criteria->add(CommonTDonneeComplementairePeer::ADD_REUNION, $this->add_reunion);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_TR_ADD_REUNION)) $criteria->add(CommonTDonneeComplementairePeer::ID_TR_ADD_REUNION, $this->id_tr_add_reunion);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DATE_REUNION)) $criteria->add(CommonTDonneeComplementairePeer::DATE_REUNION, $this->date_reunion);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::REUNION)) $criteria->add(CommonTDonneeComplementairePeer::REUNION, $this->reunion);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VISITES_LIEUX)) $criteria->add(CommonTDonneeComplementairePeer::VISITES_LIEUX, $this->visites_lieux);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ECHANTILLON)) $criteria->add(CommonTDonneeComplementairePeer::ECHANTILLON, $this->echantillon);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTES)) $criteria->add(CommonTDonneeComplementairePeer::VARIANTES, $this->variantes);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::VARIANTE_CALCULE)) $criteria->add(CommonTDonneeComplementairePeer::VARIANTE_CALCULE, $this->variante_calcule);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::CRITERES_IDENTIQUES)) $criteria->add(CommonTDonneeComplementairePeer::CRITERES_IDENTIQUES, $this->criteres_identiques);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::DATE_EXPRESSION_BESOIN)) $criteria->add(CommonTDonneeComplementairePeer::DATE_EXPRESSION_BESOIN, $this->date_expression_besoin);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_REF_CONTACT_1)) $criteria->add(CommonTDonneeComplementairePeer::ID_REF_CONTACT_1, $this->id_ref_contact_1);
        if ($this->isColumnModified(CommonTDonneeComplementairePeer::ID_REF_CONTACT_2)) $criteria->add(CommonTDonneeComplementairePeer::ID_REF_CONTACT_2, $this->id_ref_contact_2);
    ...
    {
        $criteria = new Criteria(CommonTDonneeComplementairePeer::DATABASE_NAME);
        $criteria->add(CommonTDonneeComplementairePeer::ID_DONNEE_COMPLEMENTAIRE, $this->id_donnee_complementaire);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonTDonneeComplementaire (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCriteresIdentiques($this->getCriteresIdentiques());
        $copyObj->setDateExpressionBesoin($this->getDateExpressionBesoin());
        $copyObj->setIdRefContact1($this->getIdRefContact1());
        $copyObj->setIdRefContact2($this->getIdRefContact2());
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getCommonTLotTechniques() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addCommonTLotTechnique($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonTDonneeComplementaire Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonTDonneeComplementairePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonTDonneeComplementairePeer();
        }
    ...
    {
        if ('CommonTLotTechnique' == $relationName) {
            $this->initCommonTLotTechniques();
        }
    ...
    /**
     * Clears out the collCommonTLotTechniques collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     * @see        addCommonTLotTechniques()
     */
    public function clearCommonTLotTechniques()
    {
        $this->collCommonTLotTechniques = null; // important to set this to null since that means it is uninitialized
        $this->collCommonTLotTechniquesPartial = null;

        return $this;
    }

    /**
     * reset is the collCommonTLotTechniques collection loaded partially
     *
     * @return void
     */
    public function resetPartialCommonTLotTechniques($v = true)
    {
        $this->collCommonTLotTechniquesPartial = $v;
    }

    /**
     * Initializes the collCommonTLotTechniques collection.
     *
     * By default this just sets the collCommonTLotTechniques collection to an empty array (like clearcollCommonTLotTechniques());
     ...
     * @return void
     */
    public function initCommonTLotTechniques($overrideExisting = true)
    {
        if (null !== $this->collCommonTLotTechniques && !$overrideExisting) {
            return;
        }
        $this->collCommonTLotTechniques = new PropelObjectCollection();
        $this->collCommonTLotTechniques->setModel('CommonTLotTechnique');
    }

    /**
     * Gets an array of CommonTLotTechnique objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this CommonTDonneeComplementaire is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|CommonTLotTechnique[] List of CommonTLotTechnique objects
     * @throws PropelException
     */
    public function getCommonTLotTechniques($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collCommonTLotTechniquesPartial && !$this->isNew();
        if (null === $this->collCommonTLotTechniques || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collCommonTLotTechniques) {
                // return empty collection
                $this->initCommonTLotTechniques();
            } else {
                $collCommonTLotTechniques = CommonTLotTechniqueQuery::create(null, $criteria)
                    ->filterByCommonTDonneeComplementaire($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collCommonTLotTechniquesPartial && count($collCommonTLotTechniques)) {
                      $this->initCommonTLotTechniques(false);

                      foreach ($collCommonTLotTechniques as $obj) {
                        if (false == $this->collCommonTLotTechniques->contains($obj)) {
                          $this->collCommonTLotTechniques->append($obj);
                        }
                      }

                      $this->collCommonTLotTechniquesPartial = true;
                    }

                    $collCommonTLotTechniques->getInternalIterator()->rewind();

                    return $collCommonTLotTechniques;
                }

                if ($partial && $this->collCommonTLotTechniques) {
                    foreach ($this->collCommonTLotTechniques as $obj) {
                        if ($obj->isNew()) {
                            $collCommonTLotTechniques[] = $obj;
                        }
                    }
                }

                $this->collCommonTLotTechniques = $collCommonTLotTechniques;
                $this->collCommonTLotTechniquesPartial = false;
            }
        }

        return $this->collCommonTLotTechniques;
    }

    /**
     * Sets a collection of CommonTLotTechnique objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $commonTLotTechniques A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function setCommonTLotTechniques(PropelCollection $commonTLotTechniques, PropelPDO $con = null)
    {
        $commonTLotTechniquesToDelete = $this->getCommonTLotTechniques(new Criteria(), $con)->diff($commonTLotTechniques);


        $this->commonTLotTechniquesScheduledForDeletion = $commonTLotTechniquesToDelete;

        foreach ($commonTLotTechniquesToDelete as $commonTLotTechniqueRemoved) {
            $commonTLotTechniqueRemoved->setCommonTDonneeComplementaire(null);
        }

        $this->collCommonTLotTechniques = null;
        foreach ($commonTLotTechniques as $commonTLotTechnique) {
            $this->addCommonTLotTechnique($commonTLotTechnique);
        }

        $this->collCommonTLotTechniques = $commonTLotTechniques;
        $this->collCommonTLotTechniquesPartial = false;
    ...
    /**
     * Returns the number of related CommonTLotTechnique objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related CommonTLotTechnique objects.
     * @throws PropelException
     */
    public function countCommonTLotTechniques(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collCommonTLotTechniquesPartial && !$this->isNew();
        if (null === $this->collCommonTLotTechniques || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collCommonTLotTechniques) {
            ...
            if ($partial && !$criteria) {
                return count($this->getCommonTLotTechniques());
            }
            $query = CommonTLotTechniqueQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collCommonTLotTechniques);
    }

    /**
     * Method called to associate a CommonTLotTechnique object to this object
     * through the CommonTLotTechnique foreign key attribute.
     *
     * @param   CommonTLotTechnique $l CommonTLotTechnique
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function addCommonTLotTechnique(CommonTLotTechnique $l)
    {
        if ($this->collCommonTLotTechniques === null) {
            $this->initCommonTLotTechniques();
            $this->collCommonTLotTechniquesPartial = true;
        }
        if (!in_array($l, $this->collCommonTLotTechniques->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddCommonTLotTechnique($l);
        }
    ...
    /**
     * @param	CommonTLotTechnique $commonTLotTechnique The commonTLotTechnique object to add.
     */
    protected function doAddCommonTLotTechnique($commonTLotTechnique)
    {
        $this->collCommonTLotTechniques[]= $commonTLotTechnique;
        $commonTLotTechnique->setCommonTDonneeComplementaire($this);
    }

    /**
     * @param	CommonTLotTechnique $commonTLotTechnique The commonTLotTechnique object to remove.
     * @return CommonTDonneeComplementaire The current object (for fluent API support)
     */
    public function removeCommonTLotTechnique($commonTLotTechnique)
    {
        if ($this->getCommonTLotTechniques()->contains($commonTLotTechnique)) {
            $this->collCommonTLotTechniques->remove($this->collCommonTLotTechniques->search($commonTLotTechnique));
            if (null === $this->commonTLotTechniquesScheduledForDeletion) {
                $this->commonTLotTechniquesScheduledForDeletion = clone $this->collCommonTLotTechniques;
                $this->commonTLotTechniquesScheduledForDeletion->clear();
            }
            $this->commonTLotTechniquesScheduledForDeletion[]= clone $commonTLotTechnique;
            $commonTLotTechnique->setCommonTDonneeComplementaire(null);
        }
    ...
    public function setCommonTTranches(PropelCollection $commonTTranches, PropelPDO $con = null)
    {
        ...
        foreach ($commonTTranchesToDelete as $commonTTrancheRemoved) {
            $commonTTrancheRemoved->setCommonTDonneeComplementaire(null);
        }
    ...
    protected function doAddCommonTTranche($commonTTranche)
    {
        ...
        $commonTTranche->setCommonTDonneeComplementaire($this);
    }
    ...
    public function removeCommonTTranche($commonTTranche)
    {
        if ($this->getCommonTTranches()->contains($commonTTranche)) {
            ...
            $commonTTranche->setCommonTDonneeComplementaire(null);
        }
     ...
     * Otherwise if this CommonTDonneeComplementaire is new, it will return
     * an empty collection; or if this CommonTDonneeComplementaire has previously
     * been saved, it will retrieve related CommonTTranches from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CommonTDonneeComplementaire.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|CommonTTranche[] List of CommonTTranche objects
     */
    public function getCommonTTranchesJoinCommonTFormePrix($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommonTTrancheQuery::create(null, $criteria);
        $query->joinWith('CommonTFormePrix', $join_behavior);
    ...
    public function clear()
    {
        ...
        $this->criteres_identiques = null;
        $this->date_expression_besoin = null;
        $this->id_ref_contact_1 = null;
        $this->id_ref_contact_2 = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collCommonTLotTechniques) {
                foreach ($this->collCommonTLotTechniques as $o) {
        ...
        if ($this->collCommonTLotTechniques instanceof PropelCollection) {
            $this->collCommonTLotTechniques->clearIterator();
        }
        $this->collCommonTLotTechniques = null;
    ...
    {
        return (string) $this->exportTo(CommonTDonneeComplementairePeer::DEFAULT_STRING_FORMAT);
    }
