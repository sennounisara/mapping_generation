...
/**
 * Base class that represents a row from the 'DecisionPassationMarcheAVenir' table.
 *
 * 
 *
 * @package    propel.generator.mpe.om
 */
abstract class BaseCommonDecisionPassationMarcheAVenir extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CommonDecisionPassationMarcheAVenirPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CommonDecisionPassationMarcheAVenirPeer
     */
     ...
     * @return CommonDecisionPassationMarcheAVenir The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::ID;
        }
    ...
    public function setLibelle($v)
    {
        ...
        if ($this->libelle !== $v) {
            $this->libelle = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE;
        }
    ...
    public function setLibelleFr($v)
    {
        ...
        if ($this->libelle_fr !== $v) {
            $this->libelle_fr = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_FR;
        }
    ...
    public function setLibelleEn($v)
    {
        ...
        if ($this->libelle_en !== $v) {
            $this->libelle_en = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_EN;
        }
    ...
    public function setLibelleEs($v)
    {
        ...
        if ($this->libelle_es !== $v) {
            $this->libelle_es = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_ES;
        }
    ...
    public function setLibelleSu($v)
    {
        ...
        if ($this->libelle_su !== $v) {
            $this->libelle_su = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_SU;
        }
    ...
    public function setLibelleDu($v)
    {
        ...
        if ($this->libelle_du !== $v) {
            $this->libelle_du = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_DU;
        }
    ...
    public function setLibelleCz($v)
    {
        ...
        if ($this->libelle_cz !== $v) {
            $this->libelle_cz = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_CZ;
        }
    ...
    public function setLibelleAr($v)
    {
        ...
        if ($this->libelle_ar !== $v) {
            $this->libelle_ar = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_AR;
        }
    ...
    public function setLibelleIt($v)
    {
        ...
        if ($this->libelle_it !== $v) {
            $this->libelle_it = $v;
            $this->modifiedColumns[] = CommonDecisionPassationMarcheAVenirPeer::LIBELLE_IT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 10; // 10 = CommonDecisionPassationMarcheAVenirPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CommonDecisionPassationMarcheAVenir object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CommonDecisionPassationMarcheAVenirPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CommonDecisionPassationMarcheAVenirQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CommonDecisionPassationMarcheAVenirPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE)) {
            $modifiedColumns[':p' . $index++]  = '`libelle`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_FR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_fr`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_EN)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_en`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_ES)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_es`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_SU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_su`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_DU)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_du`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_CZ)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_cz`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_AR)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_ar`';
        }
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_IT)) {
            $modifiedColumns[':p' . $index++]  = '`libelle_it`';
        }

        $sql = sprintf(
            'INSERT INTO `DecisionPassationMarcheAVenir` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CommonDecisionPassationMarcheAVenirPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CommonDecisionPassationMarcheAVenirPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CommonDecisionPassationMarcheAVenir'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CommonDecisionPassationMarcheAVenir'][$this->getPrimaryKey()] = true;
        $keys = CommonDecisionPassationMarcheAVenirPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::ID)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::ID, $this->id);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE, $this->libelle);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_FR)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_FR, $this->libelle_fr);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_EN)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_EN, $this->libelle_en);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_ES)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_ES, $this->libelle_es);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_SU)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_SU, $this->libelle_su);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_DU)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_DU, $this->libelle_du);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_CZ)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_CZ, $this->libelle_cz);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_AR)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_AR, $this->libelle_ar);
        if ($this->isColumnModified(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_IT)) $criteria->add(CommonDecisionPassationMarcheAVenirPeer::LIBELLE_IT, $this->libelle_it);
    ...
    {
        $criteria = new Criteria(CommonDecisionPassationMarcheAVenirPeer::DATABASE_NAME);
        $criteria->add(CommonDecisionPassationMarcheAVenirPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CommonDecisionPassationMarcheAVenir (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CommonDecisionPassationMarcheAVenir Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CommonDecisionPassationMarcheAVenirPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CommonDecisionPassationMarcheAVenirPeer();
        }
    ...
    {
        return (string) $this->exportTo(CommonDecisionPassationMarcheAVenirPeer::DEFAULT_STRING_FORMAT);
    }
